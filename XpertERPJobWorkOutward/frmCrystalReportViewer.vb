...
#End Region
    ...
    Public Function GetReportPath(ByVal crpfolder As CrystalReportFolder, ByVal strReportName As String) As String
        ...
        strReportPath = GetReportPath(crpfolder, strReportName, Nothing)
    ...
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal ePaperSize As EnumTecxpertPaperSize, ByVal strReportName As String, ByVal strCaption As String)
        funreport(crpfolder, dt, ePaperSize, strReportName, strCaption, False, Nothing)
    End Sub
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal ePaperSize As EnumTecxpertPaperSize, ByVal strReportName As String, ByVal strCaption As String, ByVal IsShowDilogue As Boolean)
        funreport(crpfolder, dt, ePaperSize, strReportName, strCaption, IsShowDilogue, Nothing)
    End Sub
    ...
    Public Sub funsubreport(ByVal crpfolder As CrystalReportFolder, ByVal qry As String, ByVal qry1 As String, ByVal strReportName As String, ByVal strCaption As String)
        funsubreport(crpfolder, qry, qry1, strReportName, strCaption, vbNullString, Nothing)
    End Sub
    ...
    Public Sub funsubreportWithdt(ByVal crpfolder As CrystalReportFolder, ByVal dt1 As DataTable, ByVal dt2 As DataTable, ByVal strReportName As String, ByVal strCaption As String, Optional ByVal strSubReport1 As String = vbNullString, Optional ByVal strSubReport2 As String = vbNullString, Optional ByVal dt3 As DataTable = Nothing, Optional ByVal strSubReport3 As String = vbNullString, Optional ByVal dt4 As DataTable = Nothing)
        funsubreportWithdt(crpfolder, dt1, dt2, strReportName, strCaption, Nothing, strSubReport1, strSubReport2, dt3, strSubReport3, dt4)
    End Sub
    

    Public Sub funsubreportWithdt(ByVal crpfolder As CrystalReportFolder, ByVal dt1 As DataTable, ByVal dt2 As DataTable, ByVal strReportName As String, ByVal strCaption As String, ByVal dtTranDate? As Date, Optional ByVal strSubReport1 As String = vbNullString, Optional ByVal strSubReport2 As String = vbNullString, Optional ByVal dt3 As DataTable = Nothing, Optional ByVal strSubReport3 As String = vbNullString, Optional ByVal dt4 As DataTable = Nothing)
        Try
            Dim rptshow As Boolean
            If dt1.Rows.Count > 0 Then
                Dim rpdoc As New ReportDocument()
    ...
    Public Sub funSubreport(ByVal crpfolder As CrystalReportFolder, ByVal strquery As String, ByVal strquery1 As String, ByVal strquery2 As String, ByVal strquery3 As String, ByVal strquery4 As String, ByVal strReportName As String, ByVal strCaption As String, Optional ByVal strSubReport1 As String = vbNullString, Optional ByVal strSubReport2 As String = vbNullString, Optional ByVal strSubReport3 As String = vbNullString, Optional ByVal strSubReport4 As String = vbNullString, Optional ByVal strSubReport5 As String = vbNullString, Optional ByVal strSubReport6 As String = vbNullString, Optional ByVal strSubReport7 As String = vbNullString, Optional ByVal strSubReport8 As String = vbNullString, Optional ByVal strSubReport9 As String = vbNullString, Optional ByVal strSubReport10 As String = vbNullString)
        funsubreport(crpfolder, strquery, strquery1, strquery2, strquery3, strquery4, strReportName, strCaption, Nothing, strSubReport1, strSubReport2, strSubReport3, strSubReport4, strSubReport5, strSubReport6, strSubReport7, strSubReport8, strSubReport9, strSubReport10)
    End Sub

    Public Sub funSubreport(ByVal crpfolder As CrystalReportFolder, ByVal strquery As String, ByVal strquery1 As String, ByVal strquery2 As String, ByVal strquery3 As String, ByVal strquery4 As String, ByVal strReportName As String, ByVal strCaption As String, ByVal dtTranDate? As Date, Optional ByVal strSubReport1 As String = vbNullString, Optional ByVal strSubReport2 As String = vbNullString, Optional ByVal strSubReport3 As String = vbNullString, Optional ByVal strSubReport4 As String = vbNullString, Optional ByVal strSubReport5 As String = vbNullString, Optional ByVal strSubReport6 As String = vbNullString, Optional ByVal strSubReport7 As String = vbNullString, Optional ByVal strSubReport8 As String = vbNullString, Optional ByVal strSubReport9 As String = vbNullString, Optional ByVal strSubReport10 As String = vbNullString)
        Try
