...
Public Class frmJWPriceCodeMaster
...
#End Region
    ...
    Public Sub Save()
        ...
        If AllowToSave() Then
            ...
            Dim obj As New clsJobWorkOutward()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsJobWorkOutward()
        obj = clsJobWorkOutward.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_JOB_OUTWARD_PRICE_MASTER where Code ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            txtCode.Value = clsJobWorkOutward.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Export.Click
        Dim str As String
        str = "select Code, Description from TSPL_JOB_OUTWARD_PRICE_MASTER"
            ...
            Try
                ...
                Try
                    For Each grow As GridViewRowInfo In gv.Rows
                        ...
                        End If
                        clsJobWorkOutward.SaveData(obj, isNewEntry)
