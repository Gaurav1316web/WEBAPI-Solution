...
Public Class frmJobworkSRNReceiptReport
    ...
    Sub LoadData(ByVal IsPrint As Exporter)
        Try
            ...
            Dim wherDateSRNReturn As String = " and CONVERT(DATE,TSPL_JWO_SRN_RETURN.Document_Date,103)>='" & clsCommon.GetPrintDate(fromDate.Value, "dd/MMM/yyyy") & "' and  CONVERT(DATE,TSPL_JWO_SRN_RETURN.Document_Date,103)<='" & clsCommon.GetPrintDate(ToDate.Value, "dd/MMM/yyyy") & "' "
    ...
    Private Sub ExportGrid(ByVal exporter As EnumExportTo)
        Try
            ...
            arrHeader.Add("Company : " + objCommonVar.CurrentCompanyName)
            arrHeader.Add("Name : " & clsDBFuncationality.getSingleValue("select program_name from tspl_program_Master where program_cODE='" & clsUserMgtCode.frmJobworkSRNReceiptReport & "'"))
