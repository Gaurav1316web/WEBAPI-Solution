    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                frmCRV.funsubreportWithdt(MyBase.Form_ID, CrystalReportFolder.KwalitySalesReport, dt, clsERPFuncationality.CompanyAddresShowinFooter(), "rptJobWorkBilling", "Invoice", clsCommon.myCDate(dt.Rows(0)("Document_Date")), "rptCompanyAddress.rpt", "rptItemHashCodeSummaryForJW.rpt", dtHashCodeSummary, "rptItemHashCodeSummaryForJW.rpt", dtHashCodeSummary)
