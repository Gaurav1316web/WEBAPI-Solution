...
Public Class frmProductionTransactionType
    ...
    Private Sub frmProductionTransactionType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Public Sub Save()
        If AllowToSave() Then
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmProductionTransactionType, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
            Dim obj As New clsProductionTransactionType()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsProductionTransactionType()
        obj = clsProductionTransactionType.GetData(strCode, NavTyep)
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsProductionTransactionType.DeleteData(txtCode.Value)) Then
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_MIS_PRODUCTION_TRANSACTION_TYPE where Trans_Code ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            txtCode.Value = clsProductionTransactionType.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub txtCode__MYNavigator(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal NavType As common.NavigatorType) Handles txtCode._MYNavigator
        ...
        End Try
    End Sub
    Private Sub frmProductionTransactionType_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select Trans_Code as [Transaction Code], Trans_Name as 'Transaction Name' from TSPL_MIS_PRODUCTION_TRANSACTION_TYPE"
        ListImpExpColumnsMandatory = New List(Of String)({"Transaction Code", "Item Name"})
        ListImpExpColumnsSuperMandatory = New List(Of String)({"Transaction Code"})
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Transaction Code", "Transaction Name") Then
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsProductionTransactionType.CheckNewEntry(obj.Code))
                Next
