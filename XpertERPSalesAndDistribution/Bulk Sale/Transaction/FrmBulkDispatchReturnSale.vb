        ...
        Try
            For i As Integer = 0 To Gv1.Rows.Count - 1
                If Gv1.Rows(i).Cells(colSelect).Value = True Then
                    ...
                    clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleBulkSale, clsUserMgtCode.FrmBulkDispatchReturnSale, obj.Location_Code, clsCommon.myCDate(Gv1.Rows(i).Cells(colDispatchDaTe).Value), trans)

                    If obj IsNot Nothing Then
                        ClsDispatchBulkSale.updateJournalEntry("DS-BS", obj.Document_No, 0, trans)
                        '' Delete data from inventory movement 
                        clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, obj.Document_No, "TSPL_INVENTORY_MOVEMENT_NEW", "Source_Doc_No", trans)
