...
#End Region
    ...
    Private Sub UpdateAllTotals()
        Try
            ...
            lblTotRAmt1.Text = clsCommon.myFormat(clsCommon.myCdbl(dblTaxTotAmt) + clsCommon.myCdbl(dblTotAmt) + clsCommon.myCdbl(lblAdditionalCharges.Text))
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        If obj IsNot Nothing Then
            ...
            lblCustomerName.Text = clsDBFuncationality.getSingleValue("Select Customer_Name  from TSPL_CUSTOMER_MASTER where Cust_Code='" + fndCustomerNo.Value + "'")
            lblAdditionalCharges.Text = obj.Total_Add_Charge
    ...
    Private Sub btnPrintJV_Click(sender As Object, e As EventArgs) Handles btnPrintJV.Click
        Try
            If clsCommon.myLen(txtDocNo.Value) > 0 Then
                ...
                If dt.Rows.Count > 0 Then
                    Dim frmCRV As New frmCrystalReportViewer()
                    frmCRV.funsubreportWithdt(MyBase.Form_ID, CrystalReportFolder.KwalitySalesReport, dt, Nothing, "crptBulkSaleInvAndDispatchJV", "Journal Voucher", "")
                    'frmCRV.funsubreportWithdt(CrystalReportFolder.KwalitySalesReport, dt, clsERPFuncationality.CompanyAddresShowinFooter(), "rptInvoiceBulkSale", "Milk Sales Invoice", txtDate.Value, "rptCompanyAddress.rpt")
                    frmCRV = Nothing
                    Qry = Nothing
                    dt = Nothing
