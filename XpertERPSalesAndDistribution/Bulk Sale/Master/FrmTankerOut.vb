...
#End Region
    ...
    Private Sub fndGateOutNo__MYValidating(ByVal sender As Object, ByVal e As System.EventArgs, ByVal isButtonClicked As Boolean) Handles fndGateOutNo._MYValidating
        ...
        fndGateOutNo.Value = clsCommon.ShowSelectForm("TankerOut", qry, "Code", " TSPL_GATEOUT_SALE.Location_Code in (" + arrLoc + ") and TSPL_GATEOUT_SALE.Comp_Code='" + objCommonVar.CurrentCompanyCode + "'", fndGateOutNo.Value, "", isButtonClicked, "Document_Date")
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(fndGateOutNo.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(fndGateOutNo.Value, "Document_No", "TSPL_GATEOUT_SALE")
        Catch ex As Exception
