...
#End Region
    ...
    Private Sub fndcode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles fndcode._MYValidating
        ...
        fndcode.Value = clsCommon.ShowSelectForm("BulkSalePriceChart", qry, "Code", "", fndcode.Value, "", isButtonClicked, "Price_Date")
        LoadData(fndcode.Value, NavigatorType.Current)
        qry = Nothing
    End Sub
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(fndcode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(fndcode.Value, "Price_Code", "TSPL_BulkSalePrice_MASTER")
        Catch ex As Exception
    ...
    Sub funPrint()
        Try
            ...
            frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.KwalitySalesReport, dt, "rptBulkSalePriceChart", "Price Chart")
            frmCRV = Nothing
        Catch ex As Exception
            common.clsCommon.MyMessageBoxShow(Me, ex.Message, Me.Text)
        End Try
