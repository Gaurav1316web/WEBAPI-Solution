...
Public Class FrmExpiryDate
    ...
    Sub LoadScreenName()
        ...
        Dim qry As String = "select Program_Code as [Code] ,Program_Name as [Name]   from TSPL_PROGRAM_MASTER where  Program_Code in ('" + clsUserMgtCode.frmBookingProductSale + " ', '" + clsUserMgtCode.frmDeliveryPrderProductSale + "','" + clsUserMgtCode.frmSalesOrderProductSale + "','" + clsUserMgtCode.mbtnPurchaseOrder + "')"
    ...
    Private Sub txtDocumnetNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles FndDocumnetNo._MYValidating
        ...
        Dim DocNo As String = ""
        If clsCommon.CompairString(cmbScreenName.SelectedValue, clsUserMgtCode.mbtnPurchaseOrder) = CompairStringResult.Equal Then
        ...
        ElseIf clsCommon.CompairString(cmbScreenName.SelectedValue, clsUserMgtCode.frmBookingProductSale) = CompairStringResult.Equal Then
            ...
            DocNo = "Document_Code"
        Else
            Throw New Exception("Wrong Screen Selected")
        End If
