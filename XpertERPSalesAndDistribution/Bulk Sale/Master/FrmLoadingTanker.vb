...
#End Region
    ...
    Private Sub fndLoadingcode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles fndLoadingcode._MYValidating
        ...
        fndLoadingcode.Value = clsCommon.ShowSelectForm("LoadingTanker", qry, "Code", " TSPL_LOADING_TANKER_DETAIL_BULKSALE.Location_Code in (" + arrLoc + ") ", fndLoadingcode.Value, "", isButtonClicked, "LoadingTanker_Date")
