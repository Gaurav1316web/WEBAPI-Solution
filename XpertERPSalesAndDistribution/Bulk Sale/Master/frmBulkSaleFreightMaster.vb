...
#End Region
    ...
    Function AllowToSave() As Boolean
        ...
        If clsCommon.myLen(txtCustomer.Value) <= 0 Then
            txtCustomer.Focus()
            clsCommon.MyMessageBoxShow("Customer can't be blank.")
        End If
        Return True
    End Function
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtDocumentNo.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtDocumentNo.Value, "Document_Code", "TSPL_BLK_FREIGHT_MASTER", "TSPL_BLK_FREIGHT_DETAIL")
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Sub
