...
Public Class FrmFilledOutwardRegister
    ...
    Sub print()
        Try
            ...
            frmcrystal.funreport(MyBase.Form_ID, CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptFilledoutwardRegister", "Filled Outward Register")
