        ...
        Try
            ...
            If clsCommon.CompairString(locationType, "T") = CompairStringResult.Equal Then
                If prePrinted = True Then
                    ...
                    frmcrystal.funreport(CrystalReportFolder.SalesReport, dtBasic, EnumTecxpertPaperSize.PaperSize10x12, "rptSaleInvoiceExcisePrePrint", "Sales Report", True)
                Else
                    ...
                    SetItemWiseTax(prePrinted, dtBasic, strInvoiceNo)
                    Dim frmcrystal As New frmCrystalReportViewer()
                    frmcrystal.funreport(CrystalReportFolder.SalesReport, dtBasic, EnumTecxpertPaperSize.NA, "rptSaleInvoiceExcise", "Sales Report", True)
                End If
            Else
                If prePrinted = True Then
                    ...
                    Dim frmcrystal As New frmCrystalReportViewer()
                    frmcrystal.funreport(CrystalReportFolder.SalesReport, dtNew, EnumTecxpertPaperSize.Guntur10x12, "rptSaleInvoiceNonExcisePrePrint", "Sales Report", True)
                Else
                   ...
                   " left outer join TSPL_COMPANY_MASTER on TSPL_SALE_INVOICE_HEAD.Comp_Code =TSPL_COMPANY_MASTER.Comp_Code left outer join TSPL_EMPLOYEE_MASTER on TSPL_EMPLOYEE_MASTER.EMP_CODE=TSPL_SALE_INVOICE_HEAD.Salesman_Code left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Type_Code=TSPL_SALE_INVOICE_HEAD.Cust_Code and TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_SALE_INVOICE_HEAD.Ship_To "
                    ...
                    If clsCommon.CompairString(objCommonVar.CurrentCompanyCode, "GUNTUR") = CompairStringResult.Equal Then
                        Dim frmcrystal As New frmCrystalReportViewer()
                        frmcrystal.funreport(CrystalReportFolder.SalesReport, dtNew, EnumTecxpertPaperSize.NA, "rptSaleInvoiceNonExcise-G", "Sales Report", True)
                    Else
                        Dim frmcrystal As New frmCrystalReportViewer()
                        frmcrystal.funreport(CrystalReportFolder.SalesReport, dtNew, EnumTecxpertPaperSize.NA, "rptSaleInvoiceNonExcise", "Sales Report", True)
                    End If
