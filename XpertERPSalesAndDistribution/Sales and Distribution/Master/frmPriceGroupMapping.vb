        ...
        Try
            If (AllowToSave()) Then
                ...
                For Each grow As GridViewRowInfo In grdPrice.Rows
                    If clsCommon.myLen(grow.Cells("Price Code").Value) > 0 Then
