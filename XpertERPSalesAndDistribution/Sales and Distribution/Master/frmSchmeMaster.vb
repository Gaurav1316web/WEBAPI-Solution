        ...
        Try
            If ValidateSave() Then
                ...
                If PageMode = "New" Then
                    ...
                    If arr.Count <> 0 Then
                        ...
                        For i As Integer = 0 To arr.Count - 1
                            ...
                            ''isSaved1 = clsDBFuncationality.SaveAStorePorcedure(trans, arrDBName, "InsertSchemeMaster", New SqlParameter("@Code", value), New SqlParameter("@Type", schemeType), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@Start", dtpStart.Value), New SqlParameter("@EndDate", expdate), New SqlParameter("@MainItem", arr.Item(i).ToString), New SqlParameter("@Quantity", txtQuatity.Text), New SqlParameter("@MainItemdesc", txtMDesc.Text), New SqlParameter("@Comment", txtComment.Text), New SqlParameter("@Amount", cashDiscount), New SqlParameter("@CreatedBy", userCode), New SqlParameter("@CreatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", fndUnit.Value), New SqlParameter("@MRP", mainmrp), New SqlParameter("@Item_Basic_Price", mainbasicprice), New SqlParameter("@Cust_Cate", fndcuscategory.Value), New SqlParameter("@Cust_Cate_desc", txtcuscategory.Text))

                            isSaved1 = clsDBFuncationality.SaveAStorePorcedure(trans, "InsertSchemeMaster", New SqlParameter("@Code", value), New SqlParameter("@Type", schemeType), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@Start", dtpStart.Value), New SqlParameter("@EndDate", expdate), New SqlParameter("@MainItem", arr.Item(i).ToString), New SqlParameter("@Quantity", txtQuatity.Text), New SqlParameter("@MainItemdesc", desc), New SqlParameter("@Comment", txtComment.Text), New SqlParameter("@Amount", cashDiscount), New SqlParameter("@CreatedBy", userCode), New SqlParameter("@CreatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", fndUnit.Value), New SqlParameter("@MRP", mainmrp), New SqlParameter("@Item_Basic_Price", mainbasicprice), New SqlParameter("@Cust_Cate", fndcuscategory.Value), New SqlParameter("@Cust_Cate_desc", txtcuscategory.Text))
                            ...
                            For ii As Integer = 0 To grdScheme.Rows.Count - 1
                                If clsCommon.myLen(clsCommon.myCstr(grdScheme.Rows(ii).Cells(0).Value)) <> 0 Then
                                    ...
                                    Dim basicPrice As Decimal = 0
                                    'isSaved1 = clsDBFuncationality.SaveAStorePorcedure(trans1, arrDBName, "InsertSchemeDetail", New SqlParameter("@Code", value), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@MainItem ", clsCommon.myCstr(arr(i))), New SqlParameter("@Quantity", Qty), New SqlParameter("@MainItemDesc", ItemDesc), New SqlParameter("@Comment", Remarks), New SqlParameter("@CreatedBy", userCode), New SqlParameter("@CreatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", UOM), New SqlParameter("@MRP", mrp), New SqlParameter("@Price_Date", priceDate), New SqlParameter("@Item_Basic_price", basicPrice))
                                    isSaved1 = clsDBFuncationality.SaveAStorePorcedure(trans, "InsertSchemeDetail", New SqlParameter("@Code", value), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@MainItem ", ItemCode), New SqlParameter("@Quantity", Qty), New SqlParameter("@MainItemDesc", ItemDesc), New SqlParameter("@Comment", Remarks), New SqlParameter("@CreatedBy", userCode), New SqlParameter("@CreatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", UOM), New SqlParameter("@MRP", mrp), New SqlParameter("@Price_Date", priceDate), New SqlParameter("@Item_Basic_price", basicPrice))
                                End If
                            Next
                        Next
                    End If
                    ...
                    ''            isSaved1 = clsDBFuncationality.SaveAStorePorcedure(trans1, arrDBName, "InsertSchemeMaster", New SqlParameter("@Code", value), New SqlParameter("@Type", schemeType), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@Start", dtpStart.Value), New SqlParameter("@EndDate", expdate), New SqlParameter("@MainItem", arr.Item(i).ToString), New SqlParameter("@Quantity", txtQuatity.Text), New SqlParameter("@MainItemdesc", txtMDesc.Text), New SqlParameter("@Comment", txtComment.Text), New SqlParameter("@Amount", cashDiscount), New SqlParameter("@CreatedBy", userCode), New SqlParameter("@CreatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", fndUnit.txtValue.Text), New SqlParameter("@MRP", mainmrp), New SqlParameter("@Item_Basic_Price", mainbasicprice), New SqlParameter("@Cust_Cate", fndcuscategory.Value), New SqlParameter("@Cust_Cate_desc", txtcuscategory.Text))
                ...
                Else
                    ...
                    isSaved = clsDBFuncationality.SaveAStorePorcedure(trans, "UpdateSchemeMaster", New SqlParameter("@Code", fndScheme.Value), New SqlParameter("@Type", schemeType), New SqlParameter("@Desc", txtDesc.Text), New SqlParameter("@Start", dtpStart.Value), New SqlParameter("@EndDate", expdate), New SqlParameter("@MainItem", fndMainItem.Value), New SqlParameter("@Quantity", txtQuatity.Text), New SqlParameter("@MainItemdesc", txtMDesc.Text), New SqlParameter("@Comment", txtComment.Text), New SqlParameter("@Amount", cashDiscount), New SqlParameter("@UpdatedBy", userCode), New SqlParameter("@UpdatedDate", Date.Now), New SqlParameter("@Company", companyCode), New SqlParameter("@UOM", fndUnit.Value), New SqlParameter("@MRP", mainmrp), New SqlParameter("@Item_Basic_Price", mainbasicprice), New SqlParameter("@Cust_Cate", fndcuscategory.Value), New SqlParameter("@Cust_Cate_desc", txtcuscategory.Text))
                    isSaved = clsDBFuncationality.SaveAStorePorcedure(trans, "DeleteSchemeDetail", New SqlParameter("@Code", fndScheme.Value))
    ...
    Public Sub funDelete()
        ...
        ElseIf myMessages.deleteConfirm Then
            ...
            Try
                ...
                isSaved = clsDBFuncationality.SaveAStorePorcedure(trans, "DeleteSchemeDetail", New SqlParameter("@Code", Me.fndScheme.Value))
                isSaved = clsDBFuncationality.SaveAStorePorcedure(trans, "DeleteSchemeMaster", New SqlParameter("@Code", Me.fndScheme.Value))
                If isSaved Then
                    trans.Commit()
                    myMessages.delete()
                    'funNew()
