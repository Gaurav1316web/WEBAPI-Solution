...
Partial Class frmStandardRateItem
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnimprtHead.Visibility = Telerik.WinControls.ElementVisibility.Visible
        '
        'BtnimportDetails
        '
        Me.BtnimportDetails.AccessibleDescription = "Standard ROI Details"
        Me.BtnimportDetails.AccessibleName = "Standard ROI Details"
        Me.BtnimportDetails.Name = "BtnimportDetails"
        Me.BtnimportDetails.Text = "Standard ROI Details"
        Me.BtnimportDetails.Visibility = Telerik.WinControls.ElementVisibility.Visible
        '
        'exportmenu
        '
        ...
        'btnExportStdhead
        '
        Me.btnExportStdhead.AccessibleDescription = "Std ROI Head"
        Me.btnExportStdhead.AccessibleName = "Std ROI Head"
        Me.btnExportStdhead.Name = "btnExportStdhead"
        Me.btnExportStdhead.Text = "Std ROI Head"
        Me.btnExportStdhead.Visibility = Telerik.WinControls.ElementVisibility.Visible
        '
        'BtnExportstdDetails
        '
        Me.BtnExportstdDetails.AccessibleDescription = "Std ROI Details"
        Me.BtnExportstdDetails.AccessibleName = "Std ROI Details"
        Me.BtnExportstdDetails.Name = "BtnExportstdDetails"
        Me.BtnExportstdDetails.Text = "Std ROI Details"
        Me.BtnExportstdDetails.Visibility = Telerik.WinControls.ElementVisibility.Visible
        '
        'Exitmenu
        '
