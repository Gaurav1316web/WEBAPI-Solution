...
Public Class frmCompetitorMaster
    ...
    Private Sub frmCompetitorMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        funreset()
        SetUserMgmtNew()
    ...
    Function AllowToSave() As Boolean
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) AndAlso clsCommon.myLen(txtCode.Value) <= 0 Then
            myMessages.blankValue(Me, "Competitor Code", Me.Text)
            txtCode.Focus()
            Return False
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    If (String.IsNullOrEmpty(strcode)) Or clsCommon.myLen(strcode) > 30 Then
                        Throw New Exception("Length of Competitor Code should be max. 30 character At Line No. " + clsCommon.myCstr(linno) + ".")
                    End If
                    strname = clsCommon.myCstr(grow.Cells(1).Value)
                    If (String.IsNullOrEmpty(strname)) Or clsCommon.myLen(strname) > 200 Then
                        Throw New Exception("Length of Competitor Name should be max. 200 character At Line No. " + clsCommon.myCstr(linno) + ".")
                    End If
                    ...
                    Dim Count1 As Integer = clsCommon.myCdbl(clsDBFuncationality.getSingleValue("Select COunt(*) from TSPL_COMPETITOR_MASTER WHERE code='" + clsCommon.myCstr(grow.Cells(0).Value) + "'", trans))
                    If Count1 <= 0 Then
    ...
    Private Sub frmCompetitorMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        ElseIf e.Alt AndAlso e.Shift AndAlso e.Control And e.KeyCode = Keys.F12 Then
            ButtonToolTip.SetToolTip(btnsave, "Press Alt+S for Save/Update Trasnaction" + Environment.NewLine +
                                                             "TSPL_COMPETITOR_MASTER ")
        End If
    End Sub


    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        Dim qst As String = "select count(*) from TSPL_COMPETITOR_MASTER where Code='" + txtCode.Value + "'"
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            Dim qry As String = " select Code as [Code],Name as [Name],Created_By as [Created By],Created_Date as [Created Date],Modify_By as [Modify By],Modify_Date as [Modify Date],Comp_Code as [Company Code] from TSPL_COMPETITOR_MASTER  "
            txtCode.Value = clsCommon.ShowSelectForm("RPTCOMPET", qry, "Code", whrClas, txtCode.Value, "Code", isButtonClicked)
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            isNewEntry = False
            Dim obj As New ClsCompetitorMaster()
            obj = ClsCompetitorMaster.GetData(strCode, NavTyep)
    ...
    Private Sub export_Click(sender As Object, e As EventArgs) Handles export.Click
        Dim str As String
        str = " select TSPL_COMPETITOR_MASTER.Code as [Competitor Code] ,TSPL_COMPETITOR_MASTER.Name as [Competitor Name]  
                 from TSPL_COMPETITOR_MASTER "
