...
Public Class FrmScrapSaleGateOut
    ...
    Private Sub FrmScrapSaleGateOut_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.Alt AndAlso e.Shift AndAlso e.Control And e.KeyCode = Keys.F12 Then
            'Add Tool tip Task No- TEC/22/05/18-000245
            ButtonToolTip.SetToolTip(btnSave, "TSPL_SCRAPSALE_GATE_OUT")
            'Add Tool tip Task No- TEC/22/05/18-000245
        End If
    End Sub
