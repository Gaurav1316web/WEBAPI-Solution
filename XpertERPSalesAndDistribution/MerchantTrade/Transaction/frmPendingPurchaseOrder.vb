...
Imports common
Public Class frmPendingPurchaseOrder
...
#End Region
    ...
    Private Sub FrmPendingRequistion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        ''------------
        qry += " ) Final left outer join TSPL_CUSTOMER_MASTER  on TSPL_CUSTOMER_MASTER.Cust_Code =final.Customer  left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=Final.Location group by Code,ICode having (SUM(Qty *RI)-SUM(Unapproved)) >0 order by Code,ICode "
        ''        
