...
#End Region
    ...
    Sub Print(ByVal IsPrint As Exporter)
        Try
            ...
            If IsPrint = Exporter.Excel Then
                clsCommon.MyExportToExcelGrid(" TCS Ledger:" + ddlReportType.SelectedValue, Gv1, arrHeader, Me.Text)
                Exit Sub
            ElseIf IsPrint = Exporter.PDF Then
                clsCommon.MyExportToPDF("TCS Ledger" + ddlReportType.SelectedValue, Gv1, arrHeader, "TCS Ledger", True)
                Exit Sub
            End If
    ...
    Function ReturnFilterData() As clsSaleRegisterParameterType
        ...
        Else
            Dim qry As String
            qry = clsPSInvoiceHead.GetSaleTransactionTypeQuery_ForTCSLEDGER()
            Dim dtTrans As DataTable = clsDBFuncationality.GetDataTable(qry)
            Dim arrTrans As New ArrayList
            For Each dr As DataRow In dtTrans.Rows
                arrTrans.Add(clsCommon.myCstr(dr.Item("Name")))
    ...
    Sub SetGridFormationOFGV1()
        ...
        For ii As Integer = 0 To Gv1.Columns.Count - 1
            ...
            If Gv1.Columns(ii).Name.Contains("TCS%") = True Then
    ...
    Private Sub txtTransaction__My_Click(sender As Object, e As EventArgs) Handles txtTransaction._My_Click
        ...
        Dim qry As String = clsPSInvoiceHead.GetSaleTransactionTypeQuery_ForTCSLEDGER()
    ...
    Private Sub btnQuickExport_Click(sender As Object, e As EventArgs)
        Try
            ...
            arrHeader.Add("Company : " & objCommonVar.CurrentCompanyName)
            arrHeader.Add("Name : " & clsDBFuncationality.getSingleValue("select program_name from tspl_program_Master where program_cODE='" & clsUserMgtCode.rptTCSLedger & "'"))
            If txtLocation.arrDispalyMember IsNot Nothing AndAlso txtLocation.arrDispalyMember.Count > 0 Then
                arrHeader.Add(" Location : " + clsCommon.GetMulcallStringWithComma(txtLocation.arrDispalyMember))
            End If
