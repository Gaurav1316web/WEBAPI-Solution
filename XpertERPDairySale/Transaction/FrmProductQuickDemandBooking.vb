            ...
            If clsCommon.myLen(DocumentNO) > 0 Then
                ...
                If dtDS IsNot Nothing AndAlso dtDS.Rows.Count > 0 Then
                    ...
                    For Each dr As DataRow In dtDS.Rows
                        ...
                        "TSPL_ITEM_PRICE_MASTER.UOM=TSPL_ITEM_UOM_DETAIL.UOM_Code   where  Start_Date<='" & clsCommon.GetPrintDate(DemandData, "dd/MMM/yyyy") & "'  and (End_Date >= '" & clsCommon.GetPrintDate(DemandData, "dd/MMM/yyyy") & "'  or End_date is null)  and  " &
