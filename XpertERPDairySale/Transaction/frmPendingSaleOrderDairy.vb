...
#Region "Variables"
    ...
    Const colHItemwise As String = "colHItemwise"
#End Region
    ...
    Private Sub FrmPendingRequistion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '" select TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code as Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Desc as IName,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Row_Type as IType,(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRN_Qty +isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Leak_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Burst_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Short_Qty,0)) as Qty,0 as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_Code as Unit,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Location as Location,1 as RI,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Cost as Rate,1 as Chk,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Tax_Group,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Batch_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MFG_Date,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Expiry_Date,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Disc_Per,MRN_Date as TransDate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Leak_Qty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Burst_Qty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Short_Qty  from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code where TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Status=0 and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=1 "
        'If clsCommon.myLen(VendorCode) > 0 Then
        '    qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code='" + VendorCode + "'"
        'End If
        'qry += " union all" & _
        '" select TSPL_SD_SALES_ORDER_DETAIL.delivery_code as Code,TSPL_SD_SALES_ORDER_HEAD.Customer_Code as Vendor,TSPL_SD_SALES_ORDER_DETAIL.Item_Code as ICode,TSPL_SD_SALES_ORDER_DETAIL.Item_Desc as IName,'' as IType,(isnull(TSPL_SD_SALES_ORDER_DETAIL.SRN_Qty,0) +isnull(TSPL_SD_SALES_ORDER_DETAIL.Leak_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Burst_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Short_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Rejected_Qty,0) ) as Qty,0 as Unapproved,TSPL_SD_SALES_ORDER_DETAIL.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,isnull(TSPL_SD_SALES_ORDER_DETAIL.MRP,0) as MRP,'' as Batch_No,null as MFG_Date,null as Expiry_Date,0 as Disc_Per,null as TransDate,isnull(TSPL_SD_SALES_ORDER_DETAIL.Assessable,0)as Assessable,0 as Leak_Qty,0 as Burst_Qty,0 as Short_Qty from TSPL_SD_SALES_ORDER_DETAIL left outer join TSPL_SD_SALES_ORDER_HEAD on TSPL_SD_SALES_ORDER_HEAD.SRN_No=TSPL_SD_SALES_ORDER_DETAIL.SRN_No where TSPL_SD_SALES_ORDER_HEAD.Status=1 and len(isnull(TSPL_SD_SALES_ORDER_DETAIL.delivery_code,''))>0  " & _
        '" union all  " & _
        '" select TSPL_SD_SALES_ORDER_DETAIL.delivery_code as Code,TSPL_SD_SALES_ORDER_HEAD.Customer_Code as Vendor,TSPL_SD_SALES_ORDER_DETAIL.Item_Code as ICode,TSPL_SD_SALES_ORDER_DETAIL.Item_Desc as IName,'' as IType,0  as Qty,(isnull(TSPL_SD_SALES_ORDER_DETAIL.SRN_Qty,0) +isnull(TSPL_SD_SALES_ORDER_DETAIL.Leak_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Burst_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Short_Qty,0)+isnull(TSPL_SD_SALES_ORDER_DETAIL.Rejected_Qty,0)) as Unapproved,TSPL_SD_SALES_ORDER_DETAIL.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,isnull(TSPL_SD_SALES_ORDER_DETAIL.MRP,0) as MRP,'' as Batch_No,null as MFG_Date,null as Expiry_Date,0 as Disc_Per,null as TransDate,isnull(TSPL_SD_SALES_ORDER_DETAIL.Assessable,0) as Assessable,0 as Leak_Qty,0 as Burst_Qty,0 as Short_Qty from TSPL_SD_SALES_ORDER_DETAIL left outer join TSPL_SD_SALES_ORDER_HEAD on TSPL_SD_SALES_ORDER_HEAD.SRN_No=TSPL_SD_SALES_ORDER_DETAIL.SRN_No  where TSPL_SD_SALES_ORDER_HEAD.Status=0 and len(isnull(TSPL_SD_SALES_ORDER_DETAIL.delivery_code,''))>0 and TSPL_SD_SALES_ORDER_DETAIL.SRN_No not in ('" + strCurrCode + "')   " & _
        ...
        qry += " where TSPL_SD_SALES_ORDER_DETAIL.Status=0 and Scheme_Item='N'and Auto_SaleOrder=0  and TSPL_SD_SALES_ORDER_HEAD.Status=1 and TSPL_SD_SALES_ORDER_HEAD.close_yn='N'  and Delivery_date >= '" & clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(), "dd/MMM/yyyy") & "'   " + Environment.NewLine
        If clsCommon.myLen(VendorCode) > 0 Then
            qry += " and TSPL_SD_SALES_ORDER_HEAD.Customer_Code='" + VendorCode + "'"
        End If
        qry += " union all " + Environment.NewLine
        qry += " select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Itemwise,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Group,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Against_Sales_Order as Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,'' as IName,'' as IType,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty,0) as Qty,0 as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,MRP as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)as Assessable" + Environment.NewLine
        ...
        qry += " where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Posted=1 and Scheme_Item='N'   and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Against_Sales_Order,''))>0   " + Environment.NewLine
        qry += " union all   " + Environment.NewLine
        qry += " select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Itemwise,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Group,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Against_Sales_Order as Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,'' as IName,'' as IType,0 as Qty,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty,0) as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,MRP as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)as Assessable" + Environment.NewLine
        qry += " ,Scheme_Code from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE " + Environment.NewLine
        qry += " left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code" + Environment.NewLine
        qry += " where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Posted=0 and Scheme_Item='N' and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Against_Sales_Order,''))>0 and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.DOCUMENT_CODE not in ('" + strCurrCode + "')  " + Environment.NewLine
        ...
        If IsAllowSingleSI4SingleSO = True Then
            qry += " WHERE Code Not in (Select Distinct Against_Sales_Order from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE WHERE ISNULL(Against_Sales_Order,'')<>'') " + StrCondition + " "
        Else
            qry += "" + StrCondition1 + "  "
        End If
        qry += " group by Code,Item_Group,ICode,Unit,MRP,Ship_Party having SUM(Chk)>0 and SUM(Qty *RI) <>0  order by Code,max(Line_No),Ship_Party"
        ...
        If dtAllData Is Nothing OrElse dtAllData.Rows.Count <= 0 Then
            If clsCommon.myLen(VendorName) > 0 Then
                common.clsCommon.MyMessageBoxShow(Me, "No record found for vendor " + VendorName + "", Me.Text)
            Else
    ...
    Sub LoadHeadData()
        ...
        For Each dr As DataRow In dtAllData.Rows
            ...
            Dim strShipCode As String = clsCommon.myCstr(dr("code")) + clsCommon.myCstr(dr("Ship_Party"))
            If Not arr.Contains(strShipCode) Then
                arr.Add(strShipCode)
                'arr1.Add(strShipCode)
                gvHead.Rows.AddNew()
                ...
                gvHead.Rows(gvHead.RowCount - 1).Cells(colHItemwise).Value = clsCommon.myCstr(dr("Itemwise"))
    ...
    Sub LoadBlankHeadGrid()
        ...
        Dim repoItemwise As GridViewDecimalColumn = New GridViewDecimalColumn()
        repoItemwise.FormatString = ""
        repoItemwise.HeaderText = "Item wise"
        repoItemwise.Name = colHItemwise
        repoItemwise.Width = 170
        repoItemwise.ReadOnly = True
        repoItemwise.IsVisible = False
        gvHead.MasterTemplate.Columns.Add(repoItemwise)
    ...
    Sub LoadBlankGridDetail()
        ...
        repoICodegrp.Name = colDICodegrp
    ...
    Sub btnOKPressed()
        ArrReturn = New List(Of clsPSSalesOrderDetail)
        Dim obj As clsPSSalesOrderDetail = Nothing
        For ii As Integer = 0 To gv1.RowCount - 1
            If (clsCommon.myCBool(gv1.Rows(ii).Cells(colDSelect).Value)) Then
                obj = New clsPSSalesOrderDetail()
                obj.Document_Code = clsCommon.myCstr(gv1.Rows(ii).Cells(colDCode).Value)
                obj.Item_Group = clsCommon.myCstr(gv1.Rows(ii).Cells(colDICodegrp).Value)
        ...
        If Not IsInsideLoadData Then
            If Not IsAllowSingleSI4SingleSO Then
                If gvHead.CurrentColumn Is gvHead.Columns(colHSelect) Then
                    ...
                    If clsCommon.CompairString(strShipPartyCode1, VendorCode) = CompairStringResult.Equal Then
                        ...
                        If clsCommon.myLen(strCode) > 0 Then
                            LoadDetailData(e.NewValue, strCode, strShipPartyCode)
                        End If
                    Else
                        common.clsCommon.MyMessageBoxShow(Me, "Order's Customer should be `" + strShipPartyCodeName)
                        e.Cancel = True
                    End If
                End If
            Else
                ...
                If e.NewValue = True Then
                    ...
                    Next
                    LoadDetailData(e.NewValue, strCode1, strShipPartyCode1)
                End If
            End If
    ...
    Sub LoadDetailData(ByVal NewVal As Boolean, ByVal strCode As String, ByVal strShipPartyCode As String)
        If NewVal Then
            For Each dr As DataRow In dtAllData.Rows
                If clsCommon.CompairString(strCode, clsCommon.myCstr(dr("Code"))) = CompairStringResult.Equal AndAlso clsCommon.CompairString(strShipPartyCode, clsCommon.myCstr(dr("Ship_Party"))) = CompairStringResult.Equal Then
                    gv1.Rows.AddNew()
                    ...
                    gv1.Rows(gv1.Rows.Count - 1).Cells(colDICodegrp).Value = clsCommon.myCstr(dr("Item_Group"))
