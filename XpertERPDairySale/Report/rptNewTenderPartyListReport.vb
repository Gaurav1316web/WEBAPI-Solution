...
from (Select Customer_Code ,Sum(Total_Amt)Return_Amt from TSPL_SD_SALE_RETURN_HEAD where convert(date,Document_Date,103) = '23/Dec/2025 ' group by Customer_Code
union all
...
left join (Select Customer_Code as Credit_Cust,Sum(Document_Total)Document_Total from TSPL_Customer_Invoice_Head 
...
left join (Select Customer_Code as Debit_Cust,Sum(Document_Total)Document_Total from TSPL_Customer_Invoice_Head 
