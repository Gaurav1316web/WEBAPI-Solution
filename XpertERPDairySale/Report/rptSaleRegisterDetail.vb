...
Public Class rptSaleRegisterDetail
...
#End Region
    ...
    Sub Print(ByVal IsPrint As Exporter)
        Try
            ...
            TxtMultiRSM.Enabled = False
            TxtMultiZSM.Enabled = False
            TxtMultiASM.Enabled = False
            TxtMultiASO.Enabled = False
            ...
            If ddlReportType.SelectedValue = "Sale Register With Purchase" Then
                ...
                Sql = "select (select DISTINCT ',['+UOM_Code+']' " & _
                      " from TSPL_ITEM_UOM_DETAIL " & _
                      " left join  TSPL_SD_SALE_INVOICE_DETAIL on TSPL_SD_SALE_INVOICE_DETAIL.item_code=TSPL_ITEM_UOM_DETAIL.item_code " & _
                      " left join TSPL_SD_SALE_INVOICE_HEAD on TSPL_SD_SALE_INVOICE_HEAD.Document_Code=TSPL_SD_SALE_INVOICE_DETAIL.DOCUMENT_CODE " & _
                      " where convert(date,TSPL_SD_SALE_INVOICE_HEAD.Document_Date,103) >= convert(date,('" + fromDate.Value + "'),103) and convert(date,TSPL_SD_SALE_INVOICE_HEAD.Document_Date,103) <= convert(date,('" & ToDate.Value & "'),103)" & _
                      " for xml path('')) "
                ...
                If clsCommon.myLen(str_UOM) > 0 Then
                    ...
                    Sql = "select TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item,TSPL_SD_SALE_INVOICE_HEAD.Document_Code as [Document Code],  convert(varchar,TSPL_SD_SALE_INVOICE_HEAD.Document_Date,103 ) as [Document Date]  " & _
                        ",TSPL_CUSTOMER_MASTER.Customer_Name as [Party Name]" & _
                         ",TSPL_ITEM_MASTER.Item_Desc As [Item Name] " & _
                      ",TSPL_SD_SALE_INVOICE_DETAIL.Line_No  " & _
                       ", TSPL_SD_SALE_INVOICE_DETAIL.Unit_code AS UOM " & _
                    ...
                    Sql += ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE TSPL_SD_SALE_INVOICE_DETAIL.Item_Cost*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) END as Rate " & _
                       ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (TSPL_SD_SALE_INVOICE_DETAIL.Amount *(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end)- case when TSPL_SD_SALE_INVOICE_HEAD.trans_type='FS' then coalesce(TSPL_SD_SALE_INVOICE_Detail.Cash_Scheme_Amount,0)*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) else 0 end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Sale Amount] " & _
                     ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (TSPL_SD_SALE_INVOICE_detail.Total_Disc_Amt*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) - case when TSPL_SD_SALE_INVOICE_HEAD.trans_type='FS' then coalesce(TSPL_SD_SALE_INVOICE_Detail.Cash_Scheme_Amount,0)*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) else 0 end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0 and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Disc Amt] " & _
                   ", CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (case when TSPL_SD_SALE_INVOICE_DETAIL.Line_No=1 then (TSPL_SD_SALE_INVOICE_HEAD.Total_Add_Charge+coalesce(TSPL_SD_SALE_INVOICE_HEAD.RoundOffAmount,0))*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) else 0 end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0 and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Additional Amt] " & _
                    ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE ((Amount-Total_Disc_Amt)*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end)- case when TSPL_SD_SALE_INVOICE_HEAD.trans_type='AS' then coalesce(TSPL_SD_SALE_INVOICE_Detail.Cash_Scheme_Amount,0)*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end) else 0 end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0 and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Basic Sale]  " & _
                   ", CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (TSPL_SD_SALE_INVOICE_DETAIL.TAX1_Rate+TSPL_SD_SALE_INVOICE_DETAIL.TAX2_Rate+TSPL_SD_SALE_INVOICE_DETAIL.TAX3_Rate) END as [Tax Rate] " & _
                   ", CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE TSPL_SD_SALE_INVOICE_DETAIL.Total_Tax_Amt*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Total Tax Amt] " & _
                   ", CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (Amount+TSPL_SD_SALE_INVOICE_DETAIL.Total_Tax_Amt-Total_Disc_Amt)*(case when coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0)<=0  then 1 else coalesce(TSPL_SD_SALE_INVOICE_HEAD.convrate,0) end)*(case when len(TSPL_SD_SALE_INVOICE_HEAD.Invoice_No_For_Supplementary)>0 and TSPL_SD_SALE_INVOICE_HEAD.Supplementary_Type='C' then -1 else 1 end) END as [Total Sale] " & _
                    ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (CASE WHEN TAXM1.TYPE='IGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX1_AMT ELSE 0 END+CASE WHEN TAXM2.TYPE='IGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX2_AMT ELSE 0 END+CASE WHEN TAXM3.TYPE='IGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX3_AMT ELSE 0 END) END AS [IGST Amt] " & _
                   ...
                   ", CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (CASE WHEN TAXM1.TYPE='CGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX1_AMT ELSE 0 END+CASE WHEN TAXM2.TYPE='CGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX2_AMT ELSE 0 END+CASE WHEN TAXM3.TYPE='CGST' THEN TSPL_SD_SALE_INVOICE_DETAIL.TAX3_AMT ELSE 0 END) END AS [CGST Amt] "
                    ...
                    Sql += ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE tspl_item_master.cost END as [Purcahse Rate] " & _
                        ",CASE WHEN TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item='Y' THEN 0 ELSE (tspl_item_master.cost*(isnull(TSPL_SD_SALE_INVOICE_DETAIL.Qty,0) *isnull(TSPL_ITEM_UOM_DETAIL.Conversion_Factor,1))/J.Conversion_Factor) END as [Purchase Value]" & _
    ...
    Function ReturnFilterData() As clsSaleRegisterParameterType
        ...
        If TxtMultiZone.arrValueMember IsNot Nothing AndAlso TxtMultiZone.arrValueMember.Count > 0 Then
            obj.Zone_List = TxtMultiZone.arrValueMember
        End If
        If TxtMultiASM.arrValueMember IsNot Nothing AndAlso TxtMultiASM.arrValueMember.Count > 0 Then
            obj.ASM_List = TxtMultiASM.arrValueMember
        End If
        If TxtMultiZSM.arrValueMember IsNot Nothing AndAlso TxtMultiZSM.arrValueMember.Count > 0 Then
            obj.ZSM_List = TxtMultiZSM.arrValueMember
        End If
        If TxtMultiRSM.arrValueMember IsNot Nothing AndAlso TxtMultiRSM.arrValueMember.Count > 0 Then
            obj.RSM_List = TxtMultiRSM.arrValueMember
        End If
        If TxtMultiASO.arrValueMember IsNot Nothing AndAlso TxtMultiASO.arrValueMember.Count > 0 Then
            obj.ASO_List = TxtMultiASO.arrValueMember
        End If
        ...
        obj.BatchWise = chkBatchWise.Checked
        Return obj
    End Function
    ...
    Sub SetGridFormationOFGV1()
        ...
        Else
            ...
            ElseIf ddlReportType.SelectedValue = "Document Detail" Then
                ...
                If chkBatchWise.Checked = True Then
    ...
    Sub Reset()
        ...
        TxtMultiRSM.arrValueMember = Nothing
        TxtMultiZSM.arrValueMember = Nothing
        ...
        TxtMultiRSM.Enabled = True
        TxtMultiZSM.Enabled = True
        TxtMultiASM.Enabled = True
        TxtMultiASO.Enabled = True
    ...
    Sub CogsValueSummary(ByVal strItemCode As String, ByVal strCode As String)
        Try
            ...
            Dim strquery As String = "select [Batch No],max(ManualBatchNo) as [Manual Batch No],[Main Item],UOM, sum(Batch_Main_Qty) as [Batch Main Qty],sum(Item_Rate) as [Item Rate], " & Environment.NewLine & _
        " sum(Main_item_cost) as [Main item cost],sum(Issued_Cost) as [Issued Cost],sum(Consumed_Value) as [Consumed Value],sum(Main_item_cost)-sum(Consumed_Value) as [Gain Loss Value]," & Environment.NewLine & _
        " sum(Sale_Qty) as [Sale Qty],max(Sale_Uom) as [Sale UOM],convert(decimal(18,2),sum(SaleCost)/iif(sum(Sale_Qty)=0, 1,sum(Sale_Qty))) as [Sale Cogs Per Unit],sum(SaleCost) as [Sale Cogs],sum(Main_item_cost)-sum(SaleCost) as [Difference in Main item cost vs Sale Cogs]" & Environment.NewLine & _
        " from (select Document_Code ,[Batch No],ManualBatchNo ,[Main Item],UOM,case when RowNumber=1 then [Batch Main Qty] else 0 end [Batch_Main_Qty]," & Environment.NewLine & _
        " case when RowNumber=1 then Main_item_cost/iif([Batch Main Qty]=0,1,[Batch Main Qty]) else 0 end [Item_Rate]," & Environment.NewLine & _
        " case when RowNumber=1 then Main_item_cost else 0 end Main_item_cost,[Total Cost] as Issued_Cost, [Consumed Value] as Consumed_Value,case when RowNumber=1 then convert(decimal(18,2),(Sale_Qty/LtrUnit.conversion_factor)*StockUnit.conversion_factor*CurrentUnit.conversion_factor) else 0 end Sale_Qty," & Environment.NewLine & _
        " case when UOM=Sale_Uom then Sale_Uom else UOM end as Sale_Uom ,    case when RowNumber=1 then SaleCost else 0 end SaleCost  from ( select row_number() over (partition by [Batch No] order by [Batch No]) as RowNumber, *,[Required Qty]-[Consumed Qty] as [Difference Qty] from (select distinct" & Environment.NewLine & _
        " TSPL_BATCH_ITEM.Qty as [Sale_Qty],TSPL_INVENTORY_MOVEMENT.UOM as Sale_Uom ,TSPL_INVENTORY_MOVEMENT.Avg_Cost as SaleCost, TSPL_BATCH_ITEM.Document_Code ,  isnull(tspl_item_uom_detail.Item_Cost,0)*isnull(TSPL_PP_BATCH_ORDER_BOM_DETAIL.Quantity,0) as Main_item_cost ,TSPL_PP_BATCH_ORDER_BOM_DETAIL.Batch_Code as [Batch No],TSPL_PP_PRODUCTION_PLAN_DETAIL.Item_Code as [Main Item],TSPL_PP_PRODUCTION_PLAN_DETAIL.Unit_Code as UOM,TSPL_PP_BATCH_ORDER_BOM_DETAIL.Quantity  as [Batch Main Qty] ,TSPL_PP_BATCH_ORDER_BOM_DETAIL.BOM_Code as [BOM No],TSPL_PP_BOM_HEAD.PROD_QUANTITY as [BOM Qty],TSPL_PP_BATCH_ORDER_BOM_DETAIL.Unit_Code as [BOM UOM] ,TSPL_PP_BOM_ITEM_DETAIL.ITEM_CODE as [BOM Item],TSPL_PP_BOM_ITEM_DETAIL.QUANTITY as [Standard Qty],TSPL_PP_BOM_ITEM_DETAIL.UNIT_CODE as[Item UOM] ,isnull([Required Qty],0) as [Required Qty],isnull(Issue_Item.Issue_Qty,0) as [Issue Qty],isnull(Issue_Item.[Total Cost],0) as [Total Cost] ,isnull(CONSM_QTY,0) as [Consumed Qty] ,isnull([Consumed Value],0) as [Consumed Value],TSPL_PP_PRODUCTION_PLAN_HEAD.Plan_Date,BatchRawItem.Location_Code ,BatchRawItem.ManualBatchNo  from " & Environment.NewLine & _
        ...
        " TSPL_PP_BATCH_ORDER_HEAD.ManualBatchNo from TSPL_PP_BATCH_ORDER_HEAD left outer join TSPL_PP_BATCH_ORDER_RAW_ITEM_DETAIL on TSPL_PP_BATCH_ORDER_RAW_ITEM_DETAIL.Batch_Code=TSPL_PP_BATCH_ORDER_HEAD.Batch_Code)BatchRawItem on BatchRawItem.BatchCode=TSPL_PP_BATCH_ORDER_BOM_DETAIL.Batch_Code and BatchRawItem.RequiredItem=TSPL_PP_BOM_ITEM_DETAIL.Item_Code left outer join (select CONSM_QTY,Batch_Code,CONSM_ITEM_CODE,TSPL_PP_PRODUCTION_CONSUMPTION_DETAIL.Fat_Amt+TSPL_PP_PRODUCTION_CONSUMPTION_DETAIL.SNF_Amt as [Consumed Value] from TSPL_PP_PRODUCTION_ENTRY   left outer join TSPL_PP_PRODUCTION_ENTRY_DETAIL on TSPL_PP_PRODUCTION_ENTRY_DETAIL.PROD_ENTRY_CODE=TSPL_PP_PRODUCTION_ENTRY.PROD_ENTRY_CODE left outer join  TSPL_PP_PRODUCTION_CONSUMPTION_DETAIL on TSPL_PP_PRODUCTION_CONSUMPTION_DETAIL.PROD_ENTRY_CODE =TSPL_PP_PRODUCTION_ENTRY.PROD_ENTRY_CODE)TSPL_PP_PRODUCTION_ENTRY on TSPL_PP_PRODUCTION_ENTRY.Batch_Code=TSPL_PP_BATCH_ORDER_BOM_DETAIL.Batch_Code and TSPL_PP_PRODUCTION_ENTRY.CONSM_ITEM_CODE=TSPL_PP_BOM_ITEM_DETAIL.Item_Code left join ( select TSPL_PP_ISSUE_HEAD.Issue_Code ,isnull(TSPL_PP_ISSUE_ITEM_DETAIL.Qty,0) as Issue_Qty,TSPL_PP_ISSUE_HEAD.Batch_Code,TSPL_PP_ISSUE_ITEM_DETAIL.Item_Code ,isnull(TSPL_PP_ISSUE_ITEM_DETAIL.Fat_Amt,0) +isnull(TSPL_PP_ISSUE_ITEM_DETAIL.SNF_Amt,0)  as [Total Cost]  from TSPL_PP_BATCH_ORDER_HEAD " & Environment.NewLine & _
        " left outer join TSPL_PP_BATCH_ORDER_RAW_ITEM_DETAIL on TSPL_PP_BATCH_ORDER_RAW_ITEM_DETAIL.Batch_Code=TSPL_PP_BATCH_ORDER_HEAD.Batch_Code " & Environment.NewLine & _
        " left join TSPL_PP_ISSUE_HEAD on TSPL_PP_ISSUE_HEAD.Batch_Code=TSPL_PP_BATCH_ORDER_HEAD.Batch_Code " & Environment.NewLine & _
        " left join TSPL_PP_ISSUE_ITEM_DETAIL on TSPL_PP_ISSUE_ITEM_DETAIL.Issue_Code =TSPL_PP_ISSUE_HEAD.Issue_Code  ) as Issue_Item on Issue_Item.Batch_Code=TSPL_PP_BATCH_ORDER_BOM_DETAIL.Batch_Code and TSPL_PP_BOM_ITEM_DETAIL.ITEM_CODE =Issue_Item.Item_Code  " & Environment.NewLine & _
        " left join tspl_item_master on tspl_item_master.item_code=TSPL_PP_PRODUCTION_PLAN_DETAIL.Item_Code  " & Environment.NewLine & _
        " left join tspl_item_uom_detail on tspl_item_uom_detail.item_code=TSPL_PP_PRODUCTION_PLAN_DETAIL.Item_Code and tspl_item_uom_detail.Uom_code=TSPL_PP_PRODUCTION_PLAN_DETAIL.Unit_Code " & Environment.NewLine & _
        " left outer join ( select Document_Code ,Batch_No ,Manual_BatchNo,Item_Code, sum(TSPL_BATCH_ITEM.Qty) as Qty from TSPL_BATCH_ITEM  group by Document_Code ,Item_Code,Batch_No,Manual_BatchNo) TSPL_BATCH_ITEM on   BatchRawItem.[BatchCode] =TSPL_BATCH_ITEM.Batch_No AND BatchRawItem.ManualBatchNo  =TSPL_BATCH_ITEM.Manual_BatchNo " & Environment.NewLine & _
        " left outer join TSPL_INVENTORY_MOVEMENT on TSPL_INVENTORY_MOVEMENT.Source_Doc_No =TSPL_BATCH_ITEM .Document_Code and TSPL_INVENTORY_MOVEMENT.Item_Code =TSPL_BATCH_ITEM.Item_Code " & Environment.NewLine & _
        " ) " & Environment.NewLine & _
        " as xxx where 2=2   and [Batch No] is not null and xxx.Document_Code ='" & strCode & "' AND xxx.[Main Item] ='" & strItemCode & "'" & Environment.NewLine & _
        " ) as final " & Environment.NewLine & _
        " left join tspl_item_uom_detail LtrUnit on LtrUnit.item_code=final.[Main Item]	 and LtrUnit.UOM_Code=final.UOM" & Environment.NewLine & _
        " left join tspl_item_uom_detail StockUnit on StockUnit.item_code=final.[Main Item] and StockUnit.Stocking_Unit ='Y'" & Environment.NewLine & _
        " left join tspl_item_uom_detail CurrentUnit on CurrentUnit.item_code=final.[Main Item] and CurrentUnit.uom_code=	final.Sale_Uom" & Environment.NewLine & _
        ...
        " group by [Batch No],Document_Code ,[Main Item] ,uom " & Environment.NewLine
            ...
            If dt.Rows.Count <= 0 Then
                strquery = "select  " & Environment.NewLine & _
                ...
                " convert(decimal(18,2),SaleCost/iif( convert(decimal(18,2),(Sale_Qty/LtrUnit.conversion_factor)*StockUnit.conversion_factor*CurrentUnit.conversion_factor) =0, 1, convert(decimal(18,2),(Sale_Qty/LtrUnit.conversion_factor)*StockUnit.conversion_factor*CurrentUnit.conversion_factor) )) as [Sale Cogs Per Unit],SaleCost as [Sale Cogs],convert(decimal(18,2),([Batch Main Qty] *[Item Rate] ))-SaleCost as [Difference in Main item cost vs Sale Cogs] " & Environment.NewLine & _
                " from (SELECT FINAL.[BATCH NO]  ,MAX(FINAL.ManualBatchNo ) AS ManualBatchNo,MAX(FINAL.[Main Item]) AS [Main Item],MAX(FINAL.UOM ) AS UOM ,SUM(FINAL.[Batch Main Qty]) AS [Batch Main Qty], max(FINAL.[Item Rate]) as [Item Rate], " & Environment.NewLine & _
                " MAX(FINAL.Sale_Uom ) AS SALE_UOM,SUM(FINAL.SaleQty)  as Sale_Qty ,sum(final.SaleCost) as  SaleCost  from  " & Environment.NewLine & _
                " (select  " & Environment.NewLine & _
                " 1 as RowNumber,TSPL_BATCH_ITEM.Batch_No as [Batch No],TSPL_BATCH_ITEM.Manual_BatchNo as ManualBatchNo,TSPL_BATCH_ITEM.Item_Code  as [Main Item],TSPL_BATCH_ITEM.UOM, " & Environment.NewLine & _
                " TSPL_BATCH_ITEM. Qty as [Batch Main Qty],TSPL_INVENTORY_MOVEMENT.Basic_Cost   as [Item Rate],  " & Environment.NewLine & _
                " 0 as [Main item cost],0 as [Issued Cost],0 as [Consumed Value],0 as [Gain Loss Value],NULL as Sale_Uom ,0 as SaleQty,0 as SaleCost " & Environment.NewLine & _
                " from TSPL_BATCH_ITEM " & Environment.NewLine & _
                " left outer join TSPL_INVENTORY_MOVEMENT on TSPL_INVENTORY_MOVEMENT.Source_Doc_No =TSPL_BATCH_ITEM .Document_Code and TSPL_INVENTORY_MOVEMENT.Item_Code =TSPL_BATCH_ITEM.Item_Code  " & Environment.NewLine & _
                " where TSPL_BATCH_ITEM.Batch_No in (select batch_no from TSPL_BATCH_ITEM where Document_Code ='" & strCode & "' and Item_Code ='" & strItemCode & "') and TSPL_BATCH_ITEM.Item_Code ='" & strItemCode & "' AND TSPL_BATCH_ITEM.In_Out_Type ='I' AND TSPL_BATCH_ITEM.Document_Type ='IC-AD' " & Environment.NewLine & _
                " UNION ALL " & Environment.NewLine & _
                " SELECT " & Environment.NewLine & _
                " 2 as RowNumber,TSPL_BATCH_ITEM.Batch_No as [Batch No],TSPL_BATCH_ITEM.Manual_BatchNo as ManualBatchNo,TSPL_INVENTORY_MOVEMENT.Item_Code  as [Main Item],NULL AS UOM, " & Environment.NewLine & _
                " 0 as [Batch Main Qty],0  as [Item Rate],  " & Environment.NewLine & _
                " 0 as [Main item cost],0 as [Issued Cost],0 as [Consumed Value],0 as [Gain Loss Value],TSPL_INVENTORY_MOVEMENT.UOM as Sale_Uom ,TSPL_INVENTORY_MOVEMENT.Qty  as SaleQty,TSPL_INVENTORY_MOVEMENT.Avg_Cost  as SaleCost   " & Environment.NewLine & _
                " from TSPL_INVENTORY_MOVEMENT  " & Environment.NewLine & _
                " left outer join TSPL_BATCH_ITEM on TSPL_INVENTORY_MOVEMENT.Source_Doc_No =TSPL_BATCH_ITEM .Document_Code and TSPL_INVENTORY_MOVEMENT.Item_Code =TSPL_BATCH_ITEM.Item_Code  " & Environment.NewLine & _
                " where TSPL_INVENTORY_MOVEMENT.Source_Doc_No ='" & strCode & "' and TSPL_INVENTORY_MOVEMENT.iTEM_CODE ='" & strItemCode & "' " & Environment.NewLine & _
                " )FINAL group by FINAL.[BATCH NO],FINAL.[Main Item]) z " & Environment.NewLine & _
                " left join tspl_item_uom_detail LtrUnit on LtrUnit.item_code=z.[Main Item]	 and LtrUnit.UOM_Code=z.UOM " & Environment.NewLine & _
                " left join tspl_item_uom_detail StockUnit on StockUnit.item_code=z.[Main Item] and StockUnit.Stocking_Unit ='Y' " & Environment.NewLine & _
    ...
    Private Sub TxtMultiRSM__My_Click(sender As Object, e As EventArgs) Handles TxtMultiRSM._My_Click
        Dim strQry As String = "select TSPL_EMPLOYEE_MASTER.EMP_CODE as Code,TSPL_EMPLOYEE_MASTER.Emp_Name as Name from TSPL_EMPLOYEE_MASTER "
        TxtMultiRSM.arrValueMember = clsCommon.ShowMultipleSelectForm("RSMMulSel", strQry, "Code", "Name", TxtMultiRSM.arrValueMember, TxtMultiRSM.arrDispalyMember)
    End Sub

    Private Sub TxtMultiZSM__My_Click(sender As Object, e As EventArgs) Handles TxtMultiZSM._My_Click
        Dim strQry As String = "select TSPL_EMPLOYEE_MASTER.EMP_CODE as Code,TSPL_EMPLOYEE_MASTER.Emp_Name as Name from TSPL_EMPLOYEE_MASTER "
        TxtMultiZSM.arrValueMember = clsCommon.ShowMultipleSelectForm("ZSMMulSel", strQry, "Code", "Name", TxtMultiZSM.arrValueMember, TxtMultiZSM.arrDispalyMember)
    End Sub

    Private Sub TxtMultiASM__My_Click(sender As Object, e As EventArgs) Handles TxtMultiASM._My_Click
        Dim strQry As String = "select TSPL_EMPLOYEE_MASTER.EMP_CODE as Code,TSPL_EMPLOYEE_MASTER.Emp_Name as Name from TSPL_EMPLOYEE_MASTER "
        TxtMultiASM.arrValueMember = clsCommon.ShowMultipleSelectForm("ASMMulSel", strQry, "Code", "Name", TxtMultiASM.arrValueMember, TxtMultiASM.arrDispalyMember)
    End Sub

    Private Sub TxtMultiASO__My_Click(sender As Object, e As EventArgs) Handles TxtMultiASO._My_Click
        Dim strQry As String = "select TSPL_EMPLOYEE_MASTER.EMP_CODE as Code,TSPL_EMPLOYEE_MASTER.Emp_Name as Name from TSPL_EMPLOYEE_MASTER "
        TxtMultiASO.arrValueMember = clsCommon.ShowMultipleSelectForm("ASOMulSel", strQry, "Code", "Name", TxtMultiASO.arrValueMember, TxtMultiASO.arrDispalyMember)
    End Sub
    ...
    Private Sub chkBatchWise_ToggleStateChanged(sender As Object, args As StateChangedEventArgs) Handles chkBatchWise.ToggleStateChanged
        If chkBatchWise.Checked AndAlso clsCommon.CompairString(clsUserMgtCode.RptFreshSaleRegister1, FORMTYPE) <> CompairStringResult.Equal Then
            Dim arr As New ArrayList
            arr.Add("Fresh Sale")
            arr.Add("Fresh Sale Return")
