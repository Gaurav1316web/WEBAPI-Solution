...
Public Class RptRouteWiseSaleRegister
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        " ,(TSPL_ROUTE_MASTER.Route_Desc) as Route,TSPL_ROUTE_MASTER.Route_No as [Route No],Customerqty,CAN_Qty,CRATE_Qty,BOX_Qty,cast(CRATE_Total.CarteQtyLtr as decimal(18,0) ) as CarteQtyLtr,cast(CAN_Total.CanQtyLtr as decimal(18,0) ) as CanQtyLtr " & Environment.NewLine &
