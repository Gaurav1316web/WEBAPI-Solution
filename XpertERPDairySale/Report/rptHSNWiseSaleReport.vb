...
#End Region
    ...
    Private Sub txtTransaction__My_Click(sender As Object, e As EventArgs) Handles txtTransaction._My_Click
        Try
            Dim qry As String = "SELECT Program_Code As Code,Program_Name as Name from TSPL_PROGRAM_MASTER where Program_Code in ( 'AR-INVOICE','INVOICE-BS','BULK-SALE-RE','CAN-SALE','VCGL','M-Material-R','STO-TRANSFER')
