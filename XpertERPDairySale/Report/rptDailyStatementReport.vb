...
Public Class rptDailyStatementReport
    ...
    Private Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        ElseIf rbtnRouteWise.IsChecked Then
            query += " XXXFirst.Route_No, XXXFirst.Cust_Code,	XXXFirst.Item_Code ,XXXFirst.Sku_Seq  order by XXXFirst.Route_No ASC "
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            Else
                frmCRV.funreport(CrystalReportFolder.KwalitySalesReport, dt, "crptDailyStatementRouteAndDistributorWiseDetail", "")
            End If
        Else
    ...
    Private Function ReturnQry() As String
        Dim BaseQry As String = ""
        BaseQry = "Select TSPL_DEMAND_BOOKING_MASTER.Route_No,tspl_route_master.Route_Desc,  TSPL_DEMAND_BOOKING_MASTER.ShiftType, case when TSPL_ITEM_MASTER.Is_Ambient = 1 then round((isnull(TSPL_DEMAND_BOOKING_DETAIL.Qty,0) *isnull(TSPL_ITEM_UOM_DETAIL.Conversion_Factor,1))/I.KG,2) 
