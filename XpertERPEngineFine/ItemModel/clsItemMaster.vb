    ...
    Public Shared Function GetDataRMOther(ByVal strCode As String, ByVal NavType As common.NavigatorType) As clsItemMaster
        ...
        Try
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                qry = " select Item_Code,UOM_Code,UOM_Description,Conversion_Factor,Stocking_Unit,Default_UOM,Print_UOM,Report_UOM,Decimal_UOM,ProcessLoss_UOM,Gross_Weight,Net_Weight,Job_Work_Rate,pieces,Item_Cost,Custom_Conversion from TSPL_ITEM_UOM_DETAIL where Item_Code='" + obj.Item_Code + "' order by Stocking_Unit desc"
