...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsShortSupplyPenalty, ByVal isNewEntry As Boolean, ByVal trans As SqlTransaction) As Boolean
        Try
            ...
            If isPost Then
                qry = Nothing
                qry = "update TSPL_TENDER_HEADER Set close_yn='Y' Where DocumentCode='" + obj.RAL_No + "'"
                clsDBFuncationality.ExecuteNonQuery(qry, trans)
                ...
                If True AndAlso dblAmount > 0 Then
                    ...
                    'objVendorInvHead.RefDocType = "SHRT-PNT"
...
where 2=2"
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            qry = "Select * from TSPL_SHORT_SUPPLY_PENALTY_DETAIL Where Document_No='" + obj.Document_Code + "'"
            dt = New DataTable()
    ...
    Public Shared Function DeleteData(ByVal strDocCode As String) As Boolean
        ...
        Try
            ...
            isDeleted = clsDBFuncationality.ExecuteNonQuery(Qry, trans)
    ...
    Public Shared Function SaveData(ByVal strCode As String, ByVal Arr As List(Of clsShortSupplyPenaltyDetail), ByVal trans As SqlTransaction) As Boolean
        ...
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsShortSupplyPenaltyDetail In Arr
                ...
                isSaved = clsCommonFunctionality.UpdateDataTable(coll, "TSPL_SHORT_SUPPLY_PENALTY_DETAIL", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return isSaved
    End Function
