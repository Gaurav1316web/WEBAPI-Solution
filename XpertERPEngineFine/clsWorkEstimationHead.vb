'-05/08/2020--Created by--Sanjay
Imports common
Imports System.Data.SqlClient
Public Class clsWorkEstimationHead
#Region "Variables"
    Public WorkEstimation_Id As String = Nothing
    Public WorkEstimation_Date As DateTime = Nothing
    ...
    Public ArrTr As List(Of clsWorkEstimationDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsWorkEstimationHead, ByVal isNewEntry As Boolean) As Boolean
    ...
    Public Function SaveData(ByVal obj As clsWorkEstimationHead, ByVal isNewEntry As Boolean, ByVal trans As SqlTransaction) As Boolean
        Try
            Dim isSaved As Boolean = True

            'clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Purchase Order", "Purchase Requisition", obj.Location, obj.WorkEstimation_Date, trans)
            'clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Purchase Order", "Store Requisition", obj.Location, obj.WorkEstimation_Date, trans)
            ''-----------------------------------------------
            ...
            'End If
            ''-----------------------------------------------
            Dim qry As String = "delete from TSPL_WORK_ESTIMATION_DETAIL where WorkEstimation_Id='" + obj.WorkEstimation_Id + "'"
            ...
            If (isNewEntry) Then
                ...
                obj.WorkEstimation_Id = clsERPFuncationality.GetNextCode(trans, obj.WorkEstimation_Date, clsDocType.WorkEstimationEng, clsDocTransactionType.POJobWork, obj.Location)
                'Else
                ...
                '    End If
                'End If
                If (clsCommon.myLen(obj.WorkEstimation_Id) <= 0) Then
                    Throw New Exception("Error in Document Code Generation")
                End If
            End If
            Dim coll As New Hashtable()
            clsCommon.AddColumnsForChange(coll, "WorkEstimation_Date", clsCommon.GetPrintDate(obj.WorkEstimation_Date, "dd/MMM/yyyy hh:mm tt"))
            ...
            If isNewEntry Then
                clsCommon.AddColumnsForChange(coll, "WorkEstimation_Id", obj.WorkEstimation_Id)
                clsCommon.AddColumnsForChange(coll, "Created_By", objCommonVar.CurrentUserCode)
                clsCommon.AddColumnsForChange(coll, "Created_Date", clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MM/yyyy"))
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_WORK_ESTIMATION_HEAD", OMInsertOrUpdate.Insert, "", trans)
            Else
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_WORK_ESTIMATION_HEAD", OMInsertOrUpdate.Update, "WorkEstimation_Id='" + obj.WorkEstimation_Id + "'", trans)
            End If
            isSaved = isSaved AndAlso clsWorkEstimationDetail.SaveData(obj.WorkEstimation_Id, obj.ArrTr, trans)
            isSaved = isSaved AndAlso clsCustomFieldValues.SaveData(obj.Form_ID, obj.WorkEstimation_Id, obj.arrCustomFields, trans)
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal IsInternal As String) As clsWorkEstimationHead
        Return GetData(strCode, NavType, Nothing, IsInternal)
    End Function

    'Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal trans As SqlTransaction, ByVal IsInternal As String) As clsWorkEstimationHead
    '    Return GetData(strCode, NavType, trans, IsInternal, "")
    'End Function

    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal trans As SqlTransaction, ByVal IsInternal As String) As clsWorkEstimationHead
        Dim obj As clsWorkEstimationHead = Nothing
        Dim whrclas As String = ""
        Dim qry As String = "select TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id,TSPL_WORK_ESTIMATION_HEAD.close_yn,TSPL_WORK_ESTIMATION_HEAD.Requisition_Id,convert(varchar,TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Date,103) as WorkEstimation_Date,TSPL_WORK_ESTIMATION_HEAD.Cust_OrderNo,TSPL_WORK_ESTIMATION_HEAD.Expire_Date,TSPL_WORK_ESTIMATION_HEAD.Require_Date,TSPL_WORK_ESTIMATION_HEAD.Status,TSPL_WORK_ESTIMATION_HEAD.On_Hold,TSPL_WORK_ESTIMATION_HEAD.Manual_Complete,TSPL_WORK_ESTIMATION_HEAD.Ref_No,TSPL_WORK_ESTIMATION_HEAD.Description,TSPL_WORK_ESTIMATION_HEAD.Remarks,TSPL_WORK_ESTIMATION_HEAD.Location,TSPL_LOCATION_MASTER.Location_Desc as LocationName,TSPL_WORK_ESTIMATION_HEAD.RQ_Detail_Total_Amt,TSPL_WORK_ESTIMATION_HEAD.Total_RQ_Amt,TSPL_WORK_ESTIMATION_HEAD.Mode_Of_Transport,TSPL_WORK_ESTIMATION_HEAD.Comments,TSPL_WORK_ESTIMATION_HEAD.Created_By,TSPL_WORK_ESTIMATION_HEAD.Created_Date,TSPL_WORK_ESTIMATION_HEAD.Modify_By,TSPL_WORK_ESTIMATION_HEAD.Modify_Date,TSPL_WORK_ESTIMATION_HEAD.Comp_Code,TSPL_WORK_ESTIMATION_HEAD.Posting_Date,TSPL_WORK_ESTIMATION_HEAD.Dept,TSPL_WORK_ESTIMATION_HEAD.Dept_Desc,TSPL_WORK_ESTIMATION_HEAD.Item_Type,TSPL_WORK_ESTIMATION_HEAD.Request_By,Is_internal, Is_Tender,EMailID,TSPL_WORK_ESTIMATION_HEAD.Approvel_Level_Required,TSPL_WORK_ESTIMATION_HEAD.Level1_Approval_Status ,TSPL_WORK_ESTIMATION_HEAD.Level2_Approval_Status,TSPL_WORK_ESTIMATION_HEAD.SubRequest,TSPL_WORK_ESTIMATION_HEAD.CatalogueType,TSPL_WORK_ESTIMATION_HEAD.Vendor_Code ,TSPL_WORK_ESTIMATION_HEAD.Level3_Approval_Status,TSPL_WORK_ESTIMATION_HEAD.Level4_Approval_Status,TSPL_WORK_ESTIMATION_HEAD.Level5_Approval_Status ,TSPL_WORK_ESTIMATION_HEAD.Requisition_Type,TSPL_WORK_ESTIMATION_HEAD.Request_Type,TSPL_WORK_ESTIMATION_HEAD.PROJECT_ID,TSPL_WORK_ESTIMATION_HEAD.Category,TSPL_WORK_ESTIMATION_HEAD.Capex_Code,TSPL_WORK_ESTIMATION_HEAD.Capex_SubCode,TSPL_WORK_ESTIMATION_HEAD.Emergency,TSPL_WORK_ESTIMATION_HEAD.Cost_Center_Unit,TSPL_WORK_ESTIMATION_HEAD.Cost_Center_Type " &
        ...
        qry += ",From_Screen_Code,WO_To,WO_Subject,WO_Content,WO_CopySubmittedTo FROM TSPL_WORK_ESTIMATION_HEAD left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_WORK_ESTIMATION_HEAD.Location where  2=2"
        ...
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id=(select MIN(WorkEstimation_Id) from TSPL_WORK_ESTIMATION_HEAD Where 1=1 " + whrclas + ")"
            Case NavigatorType.Last
                qry += " and TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id=(select Max(WorkEstimation_Id) from TSPL_WORK_ESTIMATION_HEAD Where 1=1 " + whrclas + ")"
            Case NavigatorType.Next
                qry += " and TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id=(select Min(WorkEstimation_Id) from TSPL_WORK_ESTIMATION_HEAD where WorkEstimation_Id > '" + strCode + "' " + whrclas + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id=(select Max(WorkEstimation_Id) from TSPL_WORK_ESTIMATION_HEAD where WorkEstimation_Id < '" + strCode + "' " + whrclas + ")"
            Case NavigatorType.Current
                qry += " and TSPL_WORK_ESTIMATION_HEAD.WorkEstimation_Id='" + strCode + "'  "
        End Select

        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsWorkEstimationHead()
            obj.WorkEstimation_Id = clsCommon.myCstr(dt.Rows(0)("WorkEstimation_Id"))
            obj.WorkEstimation_Date = clsCommon.myCDate(dt.Rows(0)("WorkEstimation_Date"))
            ...
            qry = "SELECT TSPL_WORK_ESTIMATION_DETAIL.Hirerachy_Code,TSPL_WORK_ESTIMATION_DETAIL.Cost_Centre_Code,TSPL_WORK_ESTIMATION_DETAIL.WorkEstimation_Id,TSPL_WORK_ESTIMATION_DETAIL.Line_No,TSPL_WORK_ESTIMATION_DETAIL.Vendor_Code,TSPL_VENDOR_MASTER.Vendor_Name as VendorName, TSPL_WORK_ESTIMATION_DETAIL.Item_Code,TSPL_WORK_ESTIMATION_DETAIL.Item_Desc,TSPL_WORK_ESTIMATION_DETAIL.Requisition_Qty,TSPL_WORK_ESTIMATION_DETAIL.Balance_Qty,TSPL_WORK_ESTIMATION_DETAIL.Unit_Code,TSPL_WORK_ESTIMATION_DETAIL.Location,TSPL_LOCATION_MASTER.Location_Desc as LocationName ,TSPL_WORK_ESTIMATION_DETAIL.Item_Cost,TSPL_WORK_ESTIMATION_DETAIL.Item_Net_Amt,TSPL_WORK_ESTIMATION_DETAIL.Status,TSPL_WORK_ESTIMATION_DETAIL.Order_No,TSPL_WORK_ESTIMATION_DETAIL.Vendor_ItemNo,TSPL_WORK_ESTIMATION_DETAIL.Specification,TSPL_WORK_ESTIMATION_DETAIL.Remarks,TSPL_WORK_ESTIMATION_DETAIL.Row_Type,TSPL_WORK_ESTIMATION_DETAIL.Capacity,TSPL_WORK_ESTIMATION_DETAIL.Make,TSPL_WORK_ESTIMATION_DETAIL.Cost_Code,TSPL_WORK_ESTIMATION_DETAIL.Model,TSPL_WORK_ESTIMATION_DETAIL.Hirerachy_Level3,TSPL_WORK_ESTIMATION_DETAIL.Hirerachy_Level4 FROM TSPL_WORK_ESTIMATION_DETAIL left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_WORK_ESTIMATION_DETAIL.Location left outer join TSPL_VENDOR_MASTER on TSPL_VENDOR_MASTER.Vendor_Code =TSPL_WORK_ESTIMATION_DETAIL.Vendor_Code where TSPL_WORK_ESTIMATION_DETAIL.WorkEstimation_Id='" + obj.WorkEstimation_Id + "' ORDER BY TSPL_WORK_ESTIMATION_DETAIL.Line_No"
            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.ArrTr = New List(Of clsWorkEstimationDetail)
                Dim objTr As clsWorkEstimationDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsWorkEstimationDetail()
                    objTr.Line_No = clsCommon.myCdbl(dr("Line_No"))
                    objTr.Row_Type = clsCommon.myCstr(dr("Row_Type"))
                    objTr.WorkEstimation_Id = clsCommon.myCstr(dr("WorkEstimation_Id"))
    ...
    Public Shared Function CloseprData(ByVal strDocNo As String, ByVal cls As String) As Boolean
        ...
        Try
            If (clsCommon.myLen(strDocNo) <= 0) Then
                Throw New Exception("Work Estimation No not found to close")
            End If
            Dim strPostDate As String = clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt")

            Dim obj As clsWorkEstimationHead = clsWorkEstimationHead.GetData(strDocNo, NavigatorType.Current, trans, "")
            Dim totDrAmt As Double = 0
            Dim totCrAmt As Double = 0

            If (obj Is Nothing OrElse clsCommon.myLen(obj.WorkEstimation_Id) <= 0) Then
                Throw New Exception("No Data found to close")
            End If
            Dim qry As String
            qry = "Update TSPL_WORK_ESTIMATION_HEAD set close_yn='" + cls + "' where WorkEstimation_Id ='" + strDocNo + "'"
    ...
    Public Shared Function PostData(ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        ...
        Try
            If (clsCommon.myLen(strDocNo) <= 0) Then
                Throw New Exception("Work Estimation No not found to Post")
            End If
            Dim strPostDate As String = clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt")
            ...
            'Else
            qry = "Update TSPL_WORK_ESTIMATION_HEAD set Status=1, Posting_Date='" + strPostDate + "',Modify_By='" + objCommonVar.CurrentUserCode + "' where WorkEstimation_Id ='" + strDocNo + "'"
            'End If
    ...
    'Private Shared Sub CreateInternalEmailSMS(ByVal obj As clsWorkEstimationHead, ByVal trans As SqlTransaction)
    '    Dim qry As String = ""
    ...
    '            " left join TSPL_REQUISITION_HEAD on TSPL_REQUISITION_HEAD.Created_By=TSPL_USER_MASTER.User_Code " &
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        If (clsCommon.myLen(strCode) <= 0) Then
            Throw New Exception("Work Estimation No not found to Delete")
        End If
        Dim obj As clsWorkEstimationHead = clsWorkEstimationHead.GetData(strCode, NavigatorType.Current, "")
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.WorkEstimation_Id) > 0) Then
            Try
                ...
                If (obj.Status = 1) Then
                    Throw New Exception("Already Post on :" + obj.Posting_Date)
                End If
                Dim qry As String = "delete from TSPL_WORK_ESTIMATION_DETAIL where WorkEstimation_Id ='" + strCode + "'"
                isSaved = clsDBFuncationality.ExecuteNonQuery(qry, trans)

                qry = "delete from TSPL_WORK_ESTIMATION_HEAD where WorkEstimation_Id ='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
...
Public Class clsWorkEstimationDetail
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strReqNo As String, ByVal Arr As List(Of clsWorkEstimationDetail), ByVal trans As SqlTransaction) As Boolean
        Dim intLineNo As Integer = 1
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsWorkEstimationDetail In Arr
                Dim coll As New Hashtable()
                clsCommon.AddColumnsForChange(coll, "WorkEstimation_Id", strReqNo)
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_WORK_ESTIMATION_DETAIL", OMInsertOrUpdate.Insert, "", trans)
    ...
    'Public Shared Function UpdateAutoIndentReorderQty(ByVal strReqNo As String, ByVal Arr As List(Of clsWorkEstimationDetail), ByVal trans As SqlTransaction) As Boolean
    '    If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
    '        For Each obj As clsWorkEstimationDetail In Arr
    ...
    '            "select ICode,sum(Qty*RI) as Qty,1 as RI from (" + Environment.NewLine +
    '            "select  TSPL_PURCHASE_ORDER_DETAIL.PurchaseOrder_No, TSPL_PURCHASE_ORDER_DETAIL.Requisition_Id as Code,TSPL_PURCHASE_ORDER_DETAIL.Item_Code as ICode ,case when TSPL_PURCHASE_ORDER_HEAD.Status=0 then 0 else TSPL_PURCHASE_ORDER_DETAIL.PurchaseOrder_Qty end as Qty ,1 as RI,1 as Chk  " + Environment.NewLine +
    ...
    '            "and (TSPL_PURCHASE_ORDER_HEAD.close_yn='Y' or TSPL_PURCHASE_ORDER_DETAIL.Status=1) " + Environment.NewLine +
    '            "and  TSPL_PURCHASE_ORDER_DETAIL.Requisition_Id='" + strReqCode + "' and TSPL_PURCHASE_ORDER_DETAIL.Item_Code='" + strICode + "'" + Environment.NewLine +
    '            "union all" + Environment.NewLine +
    '            "select TSPL_GRN_DETAIL.PO_ID as PurchaseOrder_No, TSPL_GRN_DETAIL.Requisition_Id as Code,TSPL_GRN_DETAIL.Item_Code as ICode,TSPL_GRN_DETAIL.GRN_Qty  Qty ,-1 as RI,0 as Chk  " + Environment.NewLine +
    '            "from TSPL_GRN_DETAIL " + Environment.NewLine +
    '            "left outer join TSPL_GRN_HEAD on TSPL_GRN_HEAD.GRN_No=TSPL_GRN_DETAIL.GRN_No where len(isnull(TSPL_GRN_DETAIL.Requisition_Id,''))>0 and len(isnull( TSPL_GRN_DETAIL.PO_Id,''))>0  " + Environment.NewLine +
    '            "and TSPL_GRN_DETAIL.Requisition_Id='" + strReqCode + "' and TSPL_GRN_DETAIL.Item_Code='" + strICode + "'" + Environment.NewLine +
    '            "union all" + Environment.NewLine +
    '            "select TSPL_MRN_DETAIL.PO_ID as PurchaseOrder_No, TSPL_MRN_DETAIL.Requisition_Id as Code,TSPL_MRN_DETAIL.Item_Code as ICode,TSPL_MRN_DETAIL.Reject_Qty as Qty ,1 as RI,0 as chk" + Environment.NewLine +
    '            "from TSPL_MRN_DETAIL " + Environment.NewLine +
    '            "left outer join TSPL_MRN_HEAD on TSPL_MRN_HEAD.MRN_No=TSPL_MRN_DETAIL.MRN_No where len(isnull(TSPL_MRN_DETAIL.Requisition_Id,''))>0 and len(isnull( TSPL_MRN_DETAIL.PO_ID,''))>0  " + Environment.NewLine +
    '            " and TSPL_MRN_HEAD.Status=1 and not exists(select 1 from TSPL_SRN_DETAIL where TSPL_SRN_DETAIL.MRN_Id =TSPL_MRN_DETAIL.MRN_No and  TSPL_SRN_DETAIL.PO_ID=TSPL_MRN_DETAIL.PO_ID and TSPL_SRN_DETAIL.Req_No =TSPL_MRN_DETAIL.Requisition_Id and TSPL_SRN_DETAIL.Item_Code =TSPL_MRN_DETAIL.Item_Code)" + Environment.NewLine +
    '            " and TSPL_MRN_DETAIL.Requisition_Id ='" + strReqCode + "' and TSPL_MRN_DETAIL.Item_Code='" + strICode + "'" + Environment.NewLine +
    '            "union all" + Environment.NewLine +
    '            "select   TSPL_SRN_DETAIL.PO_ID as PurchaseOrder_No, TSPL_SRN_DETAIL.Req_No as Code,TSPL_SRN_DETAIL.Item_Code as ICode ,TSPL_SRN_DETAIL.Rejected_Qty+TSPL_SRN_DETAIL.Short_Qty as Qty   ,1 as RI,0 as chk" + Environment.NewLine +
    '            "from TSPL_SRN_DETAIL " + Environment.NewLine +
    '            "left outer join TSPL_SRN_HEAD on TSPL_SRN_HEAD.SRN_No=TSPL_SRN_DETAIL.SRN_No where len(isnull(TSPL_SRN_DETAIL.Req_No,''))>0 and len(isnull( PO_Id,''))>0  " + Environment.NewLine +
    '            "and TSPL_SRN_HEAD.Status=1 and TSPL_SRN_DETAIL.Req_No='" + strReqCode + "' and TSPL_SRN_DETAIL.Item_Code ='" + strICode + "'" + Environment.NewLine +
