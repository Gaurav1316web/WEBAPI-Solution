...
#Region "Variables"
    ...
    Public ESI_FROM_MONTH As Double
    Public ESI_TO_MONTH As Double
#End Region
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsPayPeriodMaster
        ...
        Dim qry As String = "select PAY_PERIOD_CODE, PAY_PERIOD_NAME, DATE_FROM, DATE_TO, DESCRIPTION,POSTED,Posting_Date,IsNull(ESI_FROM_MONTH,0)ESI_FROM_MONTH,IsNull(ESI_TO_MONTH,0)ESI_TO_MONTH  from TSPL_PAYPERIOD_MASTER where 2=2"
        Select Case NavType
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            End If
            obj.ESI_FROM_MONTH = clsCommon.myCdbl(dt.Rows(0)("ESI_FROM_MONTH"))
            obj.ESI_TO_MONTH = clsCommon.myCdbl(dt.Rows(0)("ESI_TO_MONTH"))
        End If
        Return obj
    End Function
    ...
    Public Function SaveData(ByVal obj As clsPayPeriodMaster, ByVal isNewEntry As Boolean) As Boolean
        ...
        Try
            ...
            clsCommon.AddColumnsForChange(coll, "ESI_FROM_MONTH", clsCommon.myCdbl(obj.ESI_FROM_MONTH))
            clsCommon.AddColumnsForChange(coll, "ESI_TO_MONTH", clsCommon.myCdbl(obj.ESI_TO_MONTH))
            If isNewEntry Then
