...
#Region "Variables"
    ...
    Private Shared _UniqueDocument As Boolean = False
    Private Shared _AllowAutoNoForBackLogEntry As Boolean = False
    Private Shared _AllowLockTransactionUserwise As Integer = 0
    Private Shared _CounterFinancialYearStyle As Boolean = False
    Private Shared _AutoGeneratePrefix As Boolean = False
    Private Shared _ERPStartDate As String = ""
...
#End Region
    ...
    Public Shared Property StopJournalEntry() As Boolean
        ...
        End Get
        Set(ByVal Value As Boolean)
            _StopJournalEntry = Value
        End Set
    End Property

    Public Shared Property StopInventory() As Boolean
        Get
            Return _StopInventory
        End Get
        Set(ByVal Value As Boolean)
            _StopInventory = Value
        End Set
    End Property

    Public Shared Property StopInventoryNew() As Boolean
        Get
            Return _StopInventoryNew
        End Get
        Set(ByVal Value As Boolean)
            _StopInventoryNew = Value
        End Set
    End Property

    Public Shared Property ERPStartDate() As String
        Get
            Return _ERPStartDate
        End Get
        Set(ByVal Value As String)
            _ERPStartDate = Value
        End Set
    ...
    Public Shared Property AutoGeneratePrefix() As Boolean
        Get
    ...
    Public Shared Property UniqueDocument() As Boolean
        Get
            Return _UniqueDocument
        End Get
        Set(ByVal Value As Boolean)
            _UniqueDocument = Value
        End Set
    End Property

    Public Shared Property AllowAutoNoForBackLogEntry() As Boolean
        Get
            Return _AllowAutoNoForBackLogEntry
        End Get
        Set(ByVal Value As Boolean)
            _AllowAutoNoForBackLogEntry = Value
        End Set
    End Property

    Public Shared Property CounterFinancialYearStyle() As Boolean
        Get
            Return _CounterFinancialYearStyle
        End Get
        Set(ByVal Value As Boolean)
            _CounterFinancialYearStyle = Value
        End Set
    End Property

    Public Shared Property AllowLockTransactionUserwise() As Integer
        Get
            Return _AllowLockTransactionUserwise
        End Get
        Set(ByVal Value As Integer)
            _AllowLockTransactionUserwise = Value
        End Set
    End Property
    ...
    Public Shared Property InstantSendTheSMS() As Boolean
        Get
            Return _InstantSendTheSMS
        End Get
        Set(ByVal Value As Boolean)
    ...
    Public Shared Sub RefreshCommonVar()
        ...
        objCommonVar.UniqueDocument = IIf(clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.CheckUniqueDocumentCode, clsFixedParameterCode.CheckUniqueDocumentCode, Nothing)) = 1, True, False)
        objCommonVar.AllowAutoNoForBackLogEntry = IIf(clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoNoForBackLogEntry, clsFixedParameterCode.AllowAutoNoForBackLogEntry, Nothing)) = 1, True, False)
        objCommonVar.AllowLockTransactionUserwise = IIf(clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.AllowLockTransactionUserwise, clsFixedParameterCode.AllowLockTransactionUserwise, Nothing)) = 1, True, False)
        objCommonVar.CounterFinancialYearStyle = IIf(clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.CounterFinancialYearStyle, clsFixedParameterCode.CounterFinancialYearStyle, Nothing)) = 1, True, False)
        objCommonVar.AutoGeneratePrefix = IIf(clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.AutoGeneratePrefix, clsFixedParameterCode.AutoGeneratePrefix, Nothing)) = 1, True, False)
        objCommonVar.ERPStartDate = clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.ERPStartDate, clsFixedParameterCode.ERPStartDate, Nothing))
