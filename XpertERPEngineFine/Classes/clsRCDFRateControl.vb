...
#End Region
    ...
    Public Shared Function DeleteData(ByVal StrCode As String, ByVal trans As SqlTransaction) As Boolean
        ...
        Try
            ...
            End If
            clsCommonFunctionality.SaveDeletedData(objCommonVar.CurrentUserCode, StrCode, "TSPL_RCDF_RATE_CONTROL", "Code", "TSPL_RCDF_RATE_CONTROL_DETAIL", "Code", "TSPL_RCDF_RATE_CONTROL_DETAIL_ALL_UOM", "Code", trans)

            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, StrCode, "TSPL_RCDF_RATE_CONTROL", "Code", "TSPL_RCDF_RATE_CONTROL_DETAIL", "Code", "TSPL_RCDF_RATE_CONTROL_DETAIL_ALL_UOM", "Code", trans)
