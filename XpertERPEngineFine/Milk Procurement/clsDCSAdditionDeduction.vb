...
#Region "Variables"
    ...
    Public FAT_Range_From As Decimal
    Public FAT_Range_To As Decimal
#End Region
    ...
    Public Function SaveData(ByVal obj As clsDCSAdditionDeduction, ByVal isNewEntry As Boolean, ByVal trans As SqlTransaction) As Boolean
        Try
            ...
            clsCommon.AddColumnsForChange(coll, "FAT_Range_From", obj.FAT_Range_From, True)
            clsCommon.AddColumnsForChange(coll, "FAT_Range_To", obj.FAT_Range_To, True)
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsDCSAdditionDeduction
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            obj.FAT_Range_From = clsCommon.myCDecimal(dt.Rows(0)("FAT_Range_From"))
            obj.FAT_Range_To = clsCommon.myCDecimal(dt.Rows(0)("FAT_Range_To"))
