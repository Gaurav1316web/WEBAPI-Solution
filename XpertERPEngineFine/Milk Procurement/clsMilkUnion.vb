...
Public Class clsMilkUnion
    ...
    Public Shared Function GetUnionDBandLocName(ByVal strName As String) As DataTable
        Dim Qry As String = "SELECT '" & strName & "' As Location_Name,'" & strName & "' As DataBase_Name ORDER BY Location_Name"
        Return clsDBFuncationality.GetDataTable(Qry)
    End Function
End Class
