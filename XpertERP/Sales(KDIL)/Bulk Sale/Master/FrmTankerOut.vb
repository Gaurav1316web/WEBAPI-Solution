...
#End Region
    ...
    Private Sub fndGateOutNo__MYValidating(ByVal sender As Object, ByVal e As System.EventArgs, ByVal isButtonClicked As Boolean) Handles fndGateOutNo._MYValidating
        ...
        fndGateOutNo.Value = clsCommon.ShowSelectForm("TankerOut", Qry, "Code", " TSPL_GATEOUT_SALE.Location_Code in (" + arrLoc + ") and TSPL_GATEOUT_SALE.Comp_Code='" + objCommonVar.CurrentCompanyCode + "'", fndGateOutNo.Value, "", isButtonClicked)
