Imports common
Public Class frmPendingDispatchNoteFreshSale
#Region "Variables"
...
#End Region
    ...
    Private Sub FrmPendingRequistion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        qry += " where TSPL_SD_SHIPMENT_DETAIL.Status=0 and Scheme_Item='N'  and TSPL_SD_SHIPMENT_HEAD.Trans_Type='FS' and TSPL_SD_SHIPMENT_HEAD.Status=1 " + Environment.NewLine
        ...
        qry += " where TSPL_SD_SALE_INVOICE_HEAD.Status=1 and Scheme_Item='N'  and TSPL_SD_SALE_INVOICE_HEAD.Trans_Type='FS' and len(isnull(TSPL_SD_SALE_INVOICE_DETAIL.Shipment_Code,''))>0   " + Environment.NewLine
        qry += " union all   " + Environment.NewLine
        ...
        qry += "  ,Scheme_Code from TSPL_SD_SALE_INVOICE_DETAIL " + Environment.NewLine
        qry += " left outer join TSPL_SD_SALE_INVOICE_HEAD on TSPL_SD_SALE_INVOICE_HEAD.Document_Code=TSPL_SD_SALE_INVOICE_DETAIL.Document_Code" + Environment.NewLine
        qry += " where TSPL_SD_SALE_INVOICE_HEAD.Status=0 and Scheme_Item='N'  and TSPL_SD_SALE_INVOICE_HEAD.Trans_Type='FS' and len(isnull(TSPL_SD_SALE_INVOICE_DETAIL.Shipment_Code,''))>0 and TSPL_SD_SALE_INVOICE_DETAIL.DOCUMENT_CODE not in ('" + strCurrCode + "')  " + Environment.NewLine
