...
Imports common
Public Class frmPendingBookingOrderPS
#Region "Variables"
...
#End Region
    ...
    Private Sub FrmPendingRequistion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '" select TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code as Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code as Vendor,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Desc as IName,TSPL_BOOKING_DETAIL_PRODUCTSALE.Row_Type as IType,(TSPL_BOOKING_DETAIL_PRODUCTSALE.MRN_Qty +isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.Leak_Qty,0)+isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.Burst_Qty,0)+isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.Short_Qty,0)) as Qty,0 as Unapproved,TSPL_BOOKING_DETAIL_PRODUCTSALE.Unit_Code as Unit,TSPL_BOOKING_DETAIL_PRODUCTSALE.Location as Location,1 as RI,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Cost as Rate,1 as Chk,TSPL_BOOKING_MASTER_PRODUCTSALE.Tax_Group,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.MRP,TSPL_BOOKING_DETAIL_PRODUCTSALE.Batch_No,TSPL_BOOKING_DETAIL_PRODUCTSALE.MFG_Date,TSPL_BOOKING_DETAIL_PRODUCTSALE.Expiry_Date,TSPL_BOOKING_DETAIL_PRODUCTSALE.Disc_Per,MRN_Date as TransDate,TSPL_BOOKING_DETAIL_PRODUCTSALE.Assessable,TSPL_BOOKING_DETAIL_PRODUCTSALE.Leak_Qty,TSPL_BOOKING_DETAIL_PRODUCTSALE.Burst_Qty,TSPL_BOOKING_DETAIL_PRODUCTSALE.Short_Qty  from TSPL_BOOKING_DETAIL_PRODUCTSALE left outer join TSPL_BOOKING_MASTER_PRODUCTSALE on TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code where TSPL_BOOKING_DETAIL_PRODUCTSALE.Status=0 and TSPL_BOOKING_MASTER_PRODUCTSALE.Status=1 "
        'If clsCommon.myLen(VendorCode) > 0 Then
        '    qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code='" + VendorCode + "'"
        'End If
        'qry += " union all" & _
        '" select TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code as Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Desc as IName,'' as IType,(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.SRN_Qty,0) +isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Leak_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Burst_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Short_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Rejected_Qty,0) ) as Qty,0 as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,0) as MRP,'' as Batch_No,null as MFG_Date,null as Expiry_Date,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)as Assessable,0 as Leak_Qty,0 as Burst_Qty,0 as Short_Qty from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.SRN_No=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.SRN_No where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=1 and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code,''))>0  " & _
        '" union all  " & _
        '" select TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code as Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Desc as IName,'' as IType,0  as Qty,(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.SRN_Qty,0) +isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Leak_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Burst_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Short_Qty,0)+isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Rejected_Qty,0)) as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,0) as MRP,'' as Batch_No,null as MFG_Date,null as Expiry_Date,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0) as Assessable,0 as Leak_Qty,0 as Burst_Qty,0 as Short_Qty from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.SRN_No=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.SRN_No  where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=0 and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code,''))>0 and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.SRN_No not in ('" + strCurrCode + "')   " & _
        ...
        '-------------------------------------
        Dim qry As String = "select CAST(0 as bit) as Sel,code,max(Final.Tax_Group) as Tax_Group,max(TSPL_TAX_GROUP_MASTER.Tax_Group_Desc) as TaxGroupName,max(Final.Is_Taxable) as IsTaxable,ICode,max(IName) as IName,MAX(IType) as IType,Unit,max(Location) as Location,MAX(TSPL_LOCATION_MASTER.Location_Desc) as LocationName, SUM(Qty* case when RI=1 then 1 else 0 end) as POQty, SUM(Qty* case when RI=-1 then 1 else 0 end) as GRNQty, SUM(Unapproved) as UnapprovedQty, SUM((Qty *RI)- Unapproved) as PedningQty ,MAX(Rate) as Rate, MAX(Final.TAX1_Rate) as TAX1_Rate,MAX(Final.TAX2_Rate) as TAX2_Rate,MAX(Final.TAX3_Rate) as TAX3_Rate,MAX(Final.TAX4_Rate) as TAX4_Rate,MAX(Final.TAX5_Rate) as TAX5_Rate,MAX(Final.TAX6_Rate) as TAX6_Rate,MAX(Final.TAX7_Rate) as TAX7_Rate,MAX(Final.TAX8_Rate) as TAX8_Rate,MAX(Final.TAX9_Rate) as TAX9_Rate,MAX(Final.TAX10_Rate) as TAX10_Rate,Final.MRP as MRP ,max(Disc_Per) as Disc_Per,max(TransDate) as TransDate ,MAX(Vendor) as Vendor,MAX(TSPL_CUSTOMER_MASTER.Customer_Name) as VendorName,0 as Assessable,max(Scheme_Code) as Scheme_Code from ( " + Environment.NewLine
        qry += " select TSPL_BOOKING_MASTER_PRODUCTSALE.Is_Taxable, TSPL_BOOKING_DETAIL_PRODUCTSALE.Line_No,TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code as Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code as Vendor,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_ITEM_MASTER.Item_Desc as IName,TSPL_BOOKING_DETAIL_PRODUCTSALE.Row_Type as IType, TSPL_BOOKING_DETAIL_PRODUCTSALE.Qty  as Qty,0 as Unapproved,TSPL_BOOKING_DETAIL_PRODUCTSALE.Unit_Code as Unit,TSPL_BOOKING_DETAIL_PRODUCTSALE.Location as Location,1 as RI,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Cost as Rate,1 as Chk,TSPL_BOOKING_MASTER_PRODUCTSALE.Tax_Group,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.MRP ,TSPL_BOOKING_DETAIL_PRODUCTSALE.Disc_Per,Document_Date as TransDate,TSPL_BOOKING_DETAIL_PRODUCTSALE.Assessable " + Environment.NewLine
        qry += " ,Scheme_Code from TSPL_BOOKING_DETAIL_PRODUCTSALE " + Environment.NewLine
        qry += " left outer join TSPL_BOOKING_MASTER_PRODUCTSALE on TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code  " + Environment.NewLine
        qry += " left outer join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER.Item_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code" + Environment.NewLine
        qry += " where TSPL_BOOKING_DETAIL_PRODUCTSALE.Status=0 and TSPL_BOOKING_MASTER_PRODUCTSALE.Itemwise=1 and Scheme_Item='N'  and TSPL_BOOKING_MASTER_PRODUCTSALE.Status=1 and TSPL_BOOKING_MASTER_PRODUCTSALE.close_yn='N'  and bookvalidity_date >= '" & clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(), "dd/MMM/yyyy") & "'  " + Environment.NewLine
        If clsCommon.myLen(VendorCode) > 0 Then
            qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code='" + VendorCode + "'"
        End If

        qry += " union all " + Environment.NewLine
        qry += " select TSPL_SD_SALES_ORDER_HEAD.Is_Taxable, TSPL_SD_SALES_ORDER_DETAIL.Line_No,TSPL_SD_SALES_ORDER_DETAIL.Against_Booking_No as Code,'' as Vendor,TSPL_SD_SALES_ORDER_DETAIL.Item_Code as ICode,'' as IName,'' as IType,isnull(TSPL_SD_SALES_ORDER_DETAIL.Qty,0) as Qty,0 as Unapproved,TSPL_SD_SALES_ORDER_DETAIL.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,0 as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_SD_SALES_ORDER_DETAIL.Assessable,0)as Assessable" + Environment.NewLine
        ...
        qry += " where TSPL_SD_SALES_ORDER_HEAD.Status=1  and TSPL_SD_SALES_ORDER_HEAD.Itemwise=1 and Auto_SaleOrder=0 and Scheme_Item='N'  and len(isnull(TSPL_SD_SALES_ORDER_DETAIL.Against_Booking_No,''))>0  and  TSPL_SD_SALES_ORDER_HEAD.Document_Code not in (select isnull(Against_Sales_Order,'') from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE) " + Environment.NewLine
        qry += " union all   " + Environment.NewLine
        qry += " select TSPL_SD_SALES_ORDER_HEAD.Is_Taxable,TSPL_SD_SALES_ORDER_DETAIL.Line_No,TSPL_SD_SALES_ORDER_DETAIL.Against_Booking_No as Code,'' as Vendor,TSPL_SD_SALES_ORDER_DETAIL.Item_Code as ICode,'' as IName,'' as IType,0 as Qty,isnull(TSPL_SD_SALES_ORDER_DETAIL.Qty,0) as Unapproved,TSPL_SD_SALES_ORDER_DETAIL.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,0 as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_SD_SALES_ORDER_DETAIL.Assessable,0)as Assessable" + Environment.NewLine
        qry += " ,Scheme_Code from TSPL_SD_SALES_ORDER_DETAIL " + Environment.NewLine
        qry += " left outer join TSPL_SD_SALES_ORDER_HEAD on TSPL_SD_SALES_ORDER_HEAD.Document_Code=TSPL_SD_SALES_ORDER_DETAIL.Document_Code" + Environment.NewLine
        qry += " where TSPL_SD_SALES_ORDER_HEAD.Status=0 and TSPL_SD_SALES_ORDER_HEAD.Itemwise=1  and Scheme_Item='N' and Auto_SaleOrder=0  and len(isnull(TSPL_SD_SALES_ORDER_DETAIL.Against_Booking_No,''))>0 and TSPL_SD_SALES_ORDER_DETAIL.DOCUMENT_CODE not in ('" + strCurrCode + "')  " + Environment.NewLine

        qry += " union all " + Environment.NewLine
        qry += " select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Is_Taxable, TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code as Code,'' as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,'' as IName,'' as IType,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty,0) as Qty,0 as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,0 as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)as Assessable" + Environment.NewLine
        ...
        qry += " where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.posted=1  and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Itemwise=1 and Scheme_Item='N'  and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code,''))>0   " + Environment.NewLine
        qry += " union all   " + Environment.NewLine
        qry += " select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Is_Taxable, TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code as Code,'' as Vendor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,'' as IName,'' as IType,0 as Qty,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty,0) as Unapproved,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code as Unit,'' as Location,-1 as RI,0 as Rate,0 as Chk,'' as Tax_Group,0 as TAX1_Rate,0 as TAX2_Rate,0 as TAX3_Rate,0 as TAX4_Rate,0 as TAX5_Rate,0 as TAX6_Rate,0 as TAX7_Rate,0 as TAX8_Rate,0 as TAX9_Rate,0 as TAX10_Rate,0 as MRP,0 as Disc_Per,null as TransDate,isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)as Assessable" + Environment.NewLine
        qry += " ,Scheme_Code from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE " + Environment.NewLine
        qry += " left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code" + Environment.NewLine
        qry += " where TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.posted=0 and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Itemwise=1  and Scheme_Item='N'  and len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code,''))>0 and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.DOCUMENT_CODE not in ('" + strCurrCode + "')  " + Environment.NewLine
        ...
        If IsAllowSingleSI4SingleSO = True Then
            qry += " WHERE Code Not in (Select Distinct Booking_Code from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE WHERE ISNULL(Booking_Code,'')<>'') " + StrCondition + " "
        Else
            qry += "" + StrCondition1 + "  "
        End If
