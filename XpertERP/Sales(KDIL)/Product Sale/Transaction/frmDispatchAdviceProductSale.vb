...
Public Class frmDispatchAdviceProductSale
...
#End Region
    Public Sub SetUserMgmtNew()
        ...
        'MyBase.SetUserMgmt(clsUserMgtCode.frmdispatchAdviceProductSale)
    ...
    Sub LoadBlankGrid()
        ...
        repoLocationCode.VisibleInColumnChooser = False
        ...
        repoLocationName.VisibleInColumnChooser = False
        ...
        BOOK_QTY_UOM.VisibleInColumnChooser = False
        BOOK_QTY_UOM.IsVisible = False
        ...
        repoShipparty.VisibleInColumnChooser = False
        ...
        repoShippartyName.IsVisible = False
        repoShippartyName.VisibleInColumnChooser = False
        ...
        repoConvQty.Step = 0
        repoConvQty.VisibleInColumnChooser = False
        ...
        repoIsSchmItem13.VisibleInColumnChooser = False
        ...
        repoIsSchmItem1c.VisibleInColumnChooser = False
        ...
        repoIsSchmItem1c2.VisibleInColumnChooser = False
        ...
        repoIsSchmItem1c3.VisibleInColumnChooser = False
        ...
        BOOK_Rate.VisibleInColumnChooser = False
        BOOK_Rate.IsVisible = False
        ...
        BOOK_RATE_UOM.VisibleInColumnChooser = False
        ...
        repoCommparty.VisibleInColumnChooser = False
        ...
        repoCommPartyName.VisibleInColumnChooser = False
        ...
        repoCommPer.VisibleInColumnChooser = False
        ...
        repoIsExcisable8.VisibleInColumnChooser = False
                ...
                If Not isCellValueChangedOpen Then
                    ...
                    If e.Column Is gv1.Columns(colUnit) OrElse e.Column Is gv1.Columns(colSchemeType) OrElse e.Column Is gv1.Columns(colShipParty) OrElse e.Column Is gv1.Columns(colUnitALter) OrElse e.Column Is gv1.Columns(colUnitRate) OrElse e.Column Is gv1.Columns(colICodeGrp) OrElse e.Column Is gv1.Columns(colTAX_PAID) OrElse e.Column Is gv1.Columns(ColCommParty) OrElse e.Column Is gv1.Columns(colCommRate) OrElse e.Column Is gv1.Columns(colLocationCode) OrElse e.Column Is gv1.Columns(colMRP) OrElse e.Column Is gv1.Columns(colSchemeApplicable) OrElse e.Column Is gv1.Columns(colHeaDDisPer) OrElse e.Column Is gv1.Columns(colTotTaxAmt) OrElse e.Column Is gv1.Columns(colICode) OrElse e.Column Is gv1.Columns(colQty) OrElse e.Column Is gv1.Columns(colManualRate) OrElse e.Column Is gv1.Columns(colSpecification) OrElse e.Column Is gv1.Columns(colRemarks) OrElse e.Column Is gv1.Columns(colDisPer) OrElse (e.Column Is gv1.Columns(colHeadDiscamt)) OrElse (e.Column Is gv1.Columns(colAmt)) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal Then
                        ...
                        If (e.Column Is gv1.Columns(colQty) OrElse (e.Column Is gv1.Columns(colHeadDiscamt)) OrElse e.Column Is gv1.Columns(colDisPer) OrElse e.Column Is gv1.Columns(colHeaDDisPer) OrElse (e.Column Is gv1.Columns(colAmt)) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal) Then
                            If (e.Column Is gv1.Columns(colQty) AndAlso clsCommon.myLen(gv1.CurrentRow.Cells(colBookingNo).Value) > 0) Then
                        ...
                        ElseIf e.Column Is gv1.Columns(colSchemeApplicable) Then
                            If clsCommon.myLen(gv1.CurrentRow.Cells(colUnit).Value) > 0 Then
                                findQtyandPromoSchemeCode(False)
                            Else
                                common.clsCommon.MyMessageBoxShow("Please select Unit")
                                isCellValueChangedOpen = False
                                Exit Sub
                            End If
        ...
        Try
            ...
            If clsCommon.CompairString(clsCommon.myCstr(gv1.Rows(Index).Cells(colSchmCodeType).Value), "None") <> CompairStringResult.Equal OrElse clsCommon.CompairString(clsCommon.myCstr(gv1.Rows(Index).Cells(colSchmCodeType).Value), "") <> CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colSchemeApplicable).Value), "Yes") = CompairStringResult.Equal Then
                    ...
                    objD = clsSchemeApplyOnDairy.GetSchemeData(clsCommon.myCstr(gv1.CurrentRow.Cells(colICode).Value), clsCommon.myCstr(gv1.CurrentRow.Cells(colUnit).Value), clsCommon.myCstr(gv1.CurrentRow.Cells(colQty).Value), strCustomer, clsCommon.myCstr(gv1.CurrentRow.Cells(colSchmCodeType).Value))
                    If objD.Arr.Count = 0 AndAlso clsCommon.myLen(gv1.CurrentRow.Cells(colUnitALter).Value) > 0 Then
                        ...
                        objD = clsSchemeApplyOnDairy.GetSchemeData(clsCommon.myCstr(gv1.CurrentRow.Cells(colICode).Value), clsCommon.myCstr(gv1.CurrentRow.Cells(colUnitALter).Value), clsCommon.myCstr(gv1.CurrentRow.Cells(colQty).Value), strCustomer, clsCommon.myCstr(gv1.CurrentRow.Cells(colSchmCodeType).Value))
                    End If
    ...
    Sub OpenUOMAlterList(ByVal isButtonClick As Boolean)
        ...
        If AllowFreshPriceChartonProductSale = 1 Then
            gv1.CurrentRow.Cells(colAlternateRate).Value = ItemPrice(gv1.CurrentRow.Cells(colICode).Value, gv1.CurrentRow.Cells(colUnitALter).Value, gv1.CurrentRow.Index)
        End If
    End Sub
    ...
    Sub OpenItemGroupList(ByVal isButtonClick As Boolean)
        If clsCommon.myLen(fndBookingNo.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow("Please select Booking First")
            isCellValueChangedOpen = False
            Exit Sub
    ...
    Sub OpenItemList(ByVal isButtonClick As Boolean)
        ...
        Dim whrCls As String
        If clsCommon.myLen(fndBookingNo.Value) = 0 Then
            whrCls = " Active =1 and Is_FreshItem=0 and Product_Type not in ('MI') and Item_Type in ('F','T') and Is_Serial_Item=0"
        ...
        Else
            ...
            Else
                ...
                If clsCommon.myLen(strIcodegrp) <= 0 Then
                    common.clsCommon.MyMessageBoxShow("Please select Item Group First")
                    isCellValueChangedOpen = False
                    Exit Sub
                End If
                ...
                whrCls = "csa_type='" & gv1.CurrentRow.Cells(colICodeGrp).Value & "' and Active =1 and Is_FreshItem=0 and Product_Type not in ('MI') and Item_Type in ('F','T') and Is_Serial_Item=0 "
    ...
    Function GetBalanceOrderQty(ByVal strOrderCode As String, ByVal strICode As String) As Double
        ...
        End If
        Dim qry As String = "select sum (qty) from (" & _
        "select Qty from TSPL_SD_SALES_ORDER_DETAIL where Document_Code='" & strOrderCode & "' and " & strItem & " union all " & _
    ...
    Sub OpenICodeListCurrentCalaculation(ByVal isButtonClick As Boolean)
        ...
        If clsCommon.CompairString(strItemType, RowTypeItem) = CompairStringResult.Equal Then
            ...
            Dim dr As DataRow = clsCommon.ShowSelectFormForRow("DSPSqw@It", qry)
            If Not dr Is Nothing Then
                If clsCommon.myLen(clsCommon.myCstr(dr("Item"))) > 0 Then
                    SetitemWiseTaxSetting(True, True)
                    gv1.CurrentRow.Cells(colRowType).Value = RowTypeItem
    ...
    Private Function GetConvRateUOM(ByVal IntRowNo As Integer) As Double
        ...
        Else
            If AllowFreshPriceChartonProductSale = 1 Then
                ItemPrice(gv1.CurrentRow.Cells(colICode).Value, strCurrentUnit, IntRowNo)
            End If
        End If
        gv1.Rows(IntRowNo).Cells(colOrgUnit).Value = strCurrentUnit
        gv1.Rows(IntRowNo).Cells(colOrgUnitRate).Value = strCurrentUnit
    ...
    Private Function GetMaxLimitSchemeConvQty(ByVal IntRowNo As Integer) As Boolean
        ...
        Dim dblConvQty As Double = 0
        Dim dblQTy As Double = clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(colQty).Value)
        Dim qry = "select MainQty,MainUnit_Code,MaxlimitStart_Date,MaxlimitEnd_Date from tspl_scheme_master_new left outer join TSPL_SCHEME_DETAIL_NEW on " & _
            ...
            "where scheme_type='MaxLimit'  and TSPL_SCHEME_DETAIL_NEW.MainItem_Code='" & strItem & "' and Cust_Code='" & clsCommon.myCstr(txtVendorNo.Value) & "' " & _
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            strConvUnit = MainUOM
            qry = "select sum( case when ConvUnit.Conversion_Factor > 0 then (qty / ConvUnit.Conversion_Factor) * TransactionUnit.Conversion_Factor*DefaultUnit.Conversion_Factor else 0 end) as ConvQty  " & _
                        "from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE left outer join TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE  on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code " & _
                        "left outer join TSPL_ITEM_UOM_DETAIL as TransactionUnit on TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code=TransactionUnit.Item_Code and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code=TransactionUnit.UOM_Code " & _
                        "left outer join TSPL_ITEM_UOM_DETAIL as ConvUnit on TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code=ConvUnit.Item_Code and ConvUnit.UOM_Code='" & clsCommon.myCstr(MainUOM) & "' " & _
                        "left outer join TSPL_ITEM_UOM_DETAIL as DefaultUnit on TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code=DefaultUnit.Item_Code and DefaultUnit.Default_UOM=1  " & _
                        "where TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code='" & strItem & "' and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code not in ('" & txtDocNo.Value & "') " & _
    ...
    Private Sub UpdateCurrentRow(ByVal IntRowNo As Integer)
        ...
        If clsCommon.myLen(strICode) > 0 And clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(ColFOC).Value) = 0 Then
            ...
            obj_Cash = clsSchemeApplyOnDairy.GetPriceSchemeData(clsCommon.myCstr(gv1.Rows(IntRowNo).Cells(colICode).Value), clsCommon.myCstr(gv1.Rows(IntRowNo).Cells(colUnit).Value), clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(colQty).Value), strCustomer)
            If clsCommon.myLen(obj_Cash.Schm_Code) = 0 AndAlso clsCommon.myLen(gv1.Rows(IntRowNo).Cells(colUnitALter).Value) > 0 Then
                obj_Cash = clsSchemeApplyOnDairy.GetPriceSchemeData(clsCommon.myCstr(gv1.Rows(IntRowNo).Cells(colICode).Value), clsCommon.myCstr(gv1.Rows(IntRowNo).Cells(colUnitALter).Value), clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(colQty).Value), strCustomer)
            End If
            If obj_Cash IsNot Nothing Then
    ...
    Function AllowToSave() As Boolean
        Try
            ...
            If Not isNewEntry AndAlso clsCommon.myLen(txtDocNo.Value) <= 0 Then
                common.clsCommon.MyMessageBoxShow("DO code Not found to save")
                txtDocNo.Focus()
                Return False
            End If
            ...
            For ii As Integer = 0 To gv1.Rows.Count - 1
                ...
                ElseIf dblEnteredQty > dblBalQty Then ' AndAlso clsCommon.CompairString(strSchemeItem, "No") = CompairStringResult.Equal Then
                    gv1.Rows(ii).Cells(colQty).Value = dblEnteredQty - dblBalQty
                End If
    ...
    Private Function SaveData(ByVal isDoAbandomentNo As Boolean) As Boolean
        Try
            ...
            If (AllowToSave()) Then
                Dim obj As New clsPSDispatchAdvice()
                ...
                totalqty = 0
                For Each grow As GridViewRowInfo In gv1.Rows
                    Dim objTr As New clsPSDispatchAdviceDetail()
                    ...
                    If (clsCommon.myLen(objTr.Item_Code) > 0) AndAlso clsCommon.myCdbl(objTr.Qty) > 0 Then
                        obj.Arr.Add(objTr)
                    End If
                Next
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As New clsPSDispatchAdvice()
            obj = clsPSDispatchAdvice.GetData(strCode, NavTyep)
    ...
    Sub PostData()
        Try
            ...
            If (myMessages.postConfirm()) Then
                SavingData(True)              
                ''=========================================
                If (clsPSDispatchAdvice.PostData(MyBase.Form_ID, txtDocNo.Value)) Then
        ...
        Try
            ...
            If (myMessages.deleteConfirm()) Then
                If clsCancelLog.CheckForReasonOnDelete() Then
                    ...
                    End If
                End If
                If (clsPSDispatchAdvice.DeleteData(txtDocNo.Value)) Then
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtDocNo._MYValidating
        ...
        " case when isnull( TSPL_SD_SALES_ORDER_HEAD.Against_Booking_No,'')='' then  TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Against_Booking_No  else TSPL_SD_SALES_ORDER_HEAD.Against_Booking_No end  as [Booking No], TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Total_Amt as Amount, " & _
    ...
    Sub LoadParentSHipCode()
        Try
            If clsCommon.myLen(txtReqNo.Value) > 0 Then
                Dim qry = "select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code,Customer_Name from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE left   outer join TSPL_CUSTOMER_MASTER on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code=TSPL_CUSTOMER_MASTER.Cust_Code   " & _
    ...
    Sub SelecBookingItems()
        isInsideLoadData = True
        Dim frm As New frmPendingBookingForProdAdvicePS()
                    ...
                    For Each obj As clsBookingDetailProductSale In objOrderHead.Arr
                        If (obj.Item_Code = frm.ArrReturn(ii).Item_Code AndAlso obj.Unit_code = frm.ArrReturn(ii).Unit_code AndAlso obj.Scheme_Item = "N") Then '' OrElse (obj.Scheme_Code = frm.ArrReturn(ii).Scheme_Code AndAlso clsCommon.myLen(obj.Scheme_Code) > 0) Then
                            If IsValidBookingItem(obj) Then
                                ...
                                gv1.Rows(gv1.Rows.Count - 1).Cells(ColActualBalQty).Value = clsItemLocationDetails.getBalance(clsCommon.myCstr(gv1.Rows(gv1.Rows.Count - 1).Cells(colICode).Value), txtBillToLocation.Value, txtDocNo.Value, txtDate.Value, Nothing, clsCommon.myCstr(gv1.Rows(gv1.Rows.Count - 1).Cells(colUnit).Value), clsCommon.myCdbl(gv1.Rows(gv1.Rows.Count - 1).Cells(colMRP).Value))
                                Dim dblBalQty As Double = clsCommon.myCdbl(gv1.Rows(gv1.Rows.Count - 1).Cells(ColActualBalQty).Value)
                                Dim dblEnteredQty As Double = clsCommon.myCdbl(frm.ArrReturn(ii).Balance_Qty)
                                If dblBalQty >= dblEnteredQty Then
                                    gv1.Rows(gv1.Rows.Count - 1).Cells(colQty).Value = 0
                                ElseIf dblEnteredQty > dblBalQty Then ' AndAlso clsCommon.CompairString(strSchemeItem, "No") = CompairStringResult.Equal Then
                                    gv1.Rows(gv1.Rows.Count - 1).Cells(colQty).Value = dblEnteredQty - dblBalQty
                                End If
            ...
            ElseIf (gv1.CurrentColumn Is gv1.Columns(colComplete) AndAlso (UsLock1.Status = ERPTransactionStatus.Approved)) Then
                ...
                If clsCommon.myLen(txtDocNo.Value) > 0 AndAlso clsCommon.myLen(strICode) > 0 AndAlso intSNo > 0 AndAlso clsCommon.CompairString(strStatus, "No") = CompairStringResult.Equal Then
                    If common.clsCommon.MyMessageBoxShow("Do you want to complete the item " + clsCommon.myCstr(gv1.CurrentRow.Cells(colIName).Value), Me.Text, MessageBoxButtons.YesNo) = System.Windows.Forms.DialogResult.Yes Then
                        If clsPSDispatchAdviceDetail.CompletePO(txtDocNo.Value, strICode, intSNo) Then
    ...
    Public Sub funPrint(ByVal StrCode As String, Optional ByVal isPDF As Boolean = False)
        ...
        Try
            ...
            qry += " TSPL_CUSTOMER_MASTER.Cust_Code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Disc_Amt,convert(varchar,TSPL_SD_SALES_ORDER_HEAD.Document_Date ,103) as SaleOrder_Date,convert(varchar,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Delivery_date,103) as Delivery_date ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Discount_Base,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Tax_Amt ,"
            ...
            qry += " ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code  as Doc_Code,convert(varchar,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Date,103)  as Doc_Date,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Cust_PO_No ,tspl_item_master.Item_Code ,tspl_item_master.Item_Desc  ,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Qty ,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.RATE_UOM  ,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Amount ,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.item_cost as Basic_Price,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Created_By ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Modify_By,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Created_Date ,case when TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Payment_Terms ='A' then 'Advanced' else '' end  as Payment_Terms,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Amt ,"
            qry += " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Discount_Amt as Disc_Amt ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Amount_Less_Discount as Amt_Less_Discount ,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Basic_Amt  ,tspl_company_master.Comp_Code ,tspl_company_master.Comp_Name ,"

            qry += " 	TAX1 .Tax_Code_Desc as tax1name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax1_amt,0) as txt1amt,       "
            qry += " tax2.Tax_Code_Desc as tax2name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax2_amt,0) as txt2amt, "
            qry += "     tax3.Tax_Code_Desc as tax3name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax3_amt,0) as txt3amt, "
            qry += " tax4.Tax_Code_Desc as tax4name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax4_amt,0) as txt4amt, "
            qry += "  tax5.Tax_Code_Desc as tax5name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax5_amt,0) as txt5amt, "
            qry += " tax6.Tax_Code_Desc as tax6name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax6_amt,0) as txt6amt, "
            qry += " tax7.Tax_Code_Desc as tax7name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax7_amt,0) as txt7amt, "
            qry += " tax8.Tax_Code_Desc as tax8name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax8_amt,0) as txt8amt,  "
            qry += " tax9.Tax_Code_Desc as tax9name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax9_amt,0) as txt9amt, "
            qry += " tax10.Tax_Code_Desc as tax10name,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax10_amt,0) as txt10amt ,"
            qry += " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Add_Charge,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name1,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt1,0) as Add_Charge_Amt1,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name2,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt2,0) as Add_Charge_Amt2,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name3,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt3,0) as Add_Charge_Amt3,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name4,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt4,0) as Add_Charge_Amt4,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name5,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt5,0) as Add_Charge_Amt5,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name6,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt6,0) as Add_Charge_Amt6,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name7,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt7,0) as Add_Charge_Amt7,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name8,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt8,0) as Add_Charge_Amt8,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name9,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt9,0) as Add_Charge_Amt9,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name10,isnull (TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt10,0) as Add_Charge_Amt10 "
            qry += " from TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE left outer join TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE on TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code =TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Document_Code "
            qry += " left outer join TSPL_COMPANY_MASTER  on TSPL_COMPANY_MASTER.Comp_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Comp_Code"
            qry += " left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code "
            ...
            qry += " left outer join TSPL_LOCATION_MASTER on  TSPL_LOCATION_MASTER.Location_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Bill_To_Location "
            qry += " LEFT outer join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER .Item_Code =TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code "
            qry += " left outer join TSPL_CITY_MASTER on TSPL_CITY_MASTER .City_Code =TSPL_CUSTOMER_MASTER.City_Code"
            qry += " left outer join TSPL_TAX_MASTER as tax1 on tax1.tax_code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax1 "
            qry += " left outer join tspl_tax_master as tax2 on tax2.tax_code = TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.tax2 "
            qry += " left outer join tspl_tax_master as tax3 on tax3.Tax_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX3 "
            qry += " left outer join TSPL_TAX_MASTER as tax4 on tax4.Tax_Code= TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .tax4 "
            qry += "  left outer join TSPL_TAX_MASTER as tax5 on tax5.Tax_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .tax5 "
            qry += " left outer join TSPL_TAX_MASTER as tax6 on tax6.Tax_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX6 "
            qry += " left outer join TSPL_TAX_MASTER as tax7 on tax7.Tax_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX7 "
            qry += " left outer join TSPL_TAX_MASTER as tax8 on tax8.Tax_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX8 "
            qry += " left outer join TSPL_TAX_MASTER as tax9 on tax9.Tax_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX9 "
            qry += " left outer join TSPL_TAX_MASTER as tax10 on tax10.Tax_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE .TAX10 "
            qry += " left outer  join TSPL_SD_SALES_ORDER_HEAD on TSPL_SD_SALES_ORDER_HEAD.Document_Code =TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Against_Sales_Order "
            ...
            qry += " where 2=2 "
            qry += "  and  TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = '" + StrCode + "'"
    ...
    Private Sub gv1_CellFormatting(ByVal sender As System.Object, ByVal e As Telerik.WinControls.UI.CellFormattingEventArgs) Handles gv1.CellFormatting
        Try
            ...
            ElseIf e.Column Is gv1.Columns(colLocationCode) Then
                ...
                Else
                    gv1.CurrentRow.Cells(colLocationCode).ReadOnly = False
                End If
            ElseIf e.Column Is gv1.Columns(colQty) Then
                If clsCommon.CompairString(gv1.CurrentRow.Cells(colSchemeItem).Value, "Yes") = CompairStringResult.Equal Then
    ...
    Private Sub btnAmendment_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAmendment.Click
        ...
        '    IsSavedData = IsSavedData AndAlso clsPSDispatchAdvice.PostData(txtDocNo.Value)
    ...
    '    frm.ShowDialog()
    '    If frm.ArrReturn IsNot Nothing AndAlso frm.ArrReturn.Count > 0 Then
    '        Dim objReq As clsPSDispatchAdvice = clsPSDispatchAdvice.GetData(frm.strFirstSO, NavigatorType.Current)
    ...
    '            gv1.Rows.RemoveAt(gv1.Rows.Count - 1)
    '        End If
    '        For Each obj As clsPSDispatchAdviceDetail In frm.ArrReturn
    '            gv1.Rows.AddNew()
...
#Region "New Mail System"
    ...
    Private Sub SendSMSandEmail(ByVal lstUsers As List(Of String), ByVal isSendForApproval As Boolean)
        Try
            ...
            'sanjay, Ticket No-TEC/18/09/19-001016, Email and SMS
            Dim strContactperson As String = ""
            Dim dtContent As DataTable = clsDBFuncationality.GetDataTable("SELECT SMS_Text,Email_Text,Email_subject from TSPL_ES_Content where Form_ID='" + clsUserMgtCode.frmdispatchAdviceProductSale + "'", Nothing)
            If dtContent IsNot Nothing AndAlso dtContent.Rows.Count > 0 Then
                ...
                objEmailH.Email_Text = objEmailH.Email_Text.Replace(frmEMailAndSMSSetting.DocAmount, lblTotRAmt.Text)
                objEmailH.Email_Text = objEmailH.Email_Text.Replace(frmEMailAndSMSSetting.Loc_Code, txtBillToLocation.Value)
                objEmailH.Email_Text = objEmailH.Email_Text.Replace(frmEMailAndSMSSetting.Loc_Name, lblBillToLocation.Text)
                objEmailH.Email_Text = objEmailH.Email_Text.Replace(frmEMailAndSMSSetting.Form_Code, clsUserMgtCode.frmdispatchAdviceProductSale)
                ...
                objEmailH.SaveData(clsUserMgtCode.frmdispatchAdviceProductSale, objEmailH, Nothing)
                objEmailH = Nothing
                clsCommon.MyMessageBoxShow("E-Mail Send Successfully", Me.Text)
                If Not clsSMSAtPost_Sales.SMSATPOST_SALE() Then
                    SMSSENDONLY(False)
        ...
        Try
            ...
            If dtContent IsNot Nothing AndAlso dtContent.Rows.Count > 0 Then
                ...
                If clsCommon.myLen(dtContent.Rows(0)("SMS_Text")) > 0 Then
                    ...
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.DocAmount, lblTotRAmt.Text)
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.Loc_Code, txtBillToLocation.Value)
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.Loc_Name, lblBillToLocation.Text)
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.ContactPerson, strContactPerson)
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.Form_Code, clsUserMgtCode.frmdispatchAdviceProductSale)

                    objSMSH.SaveData(clsUserMgtCode.frmdispatchAdviceProductSale, objSMSH, Nothing)
                    objSMSH = Nothing
                    If Not isPost Then
                        clsCommon.MyMessageBoxShow("SMS Send Successfully", Me.Text)
                    End If
...
#End Region
    ...
    Private Sub chkclose_ToggleStateChanged(ByVal sender As System.Object, ByVal args As Telerik.WinControls.UI.StateChangedEventArgs) Handles chkclose.ToggleStateChanged
        ...
        If clsPSDispatchAdvice.ClosedData(obj, txtDocNo.Value, txtCloseRemarks.Value) Then
            If chkclose.Checked Then
