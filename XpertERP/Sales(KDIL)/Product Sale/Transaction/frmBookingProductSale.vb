...
'-----BM00000003441
'--- changed by priti for umang on 28/09/2016 against BM00000009777
Imports common
...
Public Class frmBookingProductSale
...
#End Region
    ...
    Sub OpenItemGroupList(ByVal isButtonClick As Boolean)
        ...
        If GSTStatus Then
            ...
            whrCls = "(CSA_TYPE <> '' and CSA_TYPE <> 'None') " & strTax
        Else
            Qry = "select  distinct CSA_TYPE as  Code from TSPL_ITEM_MASTER "
    ...
    Sub OpenItemList(ByVal isButtonClick As Boolean)
        ...
        If GSTStatus Then
            ...
            End If
        End If
        Dim whrCls As String = "Is_FreshItem=0 and Product_Type not in ('MI')  and Item_Type in ('F','T','S') and Is_Serial_Item=0 " & strTax
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtDocNo._MYValidating
        ...
        ''End If
        '-----------------------------------------------------
        LoadData(clsCommon.ShowSelectForm("PSBookingOrderNoFndd", qry, "Code", whrClas, txtDocNo.Value, "Code desc", isButtonClicked), NavigatorType.Current)
        btnCopy.Enabled = False
    End Sub
    ...
    Private Sub FrmAPInvoiceEntry_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        ElseIf e.Alt AndAlso e.Shift AndAlso e.Control And e.KeyCode = Keys.F12 Then
            ButtonToolTip.SetToolTip(btnSave, "Press Alt+S for Save/Update Trasnaction" + Environment.NewLine + _
                              "TSPL_BOOKING_MASTER_PRODUCTSALE " + Environment.NewLine + _
    ...
    Private Sub txtVendorNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtVendorNo._MYValidating
        ...
        If AllowFreshPriceChartonProductSale = 1 Then
            ...
            If clsCommon.myLen(txtPriceCode.Text) = 0 Then
                clsCommon.MyMessageBoxShow(Me, "Please Map Price Code with customer first", Me.Text)
                txtVendorNo.Value = ""
                Exit Sub
            End If
            If AllowFreshPriceChartonBookingProductSale = 1 Then
            ...
            If objOrderHead.Arr IsNot Nothing AndAlso objOrderHead.Arr.Count > 0 Then
                For Each objTr As clsSNSalesQuotationDetail In objOrderHead.Arr
                    If objTr.Row_Type = "Misc" Then
                        ...
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colICode).Value = objTr.Item_Code
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colIName).Value = objTr.Item_Desc
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colIHSN).Value = clsItemMaster.GetItemHSNCode(objTr.Item_Desc, Nothing)
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colRate).Value = objTr.Item_Cost
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colUnit).Value = objTr.Unit_code
...
#Region "New Mail System"
    ...
    Private Sub SendSMSandEmail(ByVal lstUsers As List(Of String), ByVal isSendForApproval As Boolean)
        Try
            ...
            'sanjay
            Dim strContactperson As String = ""
            Dim dtContent As DataTable = clsDBFuncationality.GetDataTable("SELECT SMS_Text,Email_Text,Email_subject from TSPL_ES_Content where Form_ID='" + clsUserMgtCode.frmBookingProductSale + "'", Nothing)
            If dtContent IsNot Nothing AndAlso dtContent.Rows.Count > 0 Then
                ...
                objEmailH.Email_Text = objEmailH.Email_Text.Replace(frmEMailAndSMSSetting.Form_Code, clsUserMgtCode.frmBookingProductSale)
                ...
                objEmailH.SaveData(clsUserMgtCode.frmBookingProductSale, objEmailH, Nothing)
                objEmailH = Nothing
        ...
        Try
            ...
            If dtContent IsNot Nothing AndAlso dtContent.Rows.Count > 0 Then
                ...
                If clsCommon.myLen(dtContent.Rows(0)("SMS_Text")) > 0 Then
                    ...
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.Form_Code, clsUserMgtCode.frmBookingProductSale)
                    objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(frmEMailAndSMSSetting.ContactPerson, strContactPerson)

                    objSMSH.SaveData(clsUserMgtCode.frmBookingProductSale, objSMSH, Nothing)
                    objSMSH = Nothing
                    If Not isPost Then
