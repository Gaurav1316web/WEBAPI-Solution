...
Public Class RptSaleRegisterReportWithCSASalePatti
...
#Region "Functions"
    Private Sub SetUserMgmtNew()
        ...
        'MyBase.SetUserMgmt(clsUserMgtCode.MISSaleRegisterWithCSASalePatti)
...
#End Region
    ...
    Function ReturnDataReader() As SqlClient.SqlDataReader
        Dim obj As clsSaleRegisterParameterType = ReturnFilterData()
        Dim rd As SqlClient.SqlDataReader = clsPSInvoiceHead.GetReportDataReaderWithCSASalePatti(obj, clsUserMgtCode.MISSaleRegisterWithCSASalePatti)
        Return rd
    End Function
