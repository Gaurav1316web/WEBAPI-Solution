...
'================Create by Preeti Gupta against Ticket no[ADV/14/05/18-000031]=========

Public Class RptSaleRegisterReportForAdv
...
#End Region
    ...
    Function ReturnDataReader() As SqlClient.SqlDataReader
        Dim obj As clsSaleRegisterForAutoCompParameterType = ReturnFilterData()
        Dim rd As SqlClient.SqlDataReader = clsSalesRegisterForAutoComp.GetReportDataReader(obj)
    ...
    Function ReturnData() As DataTable
        Dim obj As clsSaleRegisterForAutoCompParameterType = ReturnFilterData()
        Dim dt As DataTable = clsSalesRegisterForAutoComp.GetReportData(obj)
        Return dt


    End Function
    Function ReturnFilterData() As clsSaleRegisterForAutoCompParameterType
        'strPivotForFinalOuterQuery = clsSalesRegisterForAutoComp.GetPivotForFinalOuterQry() ''for tax pivoting
        Dim obj As New clsSaleRegisterForAutoCompParameterType
        ...
        Else
            Dim qry As String
            qry = clsSalesRegisterForAutoComp.GetAllSaleTransactionTypeQuery()
    ...
    Private Sub txtCustomer__My_Click(sender As Object, e As EventArgs) Handles txtCustomer._My_Click
        Dim qry As String = " select cust_code as [Code], Customer_Name as [Name] from tspl_customer_master where 1=1 "
    ...
    Private Sub txtTransaction__My_Click(sender As Object, e As EventArgs) Handles txtTransaction._My_Click
        ...
        Dim qry As String = clsSalesRegisterForAutoComp.GetAllSaleTransactionTypeQuery()
    ...
    Sub BulkExport(ByVal FormatType As String)
        Try
            ...
            Dim obj As clsSaleRegisterForAutoCompParameterType = ReturnFilterData()
            Dim qry As String = clsSalesRegisterForAutoComp.GetReportDataQuery(obj)
    ...
    Private Sub QExpExcel_Click(sender As Object, e As EventArgs) Handles QExpExcel.Click
        Try
            ...
            'End If
            '' applyExportTemplate
            applyExportTemplate(Gv1, Me.FORMTYPE, ddlReportType.SelectedValue)
            transportSql.QuickExportToExcel(Gv1, "", Me.Text, , arrHeader)
    ...
    Private Sub btnCreateExportTemplate_Click(sender As Object, e As EventArgs) Handles btnCreateExportTemplate.Click
        Try
            If Gv1.Rows.Count <= 0 Then
                Throw New Exception("No Data in Grid")
            End If
            Dim frm As New frmExportTemplate(objCommonVar.CurrentUserCode, objCommonVar.CurrentCompanyCode, Form_ID)
            frm.gvReport = Gv1
            frm.dtReportType = ddlReportType.DataSource
