...
Public Class RptSaleRegisterReportWithCSASalePattiProductLocationWise
...
#Region "Functions"
    Private Sub SetUserMgmtNew()
        ...
        'MyBase.SetUserMgmt(clsUserMgtCode.MISSaleRegisterWithCSASalePattiProductLocationWise)
...
#End Region
    ...
    Sub Print(ByVal IsPrint As Exporter)
        Try
            ...
            ElseIf ddlReportType.SelectedValue = "Location Wise" Then
                strRunQuery = " select " + strMaxDescColumn + ", [Location Code],max ([Location Name]) as [Location Name], " & _
                              " sum([Sale Amount]/100000 )  as [Sale Amount (Rs./Lac)] " & _
                              " from (" & strMain & ") as Final   group by [Location Code]," + strCodeColumn + ""
    ...
    Function ReturnDataReader() As SqlClient.SqlDataReader
        Dim obj As clsSaleRegisterParameterType = ReturnFilterData()
        Dim rd As SqlClient.SqlDataReader = clsPSInvoiceHead.GetReportDataReaderWithCSASalePatti(obj, clsUserMgtCode.MISSaleRegisterWithCSASalePattiProductLocationWise)
        Return rd
    End Function
   ...
   Sub SetGridFormationOFGV1()
    ...
    Sub BulkExport(ByVal FormatType As String)
        Try
            ...
            Dim qry As String = ClsUDLSalesQuery.ReturnQueryWithCSASalePatti(obj, clsUserMgtCode.MISSaleRegisterWithCSASalePattiProductLocationWise)(0)
