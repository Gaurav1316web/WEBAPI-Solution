        ...
        Try
            ...
            If clsCommon.CompairString(ddlReportType.SelectedValue, "Sales Data") = CompairStringResult.Equal Then
               ...
               ",case when TSPL_BOOKING_MATSER.Booking_Type='FESTIVE ORDER' then 1 ELSE 0 END AS 'Festive Order' "
                ...
                "   where 2 = 2 "
                qry += " and  CONVERT(date,TSPL_BOOKING_MATSER.created_date,103) >= convert(date,'" + fromDate.Value + "',103) AND " + Environment.NewLine &
                    "CONVERT(date,TSPL_BOOKING_MATSER.created_date,103) <= convert(date,'" + ToDate.Value + "',103) "
