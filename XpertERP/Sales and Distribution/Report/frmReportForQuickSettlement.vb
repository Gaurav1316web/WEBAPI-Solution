...
Public Class FrmReportForQuickSettlement
    ...
    Sub print()
        ...
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptForQuickSettlement", "Report for Quick Settlement")
    End Sub
