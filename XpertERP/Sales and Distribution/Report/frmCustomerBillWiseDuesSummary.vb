...
Public Class frmCustomerBillWiseDuesSummary
    ...
    Sub print()
        ...
        Try
            ...
            'gv1.DataSource = dt
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "rptCustBillWiseDuesSummary", "Customer Bill Wise Dues Summry")
    ...
    Private Sub gv1_CellDoubleClick(ByVal sender As System.Object, ByVal e As Telerik.WinControls.UI.GridViewCellEventArgs) Handles gv1.CellDoubleClick
        If clsCommon.myLen(gv1.CurrentRow.Cells("DOC ID").Value) > 0 Then
            clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SaleInvoice, gv1.CurrentRow.Cells("DOC ID").Value)
