...
#End Region
    ...
    End Sub
    Private Sub fndToLocation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fndToCustomerGroup.Load
    ...
    Private Sub funPrint()
        Dim f1 As String = fndFromCustomerGroup.txtValue.Text
        Dim t1 As String = fndToCustomerGroup.txtValue.Text
        funReport(f1, t1)
    End Sub
    ...
    Public Sub funReport(ByVal f1 As String, ByVal t1 As String)
        Try
            ...
            Dim dt As DataTable
            dt = ds.Tables(0)
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "CustomerGroupDetails", "Customer Group Details")
    ...
    Private Sub fndFromLocation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fndFromCustomerGroup.Load
    ...
    Private Sub fndFromCustomerGroup_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fndFromCustomerGroup.Leave
    ...
    Private Sub fndToCustomerGroup_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fndToCustomerGroup.Leave
