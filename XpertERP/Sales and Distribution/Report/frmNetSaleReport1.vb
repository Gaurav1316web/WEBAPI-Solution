       ...
       "convert(date,TSPL_SALE_RETURN_HEAD.Sale_Return_Date,103) <= convert(date, '" & ToDate.Value & "',103) " + filter + " and TSPL_SALE_RETURN_HEAD.Is_Post='Y'  and TSPL_ITEM_UOM_DETAIL_1.UOM_Code='FB' "
        ...
        If clsCommon.CompairString(objCommonVar.CurrentCompanyCode, "Vizag") = CompairStringResult.Equal Then
            If clsCommon.CompairString(ddlValue.Text, "Yes") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleValueVizag", "Net Sale Report")
            ElseIf clsCommon.CompairString(ddlValue.Text, "No") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleQtyVizag", "Net Sale Report")
            ElseIf clsCommon.CompairString(ddlValue.Text, "Both") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleBothVizag", "Net Sale Report")
            End If

        Else

            If clsCommon.CompairString(ddlValue.Text, "Yes") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleValueGuntur", "Net Sale Report")
            ElseIf clsCommon.CompairString(ddlValue.Text, "No") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleQtyGuntur", "Net Sale Report")
            ElseIf clsCommon.CompairString(ddlValue.Text, "Both") = CompairStringResult.Equal Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptNetSaleBothGuntur", "Net Sale Report")
            End If
