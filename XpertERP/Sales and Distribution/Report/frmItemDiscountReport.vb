...
Public Class FrmItemDiscountReport
    ...
    Sub print()
        ...
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptItemDiscountReport", "Item Discount Report")
