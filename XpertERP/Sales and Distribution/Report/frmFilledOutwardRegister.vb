...
Public Class FrmFilledOutwardRegister
    ...
    Sub print()
        Try
            ...
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptFilledoutwardRegister", "Filled Outward Register")
