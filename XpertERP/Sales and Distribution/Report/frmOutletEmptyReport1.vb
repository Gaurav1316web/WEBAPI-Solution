               ...
               End If
                ...
                Else
                    If rdobtnSummary.IsChecked Then
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptOutletEmpty", "Outlet Empty Summary Report")
                    ElseIf rdobtndetails.IsChecked Then
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptOutletEmptyDetail", "Outlet Empty Detail Report")
                    End If
                End If
