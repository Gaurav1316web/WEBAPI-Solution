...
Public Class FrmRptCustomerRouteHistory
    ...
    Private Sub FrmRptCustomerRouteHistory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'End If
    End Sub
    Private Sub fndCustomerCode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles fndCustomerCode.Load
    ...
    Sub print()
        Try
            ...
            FrmProvionalSalesReport.proShowReport("Customer Route History", fndCustomerCode.txtValue.Text, dtpFromDate.Value, dtpToDate.Value)
        Catch ex As Exception
