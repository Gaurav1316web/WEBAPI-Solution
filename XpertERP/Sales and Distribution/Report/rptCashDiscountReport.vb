...
Public Class rptCashDiscountReport
    ...
    Sub LoadData()
        ...
        End If
        Dim qry As String = "select '" + clsCommon.GetPrintDate(txtFromDate.Value, "dd/MM/yyyy") + "' as [StartDate],'" + clsCommon.GetPrintDate(txtTodate.Value, "dd/MM/yyyy") + "' as [EndDate], Sale_Invoice_Date as [Invoice Date] ,TSPL_SALE_INVOICE_HEAD.Sale_Invoice_No as [Invoice No],Route_No AS [Route No],Route_Desc ,Cust_Code,Cust_Name, "
        ...
        If dt Is Nothing OrElse dt.Rows.Count <= 0 Then
            ...
            Exit Sub
        Else
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(qry), "crptCashDiscountReport", "Cash Discount Report")
