...
Public Class FrmSalesCollection
    ...
    Sub print()
        ...
        If rdbSummary.IsChecked = True Then
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptSalesCollectionSummary", "Sales v/s Collection")
        Else
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptSalesCollectionDetail", "Sales v/s Collection")
        End If
    End Sub
