        ...
        Try
            ...
            Else
                ...
                If rbtnDetail.IsChecked Then
                    ...
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "rptCreditSaleDetail", Me.Text)
                ElseIf rbtnSummary.IsChecked Then
                    ...
                    dt = clsDBFuncationality.GetDataTable(FinalQry)
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "rptCreditSaleSummary", Me.Text)
                End If
            End If
