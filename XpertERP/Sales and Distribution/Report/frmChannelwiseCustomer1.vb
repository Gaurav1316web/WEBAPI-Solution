...
Public Class FrmChannelwiseCustomer1
    ...
    Sub print()
        ...
        End If
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strSql), "crptChannelwiseCustomer", "Channel wise Customer")
    End Sub
