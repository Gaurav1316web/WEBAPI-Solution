...
#End Region
    ...
    Sub print()
        ...
        If rbtnInvoiceWise.IsChecked = True AndAlso dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptSaleRegisterDetailNew", "Sales Register")
        ElseIf rbtnCustomerWise.IsChecked = True AndAlso dt.Rows.Count > 0 Then
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptSaleRegisterSmryNew", "Sales Register")
        End If
    End Sub
            ...
            Else
                ...
                If clsCommon.myLen(gvReport.CurrentRow.Cells.Item("Sale_Invoice_No").Value) > 0 Then
                    ...
                    If SoucrCode = "AR-PY" Or SoucrCode = "AR-PI" Or SoucrCode = "AR-MI" Or SoucrCode = "AR-UC" Or SoucrCode = "AR-OA" Or SoucrCode = "AR-DC" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.RcptEntry, DocNo)
                    ElseIf SoucrCode = "AP-PY" Or SoucrCode = "AP-MI" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.PymntEntry, DocNo)
                    ElseIf SoucrCode = "AP-IN" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.APInvoice, DocNo)
                    ElseIf SoucrCode = "SD-IN" Then
                        ...
                        Else
                            clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SaleInvoice, ShipDocNo)
                        End If
                    ElseIf SoucrCode = "BK-TF" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.BankTransfer, DocNo)
                    ElseIf SoucrCode = "IC-AD" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.ICAdj, DocNo)
                    ElseIf SoucrCode = "PO-RC" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SRN, DocNo)
                    ElseIf SoucrCode = "SD-LO" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.LoadOut, DocNo)
                    ElseIf SoucrCode = "MM-TF" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.MMTrans, DocNo)
                    ElseIf SoucrCode = "RV-TA" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.BankRvrs, DocNo)
                    ElseIf SoucrCode = "AR-AD" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.RcptADJ, DocNo)
                    ElseIf SoucrCode = "SD-SR-INT" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SaleReturnInter, DocNo)
                    ElseIf SoucrCode = "SD-SR" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SaleReturn, DocNo)
                    ElseIf SoucrCode = "AR-IN" Or SoucrCode = "AR-CR" Or SoucrCode = "AR-DN" Then
                        clsOpenTransactionForm.OpenTransacionForm(EnumTransType.ARInvoice, DocNo)
                    Else
                        Return
                    End If
