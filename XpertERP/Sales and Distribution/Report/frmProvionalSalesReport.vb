...
Public Class FrmProvionalSalesReport
    ...
    Sub print()
        ...
        'End If
        proShowReport("Proviosional Sales", fndTransfer.txtValue.Text)
    End Sub
    ...
    Public Shared Sub funSalesmanSalesReport(ByVal fromdate As String, ByVal todate As String, ByVal strSalesmanCode As String, ByVal strSalesmanNew As String)
        ...
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(StrQuery), "rptSalesman", "Salesman Sales Report")
    End Sub
    ...
    Public Shared Sub funTrialBalanceReport(ByVal fromdate As String, ByVal todate As String)
        ...
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(StrQuery), "crptTrialBalance", "Trial Balance Report")
    End Sub
    ...
    Public Shared Sub funCustomerRouteHistory(ByVal strCustCode As String, ByVal fromdate As String, ByVal todate As String)
        ...
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(StrQuery), "CrpyCustomerRouteHistory", "Customer Route History")
    End Sub
    ...
    Public Shared Sub funprovSalesReport(ByVal strTransferNo As String)
        ...
        End If
        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(StrQuery), "crptProvisionalSales", "Proviosional Sales Report")
    End Sub
...
"TSPL_ITEM_UOM_DETAIL_1.UOM_Code = b.Uom and a.Transfer_Type='LI'  "
        ...
        End If
        frmCrystalReportViewer.funsubreport(CrystalReportFolder.SalesReport, StrQuery, "crptSettlement", "Settlement Report", "crptSettlementReceiptDetails.rpt", "crptSettlementLoadin.rpt", "crptSettlementpayment.rpt", "crptSettlementAdjustment.rpt")
    End Sub
