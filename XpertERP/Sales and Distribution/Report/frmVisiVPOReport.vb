...
Public Class FrmVisiVPOReport
    ...
    Sub printdata()
        ...
        Try
            ...
            Else
                If chkVisi.IsChecked = True Then
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptVisiVPOReport", " Visi VPO Report")
                Else
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptNonVisiVPOReport", " Visi Non VPO Report")
                End If
