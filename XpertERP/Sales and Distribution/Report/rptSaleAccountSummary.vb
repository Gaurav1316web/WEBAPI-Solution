...
Public Class RptSaleAccountSummary
    ...
    Sub print()
        Try
            ...
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptSaleAccountSummary", "Sales Account Summary")
            ''GV1.Columns.Clear()
            ''GV1.Rows.Clear()
