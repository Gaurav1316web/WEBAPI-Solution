            ...
            If rdbShip.IsChecked = True Then
                ...
                Else
                    If rdbSummary.IsChecked = True Then
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptPrimarySaleSummaryShipping", "Primary Sale Report")
                    Else
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptPrimarySaleDetailShipping", "Primary Sale Report")
                    End If
                End If
            Else
                ...
                Else
                    If rdbSummary.IsChecked = True Then
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptPrimarySaleSummaryAccount", "Primary Sale Report")
                    Else
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptPrimarySaleDetailAccount", "Primary Sale Report")
                    End If
                End If
