...
"WHERE (TSPL_TRANSFER_HEAD.Transfer_Type = 'LO') AND (TSPL_LOCATION_MASTER.Location_Type = 'logical') "
    ...
    "TSPL_ITEM_UOM_DETAIL_1.UOM_Code = b.Uom WHERE a.Transfer_Type = 'LI'  "
            ...
            End If
            StrQuery = StrQuery & un1 & StrQuery5
            frmCrystalReportViewer.funsubreport(CrystalReportFolder.SalesReport, StrQuery, StrQuery1, StrQuery2, StrQuery3, StrQuery4, "crptSettlement", "Settlement Report", "crptSettlementReceiptDetails.rpt", "crptSettlementLoadin.rpt", "crptSettlementpayment.rpt", "crptSettlementAdjustment.rpt")
        Else
