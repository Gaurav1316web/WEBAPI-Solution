        ...
        Try
            ...
            If IsPrint Then
                If rbtnSummary.IsChecked = True Then
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptExciseSummary", "Excise Report")
                Else
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptExciseDetails", "Excise Report")
                End If
            End If
