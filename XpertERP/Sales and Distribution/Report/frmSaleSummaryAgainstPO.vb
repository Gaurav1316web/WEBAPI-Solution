...
Public Class frmSaleSummaryAgainstPO
    ...
    Sub print()
        ...
        Try
            ...
            'gv1.DataSource = dt
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "rptSaleSummaryAgainstPO", "Sale Summary Against PO")
    ...
    Private Sub gv_CellDoubleClick(ByVal sender As System.Object, ByVal e As Telerik.WinControls.UI.GridViewCellEventArgs) Handles gv.CellDoubleClick
        If clsCommon.myLen(gv.CurrentRow.Cells("Document_Code").Value >= 0) Then
            clsOpenTransactionForm.OpenTransacionForm(EnumTransType.SaleInvoice, gv.CurrentRow.Cells("Document_Code").Value)
        End If
    End Sub
End Class
