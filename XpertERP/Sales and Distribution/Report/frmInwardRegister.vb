          ...
          " WHERE TSPL_TRANSFER_HEAD.Transfer_Date > = CONVERT(date,'" & dtpFdate.Value & "',103) and " & _
           ...
           "(TSPL_ITEM_DETAILS.Class_Name = 'size') AND (TSPL_ITEM_DETAILS_1.Class_Name = 'Flavour') and Location_type='Physical' and Leak <> 0 "
            ...
            If rdodetail.IsChecked = True Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptInwardRegisteDetail", "Inward Register Detail")
            Else
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptInwardRegisteSummary", "Inward Register Summary")
            End If
