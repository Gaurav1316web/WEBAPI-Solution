        ...
        Try
            ...
            Else
                ...
                If rbtnSKUWise.IsChecked Then
                    ...
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(qry), "rptPenetrationSKU", Me.Text)
                ElseIf rbtnPackWise.IsChecked Then
                    ' qry += "order by SalesManCode,Route_No,ICodePack"
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(qry), "rptPenetrationPack", Me.Text)
                ElseIf rbtnFlavourWise.IsChecked Then
                    ' qry += "order by SalesManCode,Route_No,ICodeFlavour"
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(qry), "rptPenetrationFlavour", Me.Text)
                End If
            End If
