...
Public Class Cash_Register_Details4
    ...
    Sub print(ByVal excel As Boolean)
        Try
            ...
            query += " and Receipt_Type <>'M'  and Posted='" + post + "' )xxx"
            ...
            Else
                If chkSummary.Checked = True Then
                    ...
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "CashRegisterSummary", "Cash Register Details")
                Else

                    dt = clsDBFuncationality.GetDataTable(query)
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "CashRegisterNew", "Cash Register Details")
                End If
            End If
    ...
    Private Sub btnQuickxport_Click(sender As Object, e As EventArgs) Handles btnQuickxport.Click
        Try
