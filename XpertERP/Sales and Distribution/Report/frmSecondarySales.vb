        ...
        Try
            ...
            Else
                If rdbSummary.IsChecked = True Then
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptSecondarySaleSummary", "Secondary Sale Report")
                Else
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptSecondarySaleDetail", "Secondary Sale Report")
                End If
            End If
