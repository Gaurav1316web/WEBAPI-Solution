...
#End Region
    ...
    Sub LoadBlankGrid()
        ...
        ''chk.HeaderImage = Global.ERP.My.Resources.Resources.search4
    ...
    Public Sub funprint()
        Try
            ...
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
            frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, "crptCommissionMasterHistory", "Commission History Report")
