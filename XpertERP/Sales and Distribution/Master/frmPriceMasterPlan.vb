...
#End Region
    ...
    Private Sub txtLocation__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtLocation._MYValidating
        ...
        Dim WhrCls As String = " Location_Type='Physical' and Location_Category not in('MCC') or isSaleLocation=1 "
    ...
    Private Sub gv1_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gv1.DoubleClick
        Try
            ...
            ElseIf gv1.CurrentColumn Is gv1.Columns(colSNo) AndAlso clsCommon.myLen(gv1.CurrentRow.Cells(colTRCode).Value) > 0 AndAlso clsCommon.myLen(gv1.CurrentRow.Cells(colPriceID).Value) > 0 Then
                ...
                Dim qry As String = "select  Item_Price_ID as PriceID,UOM,Item_MRP as MRP,convert(decimal(18,6), (Price_Amount1+Price_Amount2+Price_Amount3+Price_Amount4+Price_Amount5+Price_Amount6+Price_Amount7+Price_Amount8+Price_Amount9+Price_Amount10)) as ComponentAmount,convert(decimal(18,2), Item_Basic_Price) as BasicPrice,convert(decimal(18,6),(TAX1_Amt+TAX2_Amt+TAX3_Amt+TAX4_Amt+TAX5_Amt+TAX6_Amt+TAX7_Amt+TAX8_Amt+TAX9_Amt+TAX10_Amt)) as TotalTaxAmount,  convert(decimal(18,6), Item_Selling_Price) as SelePrice from TSPL_ITEM_PRICE_MASTER where Against_Plan_TR_Code in('" + clsCommon.myCstr(gv1.CurrentRow.Cells(colTRCode).Value) + "') order by PriceID"
