...
Public Class frmCustomerAccountSet
    ...
    Public Sub funinsert()
        Try
            ...
            clsCommon.AddColumnsForChange(coll, "CURRENCY_CODE", Me.fndBaseCurrency.Value, True)
    ...
    Sub SaveData()
        ...
        ElseIf (fndAccount1.Value = "") Then
            myMessages.blankValue("Account 1")
            fndAccount1.Focus()
        ElseIf (fndAccount2.Value = "") Then
            myMessages.blankValue("Account 2")
            fndAccount2.Focus()
            '---------richa Code Ends------------------------------------
        Else
    ...
    Private Sub rdmenuexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdmenuexport.Click
        ...
        Dim query As String = "select cust_account as 'Customer Account',cust_acct_desc as 'Customer Account Description',receivable_control_acct as 'Debtor Control',receipts_discount_acct as 'Receipt Discount',Advance_acct as 'Advance Account',Write_offs as 'Write Offs' , Container_Deposit as 'Container Deposite',SECURITY_ACCOUNT as 'Security Account',CREATE_SECURITY_ACCOUNT as 'Create Security Account',BANK_GUARANTEE as 'Bank Guarantee' ,ACCOUNT1 as 'Account 1',ACCOUNT2 as 'Account 2',GSOC_Acct,Consignment_Acct,Gain_Acct,Loss_Acct,Foreign_Bank_Charges_Account as [Foreign Bank Charges],Bank_Charges_Other_Account as [Bank Charges Other] from tspl_customer_account_set"
    ...
    Private Sub rdmenuimport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdmenuimport.Click
        ...
        If transportSql.importExcel(dgv, "Customer Account", "Customer Account Description", "Debtor Control", "Receipt Discount", "Advance Account", "Write Offs", "Container Deposite", "Security Account", "Create Security Account", "Bank Guarantee", "Account 1", "Account 2", "GSOC_Acct", "Consignment_Acct", "Gain_Acct", "Loss_Acct", "Foreign Bank Charges", "Bank Charges Other") Then
            ...
            Try
                ...
                For Each dgrv As GridViewRowInfo In dgv.Rows
                    ...
                    Dim account1 As String = clsCommon.myCstr(dgrv.Cells("Account 1").Value)
                    Dim account2 As String = clsCommon.myCstr(dgrv.Cells("Account 2").Value)
                    ...
                    If String.IsNullOrEmpty(account1) Or account1.Length > 50 Then
                        Throw New Exception("Account 1 Length cannot be greater than 50  or blank")
                        trans.Rollback()
                    End If
                    If String.IsNullOrEmpty(account2) Or account2.Length > 50 Then
                        Throw New Exception("Account 2 Length cannot be greater than 50  or blank")
                        trans.Rollback()
                    End If
                    If String.IsNullOrEmpty(ForeignBankCharges) Or ForeignBankCharges.Length > 50 Then
                        Throw New Exception("Foreign Bank Charges Length cannot be greater than 50  or blank")
                        trans.Rollback()
                    End If
                    If String.IsNullOrEmpty(BankChargesOther) Or BankChargesOther.Length > 50 Then
                        Throw New Exception("Bank Charges Other Length cannot be greater than 50  or blank")
                        trans.Rollback()
                    End If
                    ...
                    If clsCommon.myLen(account1) > 0 Then
                        ...
                        Dim check1 As Integer = clsDBFuncationality.getSingleValue(qry1, trans)
                        If check1 <= 0 Then
                            Throw New Exception("Filled account 1 (" & account1 & ") must be control account" + Environment.NewLine + " at line no. " + clsCommon.myCstr(linno) + ".")
                        End If
                    End If
                    If clsCommon.myLen(account2) > 0 Then
                        ...
                        Dim check1 As Integer = clsDBFuncationality.getSingleValue(qry1, trans)
                        If check1 <= 0 Then
                            Throw New Exception("Filled account 2 (" & account2 & ") must be control account" + Environment.NewLine + " at line no. " + clsCommon.myCstr(linno) + ".")
                        End If
                    End If
                    ...
                    If (i = 0) Then
                        ...
                        Dim query As String = "insert into tspl_customer_account_set values('" + strcustmaster + "','" + strcustaccountdisc + "','" + strreceivablecontrol + "','" + strrecieptdiscount + "','" + stradvanceaccount + "','" + strwriteoff + "','" + userCode + "','" + Datee + "','" + userCode + "','" + Datee + "','" + companyCode + "', '" + ContainerDeposite + "',Null,Null,Null,'" + Securityaccount + "','" + CreateSecurityaccount + "','" + BankGuaranteeaccount + "','" + account1 + "','" + account2 + "','" + gsoc + "','" + consignment + "','" + gain + "','" + loss + "','" + ForeignBankCharges + "','" + BankChargesOther + "')"
                        '---------richa Code Ends------------------------------------
                    ...
                    Else
                        ...
                        Dim query1 As String = "update tspl_customer_account_set set cust_acct_desc='" + strcustaccountdisc + "',receivable_control_acct='" + strreceivablecontrol + "',receipts_discount_acct='" + strrecieptdiscount + "',Advance_acct='" + stradvanceaccount + "',Write_offs='" + strwriteoff + "', Container_Deposit='" + ContainerDeposite + "',SECURITY_ACCOUNT='" + Securityaccount + "',CREATE_SECURITY_ACCOUNT='" + CreateSecurityaccount + "',BANK_GUARANTEE='" + BankGuaranteeaccount + "',ACCOUNT1='" + account1 + "',ACCOUNT2='" + account2 + "',GSOC_Acct='" + gsoc + "',Consignment_Acct='" + consignment + "',Gain_Acct='" + gain + "',Loss_Acct='" + loss + "',Foreign_Bank_Charges_Account='" + ForeignBankCharges + "',Bank_Charges_Other_Account='" + BankChargesOther + "' where cust_account='" + strcustmaster + "'"
                        '---------richa Code Ends------------------------------------
