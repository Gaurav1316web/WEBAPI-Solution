            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If clsCommon.CompairString(Excisable, "T") = CompairStringResult.Equal Then
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptOrderWithExcise", "Sales Order")
                    Else
                        frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptOrderWithNonExcise", "Sales Order")
                    End If
                Else
    ...
    Sub CheckSlip(ByVal OrderNo As String)
        ...
        Else
            ...
            Try
                Dim dt As DataTable = clsDBFuncationality.GetDataTable(strQuery)
                If dt.Rows.Count > 0 Then
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, clsDBFuncationality.GetDataTable(strQuery), "crptCheckSlipReport", "Check Slip")
                Else
                    common.clsCommon.MyMessageBoxShow("No Data Found", "Sales Order Report", MessageBoxButtons.OK)
                End If
