...
Public Class FrmGatePassENtry1
    ...
    Public Sub PrintGatePass(ByVal GPNo As String, ByVal PrePrinted As String)
        ...
        Try
            ...
            If PrePrinted Then
                frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, EnumTecxpertPaperSize.PaperSize10x12, "crptGatePassPreprinted", "GatePass Report", True)
            Else
                If clsCommon.CompairString(objCommonVar.CurrentCompanyCode, "Vizag") = CompairStringResult.Equal Then
                    frmCrystalReportViewer.funreport(CrystalReportFolder.SalesReport, dt, EnumTecxpertPaperSize.NA, "crptGatePassVizag", "GatePass Report", False)
                ...
                Else
                    ...
                    frmCrystalReportViewer.funsubreport(CrystalReportFolder.SalesReport, qry, subQry, "", "", "", "crptGatePassGuntur", "GatePass", "crptGatePassSubReport1.rpt")
                End If
            End If
