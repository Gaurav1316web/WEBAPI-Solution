        ...
        Try
            ...
            If clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleSaleDairy) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.SaleIncentiveMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], INCENTIVE_CODE as [Document Code],Description as [Description] ,Convert (varchar,INCENTIVE_DATE,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Status = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_SALES_INCENTIVE_HEADER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerDeduction) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Deduction_Code as [Document Code],Deduction_Name as [Description] ,'' as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_CUSTOMER_DEDUCTION_HEAD " & _
                          "  where Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime,zz.[Created Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleMCCMilkProcurement) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],MCC_Code as [Document Code], MCC_NAME as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_mcc_master " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkRouteMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Route_Code as [Document Code], Route_Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_mcc_route_master " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVillageMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Village_Code as [Document Code], Village_Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_village_master " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVSPMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Vendor_Code as [Document Code], Vendor_Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VENDOR_MASTER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVLCMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],VLC_Code as [Document Code], VLC_Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VLC_MASTER_HEAD " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVLCUploader) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],VLC_Code as [Document Code], '' as Description,convert (varchar,TSPL_VLC_UPLOADER_MASTER.Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VLC_UPLOADER_MASTER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMPMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],MP_Code as [Document Code], MP_Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_mp_master " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPrimaryTransporterVehicalMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Vehicle_Code as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_Primary_Vehicle_Master " & _
                      "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVLCRouteShiftMaster) = CompairStringResult.Equal Then
                    qry = " SELECT distinct '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], Description as Description,convert (varchar,Doc_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_vlc_route_shift_master " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkPricePlanning) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Planning_Code as [Document Code], Planning_Description as Description,convert (varchar,Planning_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PRICE_CHART_PLANNING " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPriceChartMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code],Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_PRICE_MASTER " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmPriceChartUploader) = CompairStringResult.Equal Then
                    qry = " SELECT distinct '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code as [Document Code], '' as Description,convert (varchar,TSPL_FAT_SNF_UPLOADER_MASTER.date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_FAT_SNF_UPLOADER_MASTER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCMaterialSalePriceChart) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code as [Document Code], '' as Description,convert (varchar,TSPL_MCC_RATE_UPLOADER_MASTER.date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_MCC_RATE_UPLOADER_MASTER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkVehicleMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Vehicle_Id as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VEHICLE_MASTER " & _
                 "  where 2= 2  and  Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmdeductionGroup) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Ded_Code as [Document Code], Ded_Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_DEDUCTION_GROUP " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date,Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDeductionMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_DEDUCTION_MASTER " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.DeductionMapping) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], Description as Description,convert (varchar,Doc_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Post_Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_DEDUCTION_MAPPING_HEAD " & _
                 "  where 2= 2  and  Convert (date, Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CanMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_CAN_MASTER " & _
                 "  where 2= 2  and  Convert (date, Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date,Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.DockMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_DOCK_MASTER " & _
                 "  where 2= 2  and  Convert (date, Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmTankerDispatchPriceMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PRICE_CODE as [Document Code], PRICE_DESC as Description,convert (varchar,PRICE_DATE,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_TANKER_DISPATCH_PRICE_MASTER " & _
                 "  where 2= 2  and  Convert (date, PRICE_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, PRICE_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkRejectType) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_MILK_REJECT_TYPE " & _
                 "  where 2= 2  and  Convert (date, Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkReasonMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from Tspl_Mcc_Reason_Master " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date,Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPaymentCycleMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PC_CODE as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PAYMENT_CYCLE_MASTER " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmIncentiveMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],INCENTIVE_CODE as [Document Code], Description as Description,convert (varchar,INCENTIVE_DATE,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_INCENTIVE_MASTER_HEAD " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCSMSSettiing) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Program_Code as [Document Code], _Name as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_MCC_MAIL_SMS_Setting " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOpenMCCShiftManual) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],MCC_SHIFT_CODE as [Document Code], '' as Description,convert (varchar,MCC_SHIFT_DATE,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                     " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_OPEN_MCC_SHIFT " & _
                     "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmVSPIncentiveTagging) = CompairStringResult.Equal Then
                    qry = " SELECT DISTINCT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], '' as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VSP_INCENTIVE_Detail " & _
                 "  where 2= 2  and  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVLCMasterTarget) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], '' as Description,convert (varchar,Document_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 'Y' then 'Posted' else 'Pending'  end as [Status] from TSPL_Vlc_Target_Detail " & _
                 "  where 2= 2  and  Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date,Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmItemChargeCategoryMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Charge_Cat_Code as [Document Code], Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from tspl_charge_category " & _
                 "  where 2= 2  and  Convert (date, Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FreightChargesMaster) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Freight_Code as [Document Code], freight_Description as Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                 " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_FREIGHT_CHARGES_MASTER " & _
                 "  where 2= 2  and  Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkGateEntryIn) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Entry_Code as [Document Code], '' as Description,convert(varchar,Entry_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_GATE_ENTRY_IN " & _
                      "  where 2= 2  and  Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkGateEntryWeightment) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Weighment_Code as [Document Code], '' as Description,'' as [Document Date],GW_Created_By as [Created By],Convert(varchar, GW_Created_Date,103) as [Created Date] " & _
                     " ,GW_Modified_By as [Modified By],convert(varchar, GW_Modified_Date,103) as [Modified Date],case when GW_Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_GATE_ENTRY_WEIGHTMENT " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkReceipt) = CompairStringResult.Equal Then
                    ...
                    " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_RECEIPT_HEAD " & _
                    "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkReject) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOC_CODE as [Document Code], '' as Description,DOC_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                  " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_REJECT_HEAD " & _
                  "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkSample) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOC_CODE as [Document Code], '' as Description,DOC_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                    " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_milk_Sample_Head " & _
                    "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkGateEntryOut) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Gate_Out_Code as [Document Code], '' as Description,Gate_Out_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_GATE_ENTRY_OUT " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkSRN) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOC_CODE as [Document Code], '' as Description,DOC_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_SRN_Head " & _
                         "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MilkTruckSheet) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOC_CODE as [Document Code], '' as Description,DOC_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_milk_truck_sheet_Head " & _
                        "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVlcdataUploadar) = CompairStringResult.Equal Then
                    qry = " SELECT distinct '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], '' as Description,DOC_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                    " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_vlc_data_uploader " & _
                    "  where 2= 2  and  Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmVLCDataUploaderManual) = CompairStringResult.Equal Then
                    qry = " SELECT distinct '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], '' as Description,Document_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_VLC_DATA_UPLOADER_MASTER " & _
                        "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkShiftEndMCC) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], '' as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                       " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_Shift_End_HEAD " & _
                       "  where 2= 2  and  Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCGateEntry) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Remarks as Description,Document_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                    " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MCC_GATE_ENTRY " & _
                    "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCWeighment) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as Description,Document_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                   " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status_Gross_Weight = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MCC_WEIGHMENT " & _
                   "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCTankerGateOut) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],GATE_OUT_NO as [Document Code], '' as Description,GATE_OUT_DATE as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when IS_POSTED = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MCC_TANKER_GATE_OUT " & _
                "  where 2= 2  and  Convert (date,GATE_OUT_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, GATE_OUT_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCDispatch) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Chalan_NO as [Document Code], '' as Description,Dispatch_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
               " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when ISPOSTED = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_mcc_dispatch_challan " & _
               "  where 2= 2  and  Convert (date,Dispatch_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Dispatch_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MCCDispatchReturn) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_NO as [Document Code], Remarks as Description,Document_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                     " ,'' as [Modified By],'' as [Modified Date],'NA' as [Status] from TSPL_MCC_Dispatch_Challan_Return " & _
                     "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDispatchTransfer) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_NO as [Document Code], '' as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                   " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_MCC_dispatch_transfer " & _
                   "  where 2= 2  and  Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkPurchaseInvoice) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], Description as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVSPAssetIssue) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], Remarks as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                      " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_VSPAsset_HEAD " & _
                      "  where 2= 2  and  Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCMaterial) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], Description as Description,Document_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                  " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_SD_SHIPMENT_HEAD " & _
                  "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
               ...
               "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmVSPItemIssue) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], Remarks as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleBulkMilkProcurement) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmTankerMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Tanker_No as [Document Code], Tanker_Name as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_TANKER_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmParameterMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_parameter_master  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.ParameterValueMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Parameter_CODE as [Document Code], Value as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_Parameter_value_master  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPriceChartBulkProc) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code], '' as [Description] ,Convert (varchar,Price_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_Bulk_Price_MASTER  " & _
                         " where 2= 2  and Convert (date,Price_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Price_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmContractTanker) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TANKER_CODE as [Document Code], TANKER_NO as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_CONTRACT_TANKER_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSupplierMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],SUPPLIER_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SUPPLIER_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDivertedContractor) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CONTRACTOR_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_DIVERTED_CONTRACTOR_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkTypeMast) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],MILK_TYPE_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_MILK_TYPE_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkGradeMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],MILK_GRADE_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_MILK_GRADE_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmBulkRoutMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],ROUTE_NO as [Document Code], ROUTE_NAME as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_BULK_ROUTE_MASTER  " & _
                         " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.TankerCleaningItem) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,Convert (varchar,Apply_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                                             " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_TANKER_CLEANING_ITEM_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPOBulkProc) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PO_No as [Document Code], '' as [Description] ,Convert (varchar,Date_And_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PO_BULK_MASTER  " & _
                         " where 2= 2  and Convert (date,Date_And_Time,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Date_And_Time,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmIntimation) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Intimation_No as [Document Code], '' as [Description] ,Convert (varchar,Date_And_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_Intimation_Master  " & _
                         " where 2= 2  and Convert (date,Date_And_Time,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Date_And_Time,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGateEntry) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Gate_Entry_No as [Document Code], '' as [Description] ,Convert (varchar,Date_And_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_gate_entry_details  " & _
                         " where 2= 2  and Convert (date,Date_And_Time,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Date_And_Time,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWeighment) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Weighment_No as [Document Code], '' as [Description] ,Convert (varchar,Weighment_date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_weighment_detail  " & _
                         " where 2= 2  and Convert (date,Weighment_date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Weighment_date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmQualityCheck) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],QC_No as [Document Code], '' as [Description] ,Convert (varchar,QC_Out_Date_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_QUALITY_CHECK  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmUnloading) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Unloading_No as [Document Code], '' as [Description] ,Convert (varchar,Unloading_Date_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_UNLOADING  " & _
                         " where 2= 2  and Convert (date,Unloading_Date_Time,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Unloading_Date_Time,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCleaning) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], '' as [Description] ,convert(varchar,start_date_time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSpl_Cleaning  " & _
                         " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGateOut) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], '' as [Description] ,Convert (varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'' as [Status] from TSpl_Gate_Out  " & _
                         " where 2= 2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBulkMilkSRN) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],SRN_NO as [Document Code], '' as [Description] ,Convert (varchar,SRN_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_bulk_milk_srn  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBulkMilkPurchaseInvoice) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOC_NO as [Document Code], '' as [Description] ,Convert (varchar,DOC_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_BULK_MILK_PURCHASE_INVOICE_head  " & _
                         " where 2= 2  and Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.SecondarySettingForQC) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,Convert (varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_SECONDARY_SETTING_QC_HEAD  " & _
                         " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkTransferIn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Receipt_Challan_No as [Document Code], '' as [Description] ,Convert (varchar,Receipt_Challan_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_milk_transfer_in  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBulkMilkSRNReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],SRN_Return_NO as [Document Code], '' as [Description] ,Convert (varchar,SRN_Return_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_Bulk_Milk_SRN_Return  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmMilkPurchaseReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Pur_Return_No as [Document Code], '' as [Description] ,Convert (varchar,Pur_Return_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_BULK_MILK_PURCHASE_RETURN_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmjobWorkDebitNote) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,Convert (varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JOBWORK_DEBIT_NOTE_HEAD  " & _
                         " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkTransferInReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Receipt_Challan_Return_No as [Document Code], '' as [Description] ,Convert (varchar,Receipt_Challan_Return_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MILK_TRANSFER_IN_RETURN  " & _
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleProductionDairy) = CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSectionMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],section_code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SECTION_MASTER  " & _
                         " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmStageMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Stage_code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_STAGE_MASTER  " & _
                        " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPPLogSheetMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_QC_LOG_SHEET_MASTER  " & _
                        " where 2= 2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProcessProductionLogSheet) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], Description as [Description] ,Convert (varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PP_LOG_SHEET_HEAD  " & _
                        " where 2= 2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSectionStageMapping) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], '' as [Description] ,Convert (varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SECTION_STAGE_MAPPING_HEAD  " & _
                        " where 2= 2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBillOfMaterialDairy) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],BOM_CODE as [Document Code], Description as [Description] ,Convert (varchar,BOM_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_BOM_Head  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProfitCenter) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Name as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PROFIT_CENTER_MASTER  " & _
                        " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmLineMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LINE_NO as [Document Code], '' as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_LINE_MASTER  " & _
                        " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProductionPlanningDairy) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Plan_Code as [Document Code], Description as [Description] ,Convert (varchar,Plan_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_PRODUCTION_PLAN_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBatchOrderDairy) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Batch_Code as [Document Code], Description as [Description] ,Convert (varchar,Batch_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_BATCH_ORDER_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProcessProductionIssueEntry) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Issue_Code as [Document Code], Description as [Description] ,Convert (varchar,Issue_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_ISSUE_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProcessProductionStandardization) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Standardization_Code as [Document Code], '' as [Description] ,Convert (varchar,Standardization_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_STANDARDIZATION_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.ProcessProductionStandardizationFinalQC) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],QC_Code as [Document Code], '' as [Description] ,Convert (varchar,QC_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_STD_FINALQC_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProcessProductionStageProcess) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],STAGE_PROCESS_CODE as [Document Code], '' as [Description] ,Convert (varchar,STAGE_PROCESS_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_STAGE_PROCESS_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProductionEntry) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PROD_ENTRY_CODE as [Document Code], Description as [Description] ,Convert (varchar,PROD_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_PRODUCTION_ENTRY  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProductionEntryFinalQC) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],QC_Code as [Document Code], Description as [Description] ,Convert (varchar,QC_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PE_FINALQC_HEAD  " & _
                        " where 2= 2  and Convert (date,QC_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, QC_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWreckageBooking) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],WRECKAGE_ENTRY_CODE as [Document Code], Description as [Description] ,Convert (varchar,PROD_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_WRECKAGE_Entry  " & _
                        " where 2= 2  and Convert (date,PROD_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, PROD_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAssembDis) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Description as [Description] ,Convert (varchar,ASSEMBLY_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PROD_ASSEMBLIES  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.JobWorkDispatchProduction) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],shipment_No as [Document Code], Description as [Description] ,Convert (varchar,shipment_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when ispost = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_scrapsale_head  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmProcessProdReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PROD_RETURN_CODE as [Document Code], Description as [Description] ,Convert (varchar,RETURN_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PP_PRODUCTION_RETURN  " & _
                        " where 2= 2  and Convert (date,RETURN_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, RETURN_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSiloMilkTransfer) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], Description as [Description] ,Convert (varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                        " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_SILO_MILK_TRANSFER_HEAD  " & _
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleMaterial) = CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmItemMasterRMOther) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Item_Code as [Document Code], Item_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from tspl_item_master  " & _
                          " where Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.itemStructure) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Structure_Code as [Document Code], Structure_Descq as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Create_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_STRUCTURE_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.itemPurchaseAccount) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Purchase_Class_Code as [Document Code], Purchase_Class_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from tspl_purchase_accounts  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.itemSaleAccount) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Sales_Class_Code as [Document Code], Sales_Class_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from tspl_sales_accounts  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.unitMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Unit_Code as [Document Code], Unit_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_UNIT_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.chapterhead) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Chapter_Head_Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from tspl_chapter_head  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.packType) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Class_Type as [Document Code], '' as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PACKTYPE_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PriceComponentMasters) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Comp_code as [Document Code], Price_Comp_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PRICE_COMPONENT_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PriceComponentMapping) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code], Price_Code_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PRICE_COMPONENT_MAPPING  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PricePlan) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Plan_Code as [Document Code], '' as [Description] ,Convert (varchar,Plan_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Post_Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_ITEM_PRICE_PLAN_HEADER  " & _
                          " where 2=2  and Convert (date,Plan_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Plan_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PriceMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Item_Price_ID as [Document Code], Price_Code_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_ITEM_Price_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnBreakageHead1) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Breakage_Type as [Document Code], Description as [Description] ,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_BREAKAGE_HEAD  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date,Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.locationMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Location_Code as [Document Code], Location_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_LOCATION_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmStandardscheme) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],StdSchCode as [Document Code], Descraption as [Description] ,Convert (varchar,FomeDate,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_STANDARD_SCHEME  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmStandardRateItem) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],StdRateCode as [Document Code], Descraption as [Description] ,Convert (varchar,FomeDate,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_STANDARD_RATE_ITEM  " & _
                          " where 2=2  and Convert (date,FomeDate,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, FomeDate,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmItemCategoryLevel) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],ITEM_CATEGORY_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_ITEM_CATEGORY_LEVEL  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmItemCategoryStructure) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],ITEM_CATEGORY_STRUCT_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_ITEM_CATEGORY_STRUCTURE  " & _
                          " where Form_Type='ITEM'  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.WarrantyMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Name as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_WARRANTY_MASTER  " & _
                          " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSchemeMasterNew) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Scheme_Code as [Document Code], Scheme_Desc as [Description] ,Convert (varchar,Start_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SCHEME_MASTER_NEW  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPriceGroupMapping) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Group_Code as [Document Code], Price_Group_Desc as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_PRICE_GROUP_MAPPING_HEAD  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.SublocationMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Sub_Location_Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SUB_LOCATION_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmCatalogMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Catalog_Code as [Document Code], Catalog_Desc as [Description] ,Convert (varchar,Catalog_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_CATALOG_MASTER  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPartNoMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from tspl_part_no_master  " & _
                          " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.InvetorySourceCode) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Name as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_INVENTORY_SOURCE_CODE  " & _
                          " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmItemTypeMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],ITEM_TYPE_CODE as [Document Code], ITEM_TYPE_NAME as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_ITEM_TYPE_MASTER  " & _
                          " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmHSNMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_HSN_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOverheadCostMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],COST_CODE as [Document Code], Description as [Description] ,Convert (varchar,COST_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_OVERHEAD_COST  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmOverheadCostGroup) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],GROUP_CODE as [Document Code], Description as [Description] ,Convert (varchar,GROUP_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_OVERHEAD_COST_GROUP_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmItemCostMapping) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],HCODE as [Document Code], Description as [Description] ,Convert (varchar,DOC_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_ITEM_COST_MAPPING_HEADS  " & _
                          " where 2=2 and Convert (date,DOC_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, DOC_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWeightUomMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when POSTED = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_WEIGHT_UOM_MASTER  " & _
                          " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.Indent) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Indent_No as [Document Code], Description as [Description] ,Indent_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_INDENT_HEAD  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.Transfer) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Description as [Description] ,Document_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_TRANSFER_ORDER_HEAD  " & _
                          " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnEmptyTrans) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Adjustment_No as [Document Code], Description as [Description] ,Adjustment_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                           " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Posted = 'Y' then 'Posted' else 'Pending'  end as [Status] from TSPL_ADJUSTMENT_HEADER  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWarehouseBreakage) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Description as [Description] ,Document_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_WH_BREAKAGE_HEAD  " & _
                          " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPhysicalStock) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Physical_No as [Document Code], Description as [Description] ,Stock_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Is_Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PHYSICAL_STOCK  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.ChangeItemSerialNumber) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], '' as [Description] ,Document_Date  as [Document Date],'' as [Created By],'' as [Created Date] " & _
                          " ,'' as [Modified By],'' as [Modified Date],'NA' as [Status] from TSPL_SERIAL_ITEM  " & _
                          " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.TransferReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Remarks as [Description] ,Document_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,'' as [Modified By],'' as [Modified Date],'NA' as [Status] from TSPL_TRANSFER_RETURN  " & _
                          " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmTransferGateOut) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,Gate_Out_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_Transfer_Gate_Out  " & _
                          " where 2=2  and Convert (date,Gate_Out_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Gate_Out_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGateEntryReturnTransfer) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],GE_CODE as [Document Code], Remarks as [Description] ,GE_DATE  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_GATE_ENTRY_RETURN_TRANSFER  " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGeneralWeighment) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Weighment_No as [Document Code], Remarks as [Description] ,Weighment_Date  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " & _
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_GENERAL_WEIGHMENT_DETAIL  " & _
                          " where 2=2  and Convert (date,Weighment_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Weighment_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                End If
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModulePurchase) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CostCenter) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], cost_code as [Document Code],cost_Name AS Description" & _
                ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_CostCenter_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.RequisitSubTypeMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], code as [Document Code],Description AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],convert(varchar,Modified_By,103) as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_Requisit_SubType_Master" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmFormIssueReceiptEntry) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Doc_no as [Document Code],'' AS Description" & _
                ",doc_date as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_FORM_SERIAL_NO_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmCostCentreGroupStores) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], CostCenter_code as [Document Code],Description AS Description" & _
            " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_COST_CENTRE_GROUP_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDeliveryTermsMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], stage_code as [Document Code],Description AS Description" & _
                " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_STAGE_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.capexmaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], code as [Document Code],Description AS Description" & _
                " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_CAPEX_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.capexbudget) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], code as [Document Code],Description AS Description" & _
                ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_CAPEX_BUDGET_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmUnitMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], code as [Document Code],Description AS Description" & _
                " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_COST_CENTER_UNIT_MASTER" & _
                 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCostCenterTypeMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], code as [Document Code],Description AS Description" & _
                " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_COST_CENTER_TYPE_MASTER" & _
                 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.RFQ) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], RFQ_No  as [Document Code] ,convert(varchar,RFQ_Date,103)  as [Document Date],'' as Description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when Is_Post=1 then 'Posted' else 'pendng' end  as [Status] from TSPL_RFQ_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.VendorQuotation) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Code  as [Document Code] ,convert(varchar,VQDate,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end  as [Status] from TSPL_VENDOR_QUOTATION_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnPurchaseOrder) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Purchaseorder_no  as [Document Code] ,convert(varchar,purchaseorder_date,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status],close_yn as [Close] from tspl_purchase_order_head " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnGRN) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], GRN_No  as [Document Code] ,convert(varchar,GRN_Date,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from tspl_grn_head " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.POWeighment) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Weighment_Code  as [Document Code] ,convert(varchar,Weighment_date,103)  as [Document Date],'' as description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modified_By as [Modified By],Modified_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from TSPL_PO_WEIGHTMENT_HEAD " & _
                     " where 2=2  and Convert (date,Weighment_date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Weighment_date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnNRGP) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Booking_no  as [Document Code] ,convert(varchar,Booking_Date ,103) as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modified_By as [Modified By],Modified_Date as [Modified Date],case when Posted =1 then 'Posted' else 'pendng' end as [Status] from TSPL_NRGP_REQUEST_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnGatePass) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], RGP_No  as [Document Code] ,convert(varchar,RGP_Date,103)  as [Document Date],remarks as description ,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from tspl_RGP_Head " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMaterialQuotation) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Code  as [Document Code] ,convert(varchar,QDate,103)  as [Document Date],remarks as description ,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAP_QUOTATION_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMaterialQuotationOrder) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Code  as [Document Code] ,convert(varchar,QODate,103)  as [Document Date],remarks as description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAP_QUOTATION_ORDER_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMaterialQuotationComparison) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Code  as [Document Code] ,convert(varchar,QCDate,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAP_QUOTATION_COMPARISON_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.ScrapSale) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Shipment_no  as [Document Code] ,convert(varchar,Shipment_Date,103)  as [Document Date],'' as description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAPSALE_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmItemConversion) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Doc_code  as [Document Code] ,''  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    " ,Modified_By as [Modified By],Modified_Date as [Modified Date],case when isposted=1 then 'Posted' else 'pendng' end as [Status] from TSPL_Item_Conversion_Head " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmStoreRequistion) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], REQUISITION_ID  as [Document Code] ,convert(varchar,Requisition_Date,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when status=1 then 'Posted' else 'pendng' end  as [Status],close_yn as [Close] from TSPL_REQUISITION_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmScrapSaleGateOut) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No  as [Document Code] ,convert(varchar,Gate_Out_Date,103)  as [Document Date],'' as description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],'' as [Status] from TSPL_SCRAPSALE_GATE_OUT" & _
                     " where 2=2  and Convert (date,Gate_Out_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Gate_Out_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    If objCommonVar.ApplyLocationFilterBasedOnPermission = True AndAlso clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.JobWorkDispatch) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Shipment_no  as [Document Code] ,convert(varchar,Shipment_Date,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when status =1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAPSALE_HEAD " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.ScrapSaleRetrun) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_no  as [Document Code] ,convert(varchar,Return_ship_Date,103)  as [Document Date],description,Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when status =1 then 'Posted' else 'pendng' end as [Status] from TSPL_SCRAPSALE_HEAD_Return " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmsaleReturnGateEntryMISSAle) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Gate_Entry_No  as [Document Code] ,convert(varchar,Gate_Entry_Date,103)  as [Document Date],comment as description, Created_By as [Created By],Created_Date as [Created Date]" & _
                    ",Modify_By as [Modified By],Modify_Date as [Modified Date],case when Posted=1 then 'Posted' else 'pendng' end as [Status] from TSPL_Sale_Return_Gate_Entry_Head " & _
                     " where 2=2  and Convert (date,Gate_Entry_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Gate_Entry_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    If objCommonVar.ApplyLocationFilterBasedOnPermission = True AndAlso clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModulePayable) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.vendoraccountset) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Acct_Set_Code as [Document Code],Acct_set_desc AS Description" & _
                            " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_VENDOR_ACCOUNT_SET" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.vendorgroup) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Ven_Group_Code as [Document Code],Group_Desc AS Description" & _
                         " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_VENDOR_GROUP" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.vendormaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], vendor_Code as [Document Code],Vendor_Name AS Description" & _
                            " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_Vendor_Master" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.paymentTerms) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], terms_code as [Document Code],terms_desc AS Description" & _
                            " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_terms_master" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.VendorBankMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Bank_Code as [Document Code],Bank_Name AS Description" & _
                        " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from tspl_vendor_bank_master" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.transportMasterVendor) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Transport_ID as [Document Code],Transporter_Name AS Description" & _
                        " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_TRANSPORT_MASTER" & _
                    " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmHirerachyLevelMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Hirerachy_Code as [Document Code],description AS Description" & _
                            " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_HIRERACHY_LEVEL_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.vendorSubgroup) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Ven_Sub_Group_Code  as [Document Code],SubGroup_Desc AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from tspl_Vendor_Sub_Group" & _
                    " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PaymentEntryNew) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Payment_No as [Document Code] ,convert(date,Payment_Date,103)  as [Document Date],reference as Description,Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                            " ,Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],case when Posted =1 then 'Posted' else 'pendng' end as [Status] from TSPL_PAYMENT_HEADER " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnAPInvoiceEntry) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],Description ,convert(date,Invoice_Entry_Date,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                            ",Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],case when isnull(Posting_Date,'')='' then 'Pending' else 'Posted' end  as [Status],Invoice_Type from tspl_vendor_invoice_head " & _
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleCommonServices) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.taxRate) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Tax_Code  as [Document Code],Tax_Rate_Desc  AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_TAX_RATES" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.taxGroup) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Tax_Group_Code   as [Document Code],Tax_Group_Desc   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_TAX_GROUP_MASTER" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.paymentCodes) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Payment_code   as [Document Code],Payment_Desc   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_payment_code" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.cityMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],city_Code   as [Document Code],City_Name   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_city_master" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmAbateMentMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Abatement_Code    as [Document Code],abatement_Desc   AS Description" & _
                ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_ABATEMENT_MASTER" & _
                " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmAbateMentMaster) = CompairStringResult.Equal Then
                    '--clsUserMgtCode.FrmAbateMentMaster, "Abatment Master"
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmCompanyMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],comp_Code  as [Document Code],Comp_Name   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_company_master" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmAdditionalCharges) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code  as [Document Code],Description   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_ADDITIONAL_CHARGES" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FormMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],form_code  as [Document Code],Form_Name   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_Form_Master" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.bankMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Bank_Code  as [Document Code],Description   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from tspl_Bank_Master" & _
                    " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCurrencyMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Currency_code  as [Document Code],Currency_Name   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(date,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(date,Modified_Date,103) as [Modified Date],'' as [Status] from tspl_Currency_master" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCurrencyConversion) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code  as [Document Code],description   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from tspl_Currency_conversion_Rate" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomFieldMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code  as [Document Code],Name   AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_CUSTOM_FIELD_HEAD" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmRegionMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Region_code  as [Document Code],Region_Name   AS Description" & _
                 " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_REGION_MASTER" & _
" where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
...
" where 2=2  and Convert (date,modify_date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, modify_date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmStateMaster1) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],State_code  as [Document Code],State_Name   AS Description" & _
                  " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from tspl_state_master" & _
 " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomFieldMapping) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code  as [Document Code],Name   AS Description" & _
                  " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from tspl_district_master" & _
 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.bankBranchMaster) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],BRANCH_CODE   as [Document Code],BRANCH_NAME    AS Description" & _
                  " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from tspl_bank_branch_master" & _
 " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmFormSerialNoMaster) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No    as [Document Code],''    AS Description" & _
                 " ,convert(varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],convert(date,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(date,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_FORM_SERIAL_NO_MASTER" & _
" where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmMCCDiscountMaster) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code    as [Document Code],description   AS Description" & _
                 " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_Discount_Master" & _
" where 2=2  and Convert (date,Created_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Created_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.AreaMaster) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code    as [Document Code],Name    AS Description" & _
                 " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_AREA_MASTER" & _
" where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSAC) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code    as [Document Code],Description    AS Description" & _
                 " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_SAC_MASTER" & _
" where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmItemWiseTax) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],HCode    as [Document Code],Description    AS Description" & _
                  ",convert(varchar,doc_date,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],case when status =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_ITEM_WISE_TAX" & _
 " where 2=2  and Convert (date,Created_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Created_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmRackBinMaster) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],code    as [Document Code],Description    AS Description" & _
                 " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],''  as [Status] from tspl_Rack_master" & _
" where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDeptHeadCustomerMapping) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],User_Code    as [Document Code],''    AS Description" & _
                 " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],''  as [Status] from TSPL_CUSTOMER_GROUP_MAPPING" & _
 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and  Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
 ...
 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.RevaluationEntry) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No    as [Document Code] ,Description  as Description,convert(varchar,Document_Date  ,103)   as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],case when status=1 then 'Posted' else 'Pending' end  as [Status] from TSPL_REVALUATION_HEAD " & _
                           " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleReceivable) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerType) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Cust_Type_Code  as [Document Code],Cust_Type_Desc  AS Description" & _
                   " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_customer_type_master" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerAccountSet) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Cust_Account   as [Document Code],Cust_Acct_Desc   AS Description" & _
                     ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_CUSTOMER_ACCOUNT_SET" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerGroup) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],cust_group_code   as [Document Code],cust_group_desc   AS Description" & _
                     ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_customer_group_master" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomeCategory) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CUST_CATEGORY_CODE    as [Document Code],CUST_CATEGORY_DESC    AS Description" & _
                     " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_CUSTOMER_CATEGORY_MASTER" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerMaster) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],cust_code    as [Document Code],customer_Name    AS Description" & _
                     " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from tspl_customer_master" & _
                    " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.SecondaryCustomerMaster) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],cust_code    as [Document Code],customer_Name    AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_SECONDARY_CUSTOMER_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmPOSGRoupMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],group_code    as [Document Code],Description    AS Description" & _
                    " ,convert(varchar,doc_Date,103) as [Document Date],Create_By as [Created By],convert(varchar,Create_Date,103) as [Created Date],Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_POS_GROUP_MASTER" & _
                    " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleGL) = CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.accountStructure) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],STR_CODE  as [Document Code],STR_DESCRIPTION AS Description" & _
                     ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,ModifY_Date,103) as [Modified Date],'' as [Status] from TSPL_GL_STRUCTURE" & _
                     " where 2=2  and Convert (date,ModifY_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ModifY_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.AccountMainGroup) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Account_Main_Group_Code   as [Document Code],Account_Main_Group_Desc  AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_ACCOUNT_MAIN_GROUPS" & _
                 " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.accountGroup) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Account_Group_Code   as [Document Code],Account_Group_Desc   AS Description" & _
                     ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_ACCOUNT_GROUPS" & _
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.AccountSubGroup) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Account_Sub_Group_Code    as [Document Code],Account_Sub_Group_Desc    AS Description" & _
                    ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_ACCOUNT_SUB_GROUPS" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.AccountGLMainAccount) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Main_GL_Account    as [Document Code],Main_GL_Account_Desc     AS Description" & _
                        ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_ACCOUNT_MAIN_GL_ACCOUNT" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.glAccount) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Account_Code as [Document Code],Description      AS Description" & _
                     ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_GL_ACCOUNTS" & _
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.sourceCode) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],sourcecode     as [Document Code],sourcedescription      AS Description" & _
                            ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_GL_SOURCECODE" & _
                         " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.glsecurity) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],user_code    as [Document Code],GL_Segment      AS GL_Segment" & _
                     " ,'' as [Document Date],'' as  Description,Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],ModifY_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],'' as [Status] from TSPL_GL_SEGMENT_PERMISSION" & _
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FiscalYear) = CompairStringResult.Equal Then
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],fiscal_code    as [Document Code],Fiscal_Name      AS Description" & _
                         ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_Fiscal_Year_Master" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CostCentreFinancial) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], cost_center_fin_code     as [Document Code],cost_center_fin_Name      AS Description" & _
                         ",'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By as [Modified By],convert(varchar,Modified_Date,103) as [Modified Date],'' as [Status] from TSPL_COST_CENTRE_FINANCIAL" & _
                        " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                    '====================Transaction of GL===================================
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.journalEntry) = CompairStringResult.Equal Then
                    ...
                    qry = "select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Voucher_No as [Document Code],voucher_desc   as Description ,convert(varchar,voucher_date,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                          " ,Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],case when Authorized  ='A' then 'Posted' else 'Pending' end as [Status],Auto_Reverse from tspl_journal_master " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnVCGLEntry) = CompairStringResult.Equal Then
                    ...
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code],Remarks   as Description ,convert(varchar,Document_Date ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                          " ,Modify_By as [Modified By],convert(varchar,Modify_Date,103) as [Modified Date],case when status  =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_VCGL_Head " & _
                      " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleBulkSale) = CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmBulkSalePriceChart) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code   as [Document Code],'' AS Description " & _
                   "  ,convert(varchar,TSPL_BulkSalePrice_MASTER.Price_Date,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when posted   =1 then 'Posted' else 'Pending' end as [Status] from TSPL_BulkSalePrice_MASTER " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + " ',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.TankerMasterSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_TANKER_MASTER_SALE.Tanker_Code    as [Document Code],'' AS Description " & _
                    " ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from TSPL_TANKER_MASTER_SALE " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                    '=======================Transaction========================================
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSalesOrderBS) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_SALES_ORDER_MASTER_BulkSale.Document_No as [Document Code],''   as Description ,convert(varchar,Document_Date ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                          " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_SALES_ORDER_MASTER_BulkSale " & _
                     " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmGateEntrySale) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_GATEENTRY_SALE.Document_No as [Document Code],''   as Description ,convert(varchar,Document_Date ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                          " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_GATEENTRY_SALE" & _
                    " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmWeighmentEntry) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_WEIGHMENT_DETAIL_BULKSALE.Weighment_No  as [Document Code],''   as Description ,convert(varchar,Weighment_Date  ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                           ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_WEIGHMENT_DETAIL_BULKSALE" & _
                    " where 2=2  and Convert (date,Weighment_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Weighment_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmQualityCheckBulkSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_QUALITY_CHECK_BULKSALE.QC_No   as [Document Code],''   as Description ,convert(varchar,QC_Date   ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    "  ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_QUALITY_CHECK_BULKSALE" & _
                 " where 2=2  and Convert (date,QC_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, QC_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmLoadingTanker) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_LOADING_TANKER_DETAIL_BULKSALE.LoadingTanker_No    as [Document Code],''   as Description ,convert(varchar,LoadingTanker_Date    ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_LOADING_TANKER_DETAIL_BULKSALE" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmDispatchBulkSale) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_Dispatch_BulkSale.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_Dispatch_BulkSale" & _
                 " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmInvoiceBulkSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_INVOICE_MASTER_BULKSAlE.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_INVOICE_MASTER_BULKSAlE" & _
                 " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmDispatchBulkSaleTrade) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_Dispatch_BulkSale_Trade.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_Dispatch_BulkSale_Trade" & _
                 " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmBulkDispatchReturnSale) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_Dispatch_BulkSale_History.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_Dispatch_BulkSale_History" & _
                "  where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmBulkSaleReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_SALE_RETURN_MASTER_BULKSALE.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     " ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_SALE_RETURN_MASTER_BULKSALE" & _
                 " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmCanSaleUploader) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_CAN_SALE_HEAD.Document_No     as [Document Code],''   as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    "  ,Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_CAN_SALE_HEAD" & _
                 " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmDispatchBulkSaleTradeReturn) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_Dispatch_BulkSale_Trade_Return.Document_No     as [Document Code],''    as Description ,convert(varchar,Document_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_Dispatch_BulkSale_Trade_Return" & _
                        " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleHR) = CompairStringResult.Equal Then
                ...
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCountryMaster) = CompairStringResult.Equal Then
                    ...
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_COUNTRY_MASTER.COUNTRY_CODE   as [Document Code],TSPL_COUNTRY_MASTER.COUNTRY_NAME  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_COUNTRY_MASTER " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmStateMaster) = CompairStringResult.Equal Then
                    qry = "select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_STATE_MASTER.STATE_CODE    as [Document Code],TSPL_STATE_MASTER.STATE_NAME   AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_STATE_MASTER " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBranchMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_BRANCH_MASTER.BRANCH_CODE     as [Document Code],TSPL_BRANCH_MASTER.BRANCH_CODE    AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_BRANCH_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOTMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OT_MASTER.OT_CODE      as [Document Code],TSPL_OT_MASTER.OT_NAME    AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_OT_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAttendanceMaster) = CompairStringResult.Equal Then
                    qry = "select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_ATTENDANCE_MASTER.ATTENDANCE_CODE       as [Document Code],TSPL_ATTENDANCE_MASTER.ATTENDANCE_NAME     AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_ATTENDANCE_MASTER " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "


                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBonusMaster) = CompairStringResult.Equal Then
                    qry = "select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_BONUS_MASTER.BONUS_CODE        as [Document Code],TSPL_BONUS_MASTER.BONUS_NAME      AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_BONUS_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPayPeriodMaster) = CompairStringResult.Equal Then
                    qry = "select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_PAYPERIOD_MASTER.PAY_PERIOD_CODE         as [Document Code],TSPL_PAYPERIOD_MASTER.PAY_PERIOD_NAME       AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_PAYPERIOD_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPFRulesMaster) = CompairStringResult.Equal Then
                    qry = "select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_PF_RULE_MASTER.PFRULE_CODE          as [Document Code],''       AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_PF_RULE_MASTER" & _
                  " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmESIRulesMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_ESI_RULE_MASTER.ESIRULE_CODE           as [Document Code],''       AS Description" & _
                   " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_ESI_RULE_MASTER " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLeaveMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_LEAVE_MASTER.LEAVE_CODE            as [Document Code],TSPL_LEAVE_MASTER.LEAVE_NAME      AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_LEAVE_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmShiftMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_SHIFT_MASTER.SHIFT_CODE             as [Document Code],TSPL_SHIFT_MASTER.SHIFT_NAME       AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_SHIFT_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDepartmentMaster) = CompairStringResult.Equal Then
                    qry = "    select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_DEPARTMENT_MASTER.DEPARTMENT_CODE              as [Document Code],TSPL_DEPARTMENT_MASTER.DEPARTMENT_NAME        AS Description" & _
                   " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_DEPARTMENT_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDevisionMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_DEVISION_MASTER.DEVISION_CODE               as [Document Code],TSPL_DEVISION_MASTER.DEVISION_NAME         AS Description" & _
                   " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_DEVISION_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSubDepartmentMaster) = CompairStringResult.Equal Then
                    qry = "   select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type]," & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCastCategoryMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_CAST_CATEGORY_MASTER.CAST_CATEGORY_CODE                as [Document Code],TSPL_CAST_CATEGORY_MASTER.CAST_CATEGORY_NAME          AS Description,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By]," & _
                        " convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_CAST_CATEGORY_MASTER" & _
                        " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDocumentMaster) = CompairStringResult.Equal Then
                    qry = "   select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_DOCUMENT_MASTER.DOCUMENT_CODE  as [Document Code],TSPL_DOCUMENT_MASTER.DOCUMENT_NAME   AS Description," & _
                    " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_DOCUMENT_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCourseMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_COURSE_MASTER.COURSE_CODE   as [Document Code],TSPL_COURSE_MASTER.COURSE_CODE    AS Description," & _
                  "  '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_COURSE_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGradeMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_GRADE_MASTER.GRADE_CODE    as [Document Code],TSPL_GRADE_MASTER.GRADE_NAME     AS Description," & _
                        "  '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_GRADE_MASTER" & _
                       " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLanguageMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_LANGUAGE_MASTER.LANGUAGE_CODE     as [Document Code],TSPL_LANGUAGE_MASTER.LANGUAGE_NAME     AS Description," & _
                         " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_LANGUAGE_MASTER" & _
                        " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOccupationMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OCCUPATION_MASTER.OCCUPATION_CODE      as [Document Code],TSPL_OCCUPATION_MASTER.OCCUPATION_NAME      AS Description," & _
                  "  '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_OCCUPATION_MASTER" & _
                  " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmReligionMaster) = CompairStringResult.Equal Then
                    qry = "   select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_RELIGION_MASTER.RELIGION_CODE       as [Document Code],TSPL_RELIGION_MASTER.RELIGION_NAME       AS Description," & _
                   " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_RELIGION_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSkillMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_SKILL_MASTER.SKILL_CODE        as [Document Code],TSPL_SKILL_MASTER.SKILL_NAME        AS Description," & _
                    " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_SKILL_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOTSlab) = CompairStringResult.Equal Then
                    qry = "   select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OT_SLAB.OT_CODE         as [Document Code],TSPL_OT_SLAB.SLAB_DESCRIPTION         AS Description," & _
                    " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_OT_SLAB" & _
                      "   where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmConveyanceRateMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_CONVEYANCE_RATE_MASTER.CONV_RATE_CODE          as [Document Code],TSPL_CONVEYANCE_RATE_MASTER.DESCRIPTION          AS Description," & _
                    " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_CONVEYANCE_RATE_MASTER" & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmODMaster) = CompairStringResult.Equal Then
                    qry = "  select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OD_MASTER.OD_CODE           as [Document Code],TSPL_OD_MASTER.DESCRIPTION          AS Description," & _
                    "  '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_OD_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPayrollSetting) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_PAYROLL_SETTING.PAY_SETTING_CODE            as [Document Code],'' AS Description," & _
                   " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_PAYROLL_SETTING " & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPayrollDesignationMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_DESIGNATION_MASTER.Designation_id             as [Document Code],Designation_Desc  AS Description," & _
                   " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By   as [Modified By],convert(varchar,Modify_Date  ,103) as [Modified Date],'' as [Status] from  TSPL_DESIGNATION_MASTER" & _
                   " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPaymentMode) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_PAYMENT_MODE.Code             as [Document Code],TSPL_PAYMENT_MODE.Name   AS Description," & _
                   " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],'' as [Status] from  TSPL_PAYMENT_MODE " & _
                  " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPTSlab) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_PT_RULE_MASTER.PT_CODE as [Document Code],TSPL_PT_RULE_MASTER.PT_NAME    AS Description," & _
                   " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],'' as [Status] from  TSPL_PT_RULE_MASTER" & _
                    " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmployee_Master) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_MASTER.EMP_CODE      as [Document Code],TSPL_EMPLOYEE_MASTER.Emp_Name    as Description ,convert(varchar,Joining_date      ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      "  ,Modify_By   as [Modified By],convert(varchar,Modify_Date  ,103) as [Modified Date],''  as [Status] from TSPL_EMPLOYEE_MASTER" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmployeeStatus) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_STATUS.EMP_STATUS_CODE  as [Document Code],''   as Description ,convert(varchar,APPLICABLE_FROM       ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_EMPLOYEE_STATUS" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPayHeadDefinitions) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],PAY_HEAD_CODE   as [Document Code],PAY_HEAD_NAME   as Description ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_PAYHEAD_MASTER" & _
                  " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSalaryStructure) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],SALARY_STRUCTURE_CODE    as [Document Code],SALARY_STRUCTURE_NAME    as Description ," & _
                    " '' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_SALARY_STRUCTURE" & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmpSalary) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],EMP_SAL_CODE    as [Document Code],''   as Description ,convert(varchar,APPLICABLE_FROM       ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                      "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_EMPLOYEE_SALARY" & _
                      " where 2=2  and Convert (date,APPLICABLE_FROM,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, APPLICABLE_FROM,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPTSlab) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGeneralHolidays) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],GHOLIDAY_CODE     as [Document Code],DESCRIPTION    as Description ,convert(varchar,HOLIDAY_DATE        ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_GENERAL_HOLIDAYS" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWeeklyHolidays) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],WKHOLIDAY_CODE      as [Document Code],WKHOLIDAY_NAME     as Description ,convert(varchar,APPLICABLE_FROM         ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],''  as [Status] from TSPL_WEEKLY_HOLIDAYS" & _
                         " where 2=2  and Convert (date,APPLICABLE_FROM,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, APPLICABLE_FROM,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLeaveApplication) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LVAPPLICATION_CODE       as [Document Code],LEAVE_REASON      as Description ,convert(varchar,APPLICATION_DATE          ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                  " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pnding' end  as [Status] from TSPL_LEAVE_APPLICATION" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLeaveAdjustment) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LVADJUSTMENT_CODE        as [Document Code],LEAVE_REASON      as Description ,convert(varchar,ADJUSTMENT_DATE,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                 "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_LEAVE_ADJUSTMENT" & _
                " where 2=2  and Convert (date,ADJUSTMENT_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ADJUSTMENT_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAllowanceDetails) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],ALLOWANCE_CODE         as [Document Code],ALLOWANCE_REMARKS       as Description ,convert(varchar,ALLOWANCE_DATE ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_ALLOWANCE" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDeductionDetails) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DEDUCTION_CODE         as [Document Code],DEDUCTION_REMARKS       as Description ,convert(varchar,DEDUCTION_DATE ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
               " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_DEDUCTION" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmReimbursementDetails) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],REIMBURSEMENT_CODE          as [Document Code],REIMBURSEMENT_REMARK        as Description ,convert(varchar,REIMBURSEMENT_DATE,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_EMP_REIMBURSEMENT" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmApplyLoan) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LOAN_CODE           as [Document Code],LOAN_DESCRIPTION         as Description ,convert(varchar,LOAN_DATE ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_LOAN_APPLICATION" & _
                    " where 2=2  and Convert (date,LOAN_DATE ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, LOAN_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGenerateBonus) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],EMP_BONUS_CODE            as [Document Code],DESCRIPTION          as Description ,convert(varchar,Posting_Date  ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
               " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_EMPLOYEE_BONUS" & _
                " where 2=2  and Convert (date,Modified_Date  ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLoanGeneration) = CompairStringResult.Equal Then
                    qry = "    select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LOAN_GENERATION_CODE             as [Document Code], GENERATE_REMARKS   as Description ,convert(varchar,GENERATION_DATE   ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
              " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_LOAN_GENERATION" & _
            " where 2=2  and Convert (date,GENERATION_DATE  ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, GENERATION_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLoanAdjustment) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LOANADJUSTMENT_CODE              as [Document Code], ADJUSTMENT_REASON   as Description ,convert(varchar,ADJUSTMENT_DATE    ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_LOAN_ADJUSTMENT" & _
                " where 2=2  and Convert (date,ADJUSTMENT_DATE  ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ADJUSTMENT_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "

                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDailyAttendance) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DLA_CODE               as [Document Code], DESCRIPTION    as Description ,convert(varchar,Att_Date     ,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
              " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_DAILY_ATTENDANCE" & _
               ...
               " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date],case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_HOURLY_ATTENDANCE" & _
               " left join TSPL_HOURLY_ATTENDANCE_DETAIL on TSPL_HOURLY_ATTENDANCE_DETAIL.DLA_CODE=TSPL_HOURLY_ATTENDANCE.DLA_CODE " & _
              " where 2=2  and Convert (date,ATTENDANCE_DATE  ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ATTENDANCE_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMonthlyAttendance) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_MONTHLY_ATTENDANCE.MTA_CODE  as [Document Code], DESCRIPTION  as Description ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                         " case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_MONTHLY_ATTENDANCE" & _
                        " where 2=2  and Convert (date,Modified_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmOTSheet) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OT_SHEET.OT_SHEET_CODE  as [Document Code], ''    as Description ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                            " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                            " case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_OT_SHEET" & _
                            " where 2=2  and Convert (date,Modified_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAdjustmentVoucher) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_ADJUSTMENT_VOUCHER.ADJUSTMENT_CODE   as [Document Code], ADJUSTMENT_REMARK     as Description ,convert(varchar,ADJUSTMENT_DATE,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                          " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                          " case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_ADJUSTMENT_VOUCHER" & _
                          " where 2=2  and Convert (date,ADJUSTMENT_DATE   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, ADJUSTMENT_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSalaryGeneration) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_GENERATE_SALARY.SALARY_GENERATION_CODE    as [Document Code], GENERATE_REMARKS      as Description ,convert(varchar,GENERATE_DATE ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                        " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                        " case when POSTED =1 then 'Posted' else 'Pending' end  as [Status] from TSPL_GENERATE_SALARY" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmployeeGratuity) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_GRATUITY.EMP_CODE      as [Document Code], ''      as Description ,convert(varchar,DOJ  ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                        " ''  as [Status] from TSPL_GRATUITY" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLTAClaim) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_LTA_Claim_Head.LTA_CODE       as [Document Code], ''      as Description ,convert(varchar,Claim_From_Date   ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                    " ''  as [Status] from TSPL_LTA_Claim_Head" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMediclaimEntry) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_MEDICLAIM_HEAD.DOCUMENT_CODE        as [Document Code], DESCRIPTION       as Description ,convert(varchar,DATE    ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                            ",Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                             " case when Status  ='N' then 'Pending' else 'Posted' end as [Status] from TSPL_MEDICLAIM_HEAD" & _
                             " where 2=2  and Convert (date,DATE   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmFullAndFinalSettlement) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_FF_SETTLEMENT_HEAD.EMP_CODE         as [Document Code], DESCRIPTION       as Description ,convert(varchar,Document_Date     ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                            " case when POSTED =1 then 'Posted' else 'Pending'  end as [Status] from TSPL_FF_SETTLEMENT_HEAD" & _
                            " where 2=2  and Convert (date,Document_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmployeeShiftChange) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_SHIFT_CHANGE_HEAD.EMP_SHIFT_CODE          as [Document Code], DESCRIPTION       as Description ,convert(varchar,SHIFT_APP_DATE      ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                            " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                            " case when POSTED =1 then 'Posted' else 'Pending'  end as [Status] from TSPL_EMPLOYEE_SHIFT_CHANGE_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmODSheet) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_OD_SHEET.OD_SHEET_CODE           as [Document Code], ''       as Description ,convert(varchar,FROM_Date       ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                    " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                    " '' as [Status] from TSPL_OD_SHEET" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmConveyanceClaim) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_CONVEYANCE_CLAIM.CLAIM_CODE            as [Document Code], ''       as Description ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                          " '' as [Status] from TSPL_CONVEYANCE_CLAIM" & _
                            " where 2=2  and Convert (date,Modified_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmEmployeeTransfer) = CompairStringResult.Equal Then
                    qry = "   select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_TRANSFER.Document_Code as [Document Code], Description  as Description ,convert(varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                        " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                        " '' as [Status] from TSPL_EMPLOYEE_TRANSFER" & _
                        " where 2=2  and Convert (date,Document_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmEmpIncrement) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_INCREMENT_HEAD.INCREMENT_CODE  as [Document Code], ''  as Description ,convert(varchar,INCREMENT_DATE ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                        ",Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                        " case when POSTED =1 then 'Posted' else 'Pending' end as [Status] from TSPL_EMPLOYEE_INCREMENT_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmAllotmentOfLeaves) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_LEAVE_ALLOTMENT.LVALLOTMENT_CODE   as [Document Code], ALLOTMENT_REMARKS   as Description ,convert(varchar,ALLOTMENT_DATE  ,103)  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     " ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                  "  '' as [Status] from TSPL_LEAVE_ALLOTMENT" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.EmployeeBandMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_EMPLOYEE_BAND_MASTER.code   as [Document Code], DESCRIPTION    as Description ,''  as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                  "  ,Modified_By    as [Modified By],convert(varchar,Modified_Date   ,103) as [Modified Date]," & _
                    "'' as [Status] from TSPL_EMPLOYEE_BAND_MASTER" & _
                   " where 2=2  and Convert (date,Modified_Date   ,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                End If
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleTDS) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.NatureOfDeduction) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_TDS_DEDUCTION_HEAD.Deduction_Code   as [Document Code],TSPL_TDS_DEDUCTION_HEAD.Description  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],'' as [Status] from  TSPL_TDS_DEDUCTION_HEAD " & _
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.PartyDetails) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_TDS_VENDOR_DETAILS.Vendor_Code   as [Document Code],TSPL_VENDOR_MASTER.Vendor_Name AS Description" & _
                    " ,'' as [Document Date],TSPL_TDS_VENDOR_DETAILS.Created_By as [Created By],convert(varchar,TSPL_TDS_VENDOR_DETAILS.Created_Date,103) as [Created Date],TSPL_TDS_VENDOR_DETAILS.Modify_By  as [Modified By],convert(varchar,TSPL_TDS_VENDOR_DETAILS.Modify_Date ,103) as [Modified Date],'' as [Status] from  TSPL_TDS_VENDOR_DETAILS " & _
                    "  left join TSPL_VENDOR_MASTER ON TSPL_VENDOR_MASTER.Vendor_Code=TSPL_TDS_VENDOR_DETAILS.Vendor_Code " & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.TDSSection) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_TDS_SECTION_MASTER.TDS_Group   as [Document Code],TSPL_TDS_SECTION_MASTER.Description  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],'' as [Status] from  TSPL_TDS_SECTION_MASTER " & _
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.mbtnAPInvoiceEntryTDS) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TSPL_VENDOR_INVOICE_HEAD.Document_No as [Document Code],'' as Description ,convert(varchar,TSPL_VENDOR_INVOICE_HEAD.Invoice_Entry_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],(case when len(Posting_Date) is null then 'Pending' else 'Posted' end)   as [Status] from TSPL_VENDOR_INVOICE_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.TDSPAYMENT) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code],'' as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],case when Posted   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_TDS_PAYMENT_HEADER" & _
                        " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                End If
                ''''''Sanjay, Fixed Assets'''''''''''''''''''
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleFixedAsset) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.DepAccSets) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],AcSet_Code as [Document Code],AcSet_Desc  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_Dep_AccountSet " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.Categories) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Category_Code   as [Document Code],Description  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_ASSET_CATEGORY " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CostFACenter) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CostCenter_Code  as [Document Code],CostCenter_Name  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_FA_COST_CENTER_MASTER " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAssetGroups) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Group_Code   as [Document Code],Description  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_ASSET_GROUP " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDepreciationMethod) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code   as [Document Code],Description  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_DEPRECIATION_METHOD " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.DepPeriod) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],period_Code   as [Document Code],period_Desc  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_DEPRECIATION_PERIODS " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.Template) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Template_Code as [Document Code],template_Name  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_FA_TEMPLATE_MASTER " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAssetBookMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Book_Code as [Document Code],Book_Name  AS Description" & _
                    " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_FA_BOOK_MASTER " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FAAcquisitionEntry) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Acquisition_Code as [Document Code],Description as Description ,convert(varchar,Acquisition_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_ACQUISITION_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FAAssetDepreciation) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],'' as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Created_By  as [Modified By],convert(varchar,Created_Date ,103) as [Modified Date],'' as [Status] from TSPL_ASSET_DEPRECIATION" & _
                        " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FADisposalEntry) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code],Description as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_ASSET_SCRAP_HEAD" & _
                        " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAsset_Issue_Return) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Asset_Id as [Document Code],'' as Description ,convert(varchar,Trans_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from TSPL_ASSET_ISSUE_RETURN" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmAssetStoreRequistion) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Requisition_Id as [Document Code],Description as Description ,convert(varchar,Requisition_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_REQUISITION_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmIssueItemsToAsset) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code],'' as Description ,convert(varchar,Doc_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_IssueItemToAssembledAsset_Head" & _
                        " where 2=2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FAAssetWork) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Description as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                         ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_ASSET_WORK_HEAD" & _
                        " where 2=2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleExportSale) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEnquiryMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code],Name AS Description" & _
                    " ,convert(varchar,Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  tspl_enquiry_master " & _
                     " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmNotifiedPartyMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code],Description  AS Description" & _
                  " ,'' as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_NOTIFY_PARTY_HEAD " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCHAChargeMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code],Description  AS Description" & _
                  " ,convert(varchar,Doc_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_CHA_CHARGE_MASTER " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmExIncentiveMaster) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code],Description  AS Description" & _
                  " ,convert(varchar,Doc_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modified_By  as [Modified By],convert(varchar,Modified_Date ,103) as [Modified Date],'' as [Status] from  TSPL_Ex_Incentive_Head " & _
                   " where 2=2  and Convert (date,Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
                    ''Transaction
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEXSalesQuotation) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Description as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status=1 then 'Posted' else 'Pending' end   as [Status] from TSPL_SD_SALES_Quotation_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEXPorformaInvoice) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Description as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_EX_PI_HEAD" & _
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEXCommercialInvoice) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Description as Description ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date]" & _
                     ",Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],case when Status   =1 then 'Posted' else 'Pending' end   as [Status] from TSPL_EX_COMMERCIAL_INVOICE_HEAD" & _
            ...
            If clsCommon.myLen(qry) > 0 Then
                qry = "select zz.[Module Name],zz.[Screen Name],zz.[Screen Type],zz.[Document Code],zz.Description,zz.[Document Date],zz.[Created By],cre_user.User_Name as [Created By Name],zz.[Created Date] " & _
                    ",zz.[Modified By],modi_user.User_Name as [Modified By Name],zz.[Modified Date],zz.[Status] from (" + qry + " )zz" & _
                    " left join tspl_user_master as cre_user on cre_user.user_code=zz.[Created By] " & _
    ...
    Private Sub fndScreen__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles fndScreen._MYValidating
        ...
        ElseIf rdbTransation.Checked Then
            ...
            wher = " TBL_MODULE.Program_Code in (select  distinct Module_Name from TSPL_MODULE_PERMISSION ) and  not TSPL_PROGRAM_MASTER.Type in ('M','SM') and TBL_MODULE.Program_Code in ('" + strModuleCode + "') and TBL_SMODULE.Program_Name in ('Transaction','MCC Transaction','Bulk Transaction')  and  TSPL_PROGRAM_MASTER.Program_Code in   ('" + clsUserMgtCode.FrmZoneMasterDS + "','" + clsUserMgtCode.frmRouteMasterDS + "','" + clsUserMgtCode.FrmSchemeMasterDairyDS + "','" + clsUserMgtCode.SaleIncentiveMaster + "','" + clsUserMgtCode.CustomerDeduction + "','" + clsUserMgtCode.frmbookingdairy + "','" + clsUserMgtCode.frmDeliveryOrderDairy + "','" + clsUserMgtCode.frmSaleDispatchDairy + "','" + clsUserMgtCode.frmSaleInvoicedairy + "','" + clsUserMgtCode.frmSaleReturndairy + "','" + clsUserMgtCode.frmGatePassDairy + "','" + clsUserMgtCode.frmCrateReceviedDairySale + "','" + clsUserMgtCode.frmBookingDairyMultipleDistributor + "','" + clsUserMgtCode.frmPOSBookingDairyMultipleDistributor + "','" + clsUserMgtCode.frmDairyGatePass + "','" + clsUserMgtCode.frmDairyBookingCustomer + "','" + clsUserMgtCode.frmPerformaInvoiceDairy + "','" + clsUserMgtCode.frmItemProjection + "','" + clsUserMgtCode.CustomerIncentiveEntry + "','" + clsUserMgtCode.FrmZoneMaster + "','" + clsUserMgtCode.frmRouteMaster + "','" + clsUserMgtCode.frmSalesLevelHierarchy + "','" + clsUserMgtCode.FrmBookingEntry + "','" + clsUserMgtCode.frmDeliveryNoteFreshSale + "','" + clsUserMgtCode.FrmDispatchFreshSale + "','" + clsUserMgtCode.frmInvoiceFreshSale + "','" + clsUserMgtCode.frmCreateReceived + "','" + clsUserMgtCode.frmSaleReturnFreshSale + "','" + clsUserMgtCode.FrmGatePassFS + "','" + clsUserMgtCode.frmCrateReceviedDairySale + "','" + clsUserMgtCode.FrmInvoiceCrateLinerDetail + "','" + clsUserMgtCode.frmsaleReturnGateEntryFS + "','" + clsUserMgtCode.frmSubsidyCreditNote + "','" + clsUserMgtCode.FrmSchemeMasterDairy + "','" + clsUserMgtCode.FrmTragetMaster + "','" + clsUserMgtCode.DispatchChecklist + "','" + clsUserMgtCode.frmBookingProductSale + "','" + clsUserMgtCode.frmdispatchAdviceProductSale + "','" + clsUserMgtCode.frmDeliveryPrderProductSale + "','" + clsUserMgtCode.frmSalesOrderProductSale + "','" + clsUserMgtCode.frmShipmentProductSale + "','" + clsUserMgtCode.frmSaleInvoiceProductSale + "','" + clsUserMgtCode.frmSaleReturnProductSale + "','" + clsUserMgtCode.FrmProductDispatchGateOut + "','" + clsUserMgtCode.frmGateEntryReturnPS + "','" + clsUserMgtCode.frmsaleReturnGateEntryPS + "','" + clsUserMgtCode.FrmGatePassPS + "','" + clsUserMgtCode.ModuleElectrical + "','" + clsUserMgtCode.frmDGMaster + "','" + clsUserMgtCode.frmDailyElectricalEntry + "','" + clsUserMgtCode.frmJWParameterMaster + "','" + clsUserMgtCode.frmJWFormulaMaster + "','" + clsUserMgtCode.frmJWVendorFormula + "','" + clsUserMgtCode.JWIItemPriceMaster + "','" + clsUserMgtCode.FrmSRNJobWorkEstimate + "','" + clsUserMgtCode.frmJobWorkBillig + "','" + clsUserMgtCode.frmJobWorkoutwordMaster + "','" + clsUserMgtCode.frmJobWorkoutwordMaster + "','" + clsUserMgtCode.frmMilkJobWorkTransfer + "','" + clsUserMgtCode.frmMilkJobWorkTransferReturn + "','" + clsUserMgtCode.frmMilkJobWorkTransferOther + "','" + clsUserMgtCode.frmMilkJobWorkTransferOtherReturn + "','" + clsUserMgtCode.frmGateEntry_JWO + "','" + clsUserMgtCode.frmWeighment_JWO + "','" + clsUserMgtCode.frmQC_JWO + "','" + clsUserMgtCode.frmUnloading_JWO + "','" + clsUserMgtCode.JWO_SRN + "','" + clsUserMgtCode.JWO_SRN_Return + "','" + clsUserMgtCode.frmJobWorkConsumption + "','" + clsUserMgtCode.frmMCCMaster + "','" + clsUserMgtCode.frmMilkRouteMaster + "','" + clsUserMgtCode.frmVillageMaster + "','" + clsUserMgtCode.frmVSPMaster + "','" + clsUserMgtCode.frmVLCMaster + "','" + clsUserMgtCode.frmVLCUploader + "','" + clsUserMgtCode.frmMPMaster + "','" + clsUserMgtCode.frmPrimaryTransporterMaster + "','" + clsUserMgtCode.frmPrimaryTransporterVehicalMaster + "','" + clsUserMgtCode.frmVLCRouteShiftMaster + "','" + clsUserMgtCode.MilkPricePlanning + "','" + clsUserMgtCode.frmPriceChartMaster + "','" + clsUserMgtCode.FrmPriceChartUploader + "','" + clsUserMgtCode.frmPriceChartMaster_Bulk + "','" + clsUserMgtCode.frmMCCMaterialSalePriceChart + "','" + clsUserMgtCode.frmMilkVehicleMaster + "','" + clsUserMgtCode.frmMilkAdvanceMaster + "','" + clsUserMgtCode.frmdeductionGroup + "','" + clsUserMgtCode.frmGroupOfDeduction + "','" + clsUserMgtCode.frmDeductionMaster + "','" + clsUserMgtCode.DeductionMapping + "','" + clsUserMgtCode.CanMaster + "','" + clsUserMgtCode.DockMaster + "','" + clsUserMgtCode.FrmTankerDispatchPriceMaster + "','" + clsUserMgtCode.MilkRejectType + "','" + clsUserMgtCode.frmMilkReasonMaster + "','" + clsUserMgtCode.frmPaymentCycleMaster + "','" + clsUserMgtCode.frmIncentiveMaster + "','" + clsUserMgtCode.frmMCCSMSSettiing + "','" + clsUserMgtCode.frmOpenMCCShiftManual + "','" + clsUserMgtCode.FrmVSPIncentiveTagging + "','" + clsUserMgtCode.frmVLCMasterTarget + "','" + clsUserMgtCode.frmItemChargeCategoryMaster + "','" + clsUserMgtCode.FreightChargesMaster + "' ,'" + clsUserMgtCode.frmMCCMaster + "','" + clsUserMgtCode.frmMCCMaterialSaleReturnFarmer + "','" + clsUserMgtCode.MPBillGeneration + "','" + clsUserMgtCode.frmPaymentProcessFarmer + "','" + clsUserMgtCode.frmFarmerPaymentAdjustment + "','" + clsUserMgtCode.frmLockMPCollectionPC + "','" + clsUserMgtCode.frmSectionAllowanceMaster + "','" + clsUserMgtCode.frmSavingsMaster + "','" + clsUserMgtCode.frmEmployeeSavingsMapping + "','" + clsUserMgtCode.frmIncomeTaxSlab + "','" + clsUserMgtCode.frmHouseRentDeclaration + "','" + clsUserMgtCode.IncomeTaxTDSCalculation + "','" + clsUserMgtCode.frmOpenMCCShift + "','" + clsUserMgtCode.MilkGateEntryIn + "','" + clsUserMgtCode.MilkGateEntryWeightment + "','" + clsUserMgtCode.frmMilkReceipt + "','" + clsUserMgtCode.MilkReject + "','" + clsUserMgtCode.frmMilkSample + "','" + clsUserMgtCode.MilkGateEntryOut + "','" + clsUserMgtCode.frmMilkSRN + "','" + clsUserMgtCode.MilkTruckSheet + "','" + clsUserMgtCode.frmVlcdataUploadar + "','" + clsUserMgtCode.FrmVLCDataUploaderManual + "','" + clsUserMgtCode.frmMilkShiftEndMCC + "','" + clsUserMgtCode.frmMCCGateEntry + "','" + clsUserMgtCode.frmMCCWeighment + "','" + clsUserMgtCode.frmMCCTankerGateOut + "','" + clsUserMgtCode.frmMCCDispatch + "','" + clsUserMgtCode.MCCDispatchReturn + "','" + clsUserMgtCode.frmDispatchTransfer + "','" + clsUserMgtCode.frmMilkPurchaseInvoice + "','" + clsUserMgtCode.frmVSPAssetIssue + "','" + clsUserMgtCode.frmMCCMaterial + "','" + clsUserMgtCode.frmMCCMaterialSaleReturn + "','" + clsUserMgtCode.frmVSPItemIssue + "','" + clsUserMgtCode.frmProvisionEntry + "','" + clsUserMgtCode.IncentiveEntry + "','" + clsUserMgtCode.frmPaymentProcess + "','" + clsUserMgtCode.frmMCCTankerDispatchReturn + "','" + clsUserMgtCode.frmsaleReturnGateEntryMCCSAle + "','" + clsUserMgtCode.frmMccScrapGatePass + "','" + clsUserMgtCode.MccMilkTransferPrice + "" & _
                   ...
                   "','" + clsUserMgtCode.frmItemCategoryStructure + "','" + clsUserMgtCode.WarrantyMaster + "','" + clsUserMgtCode.frmSchemeMasterNew + "','" + clsUserMgtCode.frmPriceGroupMapping + "','" + clsUserMgtCode.SublocationMaster + "','" + clsUserMgtCode.frmLocationCategoryLevel + "','" + clsUserMgtCode.frmLocationCategoryStructure + "','" + clsUserMgtCode.FrmCatalogMaster + "','" + clsUserMgtCode.frmPartNoMaster + "','" + clsUserMgtCode.InvetorySourceCode + "','" + clsUserMgtCode.FrmItemTypeMaster + "','" + clsUserMgtCode.frmHSNMaster + "','" + clsUserMgtCode.frmOverheadCostMaster + "','" + clsUserMgtCode.FrmOverheadCostGroup + "','" + clsUserMgtCode.FrmItemCostMapping + "','" + clsUserMgtCode.frmWeightUomMaster + "" & _
                   "','" + clsUserMgtCode.Indent + "','" + clsUserMgtCode.Transfer + "','" + clsUserMgtCode.mbtnEmptyTrans + "','" + clsUserMgtCode.mbtnStoreAdjustment + "','" + clsUserMgtCode.frmWarehouseBreakage + "','" + clsUserMgtCode.frmPhysicalStock + "','" + clsUserMgtCode.ChangeItemSerialNumber + "','" + clsUserMgtCode.TransferReturn + "','" + clsUserMgtCode.FrmTransferGateOut + "','" + clsUserMgtCode.frmGateEntryReturnTransfer + "','" + clsUserMgtCode.FrmJobWorkInventory + "','" + clsUserMgtCode.frmRawMilkConsumtion + "','" + clsUserMgtCode.frmGeneralWeighment + "" & _
                    "','" + clsUserMgtCode.mbtnPurchaseRequistion + "','" + clsUserMgtCode.RFQ + "','" + clsUserMgtCode.VendorQuotation + "','" + clsUserMgtCode.mbtnPurchaseOrder + "','" + clsUserMgtCode.mbtnGRN + "','" + clsUserMgtCode.POWeighment + "','" + clsUserMgtCode.mbtnMRN + "','" + clsUserMgtCode.mbtnSRN + "','" + clsUserMgtCode.mbtnPurchaseInvoice + "','" + clsUserMgtCode.mbtnNRGP + "','" + clsUserMgtCode.mbtnPurchaseReturn + "','" + clsUserMgtCode.mbtnGatePass + "','" + clsUserMgtCode.mbtnIssueReturn + "','" + clsUserMgtCode.frmMaterialQuotation + "','" + clsUserMgtCode.frmMaterialQuotationOrder + "','" + clsUserMgtCode.frmMaterialQuotationComparison + "','" + clsUserMgtCode.ScrapSale + "','" + clsUserMgtCode.FrmItemConversion + "','" + clsUserMgtCode.frmStoreRequistion + "','" + clsUserMgtCode.frmPurchaseSchedule + "','" + clsUserMgtCode.FrmScrapSaleGateOut + "','" + clsUserMgtCode.JobWorkDispatch + "','" + clsUserMgtCode.ScrapSaleRetrun + "','" + clsUserMgtCode.frmsaleReturnGateEntryMISSAle + "" & _
                     "','" + clsUserMgtCode.PaymentEntryNew + "','" + clsUserMgtCode.mbtnAPInvoiceEntry + "','" + clsUserMgtCode.PaymentAdjustmentEntry + "','" + clsUserMgtCode.FrmSupplierReg + "','" + clsUserMgtCode.VendorRegistration + "" & _
                      "','" + clsUserMgtCode.reverseTransaction + "','" + clsUserMgtCode.bankTransfer + "','" + clsUserMgtCode.FrmBankReco + "','" + clsUserMgtCode.FrmCFormEntry + "','" + clsUserMgtCode.FrmBankGuaranteeMaster1 + "','" + clsUserMgtCode.BankOpeningReco + "','" + clsUserMgtCode.RevaluationEntry + "','" + clsUserMgtCode.LoanEntry + "','" + clsUserMgtCode.LoanInstallment + "" & _
                       "','" + clsUserMgtCode.ReceiptEntry + "','" + clsUserMgtCode.ReceiptAdjustmentEntry + "','" + clsUserMgtCode.mbtnARInvoiceEntry + "','" + clsUserMgtCode.FrmReceiptInvoiceMapping + "','" + clsUserMgtCode.FrmCustomersOutstanding + "" & _
                       "','" + clsUserMgtCode.journalEntry + "','" + clsUserMgtCode.mbtnVCGLEntry + "" & _
                       "','" + clsUserMgtCode.FrmSalesOrderBS + "','" + clsUserMgtCode.FrmGateEntrySale + "','" + clsUserMgtCode.FrmWeighmentEntry + "','" + clsUserMgtCode.FrmLoadingTanker + "','" + clsUserMgtCode.FrmQualityCheckBulkSale + "','" + clsUserMgtCode.FrmLoadingTanker + "','" + clsUserMgtCode.FrmDispatchBulkSale + "','" + clsUserMgtCode.FrmInvoiceBulkSale + "','" + clsUserMgtCode.FrmDispatchBulkSaleTrade + "','" + clsUserMgtCode.FrmCreateAutoInvoiceBS + "','" + clsUserMgtCode.FrmBulkDispatchReturnSale + "','" + clsUserMgtCode.FrmBulkSaleReturn + "','" + clsUserMgtCode.FrmCanSale + "','" + clsUserMgtCode.FrmCanReceived + "','" + clsUserMgtCode.frmMCCMaterialFarmer + "','" + clsUserMgtCode.FrmDispatchBulkSaleTradeReturn + "" & _
                        "','" + clsUserMgtCode.EmployeeBandMaster + "','" + clsUserMgtCode.FrmAllotmentOfLeaves + "','" + clsUserMgtCode.FrmEmpIncrement + "','" + clsUserMgtCode.FrmEmployeeTransfer + "','" + clsUserMgtCode.frmConveyanceClaim + "','" + clsUserMgtCode.frmODSheet + "','" + clsUserMgtCode.frmEmployeeShiftChange + "','" + clsUserMgtCode.frmFullAndFinalSettlement + "','" + clsUserMgtCode.frmMediclaimEntry + "','" + clsUserMgtCode.frmLTAClaim + "','" + clsUserMgtCode.frmEmployeeGratuity + "','" + clsUserMgtCode.frmSalaryGeneration + "','" + clsUserMgtCode.frmAdjustmentVoucher + "','" + clsUserMgtCode.frmOTSheet + "','" + clsUserMgtCode.frmMonthlyAttendance + "','" + clsUserMgtCode.frmHourlyAttendance + "','" + clsUserMgtCode.frmDailyAttendance + "','" + clsUserMgtCode.frmLoanAdjustment + "','" + clsUserMgtCode.frmLoanGeneration + "','" + clsUserMgtCode.frmGenerateBonus + "','" + clsUserMgtCode.frmApplyLoan + "','" + clsUserMgtCode.frmReimbursementDetails + "','" + clsUserMgtCode.frmDeductionDetails + "','" + clsUserMgtCode.frmAllowanceDetails + "','" + clsUserMgtCode.frmLeaveAdjustment + "','" + clsUserMgtCode.frmLeaveApplication + "','" + clsUserMgtCode.frmWeeklyHolidays + "','" + clsUserMgtCode.frmGeneralHolidays + "','" + clsUserMgtCode.frmEmpSalary + "','" + clsUserMgtCode.frmSalaryStructure + "','" + clsUserMgtCode.frmPayHeadDefinitions + "','" + clsUserMgtCode.frmEmployee_Master + "','" + clsUserMgtCode.frmHourlyAttendance + "" & _
                   "','" + clsUserMgtCode.mbtnAPInvoiceEntryTDS + "','" + clsUserMgtCode.TDSPAYMENT + "" & _
                   "','" + clsUserMgtCode.FAAcquisitionEntry + "','" + clsUserMgtCode.FAAssetDepreciation + "','" + clsUserMgtCode.FADisposalEntry + "','" + clsUserMgtCode.frmAsset_Issue_Return + "','" + clsUserMgtCode.frmAssetStoreRequistion + "','" + clsUserMgtCode.frmIssueItemsToAsset + "','" + clsUserMgtCode.FAAssetWork + "','" + clsUserMgtCode.FAMergeAcquisitionEntry + "" & _
                   "','" + clsUserMgtCode.frmEXSalesQuotation + "','" + clsUserMgtCode.frmEXSalesOrder + "','" + clsUserMgtCode.frmEXPorformaInvoice + "','" + clsUserMgtCode.frmEXCommercialInvoice + "','" + clsUserMgtCode.frmEXSalesInvoice + "','" + clsUserMgtCode.frmEXSalesReturn + "','" + clsUserMgtCode.frmsaleReturnGateEntryExportSAle + "" & _
                   "')  "
        End If
