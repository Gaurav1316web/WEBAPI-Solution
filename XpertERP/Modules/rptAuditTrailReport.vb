        ...
        Try
            ...
            If clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleSaleDairy) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGatePassDairy) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], 'NA' as [Status] from TSPL_GATEPASS_MASTER_DAIRYSALE " &
                          " where  Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBookingDairyMultipleDistributor) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Main_Booking_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_BOOKING_MATSER " &
                          " where  Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date,'" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPOSBookingDairyMultipleDistributor) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Main_Booking_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_POS_BOOKING_MATSER " &
                          " where  Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDairyGatePass) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], GPCode as [Document Code],'' as [Description] ,convert (varchar, GPDate,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Post = 'Y' then 'Posted' else 'Pending' end as [Status] from TSPL_DAIRYSALE_GATEPASS_MASTER " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPerformaInvoiceDairy) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_Code as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], Case when  Status = 1 then 'Posted' else 'Pending' end as [Status] from tspl_dairy_proforma_invoice_head " &
                          " where  Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                    ''ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmItemProjection) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], projection_code as [Document Code],'' as [Description] ,convert (varchar, projection_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], Case when  Post_Status = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_ITEM_PROJECTION_HEAD " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.CustomerIncentiveEntry) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Doc_Code as [Document Code],'' as [Description] ,convert (varchar, Doc_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when  Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_CUSTOMER_INCENTIVE_ENTRY_HEAD " &
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleFreshSale) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSalesLevelHierarchy) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Level_Code as [Document Code],Description as [Description] ,'' as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], 'NA' as [Status] from TSPL_Sales_Hierarchy_Levels " &
                          " where  Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmGatePassFS) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], GPCode as [Document Code],'' as [Description] ,convert (varchar, GPDate,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], 'NA' as [Status] from TSPL_GATEPASS_MASTER_FRESHSALE " &
                          " where   Convert (date, GPDate,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, GPDate,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmCrateReceviedDairySale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmInvoiceCrateLinerDetail) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,MODIFY_BY as [Modified By],Convert (varchar,MODIFY_DATE,103) as [Modified Date], Case when  Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_INVOICE_CRATE_LINER_HEAD " &
                          " where   Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSubsidyCreditNote) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],'' as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], ''  as [Status] from TSPL_SUBSIDY_CRADIT_NOTE " &
                          " where   Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                End If
                '==================================== Product Sale ==============================================================
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleProductSale) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmTragetMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Target_Code as [Document Code],Target_Desc as [Description] ,Convert (varchar, DocumentDate,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], 'NA'  as [Status] from TSPL_TARGET_MASTER_HEAD " &
                          " where   Convert (date, Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.DispatchChecklist) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Code as [Document Code],Description as [Description] ,'' as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], 'NA'  as [Status] from TSPL_DISPATCH_CHECKLIST_MASTER " &
                          " where   Convert (date, Modified_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Modified_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmBookingProductSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_Code as [Document Code],Description as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], Case when Status = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_BOOKING_MASTER_PRODUCTSALE " &
                          " where   Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date,'" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmdispatchAdviceProductSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_Code as [Document Code],Description as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], Case when Posted = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE " &
                          "  where   Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSalesOrderProductSale) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_Code as [Document Code],Description as [Description] ,convert (varchar, Document_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], Case when Posted = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE " &
                          " where   Convert (date, Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmProductDispatchGateOut) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], Document_No as [Document Code],'' as [Description] ,convert (varchar, Gate_Out_Date,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],Convert (varchar,Modify_Date,103) as [Modified Date], 'NA'  as [Status] from TSPL_Product_Dispatch_Gate_Out " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGateEntryReturnPS) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], GE_CODE as [Document Code],'' as [Description] ,convert (varchar, GE_DATE,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when Posted = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_GATE_ENTRY_RETURN_PS " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmGatePassPS) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type], GPCode as [Document Code],'' as [Description] ,convert (varchar, GPDate,103) as [Document Date],Created_By as [Created By],convert (varchar,Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],Convert (varchar,Modified_Date,103) as [Modified Date], Case when Post = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_GATEPASS_master_ProductSale " &
                          " where   Convert (date, GPDate,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, GPDate,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                End If
                '==================================== Electrical ==============================================================
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleElectrical) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSlotMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_SLOT_MASTER " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDGMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_DG_MASTER " &
                          " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "',103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmDailyElectricalEntry) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Remarks as [Description] ,Convert (varchar,Document_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_DAILY_ELECTRICAL_ENTRY_HEAD " &
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleJobWorkInWard) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJWParameterMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],'NA' as [Status] from TSPL_JW_Parameter_MASTER    " &
                          " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)    "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJWFormulaMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,'' as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA' as [Status] from TSPL_JW_FORMULA " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJWVendorFormula) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DocCode as [Document Code], '' as [Description] ,DocDate as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Posted_By as [Modified By],convert(varchar, Posted_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end  as [Status] from TSPL_VENDOR_FORMULA_MAPPING    " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.JWIItemPriceMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code], Description as [Description] ,convert (varchar,Price_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Posted_By as [Modified By],convert(varchar, Posted_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end  as [Status] from TSPL_JWI_PRICE_HEAD " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.FrmSRNJobWorkEstimate) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,convert (varchar,Document_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end  as [Status] from TSPL_JWI_ESTIMATION_HEAD " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJobWorkBillig) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], Description as [Description] ,convert (varchar,Document_Date,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end  as [Status] from TSPL_JOBWORK_BILLING_HEAD " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                End If
                '==================================== Job Work Outward==============================================================
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleJobWorkOutWard) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJobWorkoutwordMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code], '' as [Description] ,convert ( varchar, Price_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],'NA'  as [Status] from TSPL_JOB_OUTWARD_PRICE_HEAD    " &
                          " where 2= 2  and Convert (date,Price_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Price_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkJobWorkTransfer) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], '' as [Description] ,convert ( varchar, Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when  isPosted = 1 then 'Posted' else 'Pending' end  as [Status] from TSPL_MILK_JOBWORK_TRANSFER_HEAD " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkJobWorkTransferReturn) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Remarks as [Description] ,convert ( varchar, Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],'NA'  as [Status] from TSPL_MILK_JOBWORK_TRANSFER_RETURN  " &
                          "  where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkJobWorkTransferOther) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],TRANSFER_NO as [Document Code], Remarks as [Description] ,convert ( varchar, TRANSFER_DATE,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end  as [Status] from TSPL_JOB_WORK_OUTWARD_TRANSFER_HEAD " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMilkJobWorkTransferOtherReturn) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], Remarks as [Description] ,convert ( varchar, Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],'' as [Status] from TSPL_JOB_WORK_OUTWARD_TRANSFER_RETURN    " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date,'" + txtFromDate.Value + "'  ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmGateEntry_JWO) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Gate_Entry_No as [Document Code], '' as [Description] ,convert ( varchar, Date_And_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JWO_GATE_ENTRY " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmWeighment_JWO) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Weighment_No as [Document Code], '' as [Description] ,convert ( varchar, Weighment_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JWO_Weighment  " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmQC_JWO) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],QC_No as [Document Code], '' as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JWO_QUALITY_CHECK " &
                          " where 2= 2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmUnloading_JWO) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Unloading_No as [Document Code], '' as [Description] ,convert (varchar,Unloading_Date_Time,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JWO_UNLOADING " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.JWO_SRN) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,convert (varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_JWO_SRN_HEAD    " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103) "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.JWO_SRN_Return) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_No as [Document Code], '' as [Description] ,convert (varchar,Document_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],'' as [Status] from TSPL_JWO_SRN_RETURN  " &
                          " where 2= 2  and Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmJobWorkConsumption) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Adjustment_No as [Document Code], Description as [Description] ,convert (varchar,Adjustment_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],Case when Posted = 'Y' then 'Posted' else 'Pending' end as [Status] from TSPL_ADJUSTMENT_HEADER    " &
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleMCCMilkProcurement) = CompairStringResult.Equal Then
               ...
               "  where 2= 2  and  Convert (date,Document_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    ...
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], Remarks as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                        " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_VSPItem_HEAD " &
                        "  where 2= 2  and  Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.IncentiveEntry) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_Code as [Document Code], '' as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                      " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when is_Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_INCENTIVE_ENTRY_HEAD " &
                      "  where 2= 2  and  Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPaymentProcess) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], PaymentDesc as Description,Doc_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_PAYMENT_PROCESS_HEAD " &
                    ...
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Return_NO as [Document Code], Remarks as Description,Return_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                         " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when isPosted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MCC_Tanker_Dispatch_Return_head " &
                    ...
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Gate_Entry_No as [Document Code], Remarks as Description,Gate_Entry_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                         " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],case when Posted = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_SALE_RETURN_GATE_ENTRY_HEAD " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMccScrapGatePass) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],GPCode as [Document Code], Remarks as Description,GPDate as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                   " ,Modified_By as [Modified By],convert(varchar, Modified_Date,103) as [Modified Date],case when Post = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_MCC_SCRAP_GATEPASS_MASTER " &
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.MccMilkTransferPrice) = CompairStringResult.Equal Then
                    qry = " SELECT '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Price_Code as [Document Code], '' as Description,Price_Date as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleFarmerPayment) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCMaterialFarmer) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], '' as [Description],convert (varchar,Document_DATE,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],Case when Status = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_MCC_Sale_Farmer_Head " &
                          " where 2= 2  and Convert (date,Document_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmMCCMaterialSaleReturnFarmer) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code], '' as [Description],convert (varchar,Document_DATE,103) as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Modify_By as [Modified By],convert(varchar, Modify_Date,103) as [Modified Date],Case when Status = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_MCC_Sale_Return_Head_Farmer " &
                          " where 2= 2  and Convert (date,Document_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Document_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmPaymentProcessFarmer) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Doc_No as [Document Code], '' as [Description] ,convert (varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],Case when isPosted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_PAYMENT_PROCESS_HEAD " &
                          " where 2= 2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmFarmerPaymentAdjustment) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Adjustment_No as [Document Code], Description as [Description] ,convert (varchar,Adjustment_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, Created_Date,103) as [Modified Date],Case when Is_Post = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_MP_Pay_Adj_Head " &
                          " where 2= 2  and Convert (date,Adjustment_Date,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, Adjustment_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmLockMPCollectionPC) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],LOCK_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],Case when Posted = 1 then 'Posted' else 'Pending' end as [Status] from TSPL_LOCK_MP_PC " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleTDSPayroll) = CompairStringResult.Equal Then
                If clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSectionAllowanceMaster) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],'NA' as [Status] from TSPL_SECTION_ALLOWANCE_MASTER    " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSavingsMaster) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],SAVINGS_CODE as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],'NA' as [Status] from TSPL_SAVINGS_MASTER " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103)  "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmEmployeeSavingsMapping) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],DOCUMENT_CODE as [Document Code], '' as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],'NA' as [Status] from TSPL_EMPLOYEE_SAVINGS_MAPPING_MASTER    " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmIncomeTaxSlab) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_HR_TDS_INCOME_TAX_SLAB " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmHouseRentDeclaration) = CompairStringResult.Equal Then
                    qry = " select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,''  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],'NA' as [Status] from TSPL_HOUSE_RENT_DECLARATION    " &
                          " where 2= 2  and Convert (date,MODIFIED_DATE,103)  > = Convert (date, '" + txtFromDate.Value + "' ,103) and Convert (date, MODIFIED_DATE,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)   "
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.IncomeTaxTDSCalculation) = CompairStringResult.Equal Then
                    qry = "  select '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Code as [Document Code], Description as [Description] ,Convert (varchar,Doc_Date,103)  as [Document Date],Created_By as [Created By],Convert(varchar, Created_Date,103) as [Created Date] " &
                          " ,Created_By as [Modified By],convert(varchar, MODIFIED_DATE,103) as [Modified Date],case when Status = 1 then 'Posted' else 'Pending'  end as [Status] from TSPL_HR_TDS_INCOME_TAX_CALCULATION_HEAD  " &
                          " where 2= 2  and Convert (date,Doc_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Doc_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Document Date],103)  "
                End If
 ...
 " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
            ...
            ElseIf clsCommon.CompairString(strModuleCode, clsUserMgtCode.ModuleSalesNew) = CompairStringResult.Equal Then
                ...
                ElseIf clsCommon.CompairString(fndScreen.Value, clsUserMgtCode.frmSNSaleInvoice) = CompairStringResult.Equal Then
                    qry = " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],CONCAT(Hist_Version,' - ',Hist_By) AS Description" &
                    " ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],'Save/Update' as [Status] from  TSPL_SD_SALE_INVOICE_HEAD_Hist_Data " &
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    qry += " Union All "
                    qry += " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Delete_By AS Description" &
                    " ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],'Delete' as [Status] from  TSPL_SD_SALE_INVOICE_HEAD_Delete_Data " &
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    qry += " Union All "
                    qry += " select  '" + strMoudleName + "' as [Module Name],'" + ScrScreenName + "' as [Screen Name] , '" + ScreenType + "' as [Screen Type],Document_Code as [Document Code],Cancel_By AS Description" &
                    " ,convert(varchar,Document_Date,103) as [Document Date],Created_By as [Created By],convert(varchar,Created_Date,103) as [Created Date],Modify_By  as [Modified By],convert(varchar,Modify_Date ,103) as [Modified Date],'Cancel' as [Status] from  TSPL_SD_SALE_INVOICE_HEAD_Cancel_Data " &
                     " where 2=2  and Convert (date,Modify_Date,103)  > = Convert (date, '" + txtFromDate.Value + "'  ,103) and Convert (date, Modify_Date,103)  < = convert ( date, '" + txtToDate.Value + "',103) "
                    StrOrderBy = " order by Convert (datetime, zz.[Created Date],103)  "
