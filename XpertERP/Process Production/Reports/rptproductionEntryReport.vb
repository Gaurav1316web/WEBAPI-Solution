...
Public Class RptproductionEntryReport
    ...
    Private Sub LoadData()
        ...
        Dim Sql As String = "select (select DISTINCT ',['+UOM_Code+']' " & _
        " from TSPL_ITEM_UOM_DETAIL " & _
        " inner join TSPL_PP_PRODUCTION_ENTRY_DETAIL on TSPL_PP_PRODUCTION_ENTRY_DETAIL.ITEM_CODE=TSPL_ITEM_UOM_DETAIL.ITEM_CODE " & _
        ...
        qry += " main_location.Is_Section ,main_location .Is_Sub_Location ,case when main_location.Is_Section='y'then 'Section wise Tanker'  when main_location .Is_Sub_Location='Y' then 'Sub Location' else 'Main Location' end as Production_Location_type,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_FAT_per   as FAT_Per ,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_SNF_Per  as SNF_Per,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_FAT_per+TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_SNF_Per as TS_Per ,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_FAT_KG  as FAT_KG ,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_SNF_KG  as SNF_KG ,TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_FAT_KG+TSPL_PP_BATCH_ITEM_PRODUCTION_DETAIL.Requir_SNF_KG  as TS_KG, TSPL_PP_BATCH_ORDER_HEAD.Plan_Code "
