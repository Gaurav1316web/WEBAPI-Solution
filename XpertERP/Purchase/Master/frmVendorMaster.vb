...
#Region "Function"
    ...
    Public Sub funfill(Optional ByVal VCode As String = "")
        Try
            ...
            For Each myDr In myDs.Tables(0).Rows
                ...
                End If
                chkSecurityDed.Checked = IIf(clsCommon.myCdbl(myDr("isSecurityDeduction")) = 1, True, False)
                chkPenaltyDed.Checked = IIf(clsCommon.myCdbl(myDr("isPenaltyDeduction")) = 1, True, False)
    ...
    Public Sub funinsert(ByVal trans As SqlTransaction)
        ...
        Try
            ...
            End If
            Dim strchkCFPUnit As String = ""
            If CFP_Unitchk.Checked = True Then
                strchkCFPUnit = 1  '''''   Actice for Cattle Feed
            Else
                strchkCFPUnit = 0 '''''  InActive for Cattle Feed
            End If
    ...
    Public Sub funupdate(ByVal trans As SqlTransaction)
        ...
        Try
            ...
            Dim strchkCFPUnit As String = ""
            If CFP_Unitchk.Checked = True Then
                strchkCFPUnit = "Y"  '''''   Actice for Cattle Feed
            Else
                strchkCFPUnit = "N" '''''  InActive for Cattle Feed
            End If
    ...
    Sub updateRemainingColmns(ByVal trans As SqlTransaction, ByVal IS_TDS_App As Integer, ByVal State As String, ByVal DFoption As String, ByVal Registered As Integer, ByVal GST_Composition_scheme As Integer, ByVal VenCHA As String, ByVal IsVendorInvoiceNo As Integer, ByVal Other_For_Pan As Integer, ByVal chillingven As String, ByVal csatype As String, ByVal strTagAsFranchise As String)
        ...
        Dim QryDed As String = ""
        If chkSecurityDed.Checked Then
            QryDed = "Update TSPL_VENDOR_MASTER set isSecurityDeduction =1 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        Else
            QryDed = "Update TSPL_VENDOR_MASTER set isSecurityDeduction =0 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        End If

        QryDed = ""
        If chkSecurityDed.Checked Then
            QryDed = "Update TSPL_VENDOR_MASTER set isPenaltyDeduction =1 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        Else
            QryDed = "Update TSPL_VENDOR_MASTER set isPenaltyDeduction =0 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        End If

        QryDed = ""
        If CFP_Unitchk.Checked Then
            QryDed = "Update TSPL_VENDOR_MASTER set CFP_Unit =1 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        Else
            QryDed = "Update TSPL_VENDOR_MASTER set CFP_Unit =0 where Vendor_Code='" + fndvendorNo.Value + "'"
            clsDBFuncationality.ExecuteNonQuery(QryDed, trans)
        End If
        '****************************************************
    End Sub
