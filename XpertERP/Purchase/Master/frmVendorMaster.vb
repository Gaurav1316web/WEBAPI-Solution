    ...
    Sub SaveData()
        ...
        Try
            ...
            ElseIf txtvendorname.Text = "" Then
                myMessages.blankValue("Vendor Name")
                txtvendorname.Focus()
