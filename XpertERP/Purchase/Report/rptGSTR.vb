 ...
 + case when isnull(TSPL_Customer_Invoice_Detail.TAX5 ,'')='UGST' then TSPL_Customer_Invoice_Detail.TAX5_Rate else 0 end as Tax_Rate " & Environment.NewLine &
    ...
    Function getBaseQueryforDetail_GSTR1(ByVal strWhrCls As String, ByVal strType As String) As String
        ...
        Try
            ...
            "(Case When TSPL_Customer_INVOICE_HEAD.TAX1 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX1_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX2 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX2_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX3 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX3_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX4 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX4_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX5 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX5_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX6 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX6_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX7 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX7_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX8 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX8_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX9 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX9_Rate,0) Else 0 End +
Case When TSPL_Customer_INVOICE_HEAD.TAX10 IN ('CGST','SGST','IGST') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX10_Rate,0) Else 0  End) as TaxRate," & Environment.NewLine &
...
Case When TSPL_Customer_INVOICE_HEAD.TAX10 IN ('TCS') Then Isnull(TSPL_Customer_INVOICE_HEAD.TAX10_Amt,0) Else 0  End) as TCSAmt," & Environment.NewLine &
            ...
            " CASE WHEN TSPL_Customer_Invoice_Head.Document_Type = 'C' THEN -1 ELSE 1 END *(CASE  WHEN TSPL_SD_SALE_INVOICE_HEAD.tax2 = 'TCS' THEN 0 ELSE ISNULL(TSPL_Customer_Invoice_Head.Total_Tax, 0) 
             END) AS [Taxable Amount],case when TSPL_Customer_Invoice_Head.Document_Type ='C' then -1 else 1 end * isnull(TSPL_Customer_Invoice_Head.RoundOffAmount,0) as [Round Off Amount], case when TSPL_Customer_Invoice_Head.Document_Type ='C' then -1 else 1 end * isnull(TSPL_Customer_Invoice_Head.Document_Total,0)  as [Invoice Amount] " & Environment.NewLine &
