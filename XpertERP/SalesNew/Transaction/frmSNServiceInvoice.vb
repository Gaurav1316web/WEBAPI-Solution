...
'' updation by richa agarwal in journal entry BM00000005519
Imports common
...
Public Class frmSNServiceInvoice
...
#Region "Variables"
    ...
    Const ReportID As String = "ServiceInvoiceSaleItemGrid"
...
#End Region
    Public Sub SetUserMgmtNew()
        ...
        'MyBase.SetUserMgmt(clsUserMgtCode.frmSNServiceInvoice)
    ...
    Private Sub FrmAPInvoiceEntry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LoadItemType()
        LoadInvoiceType()
        ddlInvoiceType.SelectedValue = "S"
        LoadBlankGridAC()
        AddNew()
    ...
    Sub LoadBlankGrid()
        ...
        repoICode.HeaderText = "Additional Code"
            ...
            If (Not isInsideLoadData) Then
                If Not isCellValueChangedOpen Then
                    ...
                    If e.Column Is gv1.Columns(colICode) OrElse e.Column Is gv1.Columns(colSchemeApplicable) OrElse e.Column Is gv1.Columns(colAmt) OrElse e.Column Is gv1.Columns(colQty) OrElse e.Column Is gv1.Columns(colRate) OrElse e.Column Is gv1.Columns(colSpecification) OrElse e.Column Is gv1.Columns(colRemarks) OrElse e.Column Is gv1.Columns(colDisPer) OrElse e.Column Is gv1.Columns(colMRP) OrElse e.Column Is gv1.Columns(colBatchNo) OrElse e.Column Is gv1.Columns(colExpiry) OrElse e.Column Is gv1.Columns(colManufactureDate) OrElse e.Column Is gv1.Columns(colUnit) OrElse (e.Column Is gv1.Columns(colAmt) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal) Then
                        If (e.Column Is gv1.Columns(colQty) OrElse e.Column Is gv1.Columns(colRate) OrElse e.Column Is gv1.Columns(colDisPer) OrElse (e.Column Is gv1.Columns(colAmt) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal)) Then
                        ...
                        If dr1 IsNot Nothing AndAlso dr1.Rows.Count > 0 Then
                            For Each tdr As DataRow In dr1.Rows
                                ...
                                Else
                                    ...
                                    gv1.Rows.AddNew()
                                    gv1.Rows(intRow).Cells(colRowType).Value = RowTypeMisc
    ...
    Sub OpenICodeList(ByVal isButtonClick As Boolean)
        ...
        If obj IsNot Nothing AndAlso clsCommon.myLen(obj.Code) > 0 Then
            gv1.CurrentRow.Cells(colRowType).Value = RowTypeMisc
            ...
            gv1.CurrentRow.Cells(colSpecification).Value = obj.specification
    ...
    Function AllowToSave() As Boolean
        Try
            ...
            For ii As Integer = 0 To gv1.Rows.Count - 1
                ...
                If clsCommon.myLen(strICode) > 0 AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.Rows(ii).Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal Then
                    ...
                    If clsCommon.myLen(strICode) > 0 AndAlso clsCommon.CompairString(strSchemeItem, "No") = CompairStringResult.Equal Then
                        For jj As Integer = ii + 1 To gv1.Rows.Count - 1
                            ...
                            If clsCommon.CompairString(strICode, strInICode) = CompairStringResult.Equal Then
                                common.clsCommon.MyMessageBoxShow("Additional charges " + strICode + " is repeted at Row No" + clsCommon.myCstr(ii + 1) + " and " + clsCommon.myCstr(jj + 1), Me.Text)
                                Return False
                            End If
                        Next
                    End If
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As New clsSNInvoiceHead()
            obj = clsSNInvoiceHead.GetData(strCode, "'S'", NavTyep)
            If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_Code) > 0) Then
                ...
                If obj.Arr IsNot Nothing AndAlso obj.Arr.Count > 0 Then
                    For Each objTr As clsSNInvoiceDetail In obj.Arr
                        ...
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colIName).Value = clsCommon.myCstr(clsDBFuncationality.getSingleValue("select Description from TSPL_Additional_Charges where Code='" & objTr.Item_Code & "'"))
    ...
    '        'oMsg.Body = "Dear " & strContactperson & " (" & strCustomer & ")" & Environment.NewLine & "   your Bill/Invoice No " & txtDocNo.Value & "  dated  " & clsCommon.GetPrintDate(txtDate.Value, "dd/MM/yyyy") & "  has been dispatched with amount  " & lblTotRAmt.Text
    '        'oMsg.Subject = "Your Bill/Invoice no  " & txtDocNo.Value & "  has been booked"

    '        oMsg.Body = obj.mailbody
    '        If oMsg.Body.Contains(clsEmailSMSConstants.SaleOrderNo) Then
    '            oMsg.Body = oMsg.Body.Replace(clsEmailSMSConstants.SaleOrderNo, txtDocNo.Value)
    '        End If
    ...
    '            oMsg.Subject = oMsg.Subject.Replace(clsEmailSMSConstants.SaleOrderNo, txtDocNo.Value)
    '        End If
    ...
    '                strRptPath = frmCRV.EmailAttachment(CrystalReportFolder.NewSalesReports, dt1, "crptSaleInvoice", "Sales Invoice")
    '                frmCRV = Nothing
    ...
    Sub PostData()
        Try
            If (myMessages.postConfirm()) Then
                SaveData(True)
                If (clsSNInvoiceHead.PostData("", txtDocNo.Value)) Then
    ...
    Private Sub txtDocNo__MYNavigator(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal NavType As common.NavigatorType) Handles txtDocNo._MYNavigator
        Try
            ...
            Dim qst As String = "select count(*) from TSPL_SD_SALE_INVOICE_HEAD where Document_Code='" + txtDocNo.Value + "' and Invoice_Type in ('S')  " + strcondition + ""
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtDocNo._MYValidating
        ...
        strwherecls = Xtra.CustomerPermission()
        '-----------------------------------------------------
        Dim qry As String = "select Document_Code as Code,CONVERT(varchar(10), Document_Date,103)+' '+ CONVERT(varchar(5), Document_Date,114) as Date,Customer_Code as [Customer Code], Customer_Name as Customer,TSPL_SD_SALE_INVOICE_HEAD.Comments,Total_Amt as Amount,case when TSPL_SD_SALE_INVOICE_HEAD.Status=0 then 'Pending' else 'Approved' end as [Status],Against_Shipment_No as [Shipment No] from TSPL_SD_SALE_INVOICE_HEAD left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_SD_SALE_INVOICE_HEAD.Customer_Code "
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 And clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and Invoice_Type in ('S') and TSPL_SD_SALE_INVOICE_HEAD.Customer_Code in (" + strwherecls + ") "
        ElseIf clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            whrClas = " Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and Invoice_Type in ('S')"
        ElseIf clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " TSPL_SD_SALE_INVOICE_HEAD.Customer_Code in (" + strwherecls + ") and Invoice_Type in ('S')"
        Else
            whrClas = "  Invoice_Type in ('S')"
        End If
        '-----------------------------------------------------

        LoadData(clsCommon.ShowSelectForm("ShipmentCofndService", qry, "Code", whrClas, txtDocNo.Value, "Code", isButtonClicked), NavigatorType.Current)
    End Sub
    ...
    Private Sub txtTaxGroup__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtTaxGroup._MYValidating
        ...
        WhrClause += " TSPL_TAX_GROUP_DETAILS.Tax_Group_Code=TSPL_TAX_GROUP_MASTER.Tax_Group_Code   ) and Tax_Group_Type='S'"

        txtTaxGroup.Value = clsCommon.ShowSelectForm("Shipmentfndid", qry, "Code", WhrClause, txtTaxGroup.Value, "Code", isButtonClicked)
        SetTaxDetails()
    ...
    Public Sub funPrint(ByVal strDocNo As String)
        ...
        Try
            ...
            Qry += " SUBSTRING(cast(datepart(YYYY,TSPL_SD_SALE_INVOICE_DETAIL.Expiry_Date) as varchar(4)),3,2) as Exp_Date,TSPL_SD_SALE_INVOICE_DETAIL.mrp,TSPL_SD_SALE_INVOICE_DETAIL.Scheme_Item,TSPL_SD_SALE_INVOICE_DETAIL.Item_Weight,(case when  coalesce(TSPL_SD_SALE_INVOICE_DETAIL.WEIGHT_UOM,tspl_item_master.Weight_UOM)=TSPL_WEIGHT_CONVERSION.Container_UOM then TSPL_SD_SALE_INVOICE_DETAIL.TotalItem_Weight else (TSPL_SD_SALE_INVOICE_DETAIL.TotalItem_Weight*TSPL_WEIGHT_CONVERSION1.Container_Qty/TSPL_WEIGHT_CONVERSION1.Contained_Qty) end) as TotalItem_Weight,(case when COALESCE(TSPL_SD_SALE_INVOICE_HEAD.Invoice_Type,'R')='T' then 'Tax Invoice' when COALESCE(TSPL_SD_SALE_INVOICE_HEAD.Invoice_Type,'R')='S' THEN 'Service Tax Invoice' else 'Retail Invoice' end) as Invoice_Type " & colsTaxRateType & ",TSPL_Additional_Charges.Description as service_desc,(TSPL_Additional_Charges.specification  + ' on ' + cast(TSPL_SD_SALE_INVOICE_DETAIL.amount as varchar(20))) as service_spec  from TSPL_SD_SALE_INVOICE_DETAIL  "
            ...
            Qry += " left join TSPL_Additional_Charges on TSPL_SD_SALE_INVOICE_DETAIL.Item_Code=TSPL_Additional_Charges.CODE "
        ...
        Try
            If e.Column.Index >= 0 Then
                ...
                ElseIf e.Column Is gv1.Columns(colQty) Then
                    If clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal Then
                ...
                ElseIf e.Column Is gv1.Columns(colAmt) Then
                    ...
                    ''    If clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal AndAlso isPO_GRN_MRN_Editable Then
    ...
    Private Sub UpdateCurrentRow(ByVal IntRowNo As Integer)
        Try
            ...
            If clsCommon.CompairString(clsCommon.myCstr(gv1.Rows(IntRowNo).Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal AndAlso clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(colIsMannualAmt).Value) = 0 Then
    ...
    Private Sub gv1_RowFormatting(ByVal sender As System.Object, ByVal e As Telerik.WinControls.UI.RowFormattingEventArgs) Handles gv1.RowFormatting
        Try
            If clsCommon.CompairString(clsCommon.myCstr(e.RowElement.RowInfo.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal AndAlso clsCommon.myCdbl(e.RowElement.RowInfo.Cells(colIsMannualAmt).Value) > 0 Then
