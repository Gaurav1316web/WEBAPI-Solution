        ...
        Try
            ...
            Else
                ...
                If clsCommon.myLen(strcode) > 0 Then
                   ...
                   "(" & clsSNShipmentHead.GetCustomerBaseQry(False, False, "", False, "ConvRate", strcustomerfilter, True, clsCommon.GetPrintDate(txtDate.Value.AddDays(1), "dd/MMM/yyyy"), "", txtDocNo.Value, False, False, True, trans, False) & "   " &
