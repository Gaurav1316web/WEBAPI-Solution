                ...
                If dsSetting IsNot Nothing AndAlso dsSetting.Rows.Count > 0 Then
                    ...
                    For Each dr As DataRow In dsSetting.Rows
                        ...
                        If isVisible Then
                            ...
                            Dim BankCharges_amt As Double = clsCommon.myCdbl(dsData.Rows(0)("Bank_Charges"))
                            Dim amt As Double = clsCommon.myCdbl(dsData.Rows(0)("Check_Amount")) + BankCharges_amt
                            ...
                            Select Case fld
                                ...
                                Case ChequeSettingVar.Amount
                                    ...
                                    txt.Text = clsCommon.myFormat(clsCommon.myCdbl(dsData.Rows(0)("Check_Amount")) + BankCharges_amt) 'update by preeti gupta Against ticket no[]
                                    Exit Select
                                Case ChequeSettingVar.[Date]
...
#Region "Variables"
    ...
    Private arrLableSetting As List(Of clsLableSetting) = Nothing
    Dim dsRpt As ERP.dsRptChequeMultiple = Nothing
#End Region
    ...
    Public Sub PrintCheque(ByVal arr As List(Of clsPrintCheck))
        Try
            ...
            dsRpt = New ERP.dsRptChequeMultiple()
