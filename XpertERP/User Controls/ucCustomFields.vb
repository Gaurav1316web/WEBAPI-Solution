    ...
    Public Sub LoadCustomControls()
        ...
        If ArrMapping IsNot Nothing AndAlso ArrMapping.Count > 0 Then
            ...
            For Each obj As clsCustomFieldMapping In ArrMapping
                ...
                If obj.Type = EnumCustomFieldType.NumberType OrElse obj.Type = EnumCustomFieldType.FinderType OrElse obj.Type = EnumCustomFieldType.TextType OrElse obj.Type = EnumCustomFieldType.MultilineTextType OrElse obj.Type = EnumCustomFieldType.ComboListBoxType OrElse obj.Type = EnumCustomFieldType.DateType Then
