        ...
        Try
            If (Not isInsideLoadData) Then
                If Not isCellValueChangedOpen Then
                    ...
                    If e.Column Is gv1.Columns(colItemInsuranceAmt) OrElse e.Column Is gv1.Columns(colItemInsurancePer) OrElse e.Column Is gv1.Columns(colInsurancePer) OrElse e.Column Is gv1.Columns(colCategoryType) OrElse e.Column Is gv1.Columns(colCapexSubCode) OrElse e.Column Is gv1.Columns(colICode) OrElse e.Column Is gv1.Columns(colRejectedQty) OrElse e.Column Is gv1.Columns(colQty) OrElse e.Column Is gv1.Columns(colLeakQty) OrElse e.Column Is gv1.Columns(colBurstQty) OrElse e.Column Is gv1.Columns(colShortQty) OrElse e.Column Is gv1.Columns(colRate) OrElse e.Column Is gv1.Columns(colSpecification) OrElse e.Column Is gv1.Columns(colRemarks) OrElse e.Column Is gv1.Columns(colDisPer) OrElse e.Column Is gv1.Columns(colDisPerUnit) OrElse e.Column Is gv1.Columns(colMRP) OrElse e.Column Is gv1.Columns(colBatchNo) OrElse e.Column Is gv1.Columns(colExpiry) OrElse e.Column Is gv1.Columns(colManufactureDate) OrElse (e.Column Is gv1.Columns(colAmt)) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal Then
                        If (e.Column Is gv1.Columns(colItemInsuranceAmt) OrElse e.Column Is gv1.Columns(colItemInsurancePer) OrElse e.Column Is gv1.Columns(colInsurancePer) OrElse (e.Column Is gv1.Columns(colQty)) OrElse e.Column Is gv1.Columns(colRejectedQty) OrElse e.Column Is gv1.Columns(colLeakQty) OrElse e.Column Is gv1.Columns(colBurstQty) OrElse e.Column Is gv1.Columns(colShortQty) OrElse (e.Column Is gv1.Columns(colRate)) OrElse (e.Column Is gv1.Columns(colDisPer) OrElse e.Column Is gv1.Columns(colDisPerUnit)) OrElse (e.Column Is gv1.Columns(colAmt)) AndAlso clsCommon.CompairString(clsCommon.myCstr(gv1.CurrentRow.Cells(colRowType).Value), RowTypeMisc) = CompairStringResult.Equal) Then
...
#End Region
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click
        Try
            clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModulePurchase, clsUserMgtCode.mbtnMRN, IIf(clsCommon.myLen(txtShipToLocation.Value) <= 0, txtBillToLocation.Value, txtShipToLocation.Value), txtDate.Value, Nothing)
            PostData()
        Catch ex As Exception
            common.clsCommon.MyMessageBoxShow(Me, ex.Message, Me.Text)
        End Try
        ...
        If frm.ArrReturn IsNot Nothing AndAlso frm.ArrReturn.Count > 0 Then
            ...
            For Each obj As clsGRNDetail In frm.ArrReturn
                If IsValidItem(obj) Then
                    ...
                    Else
                        'gv1.Rows(gv1.Rows.Count - 1).Cells(colDisPer).Value = obj.Disc_Per  'Disc_Per
                        gv1.Rows(gv1.Rows.Count - 1).Cells(colDisPer).Value = frmPendingGRN.Load_discount_for_MRN(obj.GRN_No, obj.Item_Code) 'obj.Disc_Per
                    ...
                    gv1.Rows(gv1.Rows.Count - 1).Cells(colDisPerUnit).Value = frmPendingGRN.Load_discount_per_unit_for_MRN(obj.GRN_No, obj.Item_Code)
    ...
    Public Sub PrintData(ByVal StrDocNo As String)
        Try
            clsMRNHead.funMRNPrint(MyBase.Form_ID, False, txtDate.Value, StrDocNo)
            ...
            '            Dim Qry As String = "SELECT ROW_NUMBER() Over (Order By (Select 1)) As [SNo.],TSPL_COMPANY_MASTER.Phone1,TSPL_COMPANY_MASTER.Phone2,TSPL_COMPANY_MASTER.Pan_No,TSPL_LOCATION_MASTER.Location_Code  , TSPL_LOCATION_MASTER.Location_Desc , TSPL_LOCATION_MASTER.Add1 as Location_Add1, TSPL_LOCATION_MASTER.Add2 as Location_Add2 , TSPL_LOCATION_MASTER.Add3 as Location_Add3 , TSPL_LOCATION_MASTER.Add4 as Location_Add4 , TSPL_LOCATION_MASTER.City_Code as Location_City_Code , TSPL_LOCATION_MASTER.State as Location_State , TSPL_LOCATION_MASTER.Pin_Code as Location_Pin_Code , TSPL_LOCATION_MASTER.Country as Location_Country , TSPL_LOCATION_MASTER.Telphone as Location_Telphone, TSPL_LOCATION_MASTER.Email as Location_Email, TSPL_LOCATION_MASTER.Loc_Short_Name as Loc_Short_Name , TSPL_LOCATION_MASTER.IsMainPlant as Location_IsMainPlant,
            '             TSPL_COMPANY_MASTER.Comp_Code   , TSPL_COMPANY_MASTER.Comp_Name , TSPL_COMPANY_MASTER.Add1 as Comp_Add1, TSPL_COMPANY_MASTER.Add2 as Comp_Add2 , TSPL_COMPANY_MASTER.Add3 as Comp_Add3 , TSPL_COMPANY_MASTER.City_Code as Comp_City_Code, TSPL_COMPANY_MASTER.Email as Comp_Email , TSPL_COMPANY_MASTER.Pincode as Comp_Pincode , TSPL_COMPANY_MASTER.State as Comp_State , TSPL_COMPANY_MASTER.Tin_No as Comp_Tin_No , TSPL_COMPANY_MASTER.Logo_Img as Comp_Logo_Img , TSPL_COMPANY_MASTER.Logo_Img2 as Comp_Logo_Img2, TSPL_COMPANY_MASTER.GSTReg_No as Comp_GSTReg_No, TSPL_COMPANY_MASTER.CINNo as Comp_CINNo, TSPL_COMPANY_MASTER.Phone1 as Comp_Phone1 , TSPL_COMPANY_MASTER.Phone2 as Comp_Phone2 , TSPL_MRN_HEAD.MRN_No,
            ' (replace( CONVERT(varchar(11), TSPL_MRN_HEAD.MRN_Date,104),'.','/')+' '+CONVERT(varchar(100),TSPL_MRN_HEAD.MRN_Date,108) )as MRN_Date,
            'TSPL_STATE_MASTER.GST_STATE_Code,TSPL_MRN_HEAD.Vendor_Code, TSPL_MRN_HEAD.Vendor_Name,TSPL_MRN_HEAD.GRNo,TSPL_MRN_HEAD.GENo,
            ' (case when LEN(TSPL_MRN_HEAD.GEDate)>0  then REPLACE( CONVERT(varchar(11), TSPL_MRN_HEAD.GEDate,104),'.','/') else '' end) as GEDate,
            ' TSPL_MRN_DETAIL.MRN_Qty,TSPL_MRN_DETAIL.Item_Net_Amt,
            ' TSPL_MRN_HEAD.VehicleNo,TSPL_MRN_HEAD.Remarks ,TSPL_MRN_DETAIL.Item_Code,TSPL_MRN_DETAIL.Item_Desc,TSPL_MRN_DETAIL.Unit_code,
            '            (case when len(isnull(TSPL_MRN_DETAIL.GRN_Id,''))>0 then (select Max(GRN_Qty +ISNULL(Leak_Qty,0)+isnull(Burst_Qty,0)+isnull(Short_Qty,0)) from TSPL_GRN_DETAIL where TSPL_GRN_DETAIL.GRN_No=TSPL_MRN_DETAIL.GRN_Id and isnull(tspl_grn_detail.po_id,'')=isnull(tspl_mrn_detail.po_id,'')  and TSPL_GRN_DETAIL.Item_Code=TSPL_MRN_DETAIL.Item_Code and TSPL_GRN_DETAIL.Unit_code=TSPL_MRN_DETAIL.Unit_code and TSPL_GRN_DETAIL.Item_Cost=TSPL_MRN_DETAIL.Item_Cost and isnull(TSPL_GRN_DETAIL.MRP,0) = isnull(TSPL_MRN_DETAIL.MRP,0) and isnull(TSPL_GRN_DETAIL.Assessable,0)=isnull(TSPL_MRN_DETAIL.Assessable,0))  else 0 end) as OrgGRNQty,TSPL_MRN_HEAD.Total_Tax_Amt, TSPL_MRN_HEAD.Discount_Amt,TSPL_MRN_HEAD.Amount_Less_Discount,
            '            TSPL_MRN_HEAD.Total_Tax_Amt,

            '            CASE WHEN TSPL_MRN_HEAD.TAX1='CGST'  THEN TSPL_MRN_HEAD.TAX1_Amt
            '            WHEN TSPL_MRN_HEAD.TAX2='CGST'  THEN TSPL_MRN_HEAD.TAX2_Amt
            '            WHEN TSPL_MRN_HEAD.TAX3='CGST'  THEN TSPL_MRN_HEAD.TAX3_Amt
            '            WHEN TSPL_MRN_HEAD.TAX4='CGST'  THEN TSPL_MRN_HEAD.TAX4_Amt
            '            WHEN TSPL_MRN_HEAD.TAX5='CGST'  THEN TSPL_MRN_HEAD.TAX5_Amt
            '            WHEN TSPL_MRN_HEAD.TAX6='CGST'  THEN TSPL_MRN_HEAD.TAX6_Amt
            '            WHEN TSPL_MRN_HEAD.TAX7='CGST'  THEN TSPL_MRN_HEAD.TAX7_Amt
            '            WHEN TSPL_MRN_HEAD.TAX8='CGST'  THEN TSPL_MRN_HEAD.TAX8_Amt
            '            WHEN TSPL_MRN_HEAD.TAX9='CGST'  THEN TSPL_MRN_HEAD.TAX9_Amt
            '            WHEN TSPL_MRN_HEAD.TAX10='CGST' THEN TSPL_MRN_HEAD.TAX10_Amt else 0 END  AS [CGST Amt],

            '            CASE WHEN TSPL_MRN_HEAD.TAX1='SGST'  THEN TSPL_MRN_HEAD.TAX1_Amt
            '            WHEN TSPL_MRN_HEAD.TAX2='SGST'  THEN TSPL_MRN_HEAD.TAX2_Amt
            '            WHEN TSPL_MRN_HEAD.TAX3='SGST'  THEN TSPL_MRN_HEAD.TAX3_Amt
            '            WHEN TSPL_MRN_HEAD.TAX4='SGST'  THEN TSPL_MRN_HEAD.TAX4_Amt
            '            WHEN TSPL_MRN_HEAD.TAX5='SGST'  THEN TSPL_MRN_HEAD.TAX5_Amt
            '            WHEN TSPL_MRN_HEAD.TAX6='SGST'  THEN TSPL_MRN_HEAD.TAX6_Amt
            '            WHEN TSPL_MRN_HEAD.TAX7='SGST'  THEN TSPL_MRN_HEAD.TAX7_Amt
            '            WHEN TSPL_MRN_HEAD.TAX8='SGST'  THEN TSPL_MRN_HEAD.TAX8_Amt
            '            WHEN TSPL_MRN_HEAD.TAX9='SGST'  THEN TSPL_MRN_HEAD.TAX9_Amt
            '           	WHEN TSPL_MRN_HEAD.TAX10='SGST' THEN TSPL_MRN_HEAD.TAX10_Amt else 0 END  AS [SGST Amt],

            '            CASE WHEN TSPL_MRN_HEAD.TAX1='IGST'  THEN isnull (TSPL_MRN_HEAD.TAX1_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX2='IGST'  THEN isnull (TSPL_MRN_HEAD.TAX2_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX3='IGST'  THEN isnull (TSPL_MRN_HEAD.TAX3_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX4='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX4_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX5='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX5_Amt,0)
            '           	WHEN TSPL_MRN_HEAD.TAX6='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX6_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX7='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX7_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX8='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX8_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX9='IGST'  THEN isnull(TSPL_MRN_HEAD.TAX9_Amt,0)
            '            WHEN TSPL_MRN_HEAD.TAX10='IGST' THEN isnull(TSPL_MRN_HEAD.TAX10_Amt,0) else 0 END AS [IGST Amt],

            '            CASE WHEN TSPL_MRN_HEAD.TAX1='KKF'  THEN TSPL_MRN_HEAD.TAX1_Amt
            '            WHEN TSPL_MRN_HEAD.TAX2='KKF'  THEN TSPL_MRN_HEAD.TAX2_Amt
            '            WHEN TSPL_MRN_HEAD.TAX3='KKF'  THEN TSPL_MRN_HEAD.TAX3_Amt
            '            WHEN TSPL_MRN_HEAD.TAX4='KKF'  THEN TSPL_MRN_HEAD.TAX4_Amt
            '            WHEN TSPL_MRN_HEAD.TAX5='KKF'  THEN TSPL_MRN_HEAD.TAX5_Amt
            '            WHEN TSPL_MRN_HEAD.TAX6='KKF'  THEN TSPL_MRN_HEAD.TAX6_Amt
            '            WHEN TSPL_MRN_HEAD.TAX7='KKF'  THEN TSPL_MRN_HEAD.TAX7_Amt
            '            WHEN TSPL_MRN_HEAD.TAX8='KKF'  THEN TSPL_MRN_HEAD.TAX8_Amt
            '            WHEN TSPL_MRN_HEAD.TAX9='KKF'  THEN TSPL_MRN_HEAD.TAX9_Amt
            '            WHEN TSPL_MRN_HEAD.TAX10='KKF' THEN TSPL_MRN_HEAD.TAX10_Amt else 0 END AS [KKF_Amt],

            '            CASE WHEN TSPL_MRN_HEAD.TAX1='MANDITAX'  THEN TSPL_MRN_HEAD.TAX1_Amt
            '            WHEN TSPL_MRN_HEAD.TAX2='MANDITAX'  THEN TSPL_MRN_HEAD.TAX2_Amt
            '            WHEN TSPL_MRN_HEAD.TAX3='MANDITAX'  THEN TSPL_MRN_HEAD.TAX3_Amt
            '            WHEN TSPL_MRN_HEAD.TAX4='MANDITAX'  THEN TSPL_MRN_HEAD.TAX4_Amt
            '            WHEN TSPL_MRN_HEAD.TAX5='MANDITAX'  THEN TSPL_MRN_HEAD.TAX5_Amt
            '            WHEN TSPL_MRN_HEAD.TAX6='MANDITAX'  THEN TSPL_MRN_HEAD.TAX6_Amt
            '            WHEN TSPL_MRN_HEAD.TAX7='MANDITAX'  THEN TSPL_MRN_HEAD.TAX7_Amt
            '            WHEN TSPL_MRN_HEAD.TAX8='MANDITAX'  THEN TSPL_MRN_HEAD.TAX8_Amt
            '            WHEN TSPL_MRN_HEAD.TAX9='MANDITAX'  THEN TSPL_MRN_HEAD.TAX9_Amt
            '            WHEN TSPL_MRN_HEAD.TAX10='MANDITAX' THEN TSPL_MRN_HEAD.TAX10_Amt else 0 END AS  [Mandi_Tax_Amt]
            ...
            '            left Outer join TSPL_STATE_MASTER On  TSPL_STATE_MASTER.STATE_CODE=TSPL_VENDOR_MASTER.State_Code
            '            left outer join TSPL_COMPANY_MASTER on TSPL_COMPANY_MASTER.Comp_Code = TSPL_MRN_HEAD.Comp_Code
