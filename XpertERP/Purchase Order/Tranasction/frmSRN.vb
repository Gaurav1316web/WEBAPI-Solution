...
#End Region
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtDocNo._MYValidating
        ...
        If is_Load_MRN Then
            qry += ",Against_MRN as [Against MRN Code],against_grn as [Against GRN Code] , TSPL_SRN_HEAD.VehicleNo AS VehicleNO, TSPL_GRN_HEAD.GRN_Date as GRN_date"
        Else
    ...
    Private Sub RadButton2_Click_1(sender As Object, e As EventArgs) Handles RadButton2.Click
        Try
            If clsCommon.myLen(txtDocNo.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationality.ShowTransHistoryData(txtDocNo.Value, "SRN_No", "TSPL_SRN_HEAD", "TSPL_SRN_DETAIL")
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Sub
