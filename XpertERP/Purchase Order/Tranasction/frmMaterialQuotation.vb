'Sanjay Ticket No  BHA/09/05/18-000014 Dated  25/June/2018 of Client  Bharat Dairy 
Imports common
Imports System.IO

Public Class frmMaterialQuotation
...
#End Region
    ...
    End Sub
    'FrmAPInvoiceEntry
    Private Sub frmMaterialQuotation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
    ...
    Function AllowToSave() As Boolean
        Try
            ...
            If txtCustomer.arrValueMember Is Nothing Then
                txtCustomer.Focus()
                Throw New Exception("Plese enter Customer")
            End If

            If clsCommon.myCdbl(txtCustomer.arrValueMember.Count) <= 0 Then
                txtCustomer.Focus()
                Throw New Exception("Plese enter Customer")
            End If
    ...
    Sub SaveData(ByVal ChekBtnPost As Boolean, Optional ByVal isDoAbandomentNo As Boolean = False)
        Try
            If (AllowToSave()) Then
                ...
                obj.arrCustList = txtCustomer.arrValueMember
                ...
                For Each grow As GridViewRowInfo In gv1.Rows
                    If (clsCommon.myLen(grow.Cells(colICode).Value) > 0) Then
                        'obj.ArrTr.Add(objTr)
                        Dim objTr As New ClsMaterialQuotationDeatil()
    ...
    Sub LoadData(ByVal strDocumentNo As String, ByVal navType As common.NavigatorType)
        Try
            ...
            LoadBlankGrid()
            Dim obj As New ClsMaterialQuotationHead()
            obj = ClsMaterialQuotationHead.GetData(strDocumentNo, navType)
            If (obj IsNot Nothing) Then
                ...
                txtCustomer.arrValueMember = obj.arrCustList
    ...
    Private Sub txtDocNo__MYNavigator(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal NavType As common.NavigatorType) Handles txtCode._MYNavigator
        Try
            Dim qst As String = "select count(*) from TSPL_SCRAP_QUOTATION_HEAD where Code='" + txtCode.Value + "'"
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        LoadData(clsCommon.ShowSelectForm("QReqfndNo", qry, "Code", whrClas, txtCode.Value, "Code", isButtonClicked, "TSPL_SCRAP_QUOTATION_HEAD.QDate"), NavigatorType.Current)
    End Sub
    ...
    Private Sub frmPurchaseRequistion_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        ElseIf e.Alt AndAlso e.Shift AndAlso e.Control And e.KeyCode = Keys.F12 Then
            ButtonToolTip.SetToolTip(btnSave, "Press Alt+S for Save/Update Trasnaction" + Environment.NewLine + _
                                         "TSPL_SCRAP_QUOTATION_HEAD " + Environment.NewLine + _
                                         "TSPL_SCRAP_QUOTATION_DETAIL " + Environment.NewLine + _
                                         "TSPL_SCRAP_QUOTATION_CUSTOMER_DETAIL ")
        End If
    End Sub
    ...
    Private Sub txtCustomer__My_Click(sender As Object, e As EventArgs) Handles txtCustomer._My_Click
        ...
        txtCustomer.arrValueMember = clsCommon.ShowMultipleSelectForm(False, "CustMulSel", qry, "Code", "Name", txtCustomer.arrValueMember, txtCustomer.arrDispalyMember)
    End Sub
