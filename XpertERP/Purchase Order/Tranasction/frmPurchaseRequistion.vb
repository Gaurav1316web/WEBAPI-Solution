...
#End Region
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtReqNo._MYValidating
        ...
        LoadData(clsCommon.ShowSelectForm("PRReqfndNo", qry, "Code", whrClas, txtReqNo.Value, "Requisition_Date desc", isButtonClicked, "Requisition_Date"), NavigatorType.Current)
    End Sub
    ...
    Public Sub funPrint(ByVal strdocno As String, ByVal Print2 As Boolean, Optional ByVal IsPDF As Boolean = False)
        ...
        Try
            clsRequistionHead.funPurchaseReqPrint(MyBase.Form_ID, False, txtDate.Value, strdocno, Print2, IsPDF)
