...
#End Region
    ...
    Public Sub Print()
        Try
            ...
            Dim qry As String = "     SELECT  TSPL_CostCenter_MASTER.cost_name,  TSPL_IssueReturn_HEAD.Created_By ,TSPL_IssueReturn_HEAD.Modify_By ,   TSPL_IssueReturn_HEAD.Doc_No, TSPL_IssueReturn_HEAD.Doc_Date,TSPL_IssueReturn_HEAD.Doc_Type, TSPL_IssueReturn_HEAD.Remarks, TSPL_IssueReturn_HEAD.Comment,  case when  TSPL_IssueReturn_HEAD.Status=0 then 'Pending' else 'Approved' end as Status, TSPL_IssueReturn_HEAD.Posting_Date, TSPL_IssueReturn_DETAIL.Item_Code,TSPL_COMPANY_MASTER.Phone1,TSPL_COMPANY_MASTER.Email,TSPL_COMPANY_MASTER.GSTReg_No,TSPL_IssueReturn_DETAIL.Item_Desc, TSPL_IssueReturn_DETAIL.Required_Qty, TSPL_IssueReturn_DETAIL.Issued_Qty_AgainstRet as returnqty,   TSPL_IssueReturn_DETAIL.Unit_code, TSPL_COMPANY_MASTER.Comp_Name, TSPL_COMPANY_MASTER.Add1, TSPL_COMPANY_MASTER.Add2,   TSPL_COMPANY_MASTER.Add3, TSPL_COMPANY_MASTER.State, TSPL_COMPANY_MASTER.Logo_Img ,TSPL_COMPANY_MASTER.Logo_Img2, loc1.Location_Desc as Fromloc,loc2.Location_Desc as Toloc, emp1.Emp_Name as IssuesTo,emp2.Emp_Name as RequestBy,"
