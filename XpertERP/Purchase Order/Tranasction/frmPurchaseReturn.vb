...
#End Region
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModulePurchase, clsUserMgtCode.mbtnPurchaseReturn, IIf(clsCommon.myLen(txtShipToLocation.Value) <= 0, txtBillToLocation.Value, txtShipToLocation.Value), txtDate.Value, Nothing)
            SaveData(False)
        Catch ex As Exception
            common.clsCommon.MyMessageBoxShow(Me, ex.Message, Me.Text)
        End Try
    ...
    Public Sub printReport1(ByVal StrDocNo As String)
        Try
            ...
            If txtDocNo.Value = "" AndAlso clsCommon.myLen(StrDocNo) <= 0 Then
                ...
                Exit Sub
            End If
            clsPurchasReturnHead.funPRPrint(MyBase.Form_ID, False, txtDate.Value, txtDocNo.Value, cboTrType.SelectedValue, CboNoteType.SelectedValue)
