...
Public Class GroupProgramMapping
    ...
    Public Sub funfill()
        Dim strquery As String = "select group_code,tspl_group_program_Mapping.program_code,read_flag ,modify_flag,delete_flag,authorized_flag, Reverse_Flag, Export_Flag, Print_Flag,Cancel_Flag,Cancel_Flag_After_Posting,QucikExport_Flag,isModifyonPassword,is_Amendment from tspl_group_program_Mapping left outer join TSPL_PROGRAM_MASTER on TSPL_PROGRAM_MASTER.Program_Code=tspl_group_program_Mapping.Program_Code where group_code='" + fndgroup.Value + "'"
        If clsCommon.myLen(cboSubModule.SelectedValue) > 0 Then
            strquery += " and TSPL_PROGRAM_MASTER.Parent_Code='" + clsCommon.myCstr(cboSubModule.SelectedValue) + "'"
        ElseIf clsCommon.myLen(cboModule.SelectedValue) > 0 Then
    ...
    Private Sub menuImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuImport.Click
        ...
        Me.Controls.Add(gv)
        Dim currentdate As Date = Date.Today
        If transportSql.importExcel(gv, "Group Code", "Program Code", "Program Name", "SubModule", "Module", "Read", "Modify", "Delete", "Authorized", "Reverse", "Export", "Print", "Cancel", "QuickExport", "CancelPostTransaction", "isModifyonPassword", "isAmendment") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    Dim strgcode As String = grow.Cells("Group Code").Value.ToString()
                    ...
                    Dim strmodify As String = grow.Cells("Modify").Value.ToString()
                    ...
                    Dim strdelete As String = grow.Cells("Delete").Value.ToString()
                    ...
                    Dim strauth As String = grow.Cells("Authorized").Value.ToString()
                    ...
                    Dim strReverse As String = grow.Cells("Reverse").Value.ToString()
                    ...
                    Dim strExport As String = grow.Cells("Export").Value.ToString()
                    ...
                    Dim strPrint As String = grow.Cells("Print").Value.ToString()
                    ...
                    End If
                    Dim strQuickExport As String = grow.Cells("QuickExport").Value.ToString()
                    ...
                    Dim strModifyonPwd As String = grow.Cells("isModifyonPassword").Value.ToString()
                    ...
                    Dim strAmendment As String = grow.Cells("isAmendment").Value.ToString()
                    ...
                    Dim strCancel As String = grow.Cells("Cancel").Value.ToString()
                    ...
                    Dim strCancelPostTransaction As String = grow.Cells("CancelPostTransaction").Value.ToString()
