    ...
    Private Sub InternalTickerElapsed(ByVal sender As Object, ByVal e As Timers.ElapsedEventArgs)
        Try
            ...
            If idleTime > (MaxIdleTime * 1000) Then
                ...
                End If
                ' ElseIf idleTime > ((MaxIdleTime - 120) * 1000) Then
            '    Throw New Exception(" You are idle since, " & idleTime / 1000 / 60 & " Minutes" & Environment.NewLine & " Your application will be closed in 2 minutes")
            Else
                If m_IsIdle Then
                    SyncLock m_LockObject
                        m_IsIdle = False
