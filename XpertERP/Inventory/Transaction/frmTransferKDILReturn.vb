...
'' Work done against ticket no. BHA/01/02/19-000804 
Imports common
Imports System.IO

Public Class frmTransferKDILReturn
...
#End Region
    ...
    Private Sub frmTransferKDILReturn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub LoadSRNData()
        ...
        If obj IsNot Nothing Then
            ...
            lblToLocation.Text = obj.To_Location
            lblToLocationDesc.Text = obj.To_LocationName
            If clsCommon.CompairString(cmbDocumentType.SelectedValue, "I") = CompairStringResult.Equal Then
                lblBillToLocationCode.Text = obj.To_Location
                lblBillToLocationName.Text = obj.To_LocationName
            Else
                lblBillToLocationCode.Text = obj.From_Location
                lblBillToLocationName.Text = obj.From_LocationName
            End If
            ...
            Else
                ...
                If dt.Rows.Count > 0 Then
                    lblToLocation.Text = clsCommon.myCstr(dt.Rows(0)(0))
                    lblToLocationDesc.Text = clsCommon.myCstr(dt.Rows(0)(1))
                End If
            End If
            dt = Nothing
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "Document_No", "TSPL_Transfer_RETURN")
        Catch ex As Exception
