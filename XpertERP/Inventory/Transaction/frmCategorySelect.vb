...
#End Region
    ...
    Private Sub FrmCategorySelect_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf lvl = 5 Then
            RadGroupBox3.Text = "Location"
            LoadSubSectionLocationWithoutConsumptionLoc()
        Else
        ...
        End If
    End Sub
    Sub LoadSubSectionLocationWithoutConsumptionLoc()
        gvCategory.DataSource = Nothing

        Dim qry As String = " select cast( 0 as bit) as SEL,Location_Code as CODE,Location_Desc as NAME,case when Is_Sub_Location='Y' then 'Sub Location' else case when Is_Section='Y' then 'Section' else '' end end as Type, Section_Code as Section from TSPL_LOCATION_MASTER where (Main_Location_Code = '" + strCode + "' or location_code='" + strCode + "') and Is_Consumption_Location=0 order by Type desc,Location_Code"
