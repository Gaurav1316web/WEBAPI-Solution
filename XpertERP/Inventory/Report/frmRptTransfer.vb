...
Public Class frmRptTransfer
    ...
    Public Function funTransfer(ByVal FromDate As String, ByVal ToDate As String, ByVal strType As String, ByVal arrList As ArrayList) As Boolean
        ...
        If clsCommon.CompairString(strType, "LI") = CompairStringResult.Equal Then
            ...
            frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.InventoryReport, clsDBFuncationality.GetDataTable(StrQuery + StrOrderCls), "rptTransferLoadin", "Loadin Transfer Report")
        ElseIf clsCommon.CompairString(strType, "LOT") = CompairStringResult.Equal Then
            ...
            frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.InventoryReport, clsDBFuncationality.GetDataTable(StrQuery + StrOrderCls), "rptCustomTransfer", "Transfer Report")
        ElseIf clsCommon.CompairString(strType, "LON") = CompairStringResult.Equal Then
            StrQuery += " and TSPL_TRANSFER_HEAD.Transfer_Type='LO' and len(rtrim(isnull(TSPL_TRANSFER_HEAD.Tax_Group,'')))<=0"
            frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.InventoryReport, clsDBFuncationality.GetDataTable(StrQuery + StrOrderCls), "rptTransferWithouTax", "Loadout Transfer Report")
        End If
        frmCRV = Nothing
        Return True
    End Function
