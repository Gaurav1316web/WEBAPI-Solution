...
'' Work Done Against ticket no. GKD/14/09/18-000158 
Imports common
...
Public Class FrmDatewiseMilkStock
...
#End Region
    ...
    Private Sub SetUserMgmtNew()
        ''MyBase.SetUserMgmt(clsUserMgtCode.FrmDatewiseMilkStockReport)
    ...
    Private Sub LoadData(ByVal isPrintCrystalReport As Integer)
        Try
            ...
            btnGo.Enabled = False
            Dim dt As DataTable = clsInventoryMovement.GetQtyFatSNFStockGKDT(objFilter)
    ...
    Private Sub print(ByVal exporter As EnumExportTo)
        Try
            ...
            arrHeader.Add("Name : " & clsDBFuncationality.getSingleValue("select program_name from tspl_program_Master where program_cODE='" & clsUserMgtCode.frmDatewiseQtyFatSnfStockReport & "'"))
            If clsCommon.myLen(cboType.Text) > 0 Then
                arrHeader.Add("Report Type : " + cboType.Text)
            End If
            If txtItem.arrValueMember IsNot Nothing AndAlso txtItem.arrValueMember.Count > 0 Then
                arrHeader.Add("Item : " + clsCommon.GetMulcallStringWithComma(txtItem.arrValueMember))
            End If
            If rbtnLocationSelect.IsChecked Then
