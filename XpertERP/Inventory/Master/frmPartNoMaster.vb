...
#End Region
    ...
    Private Function AllowToSave() As Boolean
        Try
            ...
            If clsCommon.myLen(txtPartNo.Value) <= 0 Then
                clsCommon.MyMessageBoxShow(Me, "Fill part no.", Me.Text)
                txtPartNo.Focus()
                txtPartNo.Select()
            ...
            If clsCommon.myLen(txtDesc.Text) <= 0 Then
                clsCommon.MyMessageBoxShow(Me, "Fill description for part no.", Me.Text)
                txtDesc.Focus()
                txtDesc.Select()
    ...
    Private Sub btndelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btndelete.Click
        Try
            If clsCommon.myLen(txtPartNo.Value) <= 0 Then
                clsCommon.MyMessageBoxShow(Me, "Select part no. for deletion.", Me.Text)
                txtPartNo.Focus()
                txtPartNo.Select()
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtPartNo.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtPartNo.Value, "code", "TSPL_PART_NO_MASTER")
        Catch ex As Exception
