...
#Region "Button Click Event"
    ...
    Sub SaveData()
        ...
        Try
            ...
            End If
            If chkSaleLocation.Checked Then
                obj.IsSaleLocation = 1
            Else
                obj.IsSaleLocation = 0
            End If
    ...
    Private Sub funFill()
        Try
            ...
            For Each row As DataRow In dr.Rows
                ...
                chkSaleLocation.Checked = IIf(clsCommon.myCdbl(row("IsSaleLocation")) = 1, True, False)
