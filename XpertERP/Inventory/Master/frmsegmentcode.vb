            ...
            If Not IsDBNull(rdgdvsegmentcode.SelectedRows) Then
                ...
                If clsCommon.myLen(st) > 0 Then
                    ...
                    If (str = 2) Then
                        ...
                        If (str1 <> check) Then
                            common.clsCommon.MyMessageBoxShow(Me, "This Record Cannot be deleted.It is used in another process", Me.Text)
                            Exit Sub
                        End If
                    End If
                    If (str = 3) Then
        ...
        ElseIf rdgdvsegmentcode.Columns.Count = 3 And Not String.IsNullOrEmpty(rdgdvsegmentcode.Rows(0).Cells(2).Value) Then
            If Not IsDBNull(rdgdvsegmentcode.SelectedRows) Then
                ...
                If (str = 2) Then
                    ...
                    check = clsDBFuncationality.getSingleValue(qry)
                    If (str1 <> check) Then
                        common.clsCommon.MyMessageBoxShow("This Record Cannot be deleted.It is used in another process", Me.Text)
                        Exit Sub
                    End If
                End If
                If (str = 3) Then
