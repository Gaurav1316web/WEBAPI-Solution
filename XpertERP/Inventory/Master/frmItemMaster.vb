...
Or (Microsoft.VisualBasic.Asc(e.KeyChar) > 122) Then
    ...
    Public Sub savedata()
        ...
        Next
        If checkyes > 1 Then
            common.clsCommon.MyMessageBoxShow(Me, "Stocking Unit Yes use only one time", Me.Text)
        Else
            ...
            ElseIf father = "N" And child = "Y" Then
                ...
                If String.IsNullOrEmpty(mothercode) Then
                    common.clsCommon.MyMessageBoxShow(Me, "Please make before child code", Me.Text)
                Else
                    funbtninsertupdate()
                End If
            ElseIf father = "Y" And child = "N" Then
                ...
                If String.IsNullOrEmpty(fathercode) Then
                    common.clsCommon.MyMessageBoxShow(Me, "Please make before parent code", Me.Text)
                Else
                    funbtninsertupdate()
                End If
            ...
            ElseIf father = "Y" And child = "Y" Then
                ...
                If String.IsNullOrEmpty(fathercode) Or String.IsNullOrEmpty(mothercode) Then
                    common.clsCommon.MyMessageBoxShow(Me, "Parent and child code for this pack type is not defined", Me.Text)
                Else
                    funbtninsertupdate()
                End If
                Else
    ...
    Private Sub funbtninsertupdate()
        ...
        Dim check As String = ""
        If fndstructurecode1.Value = "" Then
            common.clsCommon.MyMessageBoxShow(Me, "Please Select the structure code", Me.Text)
            fndstructurecode1.Focus()
        ElseIf fndpurchaseaccountset1.Value = "" Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select the Purchase Account Set", Me.Text)
            fndpurchaseaccountset1.Focus()
        ElseIf fndsaleaccountset1.Value = "" Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select the Sale Account set", Me.Text)
            fndsaleaccountset1.Focus()
        ElseIf fndunitofmeasure.Value = "" Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select the Unit Of Measure", Me.Text)
        ...
        Else
            If btnsave1.Text = "Save" Then
                ...
                If Not String.IsNullOrEmpty(check) Then
                    common.clsCommon.MyMessageBoxShow(Me, "Please select all the class Code", Me.Text)
                Else
                    funinsert()
                    funfill()
                End If
    ...
    Private Sub fndItemSubCategory__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles fndItemSubCategory._MYValidating
        If clsCommon.myLen(fndcategory.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please Select 'Item Category' ", Me.Text)
        Else
    ...
    Private Sub txttolerence_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txttolerence.Leave
        If txttolerence.Text <> "" Then
            ...
            If num > 100 Then
                common.clsCommon.MyMessageBoxShow(Me, "Percentage can not be greater then 100", Me.Text)
