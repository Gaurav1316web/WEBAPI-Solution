    ...
    Function AllowToSave() As Boolean
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) Then
            If clsCommon.myLen(TxtCategoryCode.Value) <= 0 Then
                common.clsCommon.MyMessageBoxShow("Please Enter Category Code")
                TxtCategoryCode.Focus()
                Return False
            End If
        End If
            ...
            If (AllowToSave()) Then
                ...
                If (obj.SaveData(obj, isNewEntry)) Then
                    If btnSave.Text = "Save" Then
                        common.clsCommon.MyMessageBoxShow("Data Has Been Saved Successfully")
                    Else
                        common.clsCommon.MyMessageBoxShow("Data Has Been Updated Successfully")
                    End If
