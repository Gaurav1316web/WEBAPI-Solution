...
Public Class frmItemStructure
    ...
    Sub SaveData()
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) Then
            If fndstructurecode.Value = "" Then
                clsCommon.MyMessageBoxShow(Me, "Structure Code cannot be blank", Me.Text)
    ...
    Private Sub funinsert()
        ...
        Try
            ...
            End If
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, fndstructurecode.Value, "TSPL_STRUCTURE_MASTER", "Structure_Code", "TSPL_STRUCTURE_DETAIL", "Structure_Code", trans)
    ...
    Sub DeleteData()
        If fndstructurecode.Value = "" Then
            common.clsCommon.MyMessageBoxShow(Me, "Please enter the Structure Code", Me.Text)
            fndstructurecode.Focus()
        Else
