...
Public Class frmStoreIssue
    ...
    Sub CheckedRequsitionNo(ByVal strCode As String)
        ...
        Else
            qry = ""
            If MOActive = True Then
                qry = " select T1.MO_CODE as [Code],T1.DESCRIPTION as [Description], convert(varchar(12),T1.MO_DATE,103) as [Date], T1.APPROVED_BY as [Approved By]," & _
            ...
            Else
                qry = " select T1.BO_CODE as [Code],T1.DESCRIPTION as [Description], convert(varchar(12),T1.BO_DATE,103) as [Date], T1.APPROVED_BY as [Approved By]," & _
