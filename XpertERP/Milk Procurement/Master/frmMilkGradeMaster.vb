    ...
    Public Function AllowToSave() As Boolean
        Try
            ...
            ElseIf cmbMilkType.SelectedValue = "" Then
                common.clsCommon.MyMessageBoxShow(Me, "Please Enter Grade Type", Me.Text)
                Return False
            End If
            If clsCommon.myLen(txtMilktypeCode.Value) = 0 Then
                common.clsCommon.MyMessageBoxShow(Me, "Please select Milk Type", Me.Text)
                Return False
            End If
            If rbtnSave.Text = "Save" Then
                ...
                If intExist = 1 Then
                    clsCommon.MyMessageBoxShow(Me, "Code already exist for this grade.", Me.Text)
                    Return False
                End If
            End If
                ...
                If clsCommon.myLen(gv.Rows(ii).Cells(colCode).Value) > 0 Then
                    ...
                    If clsCommon.CompairString(nature, "A") = CompairStringResult.Equal Then
                        If clsCommon.myLen(gv.Rows(ii).Cells(colValue1).Value) = 0 Then
                            clsCommon.MyMessageBoxShow(Me, "Please enter Value for parameter " + code, Me.Text)
                            Return False
                        End If
                    End If
                    ...
                    If clsCommon.CompairString(nature, "R") = CompairStringResult.Equal Then
                        If clsCommon.myCdbl(gv.Rows(ii).Cells(colLower).Value) = 0 AndAlso clsCommon.myCdbl(gv.Rows(ii).Cells(colUpper).Value) = 0 Then
                            clsCommon.MyMessageBoxShow(Me, "Please enter Both range for parameter " + code, Me.Text)
                            Return False
                        ElseIf clsCommon.myCdbl(gv.Rows(ii).Cells(colLower).Value) > clsCommon.myCdbl(gv.Rows(ii).Cells(colUpper).Value) Then
                            clsCommon.MyMessageBoxShow(Me, "Lower range should be smaller than upper range for parameter " + code, Me.Text)
                            Return False
                        End If
                    End If
                    ...
                    If clsCommon.CompairString(nature, "B") = CompairStringResult.Equal Then
                        If clsCommon.myLen(gv.Rows(ii).Cells(colStatus).Value) = 0 Then
                            clsCommon.MyMessageBoxShow(Me, "Please select status for parameter " + code, Me.Text)
                            Return False
                        End If
                    End If
                End If
    ...
    Private Function SaveData() As Boolean
        Try
            ...
            If (obj.Arr Is Nothing OrElse obj.Arr.Count <= 0) Then
                common.clsCommon.MyMessageBoxShow(Me, "Please Select at least One parameter", Me.Text)
                Return False
            End If
