    ...
    Function allowToSave() As Boolean
        Try
            ...
            ElseIf clsCommon.myCdbl(txtTareWeight.Text) <= 0 Then
                common.clsCommon.MyMessageBoxShow("Please enter Tare Weight")
                txtTareWeight.Focus()
                Return False
            End If
        ...
        Try
            If (allowToSave()) Then
                ...
                If (obj.Arr Is Nothing OrElse obj.Arr.Count <= 0) Then
                    common.clsCommon.MyMessageBoxShow("Please Fill atleast one Chamber Desc")
                    Return False
                End If

                If (obj.ArrDriver Is Nothing OrElse obj.ArrDriver.Count <= 0) Then
                    common.clsCommon.MyMessageBoxShow("Please select atleast one driver")
                    Return False
                End If
