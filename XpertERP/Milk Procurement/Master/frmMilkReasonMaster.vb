...
Imports common
Public Class frmMilkReasonMaster
        ...
        Try
            If AllowTosave() Then
                ...
                If MyBase.isModifyonPasswordFlag Then
                    If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmMilkReasonMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                    Else
                        Return
                    End If
                End If
    ...
    Private Sub frmMilkReasonMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmMilkReasonMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ';If MyBase.Text = "Training Master" Then
            tb_name = "Tspl_Mcc_Reason_Master"
            'End If
            SetUserMgmtNew()
            isnewentry = True
    ...
    Private Sub SetUserMgmtNew()
        ''MyBase.SetUserMgmt(clsUserMgtCode.frmMilkReasonMaster) 'frmSourceTypeMaster
