...
Public Class frmVLCMappingForMP_PaymentProcess
    ...
    Public Sub SetUserMgmtNew()
        ''MyBase.SetUserMgmt(clsUserMgtCode.VLCMappingForMP_PP)
    ...
    Private Sub txtMCC__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtMCC._MYValidating
        ...
        LoadData(clsCommon.ShowSelectForm("VLCMPA_PaymentProcess", qry, "MCC_Code", whrClas, txtMCC.Value, "MCC_Code", isButtonClicked), NavigatorType.Current)
    End Sub

    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            Dim strMCC As String = ""
            txtVLC.arrValueMember = clsVLCMappingForMP_PaymentProcess.GetData(strCode, NavTyep, strMCC)
            txtMCC.Value = strMCC
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtMCC.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtMCC.Value, "MCC_Code", "TSPL_VLC_MAPPING_FOR_MP_PAYMENT_PROCESS")
        Catch ex As Exception
