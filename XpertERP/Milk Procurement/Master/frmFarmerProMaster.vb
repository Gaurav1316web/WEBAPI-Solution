...
Public Class frmFarmerProMaster
...
#End Region
    ...
    Public Sub Save()
        Try
            If (AllowToSave()) Then
                ...
                End If
                obj.FAT_Range = txtFatRange.Value
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            isInsideLoadData = True
            funReset()
            Dim obj As clsFarmerPro = clsFarmerPro.GetData(strCode, NavTyep)
            If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Code) > 0) Then
                ...
                End If
                txtFatRange.Value = obj.FAT_Range
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsFarmerPro.DeleteData(txtCode.Value)) Then
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_FARMER_PRO where Code ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            txtCode.Value = clsFarmerPro.getFinder("", txtCode.Value, isButtonClicked)
                ...
                If chkInactive.Checked Then
                    If clsCommon.myLen(txtCode.Value) > 0 Then
                        If clsCommon.MyMessageBoxShow("Current code [" + txtCode.Value + "] will be inactive" + Environment.NewLine + "Are you sure?", Me.Text, MessageBoxButtons.YesNo, Telerik.WinControls.RadMessageIcon.Question) = Windows.Forms.DialogResult.Yes Then
                            If (clsFarmerPro.InactiveData(txtCode.Value)) Then
    ...
    Sub PostData()
        Try
            ...
            If (myMessages.postConfirm()) Then
                If (clsFarmerPro.PostData(txtCode.Value)) Then
    ...
    Private Sub RadButton1_Click(sender As Object, e As EventArgs) Handles RadButton1.Click
        Try
            txtCode.Value = clsFarmerPro.getFinder("", txtCode.Value, True)
            If clsCommon.myLen(txtCode.Value) > 0 Then
                LoadData(txtCode.Value, NavigatorType.Current)
                UsLock1.Status = ERPTransactionStatus.Pending
                isNewEntry = True
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "Code", "TSPL_FARMER_PRO")
        Catch ex As Exception
