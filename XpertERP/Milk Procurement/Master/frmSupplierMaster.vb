        ...
        Try
            If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) Then
                 If clsCommon.myLen(fndSupplierCode.Value) = 0 Then
                    common.clsCommon.MyMessageBoxShow(Me, "Please Enter Supplier Code", Me.Text)
                    Return False
                End If
            End If
            If clsCommon.myLen(txtVendorCode.Value) = 0 Then
                common.clsCommon.MyMessageBoxShow(Me, "Please Enter Vendor Code", Me.Text)
                Return False
            End If
            ...
            If check1 = 0 Then
                common.clsCommon.MyMessageBoxShow(Me, "Invalid Vendor Code", Me.Text)
                Return False
            End If
            Return True
        Catch ex As Exception
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(fndSupplierCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(fndSupplierCode.Value, "SUPPLIER_CODE", "TSPL_SUPPLIER_MASTER")
        Catch ex As Exception
