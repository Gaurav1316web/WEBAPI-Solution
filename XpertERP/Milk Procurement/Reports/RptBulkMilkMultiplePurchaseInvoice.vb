...
Public Class RptBulkMilkMultiplePurchaseInvoice
    ...
    Function GetQuery(ByVal frmDate As String, ByVal ToDate As String, ByVal InvoiceNo As String) As String
        ...
        qry += " tspl_Bulk_milk_purchase_Invoice_detail.Net_Weight  as Milk_qty, " & _
               ...
               "tspl_Bulk_milk_purchase_Invoice_detail.NetRate as BasicRate,tspl_Bulk_milk_purchase_Invoice_detail.Fat_KG, tspl_Bulk_milk_purchase_Invoice_detail.SNF_KG, " & _
               ...
               "Account_No,TSPL_WEIGHMENT_CHEMBER_DETAILS.item_code from " & _
