...
Public Class RptVillageSlip
    ...
    Public Sub Load_Report()
        ...
        " left outer join TSPL_MCC_MASTER  on TSPL_MCC_MASTER .MCC_Code =TSPL_MILK_RECEIPT_HEAD .MCC_CODE  left outer join (select TSPL_MILK_SAMPLE_DETAIL.*,milk_receipt_code from TSPL_MILK_SAMPLE_DETAIL inner join TSPL_MILK_SAMPLE_Head on TSPL_MILK_SAMPLE_Head.doc_code= TSPL_MILK_SAMPLE_DETAIL.doc_code ) TSPL_MILK_SAMPLE_DETAIL on TSPL_MILK_SAMPLE_DETAIL.VLC_DOC_CODE =TSPL_MILK_RECEIPT_DETAIL.VLC_DOC_CODE and TSPL_MILK_SAMPLE_DETAIL.Milk_receipt_CODE=TSPL_MILK_RECEIPT_DETAIL.DOC_CODE and TSPL_MILK_RECEIPT_DETAIL.SAMPLE_NO=TSPL_MILK_sample_DETAIL.SAMPLE_NO " & Environment.NewLine & _
        " inner join TSPL_VENDOR_MASTER  on TSPL_VENDOR_MASTER.Form_Type='VSP' and TSPL_MILK_RECEIPT_DETAIL .VSP_CODE =TSPL_VENDOR_MASTER .Vendor_Code" & Environment.NewLine & _
        " left join TSPL_VLC_MASTER_HEAD  on TSPL_VLC_MASTER_HEAD.VLC_Code=TSPL_MILK_RECEIPT_DETAIL.VLC_CODE" & Environment.NewLine & _
        " left join TSPL_mcc_ROUTE_MASTER  on TSPL_mcc_ROUTE_MASTER.Route_code=TSPL_MILK_RECEIPT_DETAIL.route_code left join TSPL_VILLAGE_MASTER vlm on vlm.Village_Code=TSPL_VLC_MASTER_HEAD.Village_Code " & Environment.NewLine & _
