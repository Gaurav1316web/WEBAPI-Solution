...
Imports common
Imports System.IO
'==================created by preeti gupta===Against Ticket No[BM00000007935]
Public Class RptVSPOrVLCVarationReport
    ...
    Private Sub SetUserMgmtNew()
        ''MyBase.SetUserMgmt(clsUserMgtCode.rptVSPOrVLCVarationRpt)
    ...
    Private Sub LoadData()
        ...
        If cbtMCCRouteVLCC.CheckedValue.Count > 0 Then
            ...
            If arr IsNot Nothing AndAlso arr.Count > 0 Then
                qry += "and MCC  IN (" + clsCommon.GetMulcallString(arr) + ") "
            Else
    ...
    Sub print(ByVal exporter As EnumExportTo)
        Try
            ...
            If exporter = EnumExportTo.Excel Then
                clsCommon.MyExportToExcelGrid("VSP Or VLC Varation Report", gv, arrHeader, Me.Text)
            Else
                clsCommon.MyExportToPDF("VSP Or VLC Varation Report", gv, arrHeader, Me.Text, True)
            End If
        Catch ex As Exception
    ...
    Private Sub RptVSPOrVLCVarationReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LOCATIONRIGTHS()
        SetUserMgmtNew()
    ...
    Private Sub RptVSPOrVLCVarationReport_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub btnQuickexport_Click(sender As Object, e As EventArgs) Handles btnQuickexport.Click
        Try
            ...
            arrHeader.Add("Name : " & clsDBFuncationality.getSingleValue("select program_name from tspl_program_Master where program_cODE='" & clsUserMgtCode.rptVSPOrVLCVarationRpt & "'"))
