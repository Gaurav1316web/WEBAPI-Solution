...
Public Class rptMccMasterDetail
    ...
    Sub GetReportID()
        ...
        If clsCommon.CompairString(cmbReportType.SelectedItem.Value, "DCS Full Details") = CompairStringResult.Equal Then
            VarID += "_DFD"
        ElseIf clsCommon.CompairString(cmbReportType.SelectedItem.Value, "MP Details") = CompairStringResult.Equal Then
            VarID += "_MD"
        ElseIf clsCommon.CompairString(cmbReportType.SelectedItem.Value, "Union Wise Jan Aadhar Status") = CompairStringResult.Equal Then
            VarID += "_UWJS"
        ElseIf clsCommon.CompairString(cmbReportType.SelectedItem.Value, "Secretary") = CompairStringResult.Equal Then
            VarID += "_S"
        ElseIf clsCommon.CompairString(cmbReportType.SelectedItem.Value, "Transporter") = CompairStringResult.Equal Then
            VarID += "_T"
        ElseIf clsCommon.CompairString(cmbReportType.SelectedItem.Value, "Employee") = CompairStringResult.Equal Then
            VarID += "_E"
        End If
        Gv1.VarID = VarID
