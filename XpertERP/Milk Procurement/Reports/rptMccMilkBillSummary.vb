...
Public Class RptMccMilkBillSummary
    ...
    Public Sub Load_Report()
        Try
            ...
            " Left Outer Join TSPL_MCC_MASTER On TSPL_MILK_SRN_DETAIL .MCC_CODE = TSPL_MCC_MASTER.MCC_Code " & Environment.NewLine &
