...
Public Class FrmLostDefectSealNo
    ...
    Function AllowToSave() As Boolean
        ...
        If cntSelected = 0 Then
            clsCommon.MyMessageBoxShow(Me, "Please select atleast one seal no")
            Return False
        End If
        Return True
    End Function
        ...
        Try
            ...
            If obj.isNewEntry Then
                ...
                If clsCommon.myLen(obj.DOC_No) <= 0 Then
                    clsCommon.MyMessageBoxShow(Me, "Error In Document No Genertion")
                    Exit Sub
                End If
            Else
    ...
    Private Sub btnGo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGo.Click
        ...
        If Not itmFound Then
            clsCommon.MyMessageBoxShow(Me, "No Item found of type Paper Seal/Manual Seal")
        End If
    End Sub
