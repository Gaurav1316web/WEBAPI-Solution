...
#End Region
    ...
    Sub OpenICodeListCurrentCalaculation(ByVal isButtonClick As Boolean)
        ...
        If clsCommon.CompairString(strItemType, RowTypeItem) = CompairStringResult.Equal Then
            ...
            Dim dr As DataRow = clsCommon.ShowSelectFormForRow("ItemCode", qry)
    ...
    Function AllowToSave() As Boolean
        Try
           ...
           "where TSPL_RECEIPT_HEADER.Posted ='N' and tspl_sd_sale_invoice_head.Trans_Type='MCC' and TSPL_SD_SALE_INVOICE_HEAD.Document_Code='" & txtReqNo.Value & "' for xml path('')),'')  as DocNo ")
            ...
            clsPSInvoiceHead.IsValidCustomer(arrReqNo, txtVendorNo.Value)
    ...
    Private Sub funPrint()
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                frmCrystalReportViewer.funsubreportWithdt(CrystalReportFolder.NewSalesReports, dt, clsERPFuncationality.CompanyAddresShowinFooter(), "crptSaleReturn", "Sales Return", "rptCompanyAddress.rpt")
    ...
    Public Sub funrejprint()
        Try
            ...
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
            frmCrystalReportViewer.funreport(CrystalReportFolder.PurchaseOrder, dt, "rptMRDA", "MRDA Report")
        Catch ex As Exception
            common.clsCommon.MyMessageBoxShow(ex.Message)
        End Try
    End Sub
    ...
    Private Sub UpdateCurrentRow(ByVal IntRowNo As Integer)
        Try
            ...
            If clsCommon.myLen(strICode) > 0 And clsCommon.myCdbl(gv1.Rows(IntRowNo).Cells(ColFOC).Value) = 0 Then
                ...
                'TotalItem_Weight = clsItemMaster.getTotalItemWeight(strICode, gv1.Rows(IntRowNo).Cells(colUnitRate).Value, dblInnerQty, Nothing)
                'TotalItem_WeightMetric = TotalItem_Weight * clsItemMaster.GetWeightConverionFactor(wt_unit, gv1.Rows(IntRowNo).Cells(colBOOK_QTY_UOM).Value, Nothing)
...
#Region "Email SMS Setting"
        ...
        Try
            ...
            If obj.atchmnt = "Y" Then
                ...
                If dt1.Rows.Count > 0 Then
                    ...
                    strRptPath = frmCrystalReportViewer.EmailAttachment(CrystalReportFolder.NewSalesReports, dt1, "crptShipment", "Shipment Detail")
                End If
            End If
            '---------------------------------------------------------------------------
    ...
    Private Sub btnpreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnpreview.Click
        ...
        If dt1 IsNot Nothing AndAlso dt1.Rows.Count > 0 Then
            System.Diagnostics.Process.Start(frmCrystalReportViewer.EmailAttachment(CrystalReportFolder.NewSalesReports, dt1, "crptSaleReturn", "Sales Return"))
        End If
