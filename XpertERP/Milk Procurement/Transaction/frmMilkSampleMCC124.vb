...
Public Class frmMilkSampleMCC124
...
#Region "Variables"
    ...
    Public objSr3 As New clsSerialPort
    Public objSr4 As New clsSerialPort
    ...
    Dim irowIndex_Global_gv3 As Integer = -1
    Dim irowIndex_Global_gv4 As Integer = -1
...
#End Region
    ...
    Private Sub frmMilkReceiptMCC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If GridFontSize < 8 Then
            GridFontSize = 15
        End If
        ''ERO/25/02/19-000496 by balwinder on 26/02/2019
        ...
        If clsCommon.myLen(txtMilkReceiptNo.Tag) > 0 Then
            ...
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                If clsCommon.myLen(txtMilkReceiptNo.Value) > 0 Then
                    ...
                    Load_Receipt_From_Dt(gv3, False)
                    Load_Receipt_From_Dt(gv4, False)
        ...
        CboMachine.SelectedValue = clsMccMaster.DefaultSampleMachine(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)
        cboComPort.SelectedValue = clsMccMaster.DefaultSampleComport(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)

        CboMachine2.SelectedValue = clsMccMaster.DefaultSampleMachine2(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)
        CboComport2.SelectedValue = clsMccMaster.DefaultSampleComport2(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)

        CboMachine3.SelectedValue = clsMccMaster.DefaultSampleMachine3(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)
        CboComport3.SelectedValue = clsMccMaster.DefaultSampleComport3(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)

        CboMachine4.SelectedValue = clsMccMaster.DefaultSampleMachine4(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)
        CboComport4.SelectedValue = clsMccMaster.DefaultSampleComport4(txtMilkReceiptNo.Tag, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue), Nothing, lblDockCode.Text)
        ...
        Try
            ...
            For Each grow As GridViewRowInfo In GGGrid.Rows
                ...
                If grow.Cells(colFAT).Value <= 0 Or grow.Cells(colSNF).Value <= 0 Then
                    Throw New Exception("Please Fill Fat And SNF in all Rows. sample no [" & grow.Index + 1 & "]")
                End If
                ...
                grow.Cells(ColPriceCode).Value = clsEkoPro.getPriceCodeFromUploaderShiftwise(clsCommon.myCdbl(grow.Cells(colFAT).Value), clsCommon.myCdbl(grow.Cells(colSNF).Value), clsCommon.myCstr(txtMilkReceiptNo.Tag), clsCommon.myCstr(grow.Cells(ColVlcCode).Value), IIf(cboShift.SelectedValue.ToString.Contains("M"), "M", "E"), clsCommon.myCDate(dtpDocDate.Value), Nothing, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue))
                grow.Cells(ColRATE).Value = clsEkoPro.getRateFromUploaderShiftWise(clsCommon.myCdbl(grow.Cells(colFAT).Value), clsCommon.myCdbl(grow.Cells(colSNF).Value), clsCommon.myCstr(txtMilkReceiptNo.Tag), clsCommon.myCstr(grow.Cells(ColVlcCode).Value), IIf(cboShift.SelectedValue.ToString.Contains("M"), "M", "E"), clsCommon.myCDate(dtpDocDate.Value), Nothing, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue))
    ...
    Function SaveData_Record(ByVal GGGrid As RadGridView)
        ...
        Try
            isInsideImportData = True
            Dim dtPriceChart As DataTable = clsEkoPro.getPriceCodeDatatableFromUploader(txtMilkReceiptNo.Tag, GGGrid.Rows(0).Cells(ColVlcCode).Value, IIf(cboShift.SelectedValue.ToString.Contains("M"), "M", "E"), clsCommon.myCDate(dtpDocDate.Value), clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue))
            Dim totqty As Double = 0
            Dim totsnf As Double = 0
            Dim totfat As Double = 0
            ...
            For Each grow As GridViewRowInfo In GGGrid.Rows
                If clsCommon.myCdbl(grow.Cells(colFAT).Value) > 0 And clsCommon.myCdbl(grow.Cells(colSNF).Value) > 0 And clsCommon.myCstr(grow.Cells(colSNF).Value) <> "T" Then 'And irowIndex_Global_GGGrid = grow.Index Then
                    If clsCommon.myLen(clsCommon.myCstr(grow.Cells(colSRNo).Value)) > 0 And clsCommon.myLen(clsCommon.myCstr(grow.Cells(ColVlcDocCode).Value)) > 0 Then
                        ...
                        ElseIf GGGrid Is gv3 Then
                            irowIndex_Global_gv3 = grow.Index
                        ElseIf GGGrid Is gv4 Then
                            irowIndex_Global_gv4 = grow.Index
                        End If
                        'If GGGrid Is gv1 Then
                        ...
                        'ElseIf GGGrid Is gv3 Then
                        '    irowIndex_Global_gv3 = -1
                        'ElseIf GGGrid Is gv4 Then
                        '    irowIndex_Global_gv4 = -1
                        'End If
                        If clsCommon.myCdbl(grow.Cells(colPrevFAT).Value) > 0 And ((clsCommon.myCdbl(grow.Cells(colFAT).Value) <> clsCommon.myCdbl(grow.Cells(colPrevFAT).Value)) Or (clsCommon.myCdbl(grow.Cells(colSNF).Value) <> clsCommon.myCdbl(grow.Cells(colPrevSNF).Value))) Then
                            objH = New clsMilkSampleMCCDetailHistory
                            objH.DOC_CODE = txtCode.Value
        ...
        Try
            ...
            For Each grow As GridViewRowInfo In gv.Rows
                ...
                If clsCommon.myLen(clsCommon.myCstr(grow.Cells(colSRNo).Value)) > 0 And clsCommon.myLen(clsCommon.myCstr(grow.Cells(ColVlcDocCode).Value)) > 0 And clsCommon.myLen(clsCommon.myCstr(grow.Cells(colSRN_CODE).Value)) <= 1 Then
                    ...
                    ElseIf clsCommon.CompairString(clsCommon.myCstr(dr(0)("EMP_Type")), "FPSP") = CompairStringResult.Equal Then
                        ...
                        If objSPR IsNot Nothing Then
                            If (objSPR.Std_Percent_FAT <> 0 AndAlso objSPR.Std_Percent_SNF <> 0) Then
                                ...
                                ElseIf clsCommon.CompairString(clsCommon.myCstr(dr(0)("Service_Charge_Type")), "Rate/Ltr") = CompairStringResult.Equal Then
                                    Dim conv_fac As Decimal = clsWeightConversionInfo.GetConversion_factor(obj1.Item_CODE, obj1.UOM, IIf(clsCommon.CompairString(obj1.UOM, "KG") = CompairStringResult.Equal, "LTR", "KG"), Nothing)
                    ...
                    objHeadLoad = clsHeadLoadDCS.GetDcsData(obj1.VlC_Code, clsCommon.myCDate(dtpDocDate.Value), trans)
    ...
    Sub AddNew()
        ...
        objSr2.SetPortNameValues(CboComport2)
        objSr3.SetPortNameValues(CboComport3)
        objSr4.SetPortNameValues(CboComport4)
        ...
        clsPortSetting.GetMachineType(CboMachine3)
        clsPortSetting.GetMachineType(CboMachine4)
    End Sub
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        Try
            ...
            result = result And SaveData(gv3, False)
            result = result And SaveData(gv4, False)
            'If IsShowTwoGrid Then
            '    result = result And SaveData(gv2, False)
            'End If
            If result Then
    ...
    Private Sub btnclose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnclose.Click
        Load_Receipt_From_Dt(gv1, True)
        Load_Receipt_From_Dt(gv2, True)
        Load_Receipt_From_Dt(gv3, True)
        Load_Receipt_From_Dt(gv4, True)
        'If IsShowTwoGrid Then
        '    Load_Receipt_From_Dt(gv2, True)
        'End If
    ...
    Private Sub frmMilkReceiptMCC_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            ...
            ElseIf e.Alt And e.KeyCode = Keys.N Then
                AddNew()
            ElseIf e.KeyCode = Keys.F8 AndAlso e.Alt = False AndAlso e.Control = False Then
                If clsCommon.myCdbl(txtRangeFrom.Text) > 0 And clsCommon.myCdbl(TxtRangeTo.Text) > 0 Then
                    ...
                    'End If
                End If
            ElseIf e.KeyCode = Keys.F2 AndAlso e.Alt = False AndAlso e.Control = False Then
                If gv1.Rows.Count > 0 Then
                    If irowIndex_Global_gv1 < 0 And (clsCommon.myCdbl(gv1.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv1.Rows(0).Cells(colSNF).Value) > 0) Then
                        For Each row As GridViewRowInfo In gv1.Rows
                            If clsCommon.myCdbl(row.Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(row.Cells(colSNF).Value) > 0 Then
                                irowIndex_Global_gv1 += 1
                            Else
                                Exit For
                            End If
                    ...
                    If gv1.Rows.Count > irowIndex_Global_gv1 Then
                        If irowIndex_Global_gv1 >= 0 Then
                            If Math.Abs(clsCommon.myCdbl(LblFATPanel1.Text) - clsCommon.myCdbl(gv1.Rows(irowIndex_Global_gv1).Cells(colFAT).Value)) <= 0.09 And Math.Abs(GetSNFReading(clsCommon.myCdbl(LblSNFPanel1.Text)) - clsCommon.myCdbl(gv1.Rows(irowIndex_Global_gv1).Cells(colSNF).Value)) <= 0.09 Then
                    ...
                    End If
                End If
            ElseIf e.KeyCode = Keys.F4 AndAlso e.Alt = False AndAlso e.Control = False Then
                If gv2.Rows.Count > 0 Then
                    If gv2.Rows.Count > 0 Then
                        ...
                        If gv2.Rows.Count > irowIndex_Global_gv2 Then
                            If irowIndex_Global_gv2 >= 0 Then
                                If Math.Abs(clsCommon.myCdbl(LblFATPanel2.Text) - clsCommon.myCdbl(gv2.Rows(irowIndex_Global_gv2).Cells(colFAT).Value)) <= 0.09 And Math.Abs(GetSNFReading(clsCommon.myCdbl(LblSNFPanel2.Text)) - clsCommon.myCdbl(gv2.Rows(irowIndex_Global_gv2).Cells(colSNF).Value)) <= 0.09 Then
                                    If isStopForRepeatedFATSNF Then
                                        Exit Sub
                                    ElseIf clsCommon.MyMessageBoxShow(Me, "Previous Row have the same reading . Are you sure to Update this in this row ?", "Message", MessageBoxButtons.YesNo, RadMessageIcon.Question, MessageBoxDefaultButton.Button2) = System.Windows.Forms.DialogResult.No Then
                                        Exit Sub
                    ...
                    End If
                End If
            ElseIf e.KeyCode = Keys.F7 AndAlso e.Alt = False AndAlso e.Control = False Then
                If gv3.Rows.Count > 0 Then
                    If gv3.Rows.Count > 0 Then
                        If irowIndex_Global_gv3 < 0 And (clsCommon.myCdbl(gv3.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv3.Rows(0).Cells(colSNF).Value) > 0) Then
                            For Each row As GridViewRowInfo In gv3.Rows
                                If clsCommon.myCdbl(row.Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(row.Cells(colSNF).Value) > 0 Then
                                    irowIndex_Global_gv3 += 1
                                Else
                                    Exit For
                            ...
                            Next
                        End If
                        If gv3.Rows.Count > irowIndex_Global_gv3 Then
                            If irowIndex_Global_gv3 >= 0 Then
                                If Math.Abs(clsCommon.myCdbl(LblFATPanel3.Text) - clsCommon.myCdbl(gv3.Rows(irowIndex_Global_gv3).Cells(colFAT).Value)) <= 0.09 And Math.Abs(GetSNFReading(clsCommon.myCdbl(LblSNFPanel3.Text)) - clsCommon.myCdbl(gv3.Rows(irowIndex_Global_gv3).Cells(colSNF).Value)) <= 0.09 Then
                                    If isStopForRepeatedFATSNF Then
                                        Exit Sub
                                    ElseIf clsCommon.MyMessageBoxShow(Me, "Previous Row have the same reading . Are you sure to Update this in this row ?", "Message", MessageBoxButtons.YesNo, RadMessageIcon.Question, MessageBoxDefaultButton.Button2) = System.Windows.Forms.DialogResult.No Then
                                        Exit Sub
                            ...
                            End If
                            If settMaxFATPerLimit > 0 Then
                                If clsCommon.myCdbl(LblFATPanel3.Text) > settMaxFATPerLimit Then
                                    clsCommon.MyMessageBoxShow(Me, "FAT % Can't be more than " + clsCommon.myCstr(settMaxFATPerLimit), Me.Text, MessageBoxButtons.OK, WinControls.RadMessageIcon.Error)
                                    Exit Sub
                                End If
                            End If
                            If settMaxSNFPerLimit > 0 Then
                                If clsCommon.myCdbl(LblSNFPanel3.Text) > settMaxSNFPerLimit Then
                                    clsCommon.MyMessageBoxShow(Me, "SNF % Can't be more than " + clsCommon.myCstr(settMaxSNFPerLimit), Me.Text, MessageBoxButtons.OK, WinControls.RadMessageIcon.Error)
                                    Exit Sub
                                End If
                            End If
                            Dim objVSP As clsVendorMaster = clsVendorMaster.GetCorrectionVSP(clsCommon.myCstr(gv3.Rows(irowIndex_Global_gv3 + 1).Cells(ColVspCode).Value), Nothing)
                            Dim TempIndx3 As Integer = irowIndex_Global_gv3 + 1
                            gv3.Rows(TempIndx3).Cells(colFATCorrection).Value = objVSP.CorrectionFat
                            gv3.Rows(TempIndx3).Cells(colSNFCorrection).Value = objVSP.CorrectionSNF
                            gv3.Rows(TempIndx3).Cells(colFATOrg).Value = clsCommon.myCdbl(LblFATPanel3.Text)
                            gv3.Rows(TempIndx3).Cells(colSNFOrg).Value = GetSNFReading(clsCommon.myCdbl(LblSNFPanel3.Text))
                            gv3.Rows(TempIndx3).Cells(colFAT).Value = clsCommon.myCdbl(LblFATPanel3.Text) + objVSP.CorrectionFat
                            gv3.Rows(TempIndx3).Cells(colSNF).Value = GetSNFReading(clsCommon.myCdbl(LblSNFPanel3.Text)) + objVSP.CorrectionSNF

                            gv3.Rows(TempIndx3).Cells(COL_IS_MANUAL).Value = "Auto"
                            LblFATPanel3.Text = "00.00"
                            LblSNFPanel3.Text = "00.00"
                            If irowIndex_Global_gv3 <> clsCommon.myCdbl(gv3.Rows.Count - 1) Then
                                If clsCommon.myCdbl(gv3.Rows(TempIndx3).Cells(colFAT).Value) > 0 And clsCommon.myCdbl(gv3.Rows(TempIndx3).Cells(colSNF).Value) > 0 Then
                                    SaveData_Record(gv3)
                                End If
                            End If
                        End If
                    End If
                End If
            ElseIf e.KeyCode = Keys.F9 AndAlso e.Alt = False AndAlso e.Control = False Then
                If gv4.Rows.Count > 0 Then
                    If gv4.Rows.Count > 0 Then
                        If irowIndex_Global_gv4 < 0 And (clsCommon.myCdbl(gv4.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv4.Rows(0).Cells(colSNF).Value) > 0) Then
                            For Each row As GridViewRowInfo In gv4.Rows
                                If clsCommon.myCdbl(row.Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(row.Cells(colSNF).Value) > 0 Then
                                    irowIndex_Global_gv4 += 1
                                Else
                                    Exit For
                            ...
                            Next
                        End If
                        If gv4.Rows.Count > irowIndex_Global_gv4 Then
                            If irowIndex_Global_gv4 >= 0 Then
                                If Math.Abs(clsCommon.myCdbl(LblFATPanel4.Text) - clsCommon.myCdbl(gv4.Rows(irowIndex_Global_gv4).Cells(colFAT).Value)) <= 0.09 And Math.Abs(GetSNFReading(clsCommon.myCdbl(LblSNFPanel4.Text)) - clsCommon.myCdbl(gv4.Rows(irowIndex_Global_gv4).Cells(colSNF).Value)) <= 0.09 Then
                                    If isStopForRepeatedFATSNF Then
                                        Exit Sub
                                    ElseIf clsCommon.MyMessageBoxShow(Me, "Previous Row have the same reading . Are you sure to Update this in this row ?", "Message", MessageBoxButtons.YesNo, RadMessageIcon.Question, MessageBoxDefaultButton.Button2) = System.Windows.Forms.DialogResult.No Then
                                        Exit Sub
                            ...
                            End If
                            If settMaxFATPerLimit > 0 Then
                                If clsCommon.myCdbl(LblFATPanel4.Text) > settMaxFATPerLimit Then
                                    clsCommon.MyMessageBoxShow(Me, "FAT % Can't be more than " + clsCommon.myCstr(settMaxFATPerLimit), Me.Text, MessageBoxButtons.OK, WinControls.RadMessageIcon.Error)
                                    Exit Sub
                                End If
                            End If
                            If settMaxSNFPerLimit > 0 Then
                                If clsCommon.myCdbl(LblSNFPanel4.Text) > settMaxSNFPerLimit Then
                                    clsCommon.MyMessageBoxShow(Me, "SNF % Can't be more than " + clsCommon.myCstr(settMaxSNFPerLimit), Me.Text, MessageBoxButtons.OK, WinControls.RadMessageIcon.Error)
                                    Exit Sub
                                End If
                            End If
                            Dim objVSP As clsVendorMaster = clsVendorMaster.GetCorrectionVSP(clsCommon.myCstr(gv4.Rows(irowIndex_Global_gv4 + 1).Cells(ColVspCode).Value), Nothing)
                            Dim TempIndx4 As Integer = irowIndex_Global_gv4 + 1
                            gv4.Rows(TempIndx4).Cells(colFATCorrection).Value = objVSP.CorrectionFat
                            gv4.Rows(TempIndx4).Cells(colSNFCorrection).Value = objVSP.CorrectionSNF
                            gv4.Rows(TempIndx4).Cells(colFATOrg).Value = clsCommon.myCdbl(LblFATPanel4.Text)
                            gv4.Rows(TempIndx4).Cells(colSNFOrg).Value = GetSNFReading(clsCommon.myCdbl(LblSNFPanel4.Text))
                            gv4.Rows(TempIndx4).Cells(colFAT).Value = clsCommon.myCdbl(LblFATPanel4.Text) + objVSP.CorrectionFat
                            gv4.Rows(TempIndx4).Cells(colSNF).Value = GetSNFReading(clsCommon.myCdbl(LblSNFPanel4.Text)) + objVSP.CorrectionSNF

                            gv4.Rows(TempIndx4).Cells(COL_IS_MANUAL).Value = "Auto"
                            LblFATPanel4.Text = "00.00"
                            LblSNFPanel4.Text = "00.00"
                            If irowIndex_Global_gv4 <> clsCommon.myCdbl(gv4.Rows.Count - 1) Then
                                If clsCommon.myCdbl(gv4.Rows(TempIndx4).Cells(colFAT).Value) > 0 And clsCommon.myCdbl(gv4.Rows(TempIndx4).Cells(colSNF).Value) > 0 Then
                                    SaveData_Record(gv4)
                                End If
                            End If
                        End If
            ...
            If clsCommon.myLen(strMilkReceiptcode) <= 0 Then
                ...
                If (clsMilkSampleMCC.ObjList IsNot Nothing AndAlso clsMilkSampleMCC.ObjList.Count > 0) Then
                    ...
                    For Each obj1 As clsMilkSampleMCCDetail In clsMilkSampleMCC.ObjList
                        If (obj1.SAMPLE_NO Mod 4) = 0 Then
                            gv4.Rows.AddNew()
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colSRNo).Value = obj1.SAMPLE_NO
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColVlcDocCode).Value = obj1.VLC_DOC_CODE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColVlcCode).Value = obj1.VLC_CODE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColSampleNo).Value = obj1.sample_No_Value
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colMilkType).Value = obj1.MILK_TYPE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColType).Value = obj1.TYPE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColVspCode).Value = obj1.VSP_CODE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColItemCode).Value = obj1.ITEm_CODE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColQty).Value = obj1.MILK_Qty
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColMILK_Qty).Value = obj1.ACC_Qty
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colFAT).Value = obj1.FAT
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colSNF).Value = obj1.SNF

                            '=======Added For Save History=======================
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colPrevFAT).Value = obj1.FAT
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colPrevSNF).Value = obj1.SNF
                            If clsCommon.myCdbl(obj1.FAT) > 0 And clsCommon.myCdbl(obj1.SNF) > 0 Then
                                gv4.Rows(gv4.Rows.Count - 1).Cells(colFAT).ReadOnly = True
                                gv4.Rows(gv4.Rows.Count - 1).Cells(colSNF).ReadOnly = True
                            End If
                            '========================================
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colCOR).Value = obj1.Correction_Factor
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colCLR).Value = obj1.CLR
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColRATE).Value = obj1.RATE
                            gv4.Rows(gv4.Rows.Count - 1).Cells(COLAMOUNT).Value = obj1.AMOUNT
                            gv4.Rows(gv4.Rows.Count - 1).Cells(COL_IS_MANUAL).Value = obj1.Is_Entered_Manualy
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColUomCode).Value = obj1.UOM_Code
                            gv4.Rows(gv4.Rows.Count - 1).Cells(ColPriceCode).Value = obj1.Price_Code
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colSRN_CODE).Value = obj1.SRN_CODE

                            gv4.Rows(gv4.Rows.Count - 1).Cells(colFATOrg).Value = obj1.FAT_ORG
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colSNFOrg).Value = obj1.SNF_ORG
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colFATCorrection).Value = obj1.FAT_CORRECTION
                            gv4.Rows(gv4.Rows.Count - 1).Cells(colSNFCorrection).Value = obj1.SNF_CORRECTION
                            'CboEcoPro2.SelectedValue = IIf(obj1.Eco_Pro_Name = "", "0", obj1.Eco_Pro_Name)
                        ElseIf (obj1.SAMPLE_NO Mod 4) = 3 Then
                            gv3.Rows.AddNew()
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colSRNo).Value = obj1.SAMPLE_NO
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColVlcDocCode).Value = obj1.VLC_DOC_CODE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColVlcCode).Value = obj1.VLC_CODE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColSampleNo).Value = obj1.sample_No_Value
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colMilkType).Value = obj1.MILK_TYPE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColType).Value = obj1.TYPE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColVspCode).Value = obj1.VSP_CODE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColItemCode).Value = obj1.ITEm_CODE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColQty).Value = obj1.MILK_Qty
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColMILK_Qty).Value = obj1.ACC_Qty
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colFAT).Value = obj1.FAT
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colSNF).Value = obj1.SNF

                            '=======Added For Save History=======================
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colPrevFAT).Value = obj1.FAT
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colPrevSNF).Value = obj1.SNF
                            If clsCommon.myCdbl(obj1.FAT) > 0 And clsCommon.myCdbl(obj1.SNF) > 0 Then
                                gv3.Rows(gv3.Rows.Count - 1).Cells(colFAT).ReadOnly = True
                                gv3.Rows(gv3.Rows.Count - 1).Cells(colSNF).ReadOnly = True
                            End If
                            '========================================
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colCOR).Value = obj1.Correction_Factor
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colCLR).Value = obj1.CLR
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColRATE).Value = obj1.RATE
                            gv3.Rows(gv3.Rows.Count - 1).Cells(COLAMOUNT).Value = obj1.AMOUNT
                            gv3.Rows(gv3.Rows.Count - 1).Cells(COL_IS_MANUAL).Value = obj1.Is_Entered_Manualy
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColUomCode).Value = obj1.UOM_Code
                            gv3.Rows(gv3.Rows.Count - 1).Cells(ColPriceCode).Value = obj1.Price_Code
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colSRN_CODE).Value = obj1.SRN_CODE

                            gv3.Rows(gv3.Rows.Count - 1).Cells(colFATOrg).Value = obj1.FAT_ORG
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colSNFOrg).Value = obj1.SNF_ORG
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colFATCorrection).Value = obj1.FAT_CORRECTION
                            gv3.Rows(gv3.Rows.Count - 1).Cells(colSNFCorrection).Value = obj1.SNF_CORRECTION
                            'CboEcoPro2.SelectedValue = IIf(obj1.Eco_Pro_Name = "", "0", obj1.Eco_Pro_Name)
                        ElseIf (obj1.SAMPLE_NO Mod 4) = 2 Then
                            gv2.Rows.AddNew()
            ...
            If DtMilkReceiptEcoProWise.Rows.Count > 0 Then
                ...
                Else
                    ...
                    For Each row As DataRow In DtMilkReceiptEcoProWise.Select("" & colECOPro & " ='' and " & colSRNo & ">=" & clsCommon.myCdbl(txtRangeFrom.Text) & " and " & colSRNo & "<=" & clsCommon.myCdbl(TxtRangeTo.Text) & "", "SRNo")
                        'If IsShowTwoGrid Then
                        If gv Is gv4 AndAlso Not clsCommon.myCdbl(row("" & colSRNo & "")) Mod 4 = 0 Then
                            Continue For
                        ElseIf gv Is gv3 AndAlso Not clsCommon.myCdbl(row("" & colSRNo & "")) Mod 4 = 3 Then
                            Continue For
                        ElseIf gv Is gv2 AndAlso Not clsCommon.myCdbl(row("" & colSRNo & "")) Mod 4 = 2 Then
                            Continue For
                        ElseIf gv Is gv1 AndAlso Not clsCommon.myCdbl(row("" & colSRNo & "")) Mod 4 = 1 Then
                            Continue For
                        End If
                        'End If
    ...
    Private Sub fndMCCCode__MYValidating(ByVal sender As Object, ByVal e As System.EventArgs, ByVal isButtonClicked As Boolean) Handles txtMilkReceiptNo._MYValidating, txtMilkReceiptNo._MYValidating
        Try
            ...
            Dim whrcls As String = " TSPL_MILK_RECEIPT_HEAD.Doc_Code in (select Distinct Doc_Code from tspl_Milk_receipt_Detail where coalesce(is_Sampleed,'F')='F') "
            If clsCommon.myLen(lblDockCode.Text) > 0 Then
                whrcls += "  and TSPL_MILK_RECEIPT_HEAD.DOCK_Code='" + lblDockCode.Text + "'"
            End If

            txtMilkReceiptNo.Value = clsCommon.ShowSelectForm("MRFND", sQuery, "Code", whrcls, "", "Code", isButtonClicked)
    ...
    Private Sub ReStoreGridLayout()
        Try
            ...
            If Not obj Is Nothing Then
                If obj.GridColumns >= gv1.ColumnCount Then
                    Dim ii As Integer
                ...
                End If
                If obj.GridColumns >= gv2.ColumnCount Then
                    Dim ii As Integer
                ...
                End If
                If obj.GridColumns >= gv3.ColumnCount Then
                    Dim ii As Integer
                ...
                End If
                If obj.GridColumns >= gv4.ColumnCount Then
                    Dim ii As Integer
                    For ii = 0 To gv4.Columns.Count - 1 Step ii + 1
                        gv4.Columns(ii).IsVisible = False
                        gv4.Columns(ii).VisibleInColumnChooser = True
                    Next
                    gv4.LoadLayout(obj.GridLayout)
                End If
    ...
    Private Sub Timer3_Start()
        Try
            Dim obj As clsPortSetting = clsPortSetting.getData(0, CboMachine3.Text) ' 0 for Milk analyzer and 1 for weighing machine,
            If obj Is Nothing Then
                Throw New Exception("No setting found for device")
            End If
            objSr3.BaudRate = obj.baud_rate
            objSr3.Parity = obj.parity
            objSr3.PortName = CboComport3.Text
            objSr3.StopBits = obj.stop_bits
            objSr3.DataBits = obj.data_bits
            objSr3.DataForm = clsPortSetting.getMachineDataFormat(CboMachine3.Text)
            objSr3.isEkoProMachine = True
            objSr3.isWeighingMachine = False
            objSr3._LblFat = LblFATPanel3
            objSr3._LblSNF = LblSNFPanel3
            objSr3._LblWeight = Nothing
            objSr3.isEco2 = True
            objSr3.MachineName = clsPortSetting.getMachineMakePrefix(CboMachine3.Text, 0)
            objSr3.OpenPort()
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    Private Sub Timer4_Start()
        Try
            Dim obj As clsPortSetting = clsPortSetting.getData(0, CboMachine4.Text) ' 0 for Milk analyzer and 1 for weighing machine,
            If obj Is Nothing Then
                Throw New Exception("No setting found for device")
            End If
            objSr4.BaudRate = obj.baud_rate
            objSr4.Parity = obj.parity
            objSr4.PortName = CboComport4.Text
            objSr4.StopBits = obj.stop_bits
            objSr4.DataBits = obj.data_bits
            objSr4.DataForm = clsPortSetting.getMachineDataFormat(CboMachine4.Text)
            objSr4.isEkoProMachine = True
            objSr4.isWeighingMachine = False
            objSr4._LblFat = LblFATPanel4
            objSr4._LblSNF = LblSNFPanel4
            objSr4._LblWeight = Nothing
            objSr4.isEco2 = True
            objSr4.MachineName = clsPortSetting.getMachineMakePrefix(CboMachine4.Text, 0)
            objSr4.OpenPort()
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    Private Sub BtnStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnStart.Click
        Try
            If clsCommon.CompairString(BtnStart.Text, "Start") = CompairStringResult.Equal Then
                If ((clsCommon.CompairString(BtnStart2.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(cboComPort.Text, CboComport2.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart3.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(cboComPort.Text, CboComport3.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart4.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(cboComPort.Text, CboComport4.Text) = CompairStringResult.Equal)) Then
    ...
    Private Sub BtnStart2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnStart2.Click
        Try
            If clsCommon.CompairString(BtnStart2.Text, "Start") = CompairStringResult.Equal Then
                If ((clsCommon.CompairString(BtnStart.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport2.Text, cboComPort.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart3.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport2.Text, CboComport3.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart4.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport2.Text, CboComport4.Text) = CompairStringResult.Equal)) Then
                    Throw New Exception("This port is in use. choose another port")
                End If
                Timer2_Start()
    ...
    Private Sub BtnStart3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnStart3.Click
        Try
            If clsCommon.CompairString(BtnStart3.Text, "Start") = CompairStringResult.Equal Then
                If ((clsCommon.CompairString(BtnStart.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport3.Text, cboComPort.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart2.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport3.Text, CboComport2.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart4.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport3.Text, CboComport4.Text) = CompairStringResult.Equal)) Then
                    Throw New Exception("This port is in use. choose another port")
                End If
                Timer3_Start()
                CboComport3.Enabled = False
                CboMachine3.Enabled = False
                BtnStart3.Text = "Stop"
            Else
                BtnStart3.Text = "Start"
                CboComport3.Enabled = True
                CboMachine3.Enabled = True
                LblFATPanel3.Text = "00.00"
                LblSNFPanel3.Text = "00.00"
                objSr3.ClosePort()
            End If
    ...
    Private Sub BtnStart4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnStart4.Click
        Try
            If clsCommon.CompairString(BtnStart4.Text, "Start") = CompairStringResult.Equal Then
                If ((clsCommon.CompairString(BtnStart.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport4.Text, cboComPort.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart2.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport4.Text, CboComport2.Text) = CompairStringResult.Equal) _
                    OrElse (clsCommon.CompairString(BtnStart3.Text, "Stop") = CompairStringResult.Equal And clsCommon.CompairString(CboComport4.Text, CboComport3.Text) = CompairStringResult.Equal)) Then
                    Throw New Exception("This port is in use. choose another port")
                End If
                Timer4_Start()
                CboComport4.Enabled = False
                CboMachine4.Enabled = False
                BtnStart4.Text = "Stop"
            Else
                BtnStart4.Text = "Start"
                CboComport4.Enabled = True
                CboMachine4.Enabled = True
                LblFATPanel4.Text = "00.00"
                LblSNFPanel4.Text = "00.00"
                objSr4.ClosePort()
            End If
    ...
    Private Sub gv3_CellFormatting(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.CellFormattingEventArgs) Handles gv3.CellFormatting
        CellFormatNew(gv3, e)
    End Sub

    Private Sub gv4_CellFormatting(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.CellFormattingEventArgs) Handles gv4.CellFormatting
        CellFormatNew(gv4, e)
    End Sub
    ...
    Private Sub gv3_CellValidating(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.CellValidatingEventArgs) Handles gv3.CellValidating
        CellValidatingNew(gv3, e)
    End Sub

    Private Sub gv4_CellValidating(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.CellValidatingEventArgs) Handles gv4.CellValidating
        CellValidatingNew(gv4, e)
    End Sub
    ...
    Private Sub gv3_CellValueChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.GridViewCellEventArgs) Handles gv3.CellValueChanged
        CellValueChangedNew(gv3, e)
    End Sub

    Private Sub gv4_CellValueChanged(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.GridViewCellEventArgs) Handles gv4.CellValueChanged
        CellValueChangedNew(gv4, e)
    End Sub
    ...
    Private Sub gv3_UserDeletingRow(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.GridViewRowCancelEventArgs) Handles gv3.UserDeletingRow
        Try
            If clsCommon.MyMessageBoxShow(Me, "Do You want to delete this Row Permanently . Are You Sure ?", "Delete Row", MessageBoxButtons.YesNo) = System.Windows.Forms.DialogResult.Yes Then
                Dim sQuery As String = "delete from TSPL_MILK_SAMPLE_DETAIL where DOC_Code='" & gv3.CurrentRow.Cells("DOC CODE").Value & "' and VLC_DOC_Code='" & gv3.CurrentRow.Cells("VLC DOC CODE").Value & "'"
                clsDBFuncationality.ExecuteNonQuery(sQuery)
            Else
                e.Cancel = True
            End If
    ...
    Private Sub gv4_UserDeletingRow(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.GridViewRowCancelEventArgs) Handles gv4.UserDeletingRow
        Try
            If clsCommon.MyMessageBoxShow(Me, "Do You want to delete this Row Permanently . Are You Sure ?", "Delete Row", MessageBoxButtons.YesNo) = System.Windows.Forms.DialogResult.Yes Then
                Dim sQuery As String = "delete from TSPL_MILK_SAMPLE_DETAIL where DOC_Code='" & gv4.CurrentRow.Cells("DOC CODE").Value & "' and VLC_DOC_Code='" & gv4.CurrentRow.Cells("VLC DOC CODE").Value & "'"
                clsDBFuncationality.ExecuteNonQuery(sQuery)
            Else
                e.Cancel = True
            End If
                        ...
                        If gv1.Rows.Count > 0 Then
                            For Each row As GridViewRowInfo In gv1.Rows
                                If row.Cells(colSRNo).Value = strCode Then
                                    ...
                                    row.Cells(ColRATE).Value = clsEkoPro.getRateFromUploaderShiftWise(clsCommon.myCdbl(row.Cells(colFAT).Value), clsCommon.myCdbl(row.Cells(colSNF).Value), clsCommon.myCstr(txtMilkReceiptNo.Tag), clsCommon.myCstr(row.Cells(ColVlcCode).Value), IIf(cboShift.SelectedValue.ToString.Contains("M"), "M", "E"), clsCommon.myCDate(dtpDocDate.Value), Nothing, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue))
                                    row.Cells(ColPriceCode).Value = clsEkoPro.getPriceCodeFromUploaderShiftwise(clsCommon.myCdbl(row.Cells(colFAT).Value), clsCommon.myCdbl(row.Cells(colSNF).Value), clsCommon.myCstr(txtMilkReceiptNo.Tag), clsCommon.myCstr(row.Cells(ColVlcCode).Value), IIf(cboShift.SelectedValue.ToString.Contains("M"), "M", "E"), clsCommon.myCDate(dtpDocDate.Value), Nothing, clsCommon.myCstr(cboDockCollectionMilkType.SelectedValue))
...
a:              Next
    ...
    Private Sub MyNumBox4_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox4.TextChanged
        LblFATPanel2.Text = clsCommon.myCstr(MyNumBox4.Value)
    End Sub

    Private Sub MyNumBox3_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox3.TextChanged
        LblSNFPanel2.Text = clsCommon.myCstr(GetSNFReading(MyNumBox3.Value))
    End Sub

    Private Sub MyNumBox8_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox8.TextChanged
        LblFATPanel3.Text = clsCommon.myCstr(MyNumBox8.Value)
    End Sub

    Private Sub MyNumBox7_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox7.TextChanged
        LblSNFPanel3.Text = clsCommon.myCstr(GetSNFReading(MyNumBox7.Value))
    End Sub

    Private Sub MyNumBox10_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox10.TextChanged
        LblFATPanel4.Text = clsCommon.myCstr(MyNumBox10.Value)
    End Sub

    Private Sub MyNumBox9_TextChanged(sender As Object, e As EventArgs) Handles MyNumBox9.TextChanged
        LblSNFPanel4.Text = clsCommon.myCstr(GetSNFReading(MyNumBox9.Value))
    End Sub

    Private Sub MyLabel5_DoubleClick(sender As Object, e As EventArgs) Handles MyLabel8.DoubleClick
        ...
        If SettMaintainLogForImporperSample Then
            If clsCommon.myLen(txtCode.Value) > 0 Then
                ...
                If irowIndex_Global_gv1 < 0 And (clsCommon.myCdbl(gv1.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv1.Rows(0).Cells(colSNF).Value) > 0) Then
                    ...
                    Next
                Else
                    obj.Sample_No = irowIndex_Global_gv1 + 2
                End If
                obj.Sample_Code = txtCode.Value
                obj.Dock_Code = lblDockCode.Text
                obj.FAT = LblFATPanel1.Text
                obj.SNF = LblSNFPanel1.Text
                obj.SaveData(obj)
                obj = Nothing
            End If
        End If
        ...
        If SettMaintainLogForImporperSample Then
            If clsCommon.myLen(txtCode.Value) > 0 Then
                ...
                If irowIndex_Global_gv2 < 0 And (clsCommon.myCdbl(gv2.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv2.Rows(0).Cells(colSNF).Value) > 0) Then
                    ...
                    Next
                Else
                    obj.Sample_No = irowIndex_Global_gv2 + 2
                End If
                obj.Sample_No = (obj.Sample_No * 2)
                obj.Sample_Code = txtCode.Value
                obj.Dock_Code = lblDockCode.Text
                obj.FAT = clsCommon.myCdbl(LblFATPanel2.Text)
                obj.SNF = clsCommon.myCdbl(LblSNFPanel2.Text)
                obj.SaveData(obj)
                obj = Nothing
            End If
        End If
    ...
    Private Sub LblSNFPanel3_TextChanged(sender As Object, e As EventArgs) Handles LblSNFPanel3.TextChanged
        If SettMaintainLogForImporperSample Then
            If clsCommon.myLen(txtCode.Value) > 0 Then
                Dim obj As New clsMilkSampleReadingLog
                obj.Sample_No = 1
                If irowIndex_Global_gv3 < 0 And (clsCommon.myCdbl(gv3.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv3.Rows(0).Cells(colSNF).Value) > 0) Then
                    ...
                    Next
                Else
                    obj.Sample_No = irowIndex_Global_gv3 + 2
                End If

                obj.Sample_No = (obj.Sample_No * 3)
    ...
    Private Sub LblSNFPanel4_TextChanged(sender As Object, e As EventArgs) Handles LblSNFPanel4.TextChanged
        If SettMaintainLogForImporperSample Then
            If clsCommon.myLen(txtCode.Value) > 0 Then
                Dim obj As New clsMilkSampleReadingLog
                obj.Sample_No = 1
                If irowIndex_Global_gv4 < 0 And (clsCommon.myCdbl(gv4.Rows(0).Cells(colFAT).Value) > 0 Or clsCommon.myCdbl(gv4.Rows(0).Cells(colSNF).Value) > 0) Then
                    ...
                    Next
                Else
                    obj.Sample_No = irowIndex_Global_gv4 + 2
                End If

                obj.Sample_No = (obj.Sample_No * 4)
