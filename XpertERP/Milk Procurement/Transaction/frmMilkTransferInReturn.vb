...
Public Class frmMilkTransferInReturn
    ...
    Private Sub FrmMilkTransferIn_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        coll.Add("JWO_Transfer_No", "Varchar(30) not null References TSPL_MILK_JOBWORK_TRANSFER_HEAD(Document_Code)")
        coll.Add("Remarks", "varchar(100) NULL")
        coll.Add("SRN_Return_NO", "Varchar(30)  null References TSPL_Bulk_Milk_SRN_Return(SRN_Return_NO)")
        coll.Add("MilkTransRetNo", "Varchar(30)  null References TSPL_MILK_TRANSFER_IN_RETURN(Receipt_Challan_Return_No)")
        coll.Add("Created_By", "varchar(12) NOT NULL")
        coll.Add("Created_Date", "Datetime NOT NULL")
        clsCommonFunctionality.CreateOrAlterTable("TSPL_MILK_JOBWORK_TRANSFER_RETURN", coll)

        coll = New Dictionary(Of String, String)
        coll.Add("Doc_Type", "varchar(20)  NULL ")  'It Will Hold Doc Type  as Bulk Procurement(BulkProc) or Mcc Procurment(MccProc)
        clsCommonFunctionality.CreateOrAlterTable("TSPL_MILK_JOBWORK_TRANSFER_HEAD", coll)
