...
left join TSPL_MCC_SCRAP_GATEPASS_DETAIL on TSPL_MCC_SCRAP_GATEPASS_DETAIL.GPCode=TSPL_MCC_SCRAP_ROUTE_GATEPASS_DETAIL.GPCode LEFT OUTER JOIN TSPL_BULK_ROUTE_MASTER ON TSPL_BULK_ROUTE_MASTER.ROUTE_NO=TSPL_MCC_SCRAP_ROUTE_GATEPASS_DETAIL.ROUTE_NO  where TSPL_MCC_SCRAP_GATEPASS_DETAIL.GPCode='" + strGPCOde + "' )pppp "
    ...
    Private Function GetAttachQry(ByVal StrCode As String) As String
        ...
        Qry += " ,TSPL_MCC_SCRAP_GATEPASS_MASTER.Vehicle_Id as vehicle_id,TSPL_MCC_SCRAP_GATEPASS_MASTER.Vehicle_Number as VehicleDesc,TSPL_MCC_SCRAP_GATEPASS_MASTER.Driver_Name,TSPL_MCC_SCRAP_GATEPASS_MASTER.location_code,tspl_location_master.Location_desc,TSPL_MCC_SCRAP_GATEPASS_MASTER.remarks,TSPL_MCC_SCRAP_GATEPASS_MASTER.comments,TSPL_MCC_SCRAP_GATEPASS_MASTER.post,TSPL_MCC_SCRAP_GATEPASS_DETAIL.Item_code,tspl_item_master.item_desc,tspl_item_master.short_description,tspl_item_master.sku_seq,TSPL_MCC_SCRAP_GATEPASS_DETAIL.HSN_Code,VLC_Code_Address.VLC_Code,VLC_Code_Address.VLC_Address "
        ...
        Qry += "  Left Outer Join (Select TSPL_SD_SHIPMENT_HEAD.Document_Code,tspl_vlc_master_head.vlc_code_vlc_uploader As VLC_Code,
 Concat(TSPL_VENDOR_MASTER.Add1,TSPL_VENDOR_MASTER.Add2,TSPL_VENDOR_MASTER.Add3) As VLC_Address from TSPL_SD_SHIPMENT_HEAD 
 ...
 LEFT OUTER JOIN tspl_vlc_master_head ON tspl_customer_vendor_mapping.Vendor_Code =tspl_vlc_master_head.vsp_code 
 Left Outer Join TSPL_VENDOR_MASTER On TSPL_VENDOR_MASTER.Vendor_Code=tspl_vlc_master_head.vsp_code 
 where TSPL_SD_SHIPMENT_HEAD.Document_COde In (" & clsCommon.GetMulcallString(txtmultiBooking.arrValueMember) & ")
	) As VLC_Code_Address On VLC_Code_Address.Document_COde  In (" & clsCommon.GetMulcallString(txtmultiBooking.arrValueMember) & ") "
