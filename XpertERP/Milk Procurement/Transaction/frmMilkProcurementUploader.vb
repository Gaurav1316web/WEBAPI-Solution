...
#End Region
    ...
    Private Sub txtDocNo__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtDocNo._MYValidating
        Try
            ...
            whrcls = " final.[MCC Code] in (" & clsCommon.GetMulcallString(arrMCC) & ")"
...
"
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            LoadBlankGrid()
            Dim Whr As String = " and   TSPL_MILK_PROCUREMENT_UPLOADER_HEAD.MCC_Code in (" + clsCommon.GetMulcallString(arrMCC) + ")   "
            Dim obj As New clsMilkProcurementUploaderHead()
