...
#End Region
    ...
    Private Sub txtDocNo__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtDocNo._MYValidating
        ...
        txtDocNo.Value = clsCommon.ShowSelectForm("QCSecondarysetting", qry, "Code", " TSPL_SECONDARY_SETTING_QC_HEAD.Location_Code in (" + arrLoc + ")", txtDocNo.Value, "", isButtonClicked)
        LoadData(txtDocNo.Value, NavigatorType.Current)
        qry = Nothing
    End Sub
    ...
    Private Sub btnReverse_Click(sender As Object, e As EventArgs) Handles btnReverse.Click
        Try
            If common.clsCommon.MyMessageBoxShow("Reverse and Unpost the Current Document" + Environment.NewLine + "Are you sure", Me.Text, MessageBoxButtons.YesNo) = System.Windows.Forms.DialogResult.Yes Then
                If ClsSecondarySettingForQC.ReverseAndUnpost(txtDocNo.Value) Then
