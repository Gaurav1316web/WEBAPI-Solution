...
Public Class FrmPrefixImport
    ...
    Private Sub btnBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse.Click
        Try
            ...
            gv1.Rows.Clear()
            gv1.Columns.Clear()
            transportSql.importExcel(gv1, "Doc_Type", "Doc_Trans_Type", "Location_Code", "Doc_Prfeix", "Next_Number", "Separator", "Is_Change_Monthly", "Curr_Month", "Is_Change_Daily", "Curr_Date", "dontDisplayYearInSeries", "MinSizeofSeries", "Year_Separator")
                ...
                If gv1.Rows.Count > 0 Then
                    ...
                    For ii As Integer = 0 To gv1.RowCount - 1
                        ...
                        If clsCommon.myCdbl(gv1.Rows(ii).Cells("IsOK").Value) = 1 Then
                            ...
                            If clsCommon.myLen(obj.Doc_Prfeix) > 0 Then
                                Dim qry As String = "select 1 from TSPL_DOCPREFIX_MASTER where 2=2 and  Doc_Type= '" + obj.Doc_Type + "' and Fin_Year='" + clsCommon.myCstr(clsCommon.myCdbl(cboFiscalYear.SelectedValue)) + "' and Doc_Trans_Type=ISNULL('" + obj.Doc_Trans_Type + "','')  and Location_Code=isnull('" + obj.Location_Code + "','')"
                    ...
                    Try
                        For ii As Integer = 0 To dictionary.Keys.Count - 1
                            ...
                            clsDocPrefix.SaveData(dictionary(strKey).Item(0).Doc_Type, Convert.ToInt32(clsCommon.myCdbl(cboFiscalYear.SelectedValue)), dictionary(strKey), trans)
                        Next
                        trans.Commit()
                    Catch ex As Exception
                        trans.Rollback()
