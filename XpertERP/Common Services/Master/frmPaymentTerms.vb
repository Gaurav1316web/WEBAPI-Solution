...
#End Region
    ...
    Private Sub RadMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadMenuItem2.Click
        ''richa Ticket No.BM00000003438 on 20/08/2014
        sql = "Select Terms_Code as [Terms Code],Terms_Desc as [Terms Desc],No_Days as [No Days],LCRequired as [LC Required] from TSPL_TERMS_MASTER"
    ...
    Private Sub RadMenuItem3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadMenuItem3.Click
        ...
        Me.Controls.Add(gv)
        ''richa Ticket No.BM00000003438 on 20/08/2014
        If transportSql.importExcel(gv, "Terms Code", "Terms Desc", "No Days", "LC Required") Then
    ...
    Private Sub LoadData()
        Try
            Dim termscode As String = clsDBFuncationality.getSingleValue("select * from TSPL_TERMS_MASTER where [Terms_Code] ='" + fnd_termscode.Value + "'")
            Dim terms_code As String = ""
            If clsCommon.myLen(termscode) > 0 Then
                terms_code = termscode
