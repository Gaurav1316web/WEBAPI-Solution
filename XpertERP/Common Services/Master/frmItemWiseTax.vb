...
#End Region
    ...
    Sub LoadBlankGrid1()
        ...
        'repoTax1_Code.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        repoTax1_Rate.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        'repoTax2_Code.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        repoTax2_Rate.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        'repoTax3_Code.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        repoTax3_Rate.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        'repoTax4_Code.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        repoTax4_Rate.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        'repoTax5_Code.HeaderImage = Global.ERP.My.Resources.Resources.search4
        ...
        repoTax5_Rate.HeaderImage = Global.ERP.My.Resources.Resources.search4
                ...
                If isNewEntry = True Then
                    If clsCommon.myLen(strItemCode) > 0 Then
                        ...
                        If strCountDupicate > 0 Then
                            Dim Msg As String = " Item already Exist another Document .Duplicate Entery not Possible Same Day  at Row No " + clsCommon.myCstr(ii + 1) + " "
                            common.clsCommon.MyMessageBoxShow(Msg)
                            Return False
                        End If
                    End If
                    ...
                    If clsCommon.myLen(strItemCode) > 0 Then
                        ...
                        If clsCommon.myLen(strDocCode) > 0 Then
                            If clsCommon.CompairString(strDocCode, fndCode.Value) <> CompairStringResult.Equal Then
                                Dim Msg As String = " Item already Exist another Document : '" + strDocCode + "'.Duplicate Entery not Possible Same Day  at Row No " + clsCommon.myCstr(ii + 1) + " "
                                common.clsCommon.MyMessageBoxShow(Msg)
                                Return False
                            End If
                        End If
    ...
    Private Sub RadMenuItem2_Click(sender As Object, e As EventArgs) Handles RadMenuItem2.Click
        'Try
        '    Dim query As String = " select TSPL_ITEM_WISE_TAX_HEAD.DOC_CODE,Convert(varchar, TSPL_ITEM_WISE_TAX_HEAD.DOC_DATE,103) as Start_Date ,TSPL_ITEM_WISE_TAX_HEAD.Tax_Group_Type as Transaction_Type, TSPL_ITEM_WISE_TAX_DETAILS.Item_Code ,TSPL_ITEM_MASTER.Item_Desc,TSPL_ITEM_MASTER.HSN_Code ,TSPL_ITEM_WISE_TAX_DETAILS.Tax_Group_Code,TSPL_TAX_GROUP_MASTER.Tax_Group_Desc,TSPL_ITEM_WISE_TAX_DETAILS.Tax1_Code,convert(varchar, TSPL_ITEM_WISE_TAX_DETAILS.TAX1_Rate) as TAX1_Rate,TSPL_ITEM_WISE_TAX_DETAILS.Tax2_Code,convert(varchar, TSPL_ITEM_WISE_TAX_DETAILS.TAX2_Rate) as TAX2_Rate,TSPL_ITEM_WISE_TAX_DETAILS.Tax3_Code,convert (varchar,TSPL_ITEM_WISE_TAX_DETAILS.TAX3_Rate) as TAX3_Rate,TSPL_ITEM_WISE_TAX_DETAILS.Tax4_Code,convert ( varchar,TSPL_ITEM_WISE_TAX_DETAILS.TAX4_Rate) as TAX4_Rate,TSPL_ITEM_WISE_TAX_DETAILS.Tax5_Code, convert(varchar, TSPL_ITEM_WISE_TAX_DETAILS.TAX5_Rate) as TAX5_Rate  from TSPL_ITEM_WISE_TAX_HEAD left outer join TSPL_ITEM_WISE_TAX_DETAILS on TSPL_ITEM_WISE_TAX_HEAD.Doc_Code = TSPL_ITEM_WISE_TAX_DETAILS.Doc_Code  left outer join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER.Item_Code =TSPL_ITEM_WISE_TAX_DETAILS.Item_Code left outer join TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_ITEM_WISE_TAX_DETAILS.Tax_Group_Code and TSPL_TAX_GROUP_MASTER.Tax_Group_Type=TSPL_ITEM_WISE_TAX_HEAD.Tax_Group_Type "
    ...
    Private Sub RadMenuItem3_Click(sender As Object, e As EventArgs) Handles RadMenuItem3.Click
        ...
        'Me.Controls.Add(dgv)
        'Try
        '    If transportSql.importExcel(dgv, "Item_Code", "Item_Desc", "HSN_Code", "Tax_Group_Code", "Tax_Group_Desc", "Tax1_Code", "TAX1_Rate", "Tax2_Code", "TAX2_Rate", "Tax3_Code", "TAX3_Rate", "Tax4_Code", "TAX4_Rate", "Tax5_Code", "TAX5_Rate") Then
    ...
    Private Sub RadMenuItem4_Click(sender As Object, e As EventArgs) Handles RadMenuItem4.Click
        ...
        '    Dim query As String = "Select TSPL_ITEM_WISE_TAX_DETAILS.Item_Code,TSPL_ITEM_MASTER.Item_Desc as Item_Desc,TSPL_ITEM_MASTER.HSN_code as HSN_Code, Tax_Group_Code,'' as Tax_Group_Desc, Tax1_Code, TAX1_Rate,Tax2_Code, TAX2_Rate, Tax3_Code,TAX3_Rate, Tax4_Code, TAX4_Rate, Tax5_Code, TAX5_Rate from TSPL_ITEM_WISE_TAX_DETAILS left outer join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER.Item_Code=TSPL_ITEM_WISE_TAX_DETAILS.Item_Code "
        '    Dim wher As String = " and DOC_CODE='" + fndCode.Value + "'"
