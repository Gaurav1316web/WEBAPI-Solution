...
Imports System.IO
Public Class frmCombineDashBord
    ...
    Sub View(ByRef GridName As RadGridView)
        ...
        If GridName.Rows.Count > 0 Then
            ...
            view.ColumnGroups(0).Rows(0).Columns.Add(GridName.Columns("Item"))

            view.ColumnGroups.Add(New GridViewColumnGroup("Quantity In Ltr"))
            view.ColumnGroups(1).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(1).Rows(0).Columns.Add(GridName.Columns("Quantity In Ltr"))
            view.ColumnGroups(1).Rows(0).Columns.Add(GridName.Columns("Scheme Quantity In Ltr"))
            view.ColumnGroups(1).Rows(0).Columns.Add(GridName.Columns("Sample Quantity In Ltr"))

            view.ColumnGroups.Add(New GridViewColumnGroup("Quantity In Kg"))
            view.ColumnGroups(2).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(2).Rows(0).Columns.Add(GridName.Columns("Quantity In Kg"))
            view.ColumnGroups(2).Rows(0).Columns.Add(GridName.Columns("Scheme Quantity In Kg"))
            view.ColumnGroups(2).Rows(0).Columns.Add(GridName.Columns("Sample Quantity In Kg"))

            view.ColumnGroups.Add(New GridViewColumnGroup("FAT KG"))
            view.ColumnGroups(3).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(3).Rows(0).Columns.Add(GridName.Columns("FAT KG"))
            view.ColumnGroups(3).Rows(0).Columns.Add(GridName.Columns("Scheme FAT KG"))
            view.ColumnGroups(3).Rows(0).Columns.Add(GridName.Columns("Sample FAT KG"))

            view.ColumnGroups.Add(New GridViewColumnGroup("SNF KG"))
            view.ColumnGroups(4).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(4).Rows(0).Columns.Add(GridName.Columns("SNF KG"))
            view.ColumnGroups(4).Rows(0).Columns.Add(GridName.Columns("Scheme SNF KG"))
            view.ColumnGroups(4).Rows(0).Columns.Add(GridName.Columns("Sample SNF KG"))

            view.ColumnGroups.Add(New GridViewColumnGroup("Sale Amount"))
            view.ColumnGroups(5).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(5).Rows(0).Columns.Add(GridName.Columns("Sale Amount"))
            view.ColumnGroups(5).Rows(0).Columns.Add(GridName.Columns("Scheme Sale Amount"))
            view.ColumnGroups(5).Rows(0).Columns.Add(GridName.Columns("Sample Sale Amount"))

            view.ColumnGroups.Add(New GridViewColumnGroup("Ave Realisa Per Ltr"))
            view.ColumnGroups(6).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(6).Rows(0).Columns.Add(GridName.Columns("Ave Realisa Per Ltr"))
            view.ColumnGroups(6).Rows(0).Columns.Add(GridName.Columns("Scheme Ave Realisa Per Ltr"))
            view.ColumnGroups(6).Rows(0).Columns.Add(GridName.Columns("Sample Ave Realisa Per Ltr"))

            view.ColumnGroups.Add(New GridViewColumnGroup("Ave Realisa Per Kg"))
            view.ColumnGroups(7).Rows.Add(New GridViewColumnGroupRow())
            view.ColumnGroups(7).Rows(0).Columns.Add(GridName.Columns("Ave Realisa Per Kg"))
            view.ColumnGroups(7).Rows(0).Columns.Add(GridName.Columns("Scheme Ave Realisa Per Kg"))
            view.ColumnGroups(7).Rows(0).Columns.Add(GridName.Columns("Sample Ave Realisa Per Kg"))
