...
#End Region
    ...
    Private Sub txtCode__MYValidating1(ByVal sender As Object, ByVal e As System.EventArgs, ByVal isButtonClicked As Boolean) Handles txtCode._MYValidating
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            Dim qry As String = "SELECT T1.BOM_CODE AS Code,T1.DESCRIPTION,T1.LOCATION_CODE,FORMAT(CAST( T1.BOM_DATE AS DATETIME),'dd/MM/yyyy hh:mm tt') AS BOM_DATE,T1.REVISION_NO,T1.START_DATE,T1.END_DATE,T1.STATUS,"
