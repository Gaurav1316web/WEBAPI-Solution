...
Public Class ClsUpdateAppLocation
    ...
    Public DataBase_Name As String = Nothing
    ...
    Public Customer_Account_No As String = Nothing
    ...
    Public Function SaveData(ByVal Code As String, ByVal Arr As List(Of ClsUpdateAppLocation)) As Boolean
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()

        Dim isSaved As Boolean = True
        Try

            Dim qry As String = "delete from TSPL_MASTER.dbo.TSPL_APP_LOCATION  where Code='" + Code + "'"
            ...
            For Each obj As ClsUpdateAppLocation In Arr
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_APP_LOCATION", OMInsertOrUpdate.Insert, "", trans)
            Next
    ...
    Public Shared Function GetData(ByVal strCode As String) As List(Of ClsUpdateAppLocation)
        ...
        Dim qry As String = "select  * from TSPL_APP_LOCATION WHERE Code = '" + strCode + "'"
