...
Public Class rptSPItemConsumptionReport
    ...
    Private Sub Load_ItemWise_Report()
        ...
        Try
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                ReStoreGridLayout()
            Else
                clsCommon.MyMessageBoxShow("No data found to display.", "Material Consumption Report")
            End If
        Catch ex As Exception
            clsCommon.MyMessageBoxShow(ex.Message, Me.Text)
        End Try
    ...
    Private Sub rmiExcel_Click(sender As Object, e As EventArgs) Handles rmiExcel.Click
        Try
            If gv1.Rows.Count > 0 Then
                Dim arrHeader As List(Of String) = New List(Of String)()
                'arrHeader.Add("Company : " & objCommonVar.CurrentCompanyName)
                'arrHeader.Add("Location : " & objCommonVar.CurrLocationName)
                ...
                'Else
                'arrHeader.Add("Name : " & "Material Consumption Report")
                'End If
                ...
                clsCommon.MyExportToExcelGrid("Material Consumption Report", gv1, arrHeader, Me.Text)
