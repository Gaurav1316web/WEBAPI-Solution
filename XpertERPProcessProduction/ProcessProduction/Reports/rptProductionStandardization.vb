...
Public Class rptProductionStandardization
    ...
    Private Sub rmiPDF_Click(sender As Object, e As EventArgs) Handles rmiPDF.Click
        Try
            ...
            transportSql.applyExportTemplate(Gv1, PageSetupReport_ID)
            clsCommon.MyExportToPDF("Production standardization Report", Gv1, arrHeader, "Production standardization Report", PageSetupReport_ID, objCommonVar.CurrentUserCode)
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        Try
            ...
            qry = "   select TSPL_RCDF_STD.Doc_Code,TSPL_RCDF_STD.Doc_Date,TSPL_RCDF_STD.Location_Code,TSPL_RCDF_STD_PRODUCE.item_code,TSPL_ITEM_MASTER.Item_Desc,
                      TSPL_RCDF_STD_PRODUCE.BOM_Code,TSPL_ITEM_MASTER.Item_Desc as BOM_Description,TSPL_RCDF_STD_PRODUCE.Qty,TSPL_RCDF_STD_PRODUCE.Unit_Code,
                      TSPL_RCDF_STD_PRODUCE.FAT,TSPL_RCDF_STD_PRODUCE.FAT_KG,TSPL_RCDF_STD_PRODUCE.SNF,TSPL_RCDF_STD_PRODUCE.SNF_KG,TSPL_RCDF_STD_PRODUCE.Location_Code as Pro_Location_Code,
                      TSPL_LOCATION_MASTER.Location_Desc,TSPL_RCDF_STD_ISSUE.Item_Code as Issue_Item_Code ,I1.Item_Desc as Issue_Item_Desc,TSPL_RCDF_STD_ISSUE.Location_Code as Issue_Location_Code,
             		  L1.Location_Desc as Issue_Location_Desc,TSPL_RCDF_STD_ISSUE.Unit_Code as Issue_Unit_Code,TSPL_RCDF_STD_ISSUE.Qty as Issue_Qty,
					  ...
					  TSPL_RCDF_STD_ADD_REMOVE.ADD_REMOVE_TYPE as AR_Type,TSPL_RCDF_STD_ADD_REMOVE.Location_Code as AR_Location_Code,L2.Location_Desc as AR_Location_Desc,TSPL_RCDF_STD_ADD_REMOVE.Item_Code as AR_Item_Code,
                      I2.Item_Desc as AR_Item_Desc,I2.Product_Type as AR_Product_Type,TSPL_RCDF_STD_ADD_REMOVE.Unit_Code as AR_Unit_Code,TSPL_RCDF_STD_ADD_REMOVE.Qty as AR_Qty,
                      TSPL_RCDF_STD_ADD_REMOVE.FAT as AR_FAT,TSPL_RCDF_STD_ADD_REMOVE.FAT_KG as AR_FAT_KG,TSPL_RCDF_STD_ADD_REMOVE.SNF as AR_SNF,TSPL_RCDF_STD_ADD_REMOVE.SNF_KG as AR_SNF_KG ,

                      TSPL_RCDF_STD.Batch_No,TSPL_RCDF_STD.Tot_Produce_Qty,
                      ...
                      TSPL_RCDF_STD.Tot_AddRemove_SNFKG,TSPL_RCDF_STD.Tot_Net_Qty,TSPL_RCDF_STD.Tot_Net_FATKG,TSPL_RCDF_STD.Tot_Net_SNFKG from TSPL_RCDF_STD
                      LEFT OUTER JOIN TSPL_RCDF_STD_PRODUCE ON TSPL_RCDF_STD_PRODUCE.Doc_Code = TSPL_RCDF_STD.Doc_Code
					  left outer join TSPL_ITEM_MASTER on TSPL_RCDF_STD_PRODUCE.ITEM_CODE=TSPL_ITEM_MASTER.ITEM_CODE
        			  ...
        			  left outer join TSPL_ITEM_MASTER I1 on TSPL_RCDF_STD_ISSUE.ITEM_CODE=I1.ITEM_CODE
					  left outer join TSPL_ITEM_MASTER I2 on TSPL_RCDF_STD_ADD_REMOVE.ITEM_CODE=I2.ITEM_CODE
					  left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_RCDF_STD_PRODUCE.Location_Code
					  left outer join TSPL_LOCATION_MASTER L1 on TSPL_RCDF_STD_ISSUE.Location_Code=L1.Location_Code
					  left outer join TSPL_LOCATION_MASTER L2 on TSPL_RCDF_STD_ADD_REMOVE.Location_Code=L2.Location_Code
    ...
    Sub FormatGrid()
        ...
        Gv1.Columns("BOM_Description").IsVisible = True
        Gv1.Columns("BOM_Description").Width = 100
        Gv1.Columns("BOM_Description").HeaderText = "BOM Description"
        ...
        Gv1.Columns("Pro_Location_Code").IsVisible = True
        Gv1.Columns("Pro_Location_Code").Width = 100
        Gv1.Columns("Pro_Location_Code").HeaderText = "Location"
        ...
        Gv1.Columns("Issue_Item_Desc").IsVisible = True
        Gv1.Columns("Issue_Item_Desc").Width = 100
        Gv1.Columns("Issue_Item_Desc").HeaderText = "Item Description"
        ...
        Gv1.Columns("Issue_Location_Desc").IsVisible = True
        Gv1.Columns("Issue_Location_Desc").Width = 100
        Gv1.Columns("Issue_Location_Desc").HeaderText = "Location Description"
        ...
        Gv1.Columns("AR_Location_Desc").IsVisible = True
        Gv1.Columns("AR_Location_Desc").Width = 100
        Gv1.Columns("AR_Location_Desc").HeaderText = "Location Description"

        Gv1.Columns("AR_Item_Code").IsVisible = True
        Gv1.Columns("AR_Item_Code").Width = 100
        Gv1.Columns("AR_Item_Code").HeaderText = "Item Code"

        Gv1.Columns("AR_Item_Desc").IsVisible = True
        Gv1.Columns("AR_Item_Desc").Width = 100
        Gv1.Columns("AR_Item_Desc").HeaderText = "Item Description"

        Gv1.Columns("AR_Product_Type").IsVisible = True
        Gv1.Columns("AR_Product_Type").Width = 100
        Gv1.Columns("AR_Product_Type").HeaderText = "Product Type"
    ...
    Sub View()
        If Gv1.Rows.Count > 0 Then
            ...
            view.ColumnGroups(0).Rows(0).ColumnNames.Add(Gv1.Columns("BOM_Description").Name)
            ...
            'view.ColumnGroups(0).Rows(0).ColumnNames.Add(Gv1.Columns("Pro_Location_Code").Name)
            ...
            view.ColumnGroups(0).Rows(0).ColumnNames.Add(Gv1.Columns("Pro_Location_Code").Name)
            view.ColumnGroups(0).Rows(0).ColumnNames.Add(Gv1.Columns("Location_Desc").Name)
            ...
            view.ColumnGroups(1).Rows(0).ColumnNames.Add(Gv1.Columns("Issue_Item_Desc").Name)
            view.ColumnGroups(1).Rows(0).ColumnNames.Add(Gv1.Columns("Issue_Location_Code").Name)
            view.ColumnGroups(1).Rows(0).ColumnNames.Add(Gv1.Columns("Issue_Location_Desc").Name)
            ...
            view.ColumnGroups(2).Rows(0).ColumnNames.Add(Gv1.Columns("AR_Location_Code").Name)
            view.ColumnGroups(2).Rows(0).ColumnNames.Add(Gv1.Columns("AR_Location_Desc").Name)
            view.ColumnGroups(2).Rows(0).ColumnNames.Add(Gv1.Columns("AR_Item_Code").Name)
            view.ColumnGroups(2).Rows(0).ColumnNames.Add(Gv1.Columns("AR_Item_Desc").Name)
            view.ColumnGroups(2).Rows(0).ColumnNames.Add(Gv1.Columns("AR_Product_Type").Name)
