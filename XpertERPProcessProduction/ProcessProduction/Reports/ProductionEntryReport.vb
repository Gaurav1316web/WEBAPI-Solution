    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        Try
            ...
            qry = " select TSPL_PP_PRODUCTION_ENTRY_DETAIL.PROD_ENTRY_CODE,TSPL_PP_PRODUCTION_ENTRY.PROD_DATE,TSPL_PP_PRODUCTION_ENTRY_DETAIL.BOM_CODE,TSPL_PP_PRODUCTION_ENTRY_DETAIL.ITEM_CODE,
                    ...
                    TSPL_PP_PRODUCTION_ENTRY_DETAIL.SNF_Amt,TSPL_PP_PRODUCTION_ENTRY_DETAIL.FINAL_PRODUCTION_QTY,TSPL_PP_PRODUCTION_ENTRY_DETAIL.LOCATION_CODE,TSPL_PP_CONSUMPTION_WITHOUT_BATCH.Main_ITEM_CODE,TSPL_PP_CONSUMPTION_WITHOUT_BATCH.BOM_CODE,
