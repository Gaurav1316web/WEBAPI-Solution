    ...
    Sub DCSEntry(ByRef lst As clsBMCDCSMobile)
        Try
            ...
            For ii As Integer = 0 To lst.Arr_BMCDCS_Trip.Count - 1
                ...
                objtrMCC.Against_Milk_Collection_MCC_Detail = clsCommon.myCstr(clsDBFuncationality.getSingleValue("select TSPL_MILK_COLLECTION_MCC_DETAIL.PK_Id as PK_Id from TSPL_MILK_COLLECTION_MCC_DETAIL where REF_PK_ID_BMCDCS_TRIP=" + clsCommon.myCstr(lst.Arr_BMCDCS_Trip(ii).PK_ID)))
