...
#End Region
    ...
    Private Sub FrmSerializeItemIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        arrMCC = clsMCCCodes.GetUserHavingMCCRights()
...
where  tspl_mcc_master.MCC_Code='" + txtMCC.Value + "' and    tspl_mcc_master.mcc_Code in (" & clsCommon.GetMulcallString(arrMCC) & ")  "
        dt = clsDBFuncationality.GetDataTable(Qry)
        If dt Is Nothing OrElse dt.Rows.Count <= 0 Then
            Throw New Exception("You have not rights to save data of BMC [" + txtMCC.Value + "]")
        End If
        Return True
    End Function
    ...
    Private Sub txtDocNo__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtDocNo._MYValidating
        Dim whrcls As String = "  tspl_mcc_master.mcc_Code in (" & clsCommon.GetMulcallString(arrMCC) & ")  "
    ...
    Private Sub txtMCCCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtMCC._MYValidating
        ...
        & " and   tspl_mcc_master.mcc_Code in (" & clsCommon.GetMulcallString(arrMCC) & "))xx "
    ...
    Private Sub txtVLC__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtVLC._MYValidating
        Try
            ...
            Dim qry As String = "select TSPL_VLC_MASTER_HEAD.vlc_code_vlc_uploader as [Uploader_Code],TSPL_VLC_MASTER_HEAD.vlc_code as [DCS Code],TSPL_VLC_MASTER_HEAD.route_code as [Route Code],Route_name as [Route Name]," _
                & " TSPL_VLC_MASTER_HEAD.vlc_name as [DCS Name],TSPL_VLC_MASTER_HEAD.vehical_name as [Vehicle Name],TSPL_VLC_MASTER_HEAD.vsp_code as [Secretary Code]," _
                & " TSPL_VENDOR_MASTER.Vendor_Name as [Secretary Name],TSPL_VLC_MASTER_HEAD.mcc as [MCC Code],TSPL_MCC_MASTER.mcc_name as [MCC Name]," _
