...
Public Class AMCUMaster
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As ClsAMCUMaster = ClsAMCUMaster.GetData(strCode, NavTyep)
    ...
    Private Sub RadMenuItem2_Click(sender As Object, e As EventArgs) Handles RadMenuItem2.Click
        Dim qry As String = "select count(*) from tspl_AMCU_master"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Name from tspl_AMCU_master"
        Else
        ...
        If transportSql.importExcel(gv_Import, "Code", "Name") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(*) from tspl_AMCU_master where code='" + obj.Code + "'")
                    isNewEntry = True
                    If qry > 0 Then
                        isNewEntry = False
                    End If
    ...
    Private Sub DeleteData()
        Try
            ...
            If myMessages.deleteConfirm() Then
                If ClsAMCUMaster.DeleteData(txtCode.Value) Then
                    myMessages.delete()
                    AddNew()
                End If
            End If
    ...
    Private Sub txtCode__MYNavigator(sender As Object, e As EventArgs, NavType As NavigatorType) Handles txtCode._MYNavigator
        Try
            Dim qry As String = "select count(*) from TSPL_AMCU_Master where Code='" + txtCode.Value + "' "
    ...
    Private Sub txtCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtCode._MYValidating
        Dim Sqlqry As String = "select Code,Name from TSPL_AMCU_Master where code='" + txtCode.Value + "'"
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            Dim qry As String = "select Code,Name from TSPL_AMCU_Master"
            txtCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", whrClas, txtCode.Value, "TSPL_AMCU_Master.Code asc", isButtonClicked)
