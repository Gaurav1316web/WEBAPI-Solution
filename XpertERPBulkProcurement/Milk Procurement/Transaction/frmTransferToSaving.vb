...
left outer join TSPL_MCC_MASTER on TSPL_MCC_MASTER.MCC_Code=TSPL_TRANSFER_TO_SAVING.MCC_CODE"
        LoadData(clsCommon.ShowSelectForm("TrsToSav@F", qry, "Document_No", "", txtDocNo.Value, "Document_No", isButtonClicked, "Document_date"), NavigatorType.Current)
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtDocNo.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowTransHistoryData(txtDocNo.Value, "Document_No", "TSPL_TRANSFER_TO_SAVING", "TSPL_TRANSFER_TO_SAVING_DETAIL")
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Sub
