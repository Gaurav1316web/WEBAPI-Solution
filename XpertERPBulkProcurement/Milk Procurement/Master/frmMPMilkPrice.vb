...
#End Region
    ...
    Private Sub txtVLC__My_Click(sender As Object, e As EventArgs) Handles txtVLC._My_Click
        Try
            ...
            txtVLC.arrValueMember = clsCommon.ShowMultipleSelectForm("PCUVLC", qry, "DCS Code", "DCS Name", txtVLC.arrValueMember, Nothing)
