    ...
    Public Sub LoadData()
        Try
            ...
            If rbtnBMC.Checked Then
                strQry = "select ROW_NUMBER() Over (Order by TSPL_MILK_COLLECTION_BMCDCS.PK_ID) As [S No],TSPL_MILK_COLLECTION_BMCDCS.PK_ID,TSPL_MILK_COLLECTION_BMCDCS.IDate,TSPL_MILK_COLLECTION_BMCDCS.Truck_Sheet_SNo,TSPL_MILK_COLLECTION_BMCDCS.MCC_Code,TSPL_MCC_MASTER.MCC_NAME,TSPL_MILK_COLLECTION_BMCDCS.Route_Code,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Vehicle_No,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Trip_No,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Silo_Capacity,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Gaze_Reading,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Qty,TSPL_MILK_COLLECTION_BMCDCS_TRIP.FAT,TSPL_MILK_COLLECTION_BMCDCS_TRIP.SNF,TSPL_MILK_COLLECTION_BMCDCS_TRIP.FATKG,TSPL_MILK_COLLECTION_BMCDCS_TRIP.SNFKG,TSPL_MILK_COLLECTION_BMCDCS_TRIP.Temp
...
where TSPL_MILK_COLLECTION_BMCDCS.IDate >='" + clsCommon.GetPrintDate(fromDate.Value) + "' and TSPL_MILK_COLLECTION_BMCDCS.IDate<='" + clsCommon.GetPrintDate(dtpToDate.Value) + "'"
            ...
            If txtRoute.arrValueMember IsNot Nothing AndAlso txtRoute.arrValueMember.Count > 0 Then
                strQry += " and TSPL_MILK_COLLECTION_BMCDCS.Route_Code in (" + clsCommon.GetMulcallString(txtRoute.arrValueMember) + ")"
            End If
