...
Public Class rptMobileAppMilkCollection
    ...
    Public Sub LoadData()
        Try
            ...
            Else
                strQry = ReturnQry()
                If rbtnBMC.Checked Then
                    strQry = "select *,isnull(Average_Qty,0)Avg_Qty from ( " + strQry + " ) xx Left join ( select MCC_Code as MCC,isnull(convert(decimal(18,2),sum(qty)/count(Days)),0) as Average_Qty from ( select TSPL_MILK_COLLECTION_MCC_DETAIL.MCC_Code,sum(isnull(TSPL_MILK_COLLECTION_MCC_DETAIL.Qty,0)) as  Qty,1 as Days
           from TSPL_MILK_COLLECTION_MCC_DETAIL left outer join TSPL_MILK_COLLECTION_MCC on TSPL_MILK_COLLECTION_MCC.Document_No = TSPL_MILK_COLLECTION_MCC_DETAIL.Document_No where convert(date,TSPL_MILK_COLLECTION_MCC.Document_Date,103) >='" + clsCommon.GetPrintDate(FromDateAvg, "dd/MMM/yyyy") + "' and convert(date,TSPL_MILK_COLLECTION_MCC.Document_Date,103)<='" + clsCommon.GetPrintDate(ToDateAvg, "dd/MMM/yyyy") + "' group by MCC_Code,Document_Date ) xxxx group by MCC_Code ) xxx on xxx.MCC= xx.MCC_Code"
                ElseIf rbtnDCS.Checked Then
                    strQry = "select  *,isnull(Average_Qty,0)Avg_Qty from ( " + strQry + " )xx left join (
    ...
    Function LoadDiffData() As String
        ...
        If rbtnBMC.Checked Then
            qry = " select max(case when source = 'Mobile' then Date else '' end) as Date,max(case when source = 'Mobile' then Mcc_Code_VLC_Uploader else '' end) as Mcc_Code_VLC_Uploader,max(case when source = 'Mobile' then MCC_Code else '' end) as MCC_Code,max(case when source = 'Mobile' then MCC_NAME else '' end) as MCC_NAME,max(case when source = 'Mobile' then Gaze_Reading else 0 end) as Gaze_Reading,max(case when source = 'Mobile' then Sample_No else null end) as Sample_No, max(case when source = 'Mobile' then Route_Code else '' end) as Route_Code,max(case when source = 'Mobile' then Vehicle_No else '' end) as Vehicle_No,max(case when source = 'Mobile' then Trip_No else null end) as Trip_No,sum(case when source = 'Mobile' then Gaze_Qty else 0 end) as Gaze_Qty,sum(case when source = 'Mobile' then qty else 0 end) as Qty,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (FATKG/ qty)*100 else 0 end)) as FAT,
		 Convert(decimal(18,2), sum(case when source = 'Mobile' and qty>0 then (SNFKG/qty)*100 else 0 end)) as SNF,sum(case when source = 'Mobile' then FATKG else 0 end) as FATKG,sum(case when source = 'Mobile' then SNFKG else 0 end) as SNFKG,max(case when source = 'Erp' then Date else '' end) as Erp_Date,max(case when source = 'Erp' then Mcc_Code_VLC_Uploader else '' end) as Erp_Mcc_Code_VLC_Uploader,max(case when source = 'Erp' then MCC_Code else '' end) as Erp_MCC_Code,max(case when source = 'Erp' then MCC_NAME else '' end) as Erp_MCC_NAME,max(case when source = 'Erp' then Gaze_Reading else 0 end) as Erp_Gaze_Reading,max(case when source = 'Erp' then Sample_No else null end) as Erp_Sample_No, max(case when source = 'Erp' then Route_Code else '' end) as Erp_Route_Code,max(case when source = 'Erp' then Vehicle_No else '' end) as Erp_Vehicle_No, max(case when source = 'Erp' then Trip_No else null end) as Erp_Trip_No,
		 sum(case when source = 'Erp' then Gaze_Qty else 0 end) as Erp_Gaze_Qty,sum(case when source = 'Erp' then qty else 0 end) as Erp_Qty,Convert(decimal(18,2),sum(case when source = 'Erp' and qty>0 then (FATKG/ qty)*100 else 0 end)) as Erp_FAT,Convert(decimal(18,2), sum(case when source = 'Erp' and qty>0 then (SNFKG/qty)*100 else 0 end)) as Erp_SNF,sum(case when source = 'Erp' then FATKG else 0 end) as Erp_FATKG,sum(case when source = 'Erp' then SNFKG else 0 end) as Erp_SNFKG, max(case when source = 'Mobile' then Gaze_Reading else 0 end) - max(case when source = 'Erp' then Gaze_Reading else 0 end)  as Diff_Gaze_Reading,sum(case when source = 'Mobile' then Qty else 0 end) - sum(case when source = 'Erp' then Qty else 0 end)  as Diff_Qty,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (FATKG/QTY)*100 else 0 end) - sum(case when source = 'Erp' and qty>0 then (FATKG/QTY)*100 else 0 end))  as Diff_FAT,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (SNFKG/QTY)*100 else 0 end) - sum(case when source = 'Erp' and qty>0 then (SNFKG/QTY)*100 else 0 end))  as Diff_SNF,sum(case when source = 'Mobile' then FATKG else 0 end) - sum(case when source = 'Erp' then FATKG else 0 end)  as Diff_FATKG,
        ...
        ElseIf rbtnDCS.Checked Then
            qry = "select max(case when source = 'Mobile' then Date else '' end) as Date,max(case when source = 'Mobile' then Mcc_Code_VLC_Uploader else '' end) as Mcc_Code_VLC_Uploader,max(case when source = 'Mobile' then MCC_Code else '' end) as MCC_Code,max(case when source = 'Mobile' then MCC_NAME else '' end) as MCC_NAME,max(case when source = 'Mobile' then VLC_Code_VLC_Uploader else '' end) as VLC_Code_VLC_Uploader,max(case when source = 'Mobile' then VLC_Code else '' end) as VLC_Code,max(case when source = 'Mobile' then VLC_Name else '' end) as VLC_Name,max(case when source = 'Mobile' then Shift else '' end) as Shift, max(case when source = 'Mobile' then Route_Code else '' end) as Route_Code,max(case when source = 'Mobile' then Vehicle_No else '' end) as Vehicle_No,max(case when source = 'Mobile' then Trip_No else null end) as Trip_No,sum(case when source = 'Mobile' then qty else 0 end) as Qty,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (FATKG/ qty)*100 else 0 end)) as FAT,
		Convert(decimal(18,2), sum(case when source = 'Mobile' and qty>0 then (SNFKG/qty)*100 else 0 end)) as SNF,sum(case when source = 'Mobile' then FATKG else 0 end) as FATKG,sum(case when source = 'Mobile'  then SNFKG else 0 end) as SNFKG,max(case when source = 'Mobile' then [Own BMC] else '' end) as [Own BMC], max(case when source = 'Erp' then Date else '' end) as Erp_Date,max(case when source = 'Erp' then Mcc_Code_VLC_Uploader else '' end) as Erp_Mcc_Code_VLC_Uploader,max(case when source = 'Erp' then MCC_Code else '' end) as Erp_MCC_Code,max(case when source = 'Erp' then MCC_NAME else '' end) as Erp_MCC_NAME,max(case when source = 'Erp' then VLC_Code_VLC_Uploader else '' end) as Erp_VLC_Code_VLC_Uploader, max(case when source = 'Erp' then VLC_Code else '' end) as Erp_VLC_Code,max(case when source = 'Erp' then VLC_Name else '' end) as Erp_VLC_Name,max(case when source = 'Erp' then Shift else '' end) as Erp_Shift, max(case when source = 'Erp' then Route_Code else '' end) as Erp_Route_Code,max(case when source = 'Erp' then Vehicle_No else '' end) as Erp_Vehicle_No, max(case when source = 'Erp' then Trip_No else null end) as Erp_Trip_No,sum(case when source = 'Erp' then qty else 0 end) as Erp_Qty,
        Convert(decimal(18,2),sum(case when source = 'Erp' and qty>0 then (FATKG/ qty)*100 else 0 end)) as Erp_FAT,Convert(decimal(18,2), sum(case when source = 'Erp' and qty>0 then (SNFKG/qty)*100 else 0 end)) as Erp_SNF,sum(case when source = 'Erp' then FATKG else 0 end) as Erp_FATKG,sum(case when source = 'Erp' then SNFKG else 0 end) as Erp_SNFKG,max(case when source = 'Erp' then [Own BMC] else '' end) as Erp_OwnBMC,sum(case when source = 'Mobile' then Qty else 0 end) - sum(case when source = 'Erp' then Qty else 0 end)  as Diff_Qty,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (FATKG/QTY)*100 else 0 end) - sum(case when source = 'Erp' and qty>0 then (FATKG/QTY)*100 else 0 end))  as Diff_FAT,Convert(decimal(18,2),sum(case when source = 'Mobile' and qty>0 then (SNFKG/QTY)*100 else 0 end) - sum(case when source = 'Erp' and qty>0 then (SNFKG/QTY)*100 else 0 end))  as Diff_SNF,sum(case when source = 'Mobile' then FATKG else 0 end) - sum(case when source = 'Erp' then FATKG else 0 end)  as Diff_FATKG,sum(case when source = 'Mobile' then SNFKG else 0 end) - sum(case when source = 'Erp' then SNFKG else 0 end)  as Diff_SNFKG, max(Status)Status from (   select convert(varchar,IDate,103)Date,Mcc_Code_VLC_Uploader,MCC_Code, (MCC_NAME)MCC_NAME, Trip_No,VLC_Code_VLC_Uploader,VLC_Code,VLC_Name,IShift AS Shift, (Qty)Qty, FAT, SNF, (FATKG)FATKG, (SNFKG)SNFKG,(Route_Code)Route_Code, (Vehicle_No)Vehicle_No,[Own BMC],''AS Status,[Mobile User],'Mobile' as Source from ( " + qry + " )xx " + Environment.NewLine + " union all " + Environment.NewLine + "  select convert(varchar,TSPL_MILK_COLLECTION_DCS.Document_Date,103) Date,TSPL_MCC_MASTER.Mcc_Code_VLC_Uploader ,TSPL_MILK_COLLECTION_MCC_DETAIL.MCC_Code ,TSPL_MCC_MASTER.MCC_NAME ,TSPL_MILK_COLLECTION_MCC.Trip_No as  Trip_No,TSPL_VLC_MASTER_HEAD.VLC_Code_VLC_Uploader,TSPL_MILK_COLLECTION_DCS_DETAIL.VLC_Code,TSPL_VLC_MASTER_HEAD.VLC_Name,TSPL_MILK_COLLECTION_DCS_DETAIL.Shift  ,isnull(TSPL_MILK_COLLECTION_DCS_DETAIL.Qty,0) as  Qty,TSPL_MILK_COLLECTION_DCS_DETAIL.FAT,TSPL_MILK_COLLECTION_DCS_DETAIL.SNF,
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        select isnull(Own_BMC_Loose_Sale_Qty_E,0) as Qty,'Morning' as Shift,MCC_Code from TSPL_MILK_COLLECTION_BMCDCS  where TSPL_MILK_COLLECTION_BMCDCS.IDate >='" + clsCommon.GetPrintDate(fromDate.Value) + "' and TSPL_MILK_COLLECTION_BMCDCS.IDate<='" + clsCommon.GetPrintDate(dtpToDate.Value) + "'"
            ...
            If dt.Rows.Count > 0 Then
                Dim frmCRV As New frmCrystalReportViewer()
                If rbtnBMC.Checked Then
                    frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.MilkProcurement, dt, "rptBMCTruckSheet", "")
                ElseIf rbtnDCS.Checked Then
                    frmCRV.funsubreportWithdt(MyBase.Form_ID, CrystalReportFolder.MilkProcurement, dt, dtSubBMCTankerEntryDetails, "rptDCSTruckSheet", "", "rptSubBMCTankerEnterDetails", "rptSubOwnBMCMilkCollectionDetails", dtSubOwnBMCMilk, "rptSubBMCLocalSaleDetails", dtSubBMCLocalSale)
                End If
            End If
        Catch ex As Exception
            clsCommon.MyMessageBoxShow(Me, ex.Message, Me.Text)
