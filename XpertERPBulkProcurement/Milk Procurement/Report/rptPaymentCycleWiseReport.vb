    ...
    Sub Print(ByVal isPrint As Boolean, Optional ByVal isPrerint As Boolean = False)
        Try
            ...
            If chkPaymentSummary.Checked = True Then
                ...
                clsPaymentProcessHead.PaymentProcessDrCrPrint(strDocumentCode, date1, date2, strLocaton, strRoute, "", "", "", strDCS, True)
    ...
    Private Sub btnPrintCHT_Click(sender As Object, e As EventArgs) Handles btnPrintCHT.Click
        Try
            ...
            If dt IsNot Nothing And dt.Rows.Count > 0 Then
                ...
                frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.MilkProcurement, dt, "crptNegativeAmtCHT", "")
                frmCRV = Nothing
            Else
                clsCommon.MyMessageBoxShow(Me, "No Data Found", Me.Text)
            End If
