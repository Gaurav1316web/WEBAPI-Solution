...
And Convert(Date,TSPL_ADJUSTMENT_HEADER.Adjustment_Date,103) BETWEEN '" + clsCommon.GetPrintDate(txtFromDate.Value) + "' AND '" + clsCommon.GetPrintDate(txtToDate.Value) + "')Adjsment
            ...
            If dt2 IsNot Nothing OrElse dt2.Rows.Count > 0 Then
                ...
                If print Then
                    ...
                    Else
                        Dim frmCRV As New frmCrystalReportViewer()
                        frmCRV.funreport(MyBase.Form_ID, CrystalReportFolder.CommonForUnionAndCattlefeed, dt2, "crptmilkunionreportNEW", "") ''report for both (RCDF And RCDFCF)
                    End If
...
Where  CONVERT(DATE, TSPL_INVENTORY_MOVEMENT_new.Punching_Date, 103) BETWEEN   " & status
        If isSummary Then
