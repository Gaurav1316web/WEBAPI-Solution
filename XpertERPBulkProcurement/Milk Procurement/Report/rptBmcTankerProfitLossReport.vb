...
MAX(CAST((TSPL_MILK_COLLECTION_MCC.Entered_SNFKg * 100) / TSPL_MILK_COLLECTION_MCC.Entered_Qty AS DECIMAL(10, 2)))Entered_Qty_snf,
MAX(CAST((TSPL_MILK_COLLECTION_MCC.Entered_FATKg * 100) / TSPL_MILK_COLLECTION_MCC.Entered_Qty AS DECIMAL(10, 2)))Entered_Qty_fat
...
sum(CAST((TSPL_MILK_COLLECTION_MCC_DETAIL.Original_SNFKg * 100) /TSPL_MILK_COLLECTION_MCC_DETAIL.Original_Qty AS DECIMAL(10, 2))) AS [SNF(%)],
sum(CAST((TSPL_MILK_COLLECTION_MCC_DETAIL.Original_FATKg * 100) / TSPL_MILK_COLLECTION_MCC_DETAIL.Original_Qty AS DECIMAL(10, 2))) AS [FAT(%)]
