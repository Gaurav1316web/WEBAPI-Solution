...
,(select [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Name  from [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL LEFT OUTER JOIN [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER ON [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Code = [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.User_Code where  TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.No_Of_Level = 1 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code ) as [Level-1 Approved By]
,(SELECT  [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Modified_Date  FROM [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL  WHERE  TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' AND No_Of_Level = 1 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code  ) AS [Level-1 Approved Date]
,(select [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Name  from [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL LEFT OUTER JOIN [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER ON [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Code = [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.User_Code where TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.No_Of_Level = 2 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code  ) as [Level-2 Approved By]
,(SELECT  [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Modified_Date  FROM [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL WHERE  TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' AND No_Of_Level = 2 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code  ) AS [Level-2 Approved Date]
,(select [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Name  from [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL LEFT OUTER JOIN [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER ON [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_USER_MASTER.User_Code = [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.User_Code where TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.No_Of_Level = 3 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code  ) as [Level-3 Approved By]
,(SELECT  [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Modified_Date  FROM [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL  WHERE TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.TRANS_Code = 'DBT-NEFT-UPL' AND No_Of_Level = 3 and TSPL_APPROVAL_LEVEL_TRANSACTION_DETAIL.Document_Code=RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code  ) AS [Level-3 Approved Date]
from [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_DBT_NEFT 
left outer join RCDF.[dbo].TSPL_DBT_NEFT_RCDF on [" & clsCommon.myCstr(fndUnion.Value) & "].[dbo].TSPL_DBT_NEFT.Document_Code = RCDF.[dbo].TSPL_DBT_NEFT_RCDF.Document_Code and RCDF.[dbo].TSPL_DBT_NEFT_RCDF.DB_Name = '" & clsCommon.myCstr(fndUnion.Value) & "' where convert(date,TSPL_DBT_NEFT_RCDF.From_Date,103)>=convert(date,'" & Slot1 & "',103) and convert(date,TSPL_DBT_NEFT_RCDF.To_Date,103)<=convert(date,'" & Slot2 & "',103)"
            If rbtnTransactionPending.Checked Then
