...
Public Class FrmLastDCSCollectionItem
    ...
    Public Sub LoadData()
        Try
            ...
            whrcls = "  convert(date,DOC_DATE,103) <convert(date,'" + txtDate.Value + "' ,103) "
            ...
            If rbtnMilkSrn.Checked Then
                strQry = " select TSPL_MCC_MASTER.MCC_Code as [BMC Code],MCC_NAME as[BMC NAME],TSPL_MCC_MASTER.Mcc_Code_VLC_Uploader as [ BMC UploaderNo],
TSPL_VLC_MASTER_HEAD.VLC_Code as [DCS Code],TSPL_VLC_MASTER_HEAD.VLC_Code_VLC_Uploader as [DCS Uploader Code] ,TSPL_VLC_MASTER_HEAD.VLC_Name as [DCS Name],
FORMAT(TSPL_MILK_SRN_HEAD.DOC_DATE, 'dd/MM/yyyy') as [Date],SHIFT as [Shift],TSPL_MILK_SRN_detail.ACC_Qty as [QTY],TSPL_MILK_SRN_detail.FAT_PER as [Fat Per],TSPL_MILK_SRN_detail.SNF_PER as [SNF Per],TSPL_MILK_SRN_detail.FAT_KG as [Fat Kg],TSPL_MILK_SRN_detail.SNF_KG as [SNF KG] 
...
LEFT OUTER JOIN TSPL_MCC_MASTER ON TSPL_MCC_MASTER.MCC_Code=TSPL_MILK_SRN_HEAD.MCC_CODE where " & whrcls & ""
            Else
                strQry = "SELECT TSPL_VLC_MASTER_HEAD.VLC_Code as [DCS Code],TSPL_VLC_MASTER_HEAD.VLC_Code_VLC_Uploader as [DCS Uploader Code] , TSPL_VLC_MASTER_HEAD.VSP_Code as [DCS Code],
Item_Code as [Item Code],qty as [Qty],TSPL_SD_SALE_INVOICE_HEAD.Document_Date as [Date] 
...
where Trans_Type='MCC'  and  " & whrclsDCSSALE & ""
            End If
    ...
    Sub FormatGrid()
        ...
        For ii As Integer = 0 To Gv1.Columns.Count - 1
            ...
            If rbtnMilkSrn.Checked And rbtnDCSSaleReturn.Checked Then
