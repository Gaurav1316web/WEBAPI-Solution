    ...
    Sub Print(ByVal IsPrint As Exporter)
        Try
            ...
            If rbtnMilkProcUpl.Checked Then
                qry = ""
                qry = " WITH FirstMilkWeight AS ( SELECT  Document_No as Org_Document_No, SNo, MIN(Hist_Version) AS FirstMilkHistVersion , MIN(Hist_By)FirstMilkHist_By, min(Hist_On)FirstMilkHist_On FROM  TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data   WHERE Milk_Weight IS NOT NULL GROUP BY  Document_No, SNo ),
                   FirstNonNullFatSnf AS ( SELECT Document_No, SNo,MIN(Hist_Version) AS FirstNonNullFatSnfVersion , min(Hist_By)FirstNonNullFatSnfHist_By,min(Hist_On)FirstNonNullFatSnfHist_On , min(Manual_Sample)FirstNonNullFatSnfManual_Sample FROM TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data WHERE (ISNULL(FAT,0) > 0 or isnull(SNF,0) > 0) GROUP BY   Document_No, SNo ) ,
                   ...
                   convert(date,TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data.Hist_On,103) AS Org_Weighment_Date,TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data.FAT AS Org_FAT,TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data.SNF AS Org_SNF,TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data.Manual_Sample AS Org_Manual_Sample,
                   ...
                   TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data.Milk_Weight AS First_Milk_Weight,FirstNonNullFatSnf.FirstNonNullFatSnfHist_By AS Org_Sample_User, convert(date,FirstNonNullFatSnf.FirstNonNullFatSnfHist_On,103) AS Org_Sample_Date, FirstNonNullFatSnf.FirstNonNullFatSnfManual_Sample as Org_Manual_Sample FROM FirstNonNullFatSnf left JOIN TSPL_MILK_PROCUREMENT_UPLOADER_DETAIL_Hist_Data 
                 ...
                 ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample	 THEN MaxVersionData.Upd_Milk_Weight ELSE NULL END AS Upd_Milk_Weight,CASE WHEN FirstMilkWeightData.Org_Route_No <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader
                  or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or  ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample	 THEN MaxVersionData.Upd_Manual_Weight ELSE NULL END AS Upd_Manual_Weight, CASE WHEN FirstMilkWeightData.Org_Weighment_User <> MaxVersionData.Upd_Weighment_User and FirstMilkWeightData.Org_Route_No
                  <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or 	 ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> MaxVersionData.Upd_Manual_Weight or 	ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample	 THEN MaxVersionData.Upd_Weighment_User ELSE NULL END AS Upd_Weighment_User,
                  CASE WHEN FirstMilkWeightData.Org_Weighment_Date <> MaxVersionData.Upd_Weighment_Date and FirstMilkWeightData.Org_Route_No <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or  ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF
                  or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample THEN convert(date,MaxVersionData.Upd_Weighment_Date,103) ELSE NULL END AS Upd_Weighment_Date, CASE WHEN FirstMilkWeightData.Org_Route_No <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or   ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT
                  ...
                  or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample THEN MaxVersionData.Upd_Manual_Sample ELSE NULL END AS Upd_Manual_Sample,CASE WHEN FirstNonNullFatSnfData.Org_Sample_User <> MaxVersionData.Upd_Sample_User and FirstMilkWeightData.Org_Route_No <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or  ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> 
                  MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample THEN MaxVersionData.Upd_Sample_User ELSE NULL END AS Upd_Sample_User, CASE WHEN FirstNonNullFatSnfData.Org_Sample_Date <> MaxVersionData.Upd_Sample_Date and FirstMilkWeightData.Org_Route_No <> MaxVersionData.Upd_Route_No Or FirstMilkWeightData.Org_VLC_Code_VLC_Uploader <> MaxVersionData.Upd_VLC_Code_VLC_Uploader or FirstMilkWeightData.Org_VLC_Name <> MaxVersionData.Upd_VLC_Name or  ISNULL(FirstNonNullFatSnfData.First_Milk_Weight, FirstMilkWeightData.Org_Milk_Weight) <> MaxVersionData.Upd_Milk_Weight or  FirstMilkWeightData.Org_Manual_Weight <> 
                  MaxVersionData.Upd_Manual_Weight or ISNULL(FirstNonNullFatSnfData.First_FAT, FirstMilkWeightData.Org_FAT) <> MaxVersionData.Upd_FAT or ISNULL(FirstNonNullFatSnfData.First_SNF, FirstMilkWeightData.Org_SNF) <> MaxVersionData.Upd_SNF or FirstNonNullFatSnfData.Org_Manual_Sample <> MaxVersionData.Upd_Manual_Sample	 THEN convert(date,MaxVersionData.Upd_Sample_Date,103) ELSE NULL END AS Upd_Sample_Date FROM  FirstMilkWeightData LEFT JOIN  FirstNonNullFatSnfData  ON FirstMilkWeightData.Org_Document_No = FirstNonNullFatSnfData.Document_No AND FirstMilkWeightData.SNo = FirstNonNullFatSnfData.SNo  LEFT JOIN  MaxVersionData  ON FirstMilkWeightData.Org_Document_No = MaxVersionData.Document_No AND FirstMilkWeightData.SNo = MaxVersionData.SNo WHERE MaxVersionData.Source_API = 1 "
