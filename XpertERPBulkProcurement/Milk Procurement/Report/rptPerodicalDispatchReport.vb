...
#End Region
    ...
    Private Sub Print(ByVal print As Boolean)
        Try
            ...
            Dim qry As String = "select TSPL_COMPANY_MASTER.Comp_Name,TSPL_COMPANY_MASTER.Logo_Img ,From_Date = '12/05/2024',To_Date= '12/05/2024',aa.ROUTE_CODE as [Tanker No], aa.Mcc_Uploader_Code AS [MCC CODE],aa.[MCC Name],aa.Quantity ,CONVERT(DECIMAL(18,2),aa.FAT)FAT ,CONVERT(DECIMAL(18,2),aa.SNF) SNF ,CONVERT(DECIMAL(18,2),aa.[FAT(KG)]) KgFat ,CONVERT(DECIMAL(18,2),aa.[SNF(KG)] ) KgSNF
            ...
            where 2 = 2 and  convert(date,TSPL_MILK_SRN_HEAD.DOC_DATE,103) >=Convert(date,'" & txtfromDate.Value & "',103) 
            and convert(date,TSPL_MILK_SRN_HEAD.DOC_DATE,103) <= Convert(date,'" & txtToDate.Value & "',103)  ) As final  ) as  pp group by pp.ROUTE_CODE, pp.[MCC Code] ) as aa 
