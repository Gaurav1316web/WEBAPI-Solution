...
"
 ...
 [ERP Mp Code],max(xxx.[DCS CODE])[DCS CODE],max(xxx.[Dcs Name])[Dcs Name],max(xxx.VLC_Code_VLC_Uploader)VLC_Code_VLC_Uploader,
 max(MP_Code_VLC_Uploader)[MP Code],max(mp_name)[mp name],
max(xxx.[MP Bank])[MP Bank]
...
TSPL_MP_MASTER.MP_Code_VLC_Uploader,TSPL_MP_MASTER.mp_name,
