...
Public Class rptBMCPerodicalReport
    ...
    Public Sub Griddata(ByVal print As Boolean)
        Try
            ...
            FinalQuery = "select TSPL_COMPANY_MASTER.Comp_Name,TSPL_COMPANY_MASTER.Logo_Img ,From_Date = '" & fromDate.Value & "',To_Date= '" & ToDate.Value & "',aa.[MCC Code] ,aa.Mcc_Uploader_Code,aa.[MCC Name],aa.[Vlc Uploader Code],[VLC Name] ,aa.[Milk Weight(KG)] ,aa.[FAT(%)] ,aa.[SNF(%)] ,aa.[FAT(KG)] ,aa.[SNF(KG)] ,
