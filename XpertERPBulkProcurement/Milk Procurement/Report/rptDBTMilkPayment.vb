...
#End Region
    ...
    Private Function GetAttachQry() As String
        ...
        Qry += "   From ( Select  TSPL_MP_INCENTIVE1.Incetive_Rate,TSPL_ITEM_UOM_DETAIL.Conversion_Factor,TSPL_MILK_SRN_DETAIL.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_MILK_RECEIPT_HEAD.DOC_CODE As [Milk Receipt Code], "
        If AreaWiseBilling = True Then
