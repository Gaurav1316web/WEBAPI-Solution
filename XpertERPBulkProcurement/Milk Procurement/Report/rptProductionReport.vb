        ...
        Try
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                For ii As Integer = 0 To dt.Rows.Count - 1
                    ...
                    left JOIN [" + clsCommon.myCstr(dt.Rows(ii).Item("DataBase_Name")) + "].[dbo].TSPL_ITEM_MASTER ON TSPL_ITEM_MASTER.Item_Code = [" + clsCommon.myCstr(dt.Rows(ii).Item("DataBase_Name")) + "].[dbo].TSPL_INVENTORY_MOVEMENT.Item_Code
    ...
    Sub UnionWiseProductionDetail(LocName As String)
        Try
           ...
           *isnull(TSPL_ITEM_UOM_DETAIL.Conversion_Factor,1))/I.[KG]) as KG_QTY , TSPL_INVENTORY_MOVEMENT.Qty,TSPL_INVENTORY_MOVEMENT.Stock_UOM,TSPL_INVENTORY_MOVEMENT.Fat_KG,TSPL_INVENTORY_MOVEMENT.SNF_KG 
           ...
           left JOIN [" + UnionName + "].[dbo].TSPL_ITEM_MASTER ON TSPL_ITEM_MASTER.Item_Code = [" + UnionName + "].[dbo].TSPL_INVENTORY_MOVEMENT.Item_Code
