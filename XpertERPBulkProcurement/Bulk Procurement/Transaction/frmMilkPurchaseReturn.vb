    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(fndDocNoReturn.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowTransHistoryData(fndDocNoReturn.Value, "Pur_Return_No", "TSPL_BULK_MILK_PURCHASE_RETURN_HEAD", "TSPL_BULK_MILK_PURCHASE_RETURN_DETAIL")
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Sub
