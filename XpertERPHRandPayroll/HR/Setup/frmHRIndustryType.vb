...
Public Class frmHRIndustryType
...
#Region "Functions"
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Dim obj As ClsHRIndustryType = ClsHRIndustryType.GetData(strCode, NavTyep)
    ...
    Sub SaveData()
        Try
            If AllowToSave() Then
                Dim obj As New ClsHRIndustryType()
                obj.Code = txtcode.Value
                obj.Name = txtdesp.Text
                Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(Code) from TSPL_HR_INDUSTRY_TYPE_MASTER WHERE Code='" + obj.Code + "'")
                If (qry = 0) Then
                    isNewEntry = True
                Else
                    isNewEntry = False
...
#End Region
#Region "Events"
    Private Sub frmHRIndustryType_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub frmHRIndustryType_Load(sender As Object, e As EventArgs) Handles Me.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub txtcode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtcode._MYValidating
        Dim str As String = "select count(*) from TSPL_HR_INDUSTRY_TYPE_MASTER where Code ='" + txtcode.Value + "' "
        ...
        If txtcode.MyReadOnly OrElse isButtonClicked Then
            Dim qry As String = ""
            qry = "Select Code As [Code],Name As [Name] from TSPL_HR_INDUSTRY_TYPE_MASTER"
            txtcode.Value = clsCommon.ShowSelectForm("TSPL_HR_INDUSTRY_TYPE_MASTER", qry, "Code", "", txtcode.Value, "TSPL_HR_INDUSTRY_TYPE_MASTER.Code", isButtonClicked)
            If clsCommon.myLen(txtcode.Value) > 0 Then
                Dim objOT As ClsHRIndustryType
                objOT = ClsHRIndustryType.GetData(txtcode.Value, NavigatorType.Current)
    ...
    Private Sub rmExport_Click(sender As Object, e As EventArgs) Handles rmExport.Click
        Dim str As String
        str = "select Code as [Code],Name As [Description]  from TSPL_HR_INDUSTRY_TYPE_MASTER"
        ...
        If transportSql.importExcel(gv, "Code", "Description") Then
            ...
            Try
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    If clsCommon.myLen(strCode) > 0 AndAlso clsDBFuncationality.getSingleValue("Select count(*) from TSPL_HR_INDUSTRY_TYPE_MASTER where Code='" + strCode + "' ") > 0 Then
                        IsNewEntry = False
                    Else
                        IsNewEntry = True
