...
Public Class frmInstituteMaster
    ...
    Private Sub frmInstituteMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmInstituteMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ';If MyBase.Text = "Training Master" Then
            tb_name = "Tspl_Institute_Master"
            'End If
            SetUserMgmtNew()
            isnewentry = True
