...
Public Class FrmHRHotelRatingMaster
...
#Region "Functions"
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.FrmHRHotelRatingMaster)
    ...
    Sub SaveData()
        Try
            Dim obj As New ClsHRHotelRatingMaster()

            obj.Hotel_Rating_Code = clsCommon.myCstr(txtCode.Value)
            obj.Description = clsCommon.myCstr(txtDescription.Text).Replace("'", "`")

            If ClsHRHotelRatingMaster.SaveData(obj, txtCode.Value) Then
                clsCommon.MyMessageBoxShow("Data Saved Successfully", Me.Text)
                btnSave.Text = "Update"
                btnDelete.Enabled = True
                LoadData(obj.Hotel_Rating_Code, NavigatorType.Current)
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            obj = ClsHRHotelRatingMaster.GetData(strCode, NavTyep)

            If obj IsNot Nothing AndAlso clsCommon.myLen(obj.Hotel_Rating_Code) > 0 Then
                txtCode.Value = clsCommon.myCstr(obj.Hotel_Rating_Code)
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (ClsHRHotelRatingMaster.DeleteData(txtCode.Value)) Then
...
#Region "Events"
    Private Sub txtCode__MYNavigator(sender As Object, e As EventArgs, NavType As NavigatorType) Handles txtCode._MYNavigator
        Try
            Dim qry As String = "select count(*) from TSPL_HR_HOTEL_RATING_MASTER where Hotel_Rating_Code='" + txtCode.Value + "'"
    ...
    Private Sub txtCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtCode._MYValidating
        Try
            Dim str As String = "select count(*) from TSPL_HR_HOTEL_RATING_MASTER where Hotel_Rating_Code ='" + txtCode.Value + "' "
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                ...
                txtCode.Value = ClsHRHotelRatingMaster.GetFinder("", txtCode.Value, isButtonClicked)
                If clsCommon.myLen(txtCode.Value) > 0 Then
                    btnDelete.Enabled = True
                    btnSave.Text = "Update"
                    txtCode.MyReadOnly = True
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        End If
    End Sub
    Private Sub FrmHRHotelRatingMaster_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub FrmHRHotelRatingMaster_Load(sender As Object, e As EventArgs) Handles Me.Load
        SetUserMgmtNew()
        Reset()
    ...
    Private Sub rmExport_Click(sender As Object, e As EventArgs) Handles rmExport.Click
        Dim str As String
        str = "SELECT TSPL_HR_HOTEL_RATING_MASTER.Hotel_Rating_Code AS [Code],TSPL_HR_HOTEL_RATING_MASTER.Description AS [Description] From TSPL_HR_HOTEL_RATING_MASTER  "
        ...
        If transportSql.importExcel(gv, "Code", "Description") Then
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    ClsHRHotelRatingMaster.SaveData(obj, obj.Hotel_Rating_Code)
                Next
