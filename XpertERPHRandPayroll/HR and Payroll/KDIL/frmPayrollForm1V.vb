...
Public Class FrmPayrollForm1V
    ...
    Private Sub FrmPayrollForm1V_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        ButtonToolTip.SetToolTip(btnclose, "Press Alt+C Close the Window")
        ButtonToolTip.SetToolTip(btnGo, "Press Alt+P Print ")
    End Sub

    Private Sub FrmPayrollForm1V_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
