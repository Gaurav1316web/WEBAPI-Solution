...
Public Class RptPFForm12A_revised_
    ...
    Sub PrintData()
        Try
            ...
            If dtCurr IsNot Nothing AndAlso dtCurr.Rows.Count > 0 Then
            ...
            QryBase = "select " & LEFT_EMP_EPF & " as LEFT_EMP_EPF," & NEW_EMP_EPF & " as NEW_EMP_EPF," & LEFT_EMP_Pension & " as LEFT_EMP_Pension, " &
                " " & NEW_EMP_Pension & " as NEW_EMP_Pension," & LEFT_EMP_EDLI & " as LEFT_EMP_EDLI," & NEW_EMP_EDLI & " as NEW_EMP_EDLI, " & NoOfEmployee & " as NoOfEmployee, " &
                " " & WithPFEMP & " as WithPFEMP," & NoPFEMP & " as NoPFEMP," & TotalEMPEPFCurr & " as TotalEMPEPFCurr," & TotalEMPPensionCurr & " as TotalEMPPensionCurr, " &
                " " & TotalEMPEDLICurr & " as TotalEMPEDLICurr," & TotalEMPEPFPrev & " as TotalEMPEPFPrev," & TotalEMPPensionPrev & " as TotalEMPPensionPrev, " &
