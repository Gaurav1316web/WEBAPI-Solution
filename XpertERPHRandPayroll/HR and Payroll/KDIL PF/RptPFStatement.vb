...
Public Class RptPFStatement
    ...
    Sub loaddata()
        ...
        Try
            ...
            Dim whr As String = ""
            If chkTransPF.Checked = True Then
                str += " and  TSPL_EMPLOYEE_MASTER.Transfer_PF=1 "
            Else
                str += " and  TSPL_EMPLOYEE_MASTER.Transfer_PF<>1 "
            End If
