...
#End Region
    ...
    Public Sub Save()
        If AllowToSave() Then
            ...
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmDepartmentMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
            ...
            obj.DEPARTMENT_TYPE = cboDepartmentType.SelectedValue
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        Dim obj As New clsDepartmentMaster()
        obj = clsDepartmentMaster.GetData(strCode, NavTyep)
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Code) > 0) Then
            ...
            cboDepartmentType.SelectedValue = obj.DEPARTMENT_TYPE
    ...
    Function AllowToSave() As Boolean
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) AndAlso clsCommon.myLen(txtCode.Value) <= 0 Then
            myMessages.blankValue(Me, "Department Code", Me.Text)
            txtCode.Focus()
            Return False
        ElseIf clsCommon.myLen(txtName.Text) <= 0 Then
            myMessages.blankValue(Me, "Department Name", Me.Text)
            txtName.Focus()
            Return False
        ElseIf cboDepartmentType.SelectedIndex < 0 Then
            myMessages.blankValue(Me, "Department Type", Me.Text)
            cboDepartmentType.Focus()
            Return False
        End If
        Return True
    End Function
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsDepartmentMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmDepartmentMaster)
    ...
    Sub funReset()
        ...
        txtName.Text = ""
        txtDescription.Text = ""
        cboDepartmentType.DataSource = clsDepartmentMaster.GetCboDepartmentTypeDataTable()
        cboDepartmentType.ValueMember = "Code"
        cboDepartmentType.DisplayMember = "Name"
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_DEPARTMENT_MASTER where DEPARTMENT_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            'txtCode.Value = clsCommon.ShowSelectForm("Dep_Master", qry, "Code", "", txtCode.Value, "DEPARTMENT_CODE", isButtonClicked)
            txtCode.Value = clsDepartmentMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmDepartmentMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Department Name", "Description", "Department Type") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    Dim strName As String = clsCommon.myCstr(grow.Cells("Department Name").Value)
                    ...
                    Dim Type As String = clsCommon.myCstr(grow.Cells("Department Type").Value)
                    If Type.Length > 30 Or Type.Length <= 0 Then
                        Throw New Exception("Department Type can not be blank or incorrect.")
                    End If
                    obj.DEPARTMENT_TYPE = Type

                    obj.SaveData(obj, clsDepartmentMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select DEPARTMENT_CODE AS Code, DEPARTMENT_NAME AS [Department Name], DESCRIPTION AS Description,DEPARTMENT_TYPE as [Department Type] from TSPL_DEPARTMENT_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "DEPARTMENT_CODE", "TSPL_DEPARTMENT_MASTER")
        Catch ex As Exception
