...
#End Region
    ...
    Public Function Save()
        Dim obj As New clsGradeMaster()
        Try
            If AllowToSave() Then

                If MyBase.isModifyonPasswordFlag Then
                    If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmGradeMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                    Else
                        Return False
                    End If
                End If
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsGradeMaster()
        obj = clsGradeMaster.GetData(strCode, NavTyep)
    ...
    Function AllowToSave() As Boolean
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) AndAlso clsCommon.myLen(txtCode.Value) <= 0 Then
            myMessages.blankValue(Me, "Grade Code", Me.Text)
            txtCode.Focus()
            Return False
        ElseIf clsCommon.myLen(txtName.Text) <= 0 Then
            myMessages.blankValue(Me, "Grade Name", Me.Text)
            txtName.Focus()
            Return False
        End If
        Return True
    ...
    Sub DeleteData()
        ...
        'discCode = clsDBFuncationality.getSingleValue("select GRADE_CODE  from TSPL_SHIPMENT_DETAILS  where GRADE_CODE ='" & txtCode.Value & "'")
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsGradeMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub frmGradeMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmGradeMaster)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_GRADE_MASTER where GRADE_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            'txtCode.Value = clsCommon.ShowSelectForm("GRADE_MASTER", qry, "Code", "", txtCode.Value, "GRADE_CODE", isButtonClicked)
            txtCode.Value = clsGradeMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmGradeMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Grade Name", "Description") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsGradeMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select GRADE_CODE as Code, GRADE_NAME as [Grade Name], DESCRIPTION AS Description from TSPL_GRADE_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "GRADE_CODE", "TSPL_GRADE_MASTER")
        Catch ex As Exception
