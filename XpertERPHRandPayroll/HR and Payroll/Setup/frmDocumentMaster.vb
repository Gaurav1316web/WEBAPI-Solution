...
Public Class frmDocumentMaster
...
#End Region
    ...
    Private Sub Save()
        If AllowToSave() Then
            ...
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmDocumentMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If

            Dim obj As New clsDocumentMaster()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsDocumentMaster()
        obj = clsDocumentMaster.GetData(strCode, NavTyep)
    ...
    Function AllowToSave() As Boolean
        ...
        ElseIf clsCommon.myLen(txtName.Text) <= 0 Then
            myMessages.blankValue(Me, "Document Name", Me.Text)
            txtName.Focus()
            Return False
        End If
        Return True
    ...
    Sub DeleteData()
        ...
        'discCode = clsDBFuncationality.getSingleValue("select DOCUMENT_CODE  from TSPL_SHIPMENT_DETAILS  where DOCUMENT_CODE ='" & txtCode.Value & "'")
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsDocumentMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub frmDocumentMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmDocumentMaster)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_DOCUMENT_MASTER where DOCUMENT_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            'Dim qry As String = "select DOCUMENT_CODE AS Code, DOCUMENT_NAME as Name, DESCRIPTION AS Description from TSPL_DOCUMENT_MASTER"
            'txtCode.Value = clsCommon.ShowSelectForm("DOC_Master", qry, "Code", "", txtCode.Value, "DOCUMENT_CODE", isButtonClicked)
            txtCode.Value = clsDocumentMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmDocumentMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Document Name", "Description") Then
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsDocumentMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "DOCUMENT_CODE", "TSPL_DOCUMENT_MASTER")
        Catch ex As Exception
