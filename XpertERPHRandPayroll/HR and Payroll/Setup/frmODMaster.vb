...
#End Region
    ...
    Public Sub Save()
        If AllowToSave() Then
            ...
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmODMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If

            Dim obj As New clsODMaster()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsODMaster()
        obj = clsODMaster.GetData(strCode, NavTyep)
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsODMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub frmODMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmODMaster)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_OD_MASTER where OD_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            txtCode.Value = clsODMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmODMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If transportSql.importExcel(gv, "Code", "Description") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsODMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        ...
        Dim str As String
        str = " select OD_CODE as Code,DESCRIPTION as Description  from TSPL_OD_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "OD_CODE", "TSPL_OD_MASTER")
        Catch ex As Exception
