...
#End Region
    ...
    Function AllowToSave() As Boolean
        ...
        ElseIf clsCommon.myLen(txtAddress.Text) <= 0 Then
            myMessages.blankValue(" Address ")
            txtAddress.Focus()
            Return False
        ElseIf clsCommon.myLen(TxtCountry.Value) <= 0 Then
            myMessages.blankValue(" Country code")
            TxtCountry.Focus()
            Return False
        ...
        ElseIf clsCommon.myLen(txtperson.Text) <= 0 Then
            myMessages.blankValue(" Responsible Person/Manager")
            txtperson.Focus()
            Return False
        ...
        ElseIf clsCommon.myLen(txtPhoneNo.Text) <= 0 Then
            myMessages.blankValue(" Phone No")
            txtPhoneNo.Focus()
            Return False
        ElseIf clsCommon.myLen(txtFax.Text) <= 0 Then
            myMessages.blankValue(" Fax No ")
            txtFax.Focus()
            Return False
        ElseIf clsCommon.myLen(txtEmail.Text) <= 0 Then
            myMessages.blankValue(" Email Id")
            txtEmail.Focus()
            Return False
