...
Public Class frmDevisionMaster
...
#End Region
    ...
    Public Sub Save()
        If AllowToSave() Then
            ...
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmDevisionMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If

            Dim obj As New clsDevisionMaster()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsDevisionMaster()
        obj = clsDevisionMaster.GetData(strCode, NavTyep)
    ...
    Function AllowToSave() As Boolean
        ...
        ElseIf clsCommon.myLen(txtName.Text) <= 0 Then
            myMessages.blankValue(Me, "Devision Name", Me.Text)
            txtName.Focus()
            Return False
    ...
    Sub DeleteData()
        ...
        'discCode = clsDBFuncationality.getSingleValue("select DEVISION_CODE  from TSPL_SHIPMENT_DETAILS  where DEVISION_CODE ='" & txtCode.Value & "'")
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsDevisionMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub frmDevisionMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmDevisionMaster)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_DEVISION_MASTER where DEVISION_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            'txtCode.Value = clsCommon.ShowSelectForm("DEVISION_MASTER", qry, "Code", "", txtCode.Value, "DEVISION_CODE", isButtonClicked)
            txtCode.Value = clsDevisionMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmDevisionMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Devision Name", "Description") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsDevisionMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select DEVISION_CODE as Code, DEVISION_NAME as [Devision Name], DESCRIPTION as Description from TSPL_DEVISION_MASTER"
    ...
    Private Sub fndLocationCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles fndLocationCode._MYValidating
        ...
        fndLocationCode.Value = clsLocation.getFinder("  ", fndLocationCode.Value, isButtonClicked)
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "DEVISION_CODE", "TSPL_DEVISION_MASTER")
        Catch ex As Exception
