...
#End Region
    ...
    Function AllowToSave() As Boolean
        ...
        ElseIf clsCommon.myLen(txtCountry.Value) <= 0 Then
            myMessages.blankValue(Me, "Country Name", Me.Text)
            txtCountry.Focus()
            Return False
        End If
        If AllowGSTApplicable = True Then
            If ChkGSTUT.Checked = True Then
                If clsCommon.myLen(txtGSTStateCode.Text) <= 0 Then
                    myMessages.blankValue(Me, "Please fill GST State Code.", Me.Text)
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowTransHistoryData(txtCode.Value, "state_code", "TSPL_STATE_MASTER", "TSPL_STATE_MASTER_DETAIL")
        Catch ex As Exception
