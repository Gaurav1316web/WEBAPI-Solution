...
Public Class frmLanguageMaster
...
#End Region
    ...
    Public Sub Save()
        If AllowToSave() Then
            ...
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmLanguageMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If

            Dim obj As New clsLanguageMaster()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsLanguageMaster()
        obj = clsLanguageMaster.GetData(strCode, NavTyep)
    ...
    Function AllowToSave() As Boolean
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) AndAlso clsCommon.myLen(txtCode.Value) <= 0 Then
            myMessages.blankValue(Me, "Language Code", Me.Text)
            txtCode.Focus()
            Return False
        ElseIf clsCommon.myLen(txtName.Text) <= 0 Then
            myMessages.blankValue(Me, "Language Name", Me.Text)
            txtName.Focus()
            Return False
            End If
            Return True
    ...
    Sub funDelete()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsLanguageMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub frmLanguageMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmLanguageMaster)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_LANGUAGE_MASTER where LANGUAGE_CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            'txtCode.Value = clsCommon.ShowSelectForm("LANGUAGE_MASTER", qry, "Code", "", txtCode.Value, "LANGUAGE_CODE", isButtonClicked)
            txtCode.Value = clsLanguageMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub frmLanguageMaster_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub MenuItemImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemImport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Language Name", "Description") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    obj.SaveData(obj, clsLanguageMaster.CheckNewEntry(obj.Code))
                Next
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select LANGUAGE_CODE as Code, LANGUAGE_NAME as [Language Name], DESCRIPTION as Description from TSPL_LANGUAGE_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "LANGUAGE_CODE", "TSPL_LANGUAGE_MASTER")
        Catch ex As Exception
