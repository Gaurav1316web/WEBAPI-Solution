...
Public Class FrmEmpIncrement
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(fndIncrementCode.Value) <= 0 Then
                clsCommon.MyMessageBoxShow("Select Document No")
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowTransHistoryData(fndIncrementCode.Value, "INCREMENT_CODE", "TSPL_EMPLOYEE_INCREMENT_HEAD", "TSPL_EMPLOYEE_INCREMENT_DETAIL")
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Sub
