...
#End Region
    ...
    Function AllowToSave() As Boolean
        Xtra.TransactionValidity(dtpLoanAdjustDate.Value)
    ...
    Private Sub findLoanAdjustby__MYValidating(ByVal sender As Object, ByVal e As System.EventArgs, ByVal isButtonClicked As Boolean) Handles findLoanAdjustby._MYValidating
        ...
        Try
            ...
            findLoanAdjustby.Value = clsCommon.ShowSelectForm("TSPL_EMPLOYEE_MASTER", qry, "Code", " Emp_Status<>'Inactive'", findLoanAdjustby.Value, "", isButtonClicked)
            If clsCommon.myLen(findLoanAdjustby.Value) > 0 Then
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "LOANADJUSTMENT_CODE", "TSPL_LOAN_ADJUSTMENT")
        Catch ex As Exception
