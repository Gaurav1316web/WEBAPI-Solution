...
Public Class FrmEmployeeBandMaster
...
#End Region
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.EmployeeBandMaster)
    ...
    Private Sub FrmEmployeeBandMaster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
        funReset()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New clsEmployeeBandMaster()
        obj = clsEmployeeBandMaster.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtCode._MYValidating
        Dim str As String = "select count(*) from TSPL_EMPLOYEE_BAND_MASTER where TSPL_EMPLOYEE_BAND_MASTER.CODE ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            txtCode.Value = clsEmployeeBandMaster.getFinder("", txtCode.Value, isButtonClicked)
    ...
    Private Sub RadMenuItem3_Click(sender As Object, e As EventArgs) Handles RadMenuItem3.Click
        Dim str As String
        str = "select TSPL_EMPLOYEE_BAND_MASTER.CODE AS Code, TSPL_EMPLOYEE_BAND_MASTER.DESCRIPTION as [DESCRIPTION] from TSPL_EMPLOYEE_BAND_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "Code", "TSPL_EMPLOYEE_BAND_MASTER")
        Catch ex As Exception
