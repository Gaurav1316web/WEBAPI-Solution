...
Public Class frmLoanGeneration
    ...
    Function AllowToSave() As Boolean
        ...
        If clsCommon.myLen(findPayperiod.Value) <= 0 Then
            myMessages.blankValue(Me, "Pay Period ", Me.Text)
            findPayperiod.Focus()
            Return False
        End If
        If clsCommon.myLen(findGeneratedBy.Value) <= 0 Then
            myMessages.blankValue(Me, "Generated by Code", Me.Text)
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowTransHistoryData(txtCode.Value, "LOAN_GENERATION_CODE", "TSPL_LOAN_GENERATION", "TSPL_LOANGENERATION_DETAIL")
        Catch ex As Exception
