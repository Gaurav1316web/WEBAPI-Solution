...
Public Class frmAdjustmentRegister
    Inherits FrmMainTranScreen
    Dim ButtonToolTip As ToolTip = New ToolTip()
    Const ReportID As String = "AdjustmentRegister"
...
#End Region
    Sub LoadData()
        Try
            ...
            'DT = clsAdjustmentVoucher.GetRegisterDT(txtFromPP.Value, txtTopp.Value).Copy()
            DT_Details = clsAdjustmentVoucher.GetRegisterDTDetailed(txtFromPP.Value, txtTopp.Value, fndLocationCode.Value, fndDivisionCode.Value)
            'DT.AcceptChanges()
            ...
            Dim item1 As New GridViewSummaryItem("Adjustment Plus", "{0:F2}", GridAggregateFunction.Sum)
            Dim item2 As New GridViewSummaryItem("Adjustment Minus", "{0:F2}", GridAggregateFunction.Sum)
    ...
    Private Sub frmAdjustmentRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmAdjustmentRegister)
    ...
    Private Sub frmAdjustmentRegister_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    '    'clsCommon.MyExportToExcel("Adjustment Register", gv1, arr, "Salary Register")
    '    clsCommon.MyExportToExcelGrid("Adjustment Register", gv1, arr, "Adjustment Register", False)
    'End Sub
...
#Region "grid operations"
    ...
    Private Sub SetupMasterForAutoGenerateHierarchy()
        Using Me.gv1.DeferRefresh()
            ...
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_CODE").HeaderText = "ADJUSTMENT CODE"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_DATE").HeaderText = "ADJUSTMENT DATE"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_DATE").FormatString = "{0:  dd/MMM/yyyy}"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_PLUS").HeaderText = "ADJUSTMENT PLUS"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_MINUS").HeaderText = "ADJUSTMENT MINUS"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_REMARK").HeaderText = "REMARKS"
            ...
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_BY").HeaderText = "ADJUSTMENT BY CODE"
            Me.gv1.MasterTemplate.Columns("ADJUSTMENT_BY_NAME").HeaderText = "ADJUSTMENT BY NAME"
            ...
            template.Columns("ADJUSTMENT_CODE").HeaderText = "ADJUSTMENT CODE"
            ...
            template.Columns("ADJUSTMENT_PLUS").HeaderText = "ADJUSTMENT PLUS"
            template.Columns("ADJUSTMENT_MINUS").HeaderText = "ADJUSTMENT MINUS"
            template.AutoSizeColumnsMode = GridViewAutoSizeColumnsMode.Fill
            template.ReadOnly = True

            Dim relation As New GridViewRelation(gv1.MasterTemplate, template)
            relation.RelationName = "ADJUSTMENT_REL"
            relation.ParentColumnNames.Add("ADJUSTMENT_CODE")
            relation.ChildColumnNames.Add("ADJUSTMENT_CODE")
    ...
    Private Sub ExportGrid(ByVal exporter As EnumExportTo)
        Try
            If gv1.Rows.Count > 0 Then
                ...
                Else
                    transportSql.applyExportTemplate(gv1, PageSetupReport_ID)
                    clsCommon.MyExportToPDF("Adjustment Register", gv1, arrHeader, "Adjustment Register", False)
                End If
            Else
