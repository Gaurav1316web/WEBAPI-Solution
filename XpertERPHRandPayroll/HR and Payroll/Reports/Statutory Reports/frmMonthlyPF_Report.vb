...
Public Class frmMonthlyPF_Report
...
#End Region
    ...
    Private Sub frmMonthlyPF_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
    ...
    Private Sub SetUserMgmtNew()
        'MyBase.SetUserMgmt(clsUserMgtCode.frmMonthlyPF_Report)
    ...
    Sub PrintData()
        Try
            ...
            Qry += " LEFT OUTER JOIN TSPL_GENERATE_SALARY_ATTENDANCE T2 ON T2.EMP_CODE = T1.EMP_CODE AND T2.SALARY_GENERATION_CODE =T6.SALARY_GENERATION_CODE"
            ...
            Else
                ...
                frmcrsytal.funreport(MyBase.Form_ID, CrystalReportFolder.HRPayroll, DT, "crptMonthlyPF", "Monthly PF Report")
            End If
