...
#End Region
    ...
    Sub PrintData()
        Try
            ...
            Qry += " CONVERT(DATE,T1.Birth_date,103) AS DATE_OF_BIRTH,CONVERT(DATE,T1.Joining_date,103) AS JOINING_DATE "
            Qry += " FROM TSPL_EMPLOYEE_MASTER T1 WHERE CONVERT(date,joining_date,103) BETWEEN "
