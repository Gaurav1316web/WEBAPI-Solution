...
Imports common
Public Class PayRoll_HR_ReportViewer
#Region "Variable"
    Dim strQuery As String
    Dim Ds As DataSet
#End Region
    Private Sub PayRoll_HR_ReportViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    '            Dim strReportPath As String = strpath + "\Crystal Reports\HR_Payroll\" & strReportName & ".rpt"
