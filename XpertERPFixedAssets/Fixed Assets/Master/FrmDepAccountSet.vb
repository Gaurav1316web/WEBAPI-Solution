...
Public Class FrmDepAccountSet
    ...
    Function AllowToSave() As Boolean
        ...
        If clsCommon.myLen(fndAssetControl.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Asset Control Account", Me.Text)
            fndAssetControl.Focus()
            Return False
        End If
        If clsCommon.myLen(fndTransferClearingAccount.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Transfer Clearing Account", Me.Text)
            fndTransferClearingAccount.Focus()
            Return False
        End If

        If clsCommon.myLen(txtDisposalCostAccount.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Disposal cost account", Me.Text)
        ...
        If clsCommon.myLen(fndAccumDep.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select  Accumulated Depreciation Account", Me.Text)
            fndAccumDep.Focus()
            Return False
        End If
        If clsCommon.myLen(txtDisposalAccount.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Disposal Account", Me.Text)
        ...
        If clsCommon.myLen(fndWIP.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Work In Progress Account", Me.Text)
            fndWIP.Focus()
            Return False
        End If

        If clsCommon.myLen(fndProfit.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Profit Account", Me.Text)
            fndProfit.Focus()
            Return False
        End If

        If clsCommon.myLen(fndLoss.Value) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Please select Loss Account", Me.Text)
            fndLoss.Focus()
            Return False
        End If
    ...
    Public Sub fundelete()
        Try
            ...
            If txtDocNo.Value = "" Then
                clsCommon.MyMessageBoxShow(Me, "Select the Account Set Code", Me.Text)
                Exit Sub
            End If
