    ...
    Function AllowToSave() As Boolean
        ...
        If (IIf(clsCommon.myCstr(clsFixedParameter.GetData(clsFixedParameterType.AllowAutoGenerateDocNoInMaster, clsFixedParameterCode.AllowAutoGenerateDocNoInMaster, Nothing)) = "1", True, False) = False) Then
            If clsCommon.myLen(txtDocNo.Value) <= 0 Then
                common.clsCommon.MyMessageBoxShow(Me, "Account Set Code can't be blank", Me.Text)
                txtDocNo.Focus()
                Return False
            End If
        End If
        ...
        If clsCommon.myLen(txtDesc.Text) <= 0 Then
            common.clsCommon.MyMessageBoxShow(Me, "Account Set Description can't be blank", Me.Text)
            txtDesc.Focus()
            Return False
        End If
    ...
    Public Sub fundelete()
        Try
            ...
            If txtDocNo.Value = "" Then
                clsCommon.MyMessageBoxShow(Me, "Select the Period Code", Me.Text)
                Exit Sub
            End If
