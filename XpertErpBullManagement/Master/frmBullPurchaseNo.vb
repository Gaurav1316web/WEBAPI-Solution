...
Public Class frmBullPurchaseNo
    ...
    Private Sub fndCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles fndCode._MYValidating
        Dim Sqlqry As String = "select Code,Name from TSPL_BULL_PURCHASE_REQUEST_NO where code='" + fndCode.Value + "'"
        ...
        If fndCode.MyReadOnly OrElse isButtonClicked Then
            ...
            Dim qry As String = "select Code,Name from TSPL_BULL_PURCHASE_REQUEST_NO"
            fndCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", whrClas, fndCode.Value, "TSPL_BULL_PURCHASE_REQUEST_NO.Code asc", isButtonClicked, "TSPL_BULL_PURCHASE_REQUEST_NO.Created_Date")
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As clsBullPurchaseNo = clsBullPurchaseNo.GetData(strCode, NavTyep)
    ...
    Private Sub RadMenuItem5_Click(sender As Object, e As EventArgs) Handles RadMenuItem5.Click
        Dim qry As String = "select count(*) from TSPL_BULL_PURCHASE_REQUEST_NO"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Name from TSPL_BULL_PURCHASE_REQUEST_NO"
        Else
        ...
        If transportSql.importExcel(gv_Import, "Code", "Name") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(*) from TSPL_BULL_PURCHASE_REQUEST_NO where code='" + obj.Code + "'")
                    isNewEntry = True
                    If qry > 0 Then
                        isNewEntry = False
                    End If
    ...
    Private Sub DeleteData()
        Try
            ...
            If myMessages.deleteConfirm() Then
                If clsBullPurchaseNo.DeleteData(fndCode.Value) Then
                    myMessages.delete()
                    AddNew()
                End If
            End If
    ...
    Private Sub fndCode__MYNavigator(sender As Object, e As EventArgs, NavType As NavigatorType) Handles fndCode._MYNavigator
        Try
            Dim qry As String = "select count(*) from TSPL_BULL_PURCHASE_REQUEST_NO where Code='" + fndCode.Value + "' "
