...
Public Class frmBullShedParameterMaster
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As clsBullShedParameter = clsBullShedParameter.GetData(strCode, NavTyep)
    ...
    Private Sub fndCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles fndCode._MYValidating
        ...
        If fndCode.MyReadOnly OrElse isButtonClicked Then
            ...
            fndCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", whrClas, fndCode.Value, "TSPL_BULL_SHED_PARAMETER.Code asc", isButtonClicked, Nothing)
    ...
    Private Sub DeleteData()
        Try
            ...
            If myMessages.deleteConfirm() Then
                If clsBullShedParameter.DeleteData(fndCode.Value) Then
                    myMessages.delete()
                    AddNew()
                End If
            End If
    ...
    Private Sub RadMenuItem5_Click(sender As Object, e As EventArgs) Handles RadMenuItem5.Click
        Dim qry As String = "select count(*) from TSPL_BULL_SHED_PARAMETER"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Name from TSPL_BULL_SHED_PARAMETER"
        Else
            qry = "select '' as Code,'' as Name,'' as Type"
        End If
    ...
    Private Sub RadMenuItem6_Click(sender As Object, e As EventArgs) Handles RadMenuItem6.Click
        ...
        If transportSql.importExcel(gv_Import, "Code", "Name", "Type") Then
            Dim obj As New clsBullShedParameter()
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    obj.Type = clsCommon.myCstr(grow.Cells("Type").Value).Replace("'", "`")
                    ...
                    Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(*) from TSPL_BULL_SHED_PARAMETER where code='" + obj.Code + "'")
                    isNewEntry = True
                    If qry > 0 Then
                        isNewEntry = False
                    End If
