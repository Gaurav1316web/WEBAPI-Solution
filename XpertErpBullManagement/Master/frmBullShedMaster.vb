...
Public Class frmBullShedMaster
    ...
    Private Sub fndCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles fndCode._MYValidating
        ...
        If fndCode.MyReadOnly OrElse isButtonClicked Then
            ...
            fndCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", "", fndCode.Value, "tspl_bull_shed_master.Code asc", isButtonClicked, "tspl_bull_shed_master.Created_Date")
    ...
    Private Sub cmbArea_SelectedIndexChanged(sender As Object, e As Data.PositionChangedEventArgs) Handles cmbArea.SelectedIndexChanged
    ...
    Private Sub fndCode_Load(sender As Object, e As EventArgs) Handles fndCode.Load
