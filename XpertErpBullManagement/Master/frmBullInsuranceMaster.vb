...
Public Class frmBullInsuranceMaster
    Inherits FrmMainTranScreen
    Dim isNewEntry As Boolean = True
    Dim ErrorControl As New clsErrorControl()
    Dim ButtonToolTip As ToolTip = New ToolTip()

    Private Sub frmBullInsuranceMaster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        isNewEntry = True
        ...
        Try
            If (AllowToSave()) Then
                If MyBase.isModifyonPasswordFlag Then
                    If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmBullInsuranceMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                    Else
                        Return
                    End If
                End If
                Dim obj As New clsBullInsuranceMaster()
    ...
    Private Sub txtCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtCode._MYValidating
        Dim Sqlqry As String = "select Code,Name from TSPL_BULL_INSURANCE_MASTER where code='" + txtCode.Value + "'"
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            Dim qry As String = "select Code,Name ,Created_By as [Created By],Created_Date as [Created Date],Modified_By as [Modified By],Modified_Date as [Modified Date] from TSPL_BULL_INSURANCE_MASTER"
            txtCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", whrClas, txtCode.Value, "TSPL_BULL_INSURANCE_MASTER.Code asc", isButtonClicked, Nothing)
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As clsBullInsuranceMaster = clsBullInsuranceMaster.GetData(strCode, NavTyep)
    ...
    Private Sub RadMenuItem2_Click(sender As Object, e As EventArgs) Handles RadMenuItem2.Click
        Dim qry As String = "select count(*) from TSPL_BULL_INSURANCE_MASTER"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Name from TSPL_BULL_INSURANCE_MASTER"
        Else
    ...
    Private Sub DeleteData()
        Try
            ...
            If myMessages.deleteConfirm() Then
                If clsBullInsuranceMaster.DeleteData(txtCode.Value) Then
                    myMessages.delete()
                    AddNew()
                End If
            End If
        ...
        If transportSql.importExcel(gv_Import, "Code", "Name") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(*) from TSPL_BULL_INSURANCE_MASTER where code='" + obj.Code + "'")
                    isNewEntry = True
                    If qry > 0 Then
                        isNewEntry = False
                    End If
