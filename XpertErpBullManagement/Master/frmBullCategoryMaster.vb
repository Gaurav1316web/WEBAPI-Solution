...
Public Class frmBullCategoryMaster
    ...
    Private Sub txtCode__MYValidating(sender As Object, e As EventArgs, isButtonClicked As Boolean) Handles txtCode._MYValidating
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            txtCode.Value = clsCommon.ShowSelectForm("RTY", qry, "Code", whrClas, txtCode.Value, "TSPL_BULL_CATEGORY_MASTER.Code asc", isButtonClicked, "TSPL_BULL_CATEGORY_MASTER.Created_Date")
    ...
    Private Sub RadMenuItem5_Click(sender As Object, e As EventArgs) Handles RadMenuItem5.Click
        Dim qry As String = "select count(*) from TSPL_BULL_CATEGORY_MASTER"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Name from TSPL_BULL_CATEGORY_MASTER"
        Else
        ...
        If transportSql.importExcel(gv_Import, "Code", "Name") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(*) from TSPL_BULL_CATEGORY_MASTER where code='" + obj.Code + "'")
                    isNewEntry = True
                    If qry > 0 Then
                        isNewEntry = False
                    End If
    ...
    Private Sub txtCode__MYNavigator(sender As Object, e As EventArgs, NavType As NavigatorType) Handles txtCode._MYNavigator
        Try
            Dim qry As String = "select count(*) from TSPL_BULL_CATEGORY_MASTER where Code='" + txtCode.Value + "' "
