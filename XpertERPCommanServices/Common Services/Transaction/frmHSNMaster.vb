...
#End Region
    ...
    Private Sub frmHSNMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        ...
        isNewEntry = False
        Dim obj As New ClsHSNMaster()
        obj = ClsHSNMaster.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        Dim str As String = "select count(*) from TSPL_HSN_MASTER where Code ='" + txtCode.Value + "' "
        ...
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            txtCode.Value = ClsHSNMaster.getFinder("", txtCode.Value, isButtonClicked)
            ...
            Try
                ...
                Try
                    For Each grow As GridViewRowInfo In gv.Rows
                        ...
                        'ClsHSNMaster.SaveData(obj, ClsHSNMaster.CheckNewEntry(obj.Code, tran))
                    Next
                Catch ex As Exception
                    ' tran.Rollback()
    ...
    Private Sub MenuItemExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemExport.Click
        Dim str As String
        str = "select Code, Description from TSPL_HSN_MASTER"
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "Code", "TSPL_HSN_MASTER")
        Catch ex As Exception
