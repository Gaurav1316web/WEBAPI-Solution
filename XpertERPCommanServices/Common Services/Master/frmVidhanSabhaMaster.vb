Imports common
Public Class frmVidhanSabhaMaster
...
#End Region
    ...
    Sub SaveData()
        Try
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmVidhanSabhaMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
            Dim obj As New clsVidhanSabhaMaster()

            obj.code = clsCommon.myCstr(txtCode.Value)
            obj.name = clsCommon.myCstr(txtName.Text).Replace("'", "`")
            obj.namehindi = clsCommon.myCstr(txtNamehindi.Text)
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            obj = clsVidhanSabhaMaster.GetData(strCode, NavTyep)

            If obj IsNot Nothing AndAlso clsCommon.myLen(obj.code) > 0 Then
                txtCode.Value = obj.code
                txtName.Text = obj.name
                txtNamehindi.Text = obj.namehindi
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        'Reset()
        Try
            Dim str As String = "select count(*) from TSPL_VIDHAN_SABHA_MASTER where VIDHAN_SABHA_CODE ='" + txtCode.Value + "' "
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                ...
                txtCode.Value = clsVidhanSabhaMaster.getFinder("", txtCode.Value, isButtonClicked)
                If clsCommon.myLen(txtCode.Value) > 0 Then
                    btnDelete.Enabled = True
                    btnSave.Text = "Update"
                    txtCode.MyReadOnly = True
    ...
    Private Sub btnexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexport.Click
        Dim str As String
        str = "select VIDHAN_SABHA_CODE AS Code, VIDHAN_SABHA_NAME as [Vidhan Sabha Name] from TSPL_VIDHAN_SABHA_MASTER"
    ...
    Private Sub btnimport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Vidhan Sabha Name") Then
