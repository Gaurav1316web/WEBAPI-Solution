...
Public Class frmSetValue
    ...
    Private Sub frmSetValue_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtValue.MaxLength = 30
        For i As Integer = 0 To ColumnCount - 1
            If ColName(i) = "code" Or ColName(i) = "description" Then
