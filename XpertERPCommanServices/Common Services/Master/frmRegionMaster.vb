...
#End Region
    ...
    Sub SaveData()
        Try
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmRegionMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Dim qry As String = "SELECT Count(*) FROM TSPL_REGION_MASTER where REGION_CODE= '" & txtCode.Value & "'"
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            obj = ClsRegionMaster.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        'Reset()
        Try
            Dim str As String = "select count(*) from TSPL_REGION_MASTER where region_code ='" + txtCode.Value + "' "
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                ...
                txtCode.Value = ClsRegionMaster.getFinder("", txtCode.Value, isButtonClicked)
                If clsCommon.myLen(txtCode.Value) > 0 Then
                    btnDelete.Enabled = True
                    btnSave.Text = "Update"
                    txtCode.MyReadOnly = True
    ...
    Private Sub btnexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexport.Click
        Dim str As String
        str = "select Region_code AS Code, Region_name as [Region Name] from TSPL_REGION_MASTER"
