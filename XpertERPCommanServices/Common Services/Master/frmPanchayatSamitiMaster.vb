Imports common
Public Class frmPanchayatSamitiMaster
...
#End Region
    ...
    Sub SaveData()
        Try
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmPanchayatSamitiMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
            Dim obj As New clsPanchayatSamitiMaster()
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            obj = clsPanchayatSamitiMaster.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        'Reset()
        Try
            Dim str As String = "select count(*) from TSPL_PANCHAYAT_SAMITI_MASTER where PANCHAYAT_SAMITI_CODE ='" + txtCode.Value + "' "
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                ...
                txtCode.Value = clsPanchayatSamitiMaster.getFinder("", txtCode.Value, isButtonClicked)
                If clsCommon.myLen(txtCode.Value) > 0 Then
                    btnDelete.Enabled = True
                    btnSave.Text = "Update"
                    txtCode.MyReadOnly = True
    ...
    Private Sub btnexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexport.Click
        Dim str As String
        str = "select PANCHAYAT_SAMITI_CODE AS Code, PANCHAYAT_SAMITI_NAME as [Panchayat Samiti Name] from TSPL_PANCHAYAT_SAMITI_MASTER"
    ...
    Private Sub btnimport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Panchayat Samiti Name") Then
