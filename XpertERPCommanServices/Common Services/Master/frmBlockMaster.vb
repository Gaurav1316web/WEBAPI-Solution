...
#End Region
    ...
    Function AllowToSave() As Boolean
        Try
            ...
            If clsCommon.myLen(txtName.Text) <= 0 Then
                clsCommon.MyMessageBoxShow(Me, "Please Fill Block Name", Me.Text)
                txtName.Focus()
                txtName.Select()
                Return False
            End If
    ...
    Sub SaveData()
        Try
            If MyBase.isModifyonPasswordFlag Then
                If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmBlockMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                Else
                    Return
                End If
            End If
            Dim obj As New clsBlockMaster()

            obj.code = clsCommon.myCstr(txtCode.Value)
            obj.name = clsCommon.myCstr(txtName.Text).Replace("'", "`")

            If clsBlockMaster.SaveData(obj, txtCode.Value) Then
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                clsCommon.MyMessageBoxShow(Me, "Please Select Block Code For Deletion", Me.Text)
                Return
            End If
    ...
    Public Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            obj = clsBlockMaster.GetData(strCode, NavTyep)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        ...
        'Reset()
        Try
            Dim str As String = "select count(*) from TSPL_Block_MASTER where block_code ='" + txtCode.Value + "' "
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                ...
                txtCode.Value = clsBlockMaster.getFinder("", txtCode.Value, isButtonClicked)
                If clsCommon.myLen(txtCode.Value) > 0 Then
                    btnDelete.Enabled = True
                    btnSave.Text = "Update"
                    txtCode.MyReadOnly = True
    ...
    Private Sub btnexport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnexport.Click
        Dim str As String
        str = "select Block_code AS Code, Block_name as [Block Name] from TSPL_BLOCK_MASTER"
    ...
    Private Sub btnimport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimport.Click
        ...
        If transportSql.importExcel(gv, "Code", "Block Name") Then
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    clsBlockMaster.SaveData(obj, obj.code)
                Next
