...
#End Region
    ...
    Public Sub saveSetting(ByVal isShowMsg As Boolean)
        Try
            Dim arrLable As New List(Of clsLableSetting)()
...
#Region "Variables"
    ...
    Private arrLableSetting As List(Of clsLableSetting) = Nothing
    Dim dsRpt As XpertERPCommanServices.dsRptChequeMultiple = Nothing
#End Region
    ...
    Public Sub PrintCheque(ByVal arr As List(Of clsPrintCheck))
        Try
            ...
            dsRpt = New XpertERPCommanServices.dsRptChequeMultiple()
