...
Public Class frmCashFlowPerforma
...
#End Region
    ...
    Private Sub FrmBalanceSheetPerforma1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'ERO/12/12/18-000437,ERO/12/12/18-000438 by balwinder on 20/12/2018
        ...
        RadLabel12.Visible = settSelectGLInCashFlowPerforma
        SetUserMgmtNew()
    ...
    Sub SavingData()
        Try
            Dim arr As New List(Of clsCashFlowPerforma)
            If AllowToSave() = True Then
                ...
                For ii As Integer = 0 To gv2.Rows.Count - 1
                    Dim obj As New clsCashFlowPerforma()
    ...
    Sub LoadBlankGrid()
        ...
        repoGroupName.IsVisible = settSelectGLInCashFlowPerforma
        gv2.MasterTemplate.Columns.Add(repoGroupName)
    ...
    Sub LoadData()
        ...
        LoadBlankGrid()
        Dim arr As List(Of clsCashFlowPerforma) = clsCashFlowPerforma.GetData()
    ...
    Private Sub rdBtnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdBtnImport.Click
        ...
        If transportSql.importExcel(dgv, "S No", "Main Particular", "Particular", "Group Code", "Group Name", "Note", "Type", "Font Style", "Formula") Then
            Dim arr As New List(Of clsCashFlowPerforma)
            Dim obj As clsCashFlowPerforma
            Try
    ...
    Private Sub dbtnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dbtnExport.Click
        Try
            Dim query As String = "Select S_No as [S No],Main_Particular as [Main Particular], Particular ,Group_Code as [Group Code],Group_Name as [Group Name],Note as [Note],Type,Font_style as [Font Style],Formula from TSPL_CASH_FLOW_PERFORMA" 'tspl_balance_sheet_performa"
    ...
    Private Sub gv2_CellDoubleClick(sender As Object, e As GridViewCellEventArgs) Handles gv2.CellDoubleClick
        Try
            ...
            If e.Column Is gv2.Columns(ColGLMainAccount) Then
                If clsCommon.myLen(gv2.CurrentRow.Cells(ColMainGroupCode).Value) > 0 AndAlso settSelectGLInCashFlowPerforma Then
