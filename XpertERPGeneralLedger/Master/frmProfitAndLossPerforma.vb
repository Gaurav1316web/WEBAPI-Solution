...
Public Class frmProfitAndLossPerforma
...
#Region "Varibales"
    ...
    Dim settSelectGLInProftAndLossPerforma As Boolean = False
#End Region

    Private Sub FrmBalanceSheetPerforma1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'ERO/12/12/18-000436 by balwinder on 19/12/2018

        settSelectGLInProftAndLossPerforma = (clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.SelectGLInProftAndLossPerforma, clsFixedParameterCode.SelectGLInProftAndLossPerforma, Nothing)) > 0)
        RadLabel12.Visible = settSelectGLInProftAndLossPerforma
        SetUserMgmtNew()
    ...
    Private Sub SetUserMgmtNew()
        ''MyBase.SetUserMgmt(clsUserMgtCode.frmProfitAndLossPerforma)
    ...
    Sub SavingData()
        Try
            Dim arr As New List(Of clsProfitAndLossPerforma)
            If AllowToSave() = True Then
                ...
                For ii As Integer = 0 To gv2.Rows.Count - 1
                    Dim obj As New clsProfitAndLossPerforma()
                    ...
                    If settSelectGLInProftAndLossPerforma Then
                    ...
                    End If
                Next
                If clsProfitAndLossPerforma.SaveData(arr) = True Then
    ...
    Sub LoadBlankGrid()
        ...
        repoGroupName.IsVisible = settSelectGLInProftAndLossPerforma
        gv2.MasterTemplate.Columns.Add(repoGroupName)
    ...
    Sub LoadData()
        ...
        LoadBlankGrid()
        Dim arr As List(Of clsProfitAndLossPerforma) = clsProfitAndLossPerforma.GetData()
    ...
    Sub DeleteData()
        If common.clsCommon.MyMessageBoxShow("Do You Really Want to Delete All Data", Me.Text, MessageBoxButtons.YesNo) = System.Windows.Forms.DialogResult.Yes Then
            clsProfitAndLossPerforma.DeleteData()
            LoadBlankGrid()
            gv2.Rows.AddNew()
    ...
    Private Sub rdBtnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdBtnImport.Click
        ...
        If transportSql.importExcel(dgv, "S No", "Main Particular", "Particular", "Group Code", "Group Name", "Note", "Type", "Font Style", "Formula") Then
            Dim arr As New List(Of clsProfitAndLossPerforma)
            Dim obj As clsProfitAndLossPerforma
            Try
                ...
                For Each grow As GridViewRowInfo In dgv.Rows
                    ...
                    obj = New clsProfitAndLossPerforma
                ...
                clsProfitAndLossPerforma.SaveData(arr)
    ...
    Private Sub dbtnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dbtnExport.Click
        Try
            Dim query As String = "Select S_No as [S No],Main_Particular as [Main Particular], Particular ,Group_Code as [Group Code],Group_Name as [Group Name],Note as [Note],Type,Font_style as [Font Style],Formula from TSPL_PROFIT_AND_LOSS_PERFORMA" 'tspl_balance_sheet_performa"
        ...
        Try
            ...
            Dim arrGLMainAccount As ArrayList = Nothing
             If e.Column Is gv2.Columns(ColGLMainAccount) Then
                If clsCommon.myLen(gv2.CurrentRow.Cells(ColMainGroupCode).Value) > 0 AndAlso settSelectGLInProftAndLossPerforma Then
