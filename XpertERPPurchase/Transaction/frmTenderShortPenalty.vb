...
#End Region
    ...
    Private Sub FrmAPInvoiceEntry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        coll.Add("Short_Qty", "decimal(18, 2) NULL")
        coll.Add("Short_Tolerance", "decimal(18, 2) NULL")
        coll.Add("Penalty_Per", "decimal(18, 2) NULL")
        coll.Add("Tender_Qty", "decimal(18, 2) NULL")
        coll.Add("Tender_Rate", "decimal(18, 3) NULL")
        coll.Add("Received_Qty", "decimal(18, 2) NULL")
        coll.Add("Difference_Qty", "decimal(18,2) NULL")
        ...
        clsCommonFunctionality.CreateOrAlterTable(True, False, "TSPL_TENDER_SHORT_PENALTY", coll, "UNIQUE(Location_Code,Tender_No,Vendor_Code,Item_Code)", False, False, "", "Document_No", "Document_Date")


        coll = New Dictionary(Of String, String)
        coll.Add("PK_Id", "integer NOT NULL identity NOT FOR REPLICATION primary key")
        coll.Add("Document_No", "VARCHAR(30)  NULL REFERENCES TSPL_TENDER_SHORT_PENALTY(Document_No) ")
        coll.Add("SRN_ID", "VARCHAR(30)  NULL REFERENCES TSPL_SRN_HEAD(SRN_No) ")
        coll.Add("SRN_Qty", "decimal(18, 3) NULL")
        clsCommonFunctionality.CreateOrAlterTable(True, False, "TSPL_TENDER_SHORT_PENALTY_DETAIL", coll, Nothing, False, True, "TSPL_TENDER_SHORT_PENALTY", "Document_No", "")
    ...
    '    repoICode.HeaderImage = Global.XpertERPPurchase.My.Resources.Resources.search4
    ...
    '    ''repoLocationCode.HeaderImage = Global.XpertERPPurchase.My.Resources.Resources.search4
    ...
    '    repoCapexSubCode.HeaderImage = Global.XpertERPPurchase.My.Resources.Resources.search4
    ...
    '    repoCapexCode.HeaderImage = Global.XpertERPPurchase.My.Resources.Resources.search4
    ...
    '                                        clsCommon.MyMessageBoxShow("Entered Quantity Can't be more than Pending Quantity." + Environment.NewLine + "Entered Quantity : " + clsCommon.myCstr(dblEnteredQty) + ". Pending Quantity : " + clsCommon.myCstr(dblPendingQty))
    ...
    '                                        clsCommon.MyMessageBoxShow("Rejected Quantity Can't be more than Entered Quantity." + Environment.NewLine + "Rejected Quantity : " + clsCommon.myCstr(dblRejectedQty) + ". Entered Quantity : " + clsCommon.myCstr(dblEnteredQty))
    '                                        gv1.CurrentCell.Value = 0
    ...
    '        clsCommon.MyMessageBoxShow("Please select Row Type")
    '        Exit Sub
    '    End If
    ...
    Function AllowToSave() As Boolean
        ...
        '    Dim strchk As String = "select Status from TSPL_TENDER_SHORT_PENALTY where MRN_No='" + txtDocNo.Value + "'"
        ...
        '        clsCommon.MyMessageBoxShow("Please Select Gate Entry Date.", Me.Text)
        '        txtGEDate.Focus()
        '        Return False
        '    End If
        'End If
        ...
        '    clsCommon.MyMessageBoxShow("Please select Tax Group")
        '    txtTaxGroup.Focus()
        '    Return False
        'End If
        'If clsCommon.myLen(txtBillToLocation.Value) <= 0 Then
        '    clsCommon.MyMessageBoxShow("Please select Bill to Location")
        ...
        '    clsCommon.MyMessageBoxShow("MRN No Not found to save")
        '    txtDocNo.Focus()
        '    Return False
        'End If
        'If clsCommon.myLen(cboItemType.SelectedValue) <= 0 Then
        ...
        '            clsCommon.MyMessageBoxShow("Item " + strICode + "( " + strIName.Trim() + " ) Entered Quantity with Damage (" + clsCommon.myCstr(dblQty) + ") Can't be more Pending Quantity  (" + clsCommon.myCstr(dblPendingQty) + ").At Line No: " + clsCommon.myCstr(clsCommon.myCdbl(ii + 1)) + " ")
        '            Return False
        '        End If
        '    End If
        '    ''If clsCommon.myLen(clsCommon.myCstr(gv1.Rows(ii).Cells(colLocationCode).Value)) <= 0 Then
        '    ''    clsCommon.MyMessageBoxShow("Please select Location at Row No " + clsCommon.myCstr(clsCommon.myCdbl(ii + 1)))
        '    ''    Return False
        '    ''End If
    ...
    Private Sub txtDocNo__MYNavigator(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal NavType As common.NavigatorType) Handles txtDocNo._MYNavigator
        Try
            'Dim qst As String = "select count(*) from TSPL_TENDER_SHORT_PENALTY where MRN_No='" + txtDocNo.Value + "' and MRN_Total_Amt>0"
            Dim qst As String = "select count(*) from TSPL_TENDER_SHORT_PENALTY where MRN_No='" + txtDocNo.Value + "' "
    ...
    Private Sub txtDocNo__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtDocNo._MYValidating
        Dim qry As String = "select MRN_No as Code,FORMAT(CAST(MRN_Date AS DATETIME),'dd/MM/yyyy hh:mm tt') as Date,TSPL_TENDER_SHORT_PENALTY.Vendor_Code as [Vendor Code], TSPL_TENDER_SHORT_PENALTY.Vendor_Name as Vendor,ISNULL(TSPL_VENDOR_MASTER.alies_name,'') As [Alies Name],MRN_Total_Amt as Amount,case when TSPL_TENDER_SHORT_PENALTY.Status='0' then 'Pending' else 'Approved' end as [Status],Against_GRN as [Against GRN Code]  from TSPL_TENDER_SHORT_PENALTY"
        '' Anubhooti 12-Mar-2015 (Fetch Alies Name On Vendor Finder)
        qry += " LEFT OUTER JOIN TSPL_VENDOR_MASTER ON TSPL_VENDOR_MASTER.Vendor_Code = TSPL_TENDER_SHORT_PENALTY.Vendor_Code "
...
union all
select TSPL_TENDER_SHORT_PENALTY.Tender_No as DocumentCode,null as  DocumentDate, Location_Code as Location,Vendor_Code,Item_Code,-1 as RI,0 as Chk from TSPL_TENDER_SHORT_PENALTY where TSPL_TENDER_SHORT_PENALTY.Document_No not in ('aaaaa')
)xx 
