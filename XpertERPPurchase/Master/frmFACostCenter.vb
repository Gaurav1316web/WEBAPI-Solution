...
Public Class FrmCostCenter
    ...
    Private Sub DeleteData()
        Try
            ...
            End If
            clsCommonFunctionality.SaveDeletedData(objCommonVar.CurrentUserCode, txtCode.Value, "TSPL_CostCenter_MASTER", "Cost_Code", Nothing)
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, txtCode.Value, "TSPL_CostCenter_MASTER", "Cost_Code", Nothing)
    ...
    Private Sub btnHistory_Click(sender As Object, e As EventArgs) Handles btnHistory.Click
        Try
            If clsCommon.myLen(txtCode.Value) <= 0 Then
                ...
                Exit Sub
            End If
            clsERPFuncationalityOLD.ShowHistoryData(txtCode.Value, "Cost_Code", "TSPL_CostCenter_MASTER")
        Catch ex As Exception
