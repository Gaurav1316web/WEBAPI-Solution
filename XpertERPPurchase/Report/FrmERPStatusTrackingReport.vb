        ...
        Try
            ...
            Else
                ...
                For ii As Integer = 0 To dt.Rows.Count - 1
                    ...
                    query += ",(select FORMAT(max(Document_Date),'dd/MMM/yyyy') from [" + clsCommon.myCstr(dt.Rows(ii).Item("DataBase_Name")) + "].[dbo].TSPL_DEMAND_BOOKING_MASTER where Posted=1) as [Last Demand Date]"
