    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal trans As SqlTransaction) As List(Of clsWeighmentChemberNoDetails)
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                obj.CH_FAT_Rate = clsCommon.myCdbl(dt.Rows(0)("CH_FAT_Rate"))
                obj.CH_SNF_Rate = clsCommon.myCdbl(dt.Rows(0)("CH_SNF_Rate"))
                obj.CH_FAT_Value = clsCommon.myCdbl(dt.Rows(0)("CH_FAT_Value"))
                obj.CH_SNF_Value = clsCommon.myCdbl(dt.Rows(0)("CH_SNF_Value"))
                obj.CH_FAT_Kg = clsCommon.myCdbl(dt.Rows(0)("CH_FAT_Kg"))
                obj.CH_SNF_Kg = clsCommon.myCdbl(dt.Rows(0)("CH_SNF_Kg"))
                obj.CH_Amount = clsCommon.myCdbl(dt.Rows(0)("CH_Amount"))
