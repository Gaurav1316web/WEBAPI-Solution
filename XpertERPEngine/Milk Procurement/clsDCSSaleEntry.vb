...
#End Region
    ...
    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsDCSSaleEntry
        ...
        " ,TSPL_DCS_SALE_ENTRY.SO_Validity,TSPL_DCS_SALE_ENTRY.Commission_Apply,TSPL_DCS_SALE_ENTRY.Total_Comm_Amt,TSPL_DCS_SALE_ENTRY.Dispatch_date,TSPL_DCS_SALE_ENTRY.WayBillNo,TSPL_DCS_SALE_ENTRY.WayBillDate " &
        " ,TSPL_DCS_SALE_ENTRY.Dispatch_Terms,TSPL_DCS_SALE_ENTRY.Payment_Terms,TSPL_DCS_SALE_ENTRY.Dispatch_Period,TSPL_DCS_SALE_ENTRY.Vehicle_Capacity,TSPL_DCS_SALE_ENTRY.RoundOffAmount,TSPL_DCS_SALE_ENTRY.Is_Taxable, TSPL_DCS_SALE_ENTRY.Electronic_Ref_No " &
...
ITEMDETAIL1.Conversion_Factor As CF,TSPL_ITEM_UOM_DETAIL.Conversion_Factor As ConversionFactor,"
        ...
        End If
        Qry += " " + clsCommon.myCstr(isShowQRcode) + " as isShowQRcode, TSPL_SD_SALE_INVOICE_HEAD.EInvoice_Type ,  cast(TSPL_SD_SALE_INVOICE_HEAD.BarCode_Img as image) As BarCode_Img, TSPL_DCS_SALE_ENTRY.Bill_To_Location, TSPL_LOCATION_MASTER.Location_Desc, TSPL_DCS_SALE_ENTRY.Is_Taxable,TSPL_DCS_SALE_ENTRY.Electronic_Ref_No,TSPL_DCS_SALE_ENTRY.EWayBillNo, convert(varchar,TSPL_DCS_SALE_ENTRY.EWayBillDate,103) as EWayBillDate,  StateMasterForLocation.GST_STATE_CODE AS From_GstStateCode," &
