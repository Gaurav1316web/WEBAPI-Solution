...
Public Class clsVLCMappingForMP_PaymentProcess
    ...
    Public Shared Function GetData(ByVal strMCC As String, ByVal NavType As NavigatorType, ByRef strOutMCCCode As String) As ArrayList
        ...
        Try
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                qry = "select TSPL_VLC_MAPPING_FOR_MP_PAYMENT_PROCESS.VLC_Code from TSPL_VLC_MAPPING_FOR_MP_PAYMENT_PROCESS where MCC_Code='" + strOutMCCCode + "'"
