...
Public Class clsMCCTransportInvoice
#Region "Variables"
    ...
    Public Arr As List(Of clsMCCTransportInvoiceDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsMCCTransportInvoice, ByVal isNewEntry As Boolean) As Boolean
        ...
        Try
            ...
            If isNewEntry Then
                ...
                ElseIf clsCommon.CompairString(obj.Item_Type, "O") = CompairStringResult.Equal Then
                    obj.PI_No = clsERPFuncationality.GetNextCode(trans, obj.PI_Date, clsDocType.POInvoice, clsDocTransactionType.POOther, obj.Bill_To_Location)
                Else
            ...
            isSaved = isSaved AndAlso clsMCCTransportInvoiceDetail.SaveData(obj.PI_No, obj.Bill_To_Location, Arr, trans)
    ...
    'Public Function SaveDebitNoteEntry(ByVal obj As clsMCCTransportInvoice, ByVal trans As SqlTransaction)
    ...
    '    Dim ii As Integer = 0
    '    For Each objPIDetail As clsMCCTransportInvoiceDetail In obj.Arr
    ...
    Public Shared Function UpdateSecondaryInfo(ByVal obj As clsMCCTransportInvoice, ByVal trans As SqlTransaction) As Boolean
        Try
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsMCCTransportInvoice
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsMCCTransportInvoice
        Dim obj As clsMCCTransportInvoice = Nothing
        Dim qry As String = "SELECT TSPL_PI_HEAD.PI_No,TSPL_PI_HEAD.Vendor_Invoice_No,TSPL_PI_HEAD.PI_Date,TSPL_PI_HEAD.Vendor_Code, " & _
        " TSPL_PI_HEAD.Vendor_Name,TSPL_PI_HEAD.Status,TSPL_PI_HEAD.On_Hold,TSPL_PI_HEAD.Ref_No,TSPL_PI_HEAD.Description,TSPL_PI_HEAD.Remarks, " & _
        " TSPL_PI_HEAD.Tax_Group,TSPL_PI_HEAD.Bill_To_Location,TSPL_PI_HEAD.Ship_To_Location,TSPL_PI_HEAD.TAX1,TSPL_PI_HEAD.TAX1_Rate," & _
        " TSPL_PI_HEAD.TAX1_Amt,TSPL_PI_HEAD.TAX1_Base_Amt,TSPL_PI_HEAD.TAX2,TSPL_PI_HEAD.TAX2_Rate,TSPL_PI_HEAD.TAX2_Amt, " & _
        " TSPL_PI_HEAD.TAX2_Base_Amt,TSPL_PI_HEAD.TAX3,TSPL_PI_HEAD.TAX3_Rate,TSPL_PI_HEAD.TAX3_Amt,TSPL_PI_HEAD.TAX3_Base_Amt, " & _
        " TSPL_PI_HEAD.TAX4,TSPL_PI_HEAD.TAX4_Rate,TSPL_PI_HEAD.TAX4_Amt,TSPL_PI_HEAD.TAX4_Base_Amt,TSPL_PI_HEAD.TAX5, " & _
        " TSPL_PI_HEAD.TAX5_Rate,TSPL_PI_HEAD.TAX5_Amt,TSPL_PI_HEAD.TAX5_Base_Amt,TSPL_PI_HEAD.TAX6,TSPL_PI_HEAD.TAX6_Rate," & _
        " TSPL_PI_HEAD.TAX6_Amt,TSPL_PI_HEAD.TAX6_Base_Amt,TSPL_PI_HEAD.TAX7,TSPL_PI_HEAD.TAX7_Rate,TSPL_PI_HEAD.TAX7_Amt, " & _
        " TSPL_PI_HEAD.TAX7_Base_Amt,TSPL_PI_HEAD.TAX8,TSPL_PI_HEAD.TAX8_Rate,TSPL_PI_HEAD.TAX8_Amt,TSPL_PI_HEAD.TAX8_Base_Amt, " & _
        " TSPL_PI_HEAD.TAX9,TSPL_PI_HEAD.TAX9_Rate,TSPL_PI_HEAD.TAX9_Amt,TSPL_PI_HEAD.TAX9_Base_Amt,TSPL_PI_HEAD.TAX10, " & _
        " TSPL_PI_HEAD.TAX10_Rate,TSPL_PI_HEAD.TAX10_Amt,TSPL_PI_HEAD.TAX10_Base_Amt,TSPL_PI_HEAD.Discount_Base, " & _
        " TSPL_PI_HEAD.Discount_Amt,TSPL_PI_HEAD.Amount_Less_Discount,TSPL_PI_HEAD.Total_Tax_Amt,TSPL_PI_HEAD.Comments, " & _
        " TSPL_PI_HEAD.Comp_Code,TSPL_PI_HEAD.Terms_Code,TSPL_PI_HEAD.Due_Date ,TSPL_PI_HEAD.InvoiceDate, " & _
        ...
        " TSPL_PI_HEAD.Posting_Date,TSPL_PI_HEAD.PI_Total_Amt,TSPL_PI_HEAD.Carrier,TSPL_PI_HEAD.VehicleNo, TSPL_PI_HEAD.LR_No, " & _
        " TSPL_PI_HEAD.GRNo, TSPL_PI_HEAD.GR_Date,TSPL_PI_HEAD.GENo,TSPL_PI_HEAD.GEDate,TSPL_PI_HEAD.Item_Type,TSPL_PI_HEAD.Against_Requisition," & _
        " TSPL_PI_HEAD.Against_PO,TSPL_PI_HEAD.Against_GRN,TSPL_PI_HEAD.Against_MRN,TSPL_PI_HEAD.Against_SRN, " & _
        " TSPL_PI_HEAD.Add_Charge_Code1,TSPL_PI_HEAD.Add_Charge_Name1 ,TSPL_PI_HEAD.Add_Charge_Amt1,TSPL_PI_HEAD.Add_Charge_Code2, " & _
        " TSPL_PI_HEAD.Add_Charge_Name2,TSPL_PI_HEAD.Add_Charge_Amt2,TSPL_PI_HEAD.Add_Charge_Code3,TSPL_PI_HEAD.Add_Charge_Name3," & _
        " TSPL_PI_HEAD.Add_Charge_Amt3,TSPL_PI_HEAD.Add_Charge_Code4,TSPL_PI_HEAD.Add_Charge_Name4,TSPL_PI_HEAD.Add_Charge_Amt4, " & _
        " TSPL_PI_HEAD.Add_Charge_Code5 ,TSPL_PI_HEAD.Add_Charge_Name5, TSPL_PI_HEAD.Add_Charge_Amt5,TSPL_PI_HEAD.Add_Charge_Code6, " & _
        " TSPL_PI_HEAD.Add_Charge_Name6 ,TSPL_PI_HEAD.Add_Charge_Amt6 ,TSPL_PI_HEAD.Add_Charge_Code7 ,TSPL_PI_HEAD.Add_Charge_Name7, " & _
        " TSPL_PI_HEAD.Add_Charge_Amt7 ,TSPL_PI_HEAD.Add_Charge_Code8,TSPL_PI_HEAD.Add_Charge_Name8,TSPL_PI_HEAD.Add_Charge_Amt8 , " & _
        " TSPL_PI_HEAD.Add_Charge_Code9 ,TSPL_PI_HEAD.Add_Charge_Name9 ,TSPL_PI_HEAD.Add_Charge_Amt9 ,TSPL_PI_HEAD.Add_Charge_Code10 , " & _
        " TSPL_PI_HEAD.Add_Charge_Name10 ,TSPL_PI_HEAD.Add_Charge_Amt10 ,TSPL_PI_HEAD.Total_Add_Charge,TSPL_PI_HEAD.Tax_Calculation_Type , " & _
        " TSPL_PI_HEAD.Tot_Empty_Amount,TSPL_PI_HEAD.Dept,TSPL_PI_HEAD.Dept_Desc ,TSPL_PI_HEAD.is_Excise_On_Qty,TSPL_PI_HEAD.AssessableAmt, " & _
        " TSPL_PI_HEAD.CURRENCY_CODE,TSPL_PI_HEAD.CONVRATE,TSPL_PI_HEAD.APPLICABLEFROM,TSPL_PI_HEAD.Against_C_Form,TSPL_PI_HEAD.PROJECT_ID,TSPL_PI_HEAD.IsAbatementPO, " & _
        " TSPL_PI_HEAD.Is_Against_Form, TSPL_PI_HEAD.Against_Form, TSPL_PI_HEAD.Transporter, TSPL_PI_HEAD.Transport_Date,TSPL_PI_HEAD.TransporterDesc,TSPL_PI_HEAD.VehicleDesc " & _
        " FROM TSPL_PI_HEAD left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_PI_HEAD.Bill_To_Location " & _
        " left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_PI_HEAD.Ship_To_Location " & _
        " left outer join  TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_PI_HEAD.Tax_Group " & _
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsMCCTransportInvoice()
            ...
            qry = "SELECT TSPL_PI_DETAIL.PI_No,TSPL_PI_DETAIL.Row_Type,TSPL_PI_DETAIL.Line_No,TSPL_PI_DETAIL.Status,TSPL_PI_DETAIL.status,TSPL_PI_DETAIL.Item_Code,TSPL_PI_DETAIL.Item_Desc,TSPL_PI_DETAIL.PI_Qty,TSPL_PI_DETAIL.SRN_Id,TSPL_PI_DETAIL.Balance_Qty,TSPL_PI_DETAIL.Free_Qty,TSPL_PI_DETAIL.Unit_code,TSPL_PI_DETAIL.Location,TSPL_PI_DETAIL.Item_Cost,TSPL_PI_DETAIL.TAX1,TSPL_PI_DETAIL.TAX1_Rate,TSPL_PI_DETAIL.TAX1_Amt,TSPL_PI_DETAIL.TAX2,TSPL_PI_DETAIL.TAX2_Rate,TSPL_PI_DETAIL.TAX2_Amt,TSPL_PI_DETAIL.TAX3,TSPL_PI_DETAIL.TAX3_Rate,TSPL_PI_DETAIL.TAX3_Amt,TSPL_PI_DETAIL.TAX4,TSPL_PI_DETAIL.TAX4_Rate,TSPL_PI_DETAIL.TAX4_Amt,TSPL_PI_DETAIL.TAX5,TSPL_PI_DETAIL.TAX5_Rate,TSPL_PI_DETAIL.TAX5_Amt,TSPL_PI_DETAIL.TAX6,TSPL_PI_DETAIL.TAX6_Rate,TSPL_PI_DETAIL.TAX6_Amt,TSPL_PI_DETAIL.TAX7,TSPL_PI_DETAIL.TAX7_Rate,TSPL_PI_DETAIL.TAX7_Amt,TSPL_PI_DETAIL.TAX8,TSPL_PI_DETAIL.TAX8_Rate,TSPL_PI_DETAIL.TAX8_Amt,TSPL_PI_DETAIL.TAX9,TSPL_PI_DETAIL.TAX9_Rate,TSPL_PI_DETAIL.TAX9_Amt,TSPL_PI_DETAIL.TAX10,TSPL_PI_DETAIL.TAX10_Rate,TSPL_PI_DETAIL.TAX10_Amt,TSPL_PI_DETAIL.Amount,TSPL_PI_DETAIL.Disc_Per,TSPL_PI_DETAIL.Disc_Type,TSPL_PI_DETAIL.Disc_Amt,TSPL_PI_DETAIL.Amt_Less_Discount,TSPL_PI_DETAIL.Total_Tax_Amt,TSPL_PI_DETAIL.Item_Net_Amt,TSPL_LOCATION_MASTER.Location_Desc as LocationName,TSPL_PI_DETAIL.TAX1_Base_Amt,TSPL_PI_DETAIL.TAX2_Base_Amt,TSPL_PI_DETAIL.TAX3_Base_Amt,TSPL_PI_DETAIL.TAX4_Base_Amt,TSPL_PI_DETAIL.TAX5_Base_Amt,TSPL_PI_DETAIL.TAX6_Base_Amt,TSPL_PI_DETAIL.TAX7_Base_Amt,TSPL_PI_DETAIL.TAX8_Base_Amt,TSPL_PI_DETAIL.TAX9_Base_Amt,TSPL_PI_DETAIL.TAX10_Base_Amt,TSPL_PI_DETAIL.Bin_No,TSPL_PI_DETAIL.MRP,TSPL_PI_DETAIL.Batch_No,TSPL_PI_DETAIL.MFG_Date,TSPL_PI_DETAIL.Expiry_Date,(case when len(isnull(TSPL_PI_DETAIL.SRN_Id,''))>0 then (select MAX(SRN_Qty) from TSPL_SRN_DETAIL where TSPL_SRN_DETAIL.SRN_No=TSPL_PI_DETAIL.SRN_Id and TSPL_SRN_DETAIL.Item_Code=TSPL_PI_DETAIL.Item_Code and TSPL_SRN_DETAIL.Unit_code=TSPL_PI_DETAIL.Unit_code and ISNULL(TSPL_SRN_DETAIL.MRP,0)=isnull(TSPL_PI_DETAIL.MRP,0) and isnull(TSPL_SRN_DETAIL.Assessable,0)=isnull(TSPL_PI_DETAIL.Assessable,0))  else 0 end) as OrgSRNQty,TSPL_PI_DETAIL.Specification,TSPL_PI_DETAIL.Remarks,TSPL_PI_DETAIL.Assessable,TSPL_PI_DETAIL.AssessableAmt,TSPL_PI_DETAIL.Leak_Qty ,TSPL_PI_DETAIL.Burst_Qty,TSPL_PI_DETAIL.Short_Qty,Landed_Cost_Rate,Landed_Cost_Amount,Total_AddtionalCost_PerUnit,Total_NonRecTax_PerUnit,Total_RecTax_PerUnit,Is_Mannual_Amt,Empty_Amount,TSPL_PI_DETAIL.AbatementRate,TSPL_PI_DETAIL.AssessableMRP,TSPL_PI_DETAIL.TotalAssessableMRP,TSPL_PI_DETAIL.Reject_Qty FROM TSPL_PI_DETAIL left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_PI_DETAIL.Location where TSPL_PI_DETAIL.PI_No='" + obj.PI_No + "' ORDER BY TSPL_PI_DETAIL.Line_No"
            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.Arr = New List(Of clsMCCTransportInvoiceDetail)
                Dim objTr As clsMCCTransportInvoiceDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsMCCTransportInvoiceDetail
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String) As Boolean
        ...
        Try
            ...
            Dim obj As clsMCCTransportInvoice = clsMCCTransportInvoice.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            For Each objTr As clsMCCTransportInvoiceDetail In obj.Arr
            ...
            For Each objTr As clsMCCTransportInvoiceDetail In obj.Arr
                ...
                PIAmount = objTr.PI_Qty * objTr.Landed_Cost_Rate 'clsCommon.myCdbl(clsDBFuncationality.getSingleValue("Select (PI_Qty*Landed_Cost_Rate) AS Amount From TSPL_PI_DETAIL Where SRN_Id ='" & objTr.SRN_Id & "' And Item_Code ='" & objTr.Item_Code & "'", trans))

                DiffAmount = SRNAmount - PIAmount


                'Dim SRNNo As String = clsCommon.myCstr(clsDBFuncationality.getSingleValue(" select SRN_Id from TSPL_PI_DETAIL Where PI_No ='" + objTr.SRN_Id + "'", trans))
            ...
            qry = "Update TSPL_PI_HEAD set Status=1, Posting_Date='" + clsCommon.GetPrintDate(obj.PI_Date, "dd/MMM/yyyy") + "',Modify_By='" + objCommonVar.CurrentUserCode + "' where PI_No='" + strDocNo + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    Private Shared Function GetFirstItemCode(ByVal Arr As List(Of clsMCCTransportInvoiceDetail)) As String
        For Each objtr As clsMCCTransportInvoiceDetail In Arr
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsMCCTransportInvoice = clsMCCTransportInvoice.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
...
Public Class clsMCCTransportInvoiceDetail
#Region "Variables"
    Public PI_No As String = Nothing
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal strLocation As String, ByVal Arr As List(Of clsMCCTransportInvoiceDetail), ByVal trans As SqlTransaction) As Boolean
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsMCCTransportInvoiceDetail In Arr
                Dim coll As New Hashtable()
    ...
    Public Shared Function GetBalancePIQty(ByVal strPICode As String, ByVal strICode As String, ByVal strCurrPRNo As String, ByVal strUOM As String, ByVal dblMRP As Double, ByVal dblAssessable As Double, ByVal isForReject As Boolean) As Double
        ...
        End If
        qry += " 1 as RI  from TSPL_PI_DETAIL " & _
            " left outer join TSPL_Pi_HEAD on TSPL_Pi_HEAD.PI_No=TSPL_PI_DETAIL.PI_No where TSPL_PI_DETAIL.Status=0 and TSPL_PI_HEAD.Status=1 and TSPL_PI_DETAIL.PI_No ='" + strPICode + "' and TSPL_PI_DETAIL.Item_Code='" + strICode + "' and  TSPL_PI_DETAIL.Unit_code='" + strUOM + "' and isnull(TSPL_PI_DETAIL.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_PI_DETAIL.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "' "
        If isForReject Then
    ...
    '    qry += " select TSPL_PI_DETAIL.Item_Code as ICode,isnull( TSPL_PI_DETAIL.Reject_Qty,0) as Qty, 1 as RI  from TSPL_PI_DETAIL  left outer join TSPL_Pi_HEAD on TSPL_Pi_HEAD.PI_No=TSPL_PI_DETAIL.PI_No where TSPL_PI_DETAIL.Status=0 and TSPL_PI_HEAD.Status=1 and TSPL_PI_DETAIL.PI_No ='" + strPICode + "' and TSPL_PI_DETAIL.Item_Code='" + strICode + "' and  TSPL_PI_DETAIL.Unit_code='" + strUOM + "' and isnull(TSPL_PI_DETAIL.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_PI_DETAIL.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "' "
    '    qry += " and isnull( TSPL_PI_DETAIL.Reject_Qty,0)>0"
    '    qry += " union all  select TSPL_PR_DETAIL.Item_Code as ICode,TSPL_PR_DETAIL.PR_Qty as Qty,-1 as RI from TSPL_PR_DETAIL left outer join TSPL_PR_HEAD on TSPL_PR_HEAD.PR_No=TSPL_PR_DETAIL.PR_No where TSPL_PR_DETAIL.PI_Id='" + strPICode + "'   and TSPL_PR_DETAIL.Item_Code='" + strICode + "' and  TSPL_PR_DETAIL.Unit_code='" + strUOM + "' and isnull(TSPL_PR_DETAIL.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_PR_DETAIL.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "' and TSPL_PR_DETAIL.PR_No not in ('" + strCurrPRNo + "')"
    '    qry += " and TSPL_PR_HEAD.is_Reject_Item=1 "
    '    qry += " )Final "
