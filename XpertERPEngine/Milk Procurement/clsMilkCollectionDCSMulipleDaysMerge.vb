...
'            End If
'            clsMilkCollectionDCSMulipleDaysMergeDocument.SaveData(obj.Document_No, obj.Document_Date, obj.Arr, False, trans)
...
'        clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, clsCommon.myCstr(strCode), "TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_MERGE", "Document_No", "TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_DETAIL", "Document_No", trans)
'        Return True
'    End Function
...
'    End Function
'    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction, ByVal strDetailWhrlCls As String, ByVal strDetailOrderBy As String) As clsMilkCollectionDCSMulipleDaysMerge
'        Dim obj As clsMilkCollectionDCSMulipleDaysMerge = Nothing
'        Dim qry As String = "SELECT TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_MERGE.*,TSPL_BULK_ROUTE_MASTER.ROUTE_NAME as Route_Name , TSPL_MCC_MASTER.MCC_NAME,TSPL_MCC_MASTER.Mcc_Code_VLC_Uploader
...
'left outer join TSPL_MCC_MASTER on TSPL_MCC_MASTER.MCC_Code=TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_MERGE.MCC_Code 
'where 2=2"
'        Select Case NavType
...
'            End If
'            Dim obj As clsMilkCollectionDCSMulipleDaysMerge = clsMilkCollectionDCSMulipleDaysMerge.GetData(strCode, NavigatorType.Current, trans, "", "TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_DETAIL.Collection_Date")
'            If (obj Is Nothing OrElse clsCommon.myLen(obj.Document_No) <= 0) Then
...
'    Public Shared Function SaveData(ByVal strDocNo As String, ByVal dtDocDate As DateTime, ByVal Arr As List(Of clsMilkCollectionDCSMulipleDaysMergeDocument), ByVal IsUpdatedFromCorrection As Boolean, ByVal trans As SqlTransaction) As Boolean
...
'        Else
'            qry += " ORDER BY TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_MERGE_DOCUMENT.SNO"
'        End If
...
'                qry = "Delete from TSPL_MILK_COLLECTION_DCS_MULTIPLE_DAYS_MERGE where Document_No='" + clsCommon.myCstr(dt.Rows(0)("Document_No")) + "'"
'                clsDBFuncationality.ExecuteNonQuery(qry, trans)
'            End If
'            trans.Commit()
'        Catch ex As Exception
