...
Public Class clsPSDeliveryOrder
#Region "Variables"
    ...
    Public PendingAfterApproval As Integer = 0
    ...
    Public Arr As List(Of clsPSDeliveryOrderDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsPSDeliveryOrder, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean) As Boolean
        ...
        Try
            ...
            If isNewEntry Then
                ...
                If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
                    For Each obj11 As clsPSDeliveryOrderDetail In Arr
                ...
                If strcount > 0 Then
                    obj.Document_Code = clsERPFuncationality.GetNextCode(trans, clsCommon.myCDate(obj.Document_Date), clsDocType.frmDeliveryOrderPSForExempted, "", obj.Bill_To_Location)
                Else
                    obj.Document_Code = clsERPFuncationality.GetNextCode(trans, clsCommon.myCDate(obj.Document_Date), clsDocType.frmDeliveryPrderProductSale, "", obj.Bill_To_Location)
                End If
            ...
            clsCommon.AddColumnsForChange(coll, "PendingAfterApproval", obj.PendingAfterApproval)
            ...
            If isNewEntry Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
                ...
                If obj.Status = 2 Then
                    ...
                    "values ('Product Delivery Order','" & clsUserMgtCode.frmDeliveryPrderProductSale & "','" & obj.Document_Code & "','" & clsCommon.GetPrintDate(obj.Document_Date, "dd-MMM-yyyy") & "','Credit Limit',0,'" + objCommonVar.CurrentUserCode + "','" + clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt") + "','" + objCommonVar.CurrentUserCode + "','" + clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt") + "','" & objCommonVar.CurrentCompanyCode & "')"
                    clsDBFuncationality.ExecuteNonQuery(qry, trans)
                End If
            Else
                If obj.Status = 2 Then
                    Dim intExist As Integer = clsCommon.myCdbl(clsDBFuncationality.getSingleValue("select count(Document_No) from TSPL_TRANSACTION_APPROVAL where Program_Code='" & clsUserMgtCode.frmDeliveryPrderProductSale & "' and Document_No='" & obj.Document_Code & "' ", trans))
                    If intExist = 0 Then
                        clsCommon.AddColumnsForChange(coll, "Status", obj.Status)
                        qry = "insert into TSPL_TRANSACTION_APPROVAL(Screen_Name,Program_Code,Document_No,Doc_Date,approval_type,Approve,Created_By,Created_Date,Modified_By,Modified_Date,Comp_Code) " & _
                     "values ('Product Delivery Order','" & clsUserMgtCode.frmDeliveryPrderProductSale & "','" & obj.Document_Code & "','" & clsCommon.GetPrintDate(obj.Document_Date, "dd-MMM-yyyy") & "','Credit Limit',0,'" + objCommonVar.CurrentUserCode + "','" + clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt") + "','" + objCommonVar.CurrentUserCode + "','" + clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt") + "','" & objCommonVar.CurrentCompanyCode & "')"
                    ...
                    Else
                        If PendingAfterApproval = 1 Then
                            clsCommon.AddColumnsForChange(coll, "Is_Credit_Approved", obj.Is_Credit_Approved)
                            clsCommon.AddColumnsForChange(coll, "Status", obj.Status)
                            qry = "update TSPL_TRANSACTION_APPROVAL set Approve=0 where Document_No='" & obj.Document_Code & "' "
                            clsDBFuncationality.ExecuteNonQuery(qry, trans)
                        End If
                    End If
                    ...
                    '    clsCommon.AddColumnsForChange(coll, "Status", obj.Status)
                    '    clsCommon.AddColumnsForChange(coll, "Is_Credit_Approved", 1)
                    '    qry = "update TSPL_TRANSACTION_APPROVAL set Approve=1 where Document_No='" & obj.Document_Code & "' "
                    '    clsDBFuncationality.ExecuteNonQuery(qry, trans)
                    'comments ends here
                End If
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsPSDeliveryOrderDetail.SaveData(obj.Document_Code, Arr, trans)
            ...
            qry = "update TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE set Weight_UOM= (select Weight_UOM from TSPL_ITEM_MASTER where Item_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code)  where Document_Code='" + obj.Document_Code + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            '''' 
    ...
    Public Shared Function SaveApprovalAtTransLevel(ByVal TransID As String, ByVal ColName As String, ByVal ColValue As String, ByVal TableName As String, Optional ByVal trans As SqlTransaction = Nothing) As Boolean
        ...
        End Try
    End Function
    Public Function DemoSaveData(ByVal obj As clsPSDeliveryOrder, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean, ByVal strDatabase As String, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        'Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        ...
        Try
            ...
            Dim qry As String = "delete from " + strDatabase + ".dbo.TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE where Document_Code='" + obj.Document_Code + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            Dim strDocNo As String = ""
            If isNewEntry Then
            ...
            If isNewEntry Then
                ...
                clsCommon.AddColumnsForChange(coll, "Created_By", objCommonVar.CurrentUserCode)
                clsCommon.AddColumnsForChange(coll, "Created_Date", clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt"))
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Else
                If isMakeAbandomentNo Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsPSDeliveryOrderDetail.DemoSaveData(obj.Document_Code, Arr, trans, strDatabase)
        ...
        Return isSaved
    End Function
    Public Shared Function checkSaveNotification(ByVal obj As clsPSDeliveryOrder, ByVal trans As SqlTransaction)
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                If clsCommon.CompairString(dr("Criteria"), "Credit days") = CompairStringResult.Equal Then
                    qry += "Select COUNT(*) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE" & _
        " LEFT OUTER JOIN TSPL_SD_SHIPMENT_HEAD on TSPL_SD_SHIPMENT_HEAD.Against_Sales_Order=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code" & _
        ...
        " WHERE TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=1" & _
        " AND TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code='" + obj.Customer_Code + "'" & _
        " AND TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Due_Date<'" + clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy") + "'" & _
        " AND ISNULL(TSPL_Customer_Invoice_Head.Balance_Amt,0)<>0 "
                ...
                ElseIf clsCommon.CompairString(dr("Criteria"), "Credit Amount") = CompairStringResult.Equal Then
                    qry = "Select SUM(TSPL_Customer_Invoice_Head.Balance_Amt) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE" & _
        " LEFT OUTER JOIN TSPL_SD_SHIPMENT_HEAD on TSPL_SD_SHIPMENT_HEAD.Against_Sales_Order=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code" & _
        " LEFT OUTER JOIN TSPL_SD_SALE_INVOICE_HEAD ON TSPL_SD_SALE_INVOICE_HEAD.Against_Shipment_No=TSPL_SD_SHIPMENT_HEAD.Document_Code" & _
        " LEFT OUTER JOIN TSPL_Customer_Invoice_Head ON TSPL_Customer_Invoice_Head.Against_Sale_No=TSPL_SD_SALE_INVOICE_HEAD.Document_Code" & _
        " WHERE TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=1" & _
        " AND TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code='" + obj.Customer_Code + "'" & _
        " AND TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Date<'" + clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy") + "'" & _
        " AND ISNULL(TSPL_Customer_Invoice_Head.Balance_Amt,0)<>0 "
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsPSDeliveryOrder
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsPSDeliveryOrder
        Dim obj As clsPSDeliveryOrder = Nothing
        Dim qry As String = "SELECT TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.ChangedTCSBaseAmount,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.ActualTCSBaseAmount,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.IsSameBillShipParty, TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.PendingAfterApproval, TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Is_Taxable,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Including_Insurance,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Transport_Id,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Transporter_Name,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Posted, TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Road_Permit_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.vehicle_code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Vehicle_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Against_Booking_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Vehicle_Capacity,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.close_yn,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Cust_PO_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.price_group_code, TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Route_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Route_Desc,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Price_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.SalesOrder_Type ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Date, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.On_Hold,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Ref_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Description,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Remarks, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Tax_Group,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Bill_To_Location,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Ship_To_Location, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX1,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX1_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX1_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX1_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX2,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX2_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX2_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX2_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX3,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX3_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX3_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX3_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX4,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX4_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX4_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX4_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX5,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX5_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX5_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX5_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX6,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX6_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX6_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX6_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX7,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX7_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX7_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX7_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX8,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX8_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX8_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX8_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX9,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX9_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX9_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX9_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX10,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX10_Rate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX10_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TAX10_Base_Amt, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Discount_Base,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Discount_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Amount_Less_Discount, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Total_Tax_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Total_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Mode_Of_Transport," &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Comments,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Comp_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Terms_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Due_Date , " &
        " TSPL_LOCATION_MASTER.Location_Desc as BillToLocationName,TSPL_SHIP_TO_LOCATION.Ship_To_Desc as ShipToLocationName, " &
        " TSPL_TAX_GROUP_MASTER.Tax_Group_Desc as TaxGroupName,TSPL_TERMS_MASTER.Terms_Desc as TermsName,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Posting_Date, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Delivery_date,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Dept,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Dept_Desc,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Item_Type, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Modify_By,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Modify_Date,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Created_By," &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Created_Date,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Abandonment_No,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Against_Quotation_No, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code1,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name1,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt1, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code2,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name2,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt2, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code3,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name3,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt3, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code4,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name4,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt4, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code5,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name5,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt5, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code6,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name6,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt6, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code7,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name7,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt7, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code8,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name8,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt8, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code9 ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name9,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt9 ," &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Code10 ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Name10,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Add_Charge_Amt10, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Total_Add_Charge,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Salesman_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Salesman_Name, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.CURRENCY_CODE,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.CONVRATE,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.APPLICABLEFROM ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.PROJECT_ID,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Approvel_Required,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Is_Approved" &
        " ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.HeadDisc_Per,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.HeadDisc_PerAmt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.HeadDisc_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.TotCashDiscAmt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.CloseRemarks " &
        " ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Dispatch_Terms,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Payment_Terms,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Dispatch_Period " &
        " ,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Against_Sales_Order,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Bookingwise,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.CreditApproval_Reqd,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Is_Credit_Approved,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Cust_PODate,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Itemwise,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Advance_Percentage, " &
        " TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Total_Comm_Amt,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Commission_Apply,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.RT_Rate FROM TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Bill_To_Location " &
        " left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Ship_To_Location left outer join  " &
        " TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Tax_Group left " &
        " outer join TSPL_TERMS_MASTER on TSPL_TERMS_MASTER.Terms_Code=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Terms_Code left " &
        " outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code  where 2=2"
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 And clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code in (" + strwherecls + ") "
        ElseIf clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ")"
        ElseIf clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code in (" + strwherecls + ")"
        End If
        '-----------------------------------------------------
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code = (select MIN(Document_Code) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Last
                qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Next
                qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code = (select Min(Document_Code) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where Document_Code>'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where Document_Code<'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Current
                qry += " and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code = '" + strPONo + "'"
        End Select
        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)

        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsPSDeliveryOrder()
            obj.IsSameBillShipParty = clsCommon.myCdbl(dt.Rows(0)("IsSameBillShipParty"))
            obj.PendingAfterApproval = clsCommon.myCdbl(dt.Rows(0)("PendingAfterApproval"))
            ...
            End If
            '' END CURRENCYCONVERSION 
            qry = "SELECT TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.ItemwiseTaxCode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.AlternateRate, TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Converted_Qty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Rate_UnitQty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.OrgRateUnit_code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cash_Scheme_Amount,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cash_Scheme_Type,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cash_Scheme_Pers,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cash_Scheme_Code, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Item_UOM,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Qty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Item_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Type,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.OrgUnit_code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Ship_Party,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Booking_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Status, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Row_Type,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Quotation_Code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Balance_Qty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Location,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Cost,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX1, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX1_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX2, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX2_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX3, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX3_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX4, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX4_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX5, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX5_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX6, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX6_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX7, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX7_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX8, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX8_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX9, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX9_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX10, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX10_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Amount, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Disc_Per,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Disc_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Amt_Less_Discount, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Total_Tax_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Net_Amt,TSPL_LOCATION_MASTER.Location_Desc as LocationName, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX1_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX2_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX3_Base_Amt, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX4_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX5_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX6_Base_Amt, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX7_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX8_Base_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX9_Base_Amt, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX10_Base_Amt,(case when len(isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Quotation_Code,''))>0 then (select MAX(Qty) from TSPL_SD_QUOTATION_DETAIL where Quotation_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Quotation_Code and " & _
            "Item_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code)  else 0 end) as OriginalReqQty,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Specification, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Remarks,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable, " & _
            " TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Applicable,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Code, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Scheme_Item,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Tax,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Total_MRP_Amt, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Total_Basic_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Total_Disc_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cust_Discount, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Total_Cust_Discount,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.ActualRate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Cust_DiscountQty, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Price_code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Abatement_Per,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Abatement_Amt, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.FOC_Item,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Weight,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Price_Date,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Batch_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MFG_Date,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Expiry_Date, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TotalItem_Weight,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Conv_Factor,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Purchase_Cost,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.OrgRate, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.HeadDiscPer,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.HeadDiscPerAmt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Bin_No,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.vendor_code,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.vendor_desc,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.PrincipleCode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.PrincipleDesc,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Markup_On,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Markup_Percent,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Landing_Cost,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.HeadDiscAmt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.CustDiscPer,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.CasdDiscScheme_Code, " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.RT_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Group,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.BOOK_QTY_UOM,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.BOOK_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.BOOK_RATE_UOM,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.TAX_PAID " & _
            ",TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Manual_Item_Cost,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Commission_Rate,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Against_Sales_Order,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Commission_Party,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Commission_Amt,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Amt_Less_Commission  " & _
            ",TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Alternate_UOM,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.RATE_UOM  FROM TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on " & _
            "TSPL_LOCATION_MASTER.Location_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Location left outer join TSPL_ITEM_MASTER on " & _
            "TSPL_ITEM_MASTER.Item_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code where " & _
            "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code='" + obj.Document_Code + "' ORDER BY TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Line_No asc"

            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.Arr = New List(Of clsPSDeliveryOrderDetail)
                Dim objTr As clsPSDeliveryOrderDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsPSDeliveryOrderDetail
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, ByVal Trans As SqlTransaction) As Boolean
        ...
        Try
            ...
            Dim obj As clsPSDeliveryOrder = clsPSDeliveryOrder.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            Dim qry As String = ""
            Dim isResult As Boolean = clsApprovalScreen.CheckApprovalLevel(FormId, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", "Document_Code", strDocNo, trans)
            If isResult = False Then
                trans.Commit()
                Return False
            End If

            qry = "Update TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE set Status=4,Posted=1, Posting_Date='" + strPostDate + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + strPostDate + "' where Document_Code='" + strDocNo + "'"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)


            If clsCommon.myLen(obj.Against_Booking_No) > 0 AndAlso clsCommon.myLen(obj.Against_Sales_Order) = 0 Then
                Dim objSO As clsPSSalesOrder = ConvertDeliveryToSaleOrder(obj, Trans)
                objSO.SaveData(objSO, True, False, Trans)
                obj.Against_Sales_Order = objSO.Document_Code
                qry = "Update TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE set Against_Sales_Order='" & obj.Against_Sales_Order & "' where Document_Code='" + strDocNo + "'"
                clsDBFuncationality.ExecuteNonQuery(qry, Trans)

                qry = "Update TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE set Against_Sales_Order='" & obj.Against_Sales_Order & "' where Document_Code='" + strDocNo + "'"
                clsDBFuncationality.ExecuteNonQuery(qry, Trans)

                clsPSSalesOrder.PostData("", obj.Against_Sales_Order, Trans)
            Else
                'Dim objSO As clsPSSalesOrder = ConvertDeliveryToSaleOrder(obj, Trans)
                'objSO.SaveData(objSO, False, False, Trans)
            End If

            'trans.Commit()
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strDocNo, "TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE", "Document_Code", Trans)
        Catch ex As Exception
            'trans.Rollback() '' Commented by Panch Raj Remark: Transaction must be rollback from function where it was started.
            Throw New Exception(ex.Message)
        End Try
        Return True
    End Function
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String) As Boolean
        ...
        End Try
    End Function
    Private Shared Function ConvertDeliveryToSaleOrder(ByVal objDelivery As clsPSDeliveryOrder, ByVal trans As SqlTransaction) As clsPSSalesOrder
        ...
        End If
        obj.Document_Code = objDelivery.Against_Sales_Order
        ...
        obj.ActualTCSBaseAmount = objDelivery.ActualTCSBaseAmount
        obj.ChangedTCSBaseAmount = objDelivery.ChangedTCSBaseAmount
        ...
        For Each objDeliveryDetail As clsPSDeliveryOrderDetail In objDelivery.Arr

            Dim objTr As New clsPSSalesOrderDetail()
            If objDeliveryDetail.Scheme_Item = "N" Then
                objTr.ItemwiseTaxCode = objTr.ItemwiseTaxCode
                objTr.Line_No = objDeliveryDetail.Line_No
                objTr.Document_Code = objDelivery.Against_Sales_Order
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsPSDeliveryOrder = clsPSDeliveryOrder.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_Code) > 0) Then
            Try
                ...
                qry = "delete from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where Document_Code='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)

                qry = "delete  from  TSPL_TRANSACTION_APPROVAL where Screen_Name='Product Delivery Order' and Program_Code='" & clsUserMgtCode.frmDeliveryPrderProductSale & "' and  " & _
                      "Document_No='" & obj.Document_Code & "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    Public Shared Function IsValidCustomer(ByVal ArrPONo As List(Of String), ByVal strVendorCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code,TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Customer_Code where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Customer_Code not in ('" + strVendorCode + "')"
    ...
    Public Shared Function IsValidTaxGroupForPO(ByVal ArrPONo As List(Of String), ByVal strTaxGroupCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select Document_Code,Tax_Group from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Tax_Group not in ('" + strTaxGroupCode + "')"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                Dim msg As String = "Error. "
                For Each dr As DataRow In dt.Rows
    ...
    Public Shared Function IsValidProjectForSO(ByVal strPONo As String, ByVal strProject As String) As String
        Dim strProj As String = clsDBFuncationality.getSingleValue("select PROJECT_ID from TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE where Document_Code ='" + strPONo + "'")
        Return strProj
    End Function

    Public Shared Function ClosedData(ByVal obj As clsPSDeliveryOrder, ByVal strCode As String, ByVal strCloseRemarks As String) As Boolean
        Try
            Dim qry As String = "update TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE set close_yn='" + obj.CloseSO + "',CloseRemarks='" + strCloseRemarks + "' where comp_code='" + objCommonVar.CurrentCompanyCode + "' and document_code='" + strCode + "'"
...
Public Class clsPSDeliveryOrderDetail
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsPSDeliveryOrderDetail), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsPSDeliveryOrderDetail In Arr
                Dim coll As New Hashtable()
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    Public Shared Function DemoSaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsPSDeliveryOrderDetail), ByVal trans As SqlTransaction, ByVal strDatabase As String) As Boolean
        ...
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsPSDeliveryOrderDetail In Arr
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommon.AddColumnsForChange(coll, "HeadDiscPer", obj.HeadDiscPer)
                clsCommon.AddColumnsForChange(coll, "HeadDiscPerAmt", obj.HeadDiscPerAmt)
                clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    ...
    Public Shared Function GetBalancePOQty(ByVal strPOCode As String, ByVal strICode As String, ByVal strCurrGRNNo As String, ByVal strUOM As String, ByVal dblMRP As Double, ByVal dblAssessable As Double) As Double
        Dim qry As String = "select SUM(qty * RI) as Balance from(  " & _
            " select TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Qty as Qty,1 as RI from TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE left outer join TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE on TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Document_Code=TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code where TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Status=0 and TSPL_DELIVERY_ORDER_HEAD_PRODUCTSALE.Status=1 and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Document_Code ='" + strPOCode + "' and TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Item_Code='" + strICode + "' and  TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Unit_code='" + strUOM + "' and isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "'" & _
            " union all " & _
    ...
    Public Shared Function CompletePO(ByVal strReqCode As String, ByVal strICode As String, ByVal LineNo As Integer) As Boolean
        Dim qry As String = "update TSPL_DELIVERY_ORDER_DETAIL_PRODUCTSALE set Status ='1' where Document_Code='" + strReqCode + "' and Line_No='" + clsCommon.myCstr(LineNo) + "' and Item_Code='" + strICode + "'"
        Return clsDBFuncationality.ExecuteNonQuery(qry)
    End Function
End Class


Public Class clsPSDeliveryOrderHist
#Region "Variables"
#End Region
    ...
    Public Shared Function SaveData(ByVal strCode As String, ByVal intAmbandentNo As Integer, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        Try
            Dim obj As clsPSDeliveryOrder = clsPSDeliveryOrder.GetData(strCode, NavigatorType.Current, trans)
            Dim coll As New Hashtable()
