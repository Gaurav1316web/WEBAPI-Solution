...
#Region "Variables"
    ...
    Public Arr As List(Of clsPSDispatchAdviceDetail) = Nothing
    ...
    Public prodQty As String = Nothing
#End Region

    ''Note Very Important If any change mad in SO Head or SO Detail table allso update it's History table.

    Public Function SaveData(ByVal obj As clsPSDispatchAdvice, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean) As Boolean
        ...
        Try
            ...
            Dim qry As String = "delete from TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE where Document_Code='" + obj.Document_Code + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            Dim strDocNo As String = ""
            If isNewEntry Then


                obj.Document_Code = clsERPFuncationality.GetNextCode(trans, clsCommon.myCDate(obj.Document_Date), clsDocType.frmDispatchAdviceProductSale, "", obj.Bill_To_Location)
            ''------------------
            ...
            clsCommon.AddColumnsForChange(coll, "Bookingwise", obj.Bookingwise)
            ...
            If isNewEntry Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Else
                If isMakeAbandomentNo Then
                    obj.Abandonment_No = obj.Abandonment_No + 1
                    clsCommon.AddColumnsForChange(coll, "Abandonment_No", obj.Abandonment_No)
                End If
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsPSDispatchAdviceDetail.SaveData(obj.Document_Code, Arr, trans)
    ...
    Public Function DemoSaveData(ByVal obj As clsPSDispatchAdvice, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean, ByVal strDatabase As String, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        'Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        ...
        Try
            ...
            Dim qry As String = "delete from " + strDatabase + ".dbo.TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE where Document_Code='" + obj.Document_Code + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            Dim strDocNo As String = ""
            If isNewEntry Then
            ...
            If isNewEntry Then
                ...
                clsCommon.AddColumnsForChange(coll, "Created_By", objCommonVar.CurrentUserCode)
                clsCommon.AddColumnsForChange(coll, "Created_Date", clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt"))
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Else
                If isMakeAbandomentNo Then
                    obj.Abandonment_No = obj.Abandonment_No + 1
                    clsCommon.AddColumnsForChange(coll, "Abandonment_No", obj.Abandonment_No)
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsPSDispatchAdviceDetail.DemoSaveData(obj.Document_Code, Arr, trans, strDatabase)
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsPSDispatchAdvice
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsPSDispatchAdvice
        Dim obj As clsPSDispatchAdvice = Nothing
        Dim qry As String = "SELECT TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Transport_Id,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Transporter_Name,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Posted, TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Road_Permit_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.vehicle_code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Vehicle_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Against_Booking_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Vehicle_Capacity,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.close_yn,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Cust_PO_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.price_group_code, TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Route_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Route_Desc,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Price_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.SalesOrder_Type ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Date, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Status, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.On_Hold,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Ref_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Description,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Remarks, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Tax_Group,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Bill_To_Location,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Ship_To_Location, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX1,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX1_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX1_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX1_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX2,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX2_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX2_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX2_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX3,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX3_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX3_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX3_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX4,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX4_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX4_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX4_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX5,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX5_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX5_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX5_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX6,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX6_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX6_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX6_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX7,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX7_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX7_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX7_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX8,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX8_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX8_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX8_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX9,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX9_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX9_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX9_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX10,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX10_Rate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX10_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TAX10_Base_Amt, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Discount_Base,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Discount_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Amount_Less_Discount, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Tax_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Mode_Of_Transport," & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Comments,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Comp_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Terms_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Due_Date , " & _
        " TSPL_LOCATION_MASTER.Location_Desc as BillToLocationName,TSPL_SHIP_TO_LOCATION.Ship_To_Desc as ShipToLocationName, " & _
        " TSPL_TAX_GROUP_MASTER.Tax_Group_Desc as TaxGroupName,TSPL_TERMS_MASTER.Terms_Desc as TermsName,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Posting_Date, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Delivery_date,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Dept,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Dept_Desc,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Item_Type, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Modify_By,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Modify_Date,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Created_By," & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Created_Date,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Abandonment_No,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Against_Quotation_No, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code1,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name1,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt1, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code2,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name2,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt2, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code3,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name3,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt3, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code4,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name4,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt4, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code5,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name5,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt5, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code6,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name6,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt6, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code7,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name7,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt7, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code8,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name8,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt8, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code9 ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name9,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt9 ," & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Code10 ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Name10,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Add_Charge_Amt10, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Add_Charge,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Salesman_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Salesman_Name, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.CURRENCY_CODE,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.CONVRATE,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.APPLICABLEFROM ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.PROJECT_ID,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Approvel_Required,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Is_Approved" & _
        " ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.HeadDisc_Per,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.HeadDisc_PerAmt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.HeadDisc_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.TotCashDiscAmt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.CloseRemarks " & _
        " ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Dispatch_Terms,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Payment_Terms,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Dispatch_Period " & _
        " ,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Against_Sales_Order,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Bookingwise,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.CreditApproval_Reqd,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Is_Credit_Approved,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Cust_PODate,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Itemwise,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Advance_Percentage, " & _
        " TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Total_Comm_Amt,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Commission_Apply,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.RT_Rate FROM TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Bill_To_Location " & _
        " left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Ship_To_Location left outer join  " & _
        " TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Tax_Group left " & _
        " outer join TSPL_TERMS_MASTER on TSPL_TERMS_MASTER.Terms_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Terms_Code left " & _
        " outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code  where 2=2"
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 And clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code in (" + strwherecls + ") "
        ElseIf clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ")"
        ElseIf clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code in (" + strwherecls + ")"
        End If
        '-----------------------------------------------------
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = (select MIN(Document_Code) from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Last
                qry += " and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Next
                qry += " and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = (select Min(Document_Code) from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where Document_Code>'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where Document_Code<'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Current
                qry += " and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code = '" + strPONo + "'"
        End Select
        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)

        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsPSDispatchAdvice()
            ...
            obj.Bookingwise = clsCommon.myCdbl(dt.Rows(0)("Bookingwise"))
            ...
            obj.Vehicle_Capacity = clsCommon.myCstr(dt.Rows(0)("Vehicle_Capacity"))
            ...
            End If
            '' END CURRENCYCONVERSION 
            qry = "SELECT TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.AlternateRate, TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Converted_Qty,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Rate_UnitQty,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.OrgRateUnit_code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cash_Scheme_Amount,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cash_Scheme_Type,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cash_Scheme_Pers,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cash_Scheme_Code, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Item_UOM,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Qty,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Item_Code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Type,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.OrgUnit_code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Ship_Party,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Booking_Code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Document_Code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Line_No,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Status, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Row_Type,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Qty, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Quotation_Code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Balance_Qty,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Unit_code, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Location,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Cost,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX1, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX1_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX2, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX2_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX3, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX3_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX4, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX4_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX5, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX5_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX6, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX6_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX7, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX7_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX8, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX8_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX9, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX9_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX10, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX10_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Amount, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Disc_Per,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Disc_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Amt_Less_Discount, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Tax_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Net_Amt,TSPL_LOCATION_MASTER.Location_Desc as LocationName, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX1_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX2_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX3_Base_Amt, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX4_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX5_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX6_Base_Amt, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX7_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX8_Base_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX9_Base_Amt, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX10_Base_Amt,(case when len(isnull(TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Quotation_Code,''))>0 then (select MAX(Qty) from TSPL_SD_QUOTATION_DETAIL where Quotation_Code=TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Quotation_Code and " & _
            "Item_Code=TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code)  else 0 end) as OriginalReqQty,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Specification, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Remarks,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.MRP,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Assessable, " & _
            " TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.MRP,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Applicable,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Code, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Scheme_Item,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Tax,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_MRP_Amt, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Basic_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Disc_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cust_Discount, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Total_Cust_Discount,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.ActualRate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Cust_DiscountQty, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Price_code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Abatement_Per,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Abatement_Amt, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.FOC_Item,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Weight,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Price_Date,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Batch_No,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.MFG_Date,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Expiry_Date, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TotalItem_Weight,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Conv_Factor,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Purchase_Cost,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.OrgRate, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.HeadDiscPer,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.HeadDiscPerAmt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Bin_No,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.vendor_code,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.vendor_desc,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.PrincipleCode,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.PrincipleDesc,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Markup_On,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Markup_Percent,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Landing_Cost,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.HeadDiscAmt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.CustDiscPer,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.CasdDiscScheme_Code, " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.RT_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Group,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.BOOK_QTY_UOM,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.BOOK_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.BOOK_RATE_UOM,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.TAX_PAID " & _
            ",TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Manual_Item_Cost,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Commission_Rate,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Against_Sales_Order,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Commission_Party,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Commission_Amt,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Amt_Less_Commission  " & _
            ",TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Alternate_UOM,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.RATE_UOM  FROM TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on " & _
            "TSPL_LOCATION_MASTER.Location_Code=TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Location left outer join TSPL_ITEM_MASTER on " & _
            "TSPL_ITEM_MASTER.Item_Code=TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code where " & _
            "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Document_Code='" + obj.Document_Code + "' ORDER BY TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Line_No asc"

            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.Arr = New List(Of clsPSDispatchAdviceDetail)
                Dim objTr As clsPSDispatchAdviceDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsPSDispatchAdviceDetail
                    objTr.Converted_Qty = clsCommon.myCdbl(dr("Converted_Qty"))
                    objTr.AlternateRate = clsCommon.myCdbl(dr("AlternateRate"))
                    ...
                    objTr.Against_Sales_Order = clsCommon.myCstr(dr("Against_Sales_Order"))
                    ...
                    objTr.Booking_Code = clsCommon.myCstr(dr("Booking_Code"))
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, ByVal Trans As SqlTransaction) As Boolean
        ...
        Try
            If (clsCommon.myLen(strDocNo) <= 0) Then
                Throw New Exception("Delivery Order No not found to Post")
            End If
            Dim strPostDate As String = clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(Trans), "dd/MMM/yyyy hh:mm tt")

            Dim obj As clsPSDispatchAdvice = clsPSDispatchAdvice.GetData(strDocNo, NavigatorType.Current, Trans)
            ...
            qry = "Update TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE set Status=4,Posted=1, Posting_Date='" + strPostDate + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + strPostDate + "' where Document_Code='" + strDocNo + "'"
            clsDBFuncationality.ExecuteNonQuery(qry, Trans)
            CreateEmailingContent(obj, Trans)
    ...
    Shared Sub CreateEmailingContent(ByVal obj As clsPSDispatchAdvice, ByVal trans As SqlTransaction)
        Dim Form_ID As String = clsUserMgtCode.frmdispatchAdviceProductSale
        ...
        If dtContent IsNot Nothing AndAlso dtContent.Rows.Count > 0 Then
            If clsCommon.myLen(dtContent.Rows(0)("Email_Text")) > 0 Then
                ...
                obj.prodQty = ""
                For Each objtr As clsPSDispatchAdviceDetail In obj.Arr
                    obj.prodQty = objtr.Item_Code + " = " + clsCommon.myCstr(objtr.Qty) + ","
                Next
                obj.prodQty = obj.prodQty.Remove(obj.prodQty.Length - 1)

                objSMSH.Email_Text = objSMSH.Email_Text.Replace(frmEMailAndSMSSetting.ProdQty, obj.prodQty)
    ...
    Shared Sub CreateSMSEmailContent(ByVal Form_ID As String, ByVal obj As clsPSDispatchAdvice, ByVal trans As SqlTransaction)
        '' create sms content
        Dim dtSMSEmail As DataTable = clsDBFuncationality.GetDataTable("SELECT SMS_Text,EMail_Text from TSPL_ES_Content where Form_ID='" + clsUserMgtCode.frmdispatchAdviceProductSale + "'", trans)
        ...
        End If
        Dim strCustName = clsCommon.myCstr(clsCustomerMaster.GetName(obj.Customer_Code, trans))
        Dim strLocationName = clsCommon.myCstr(clsLocation.GetName(obj.Bill_To_Location, trans))
        'SMSCode Start
        If clsCommon.myLen(strSMSContent) > 0 Then
            Dim objSMSH As New clsSMSHead()
            objSMSH.SMS_Text = strSMSContent
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Doc_Date, clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy"))
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Doc_No, clsCommon.myCstr(obj.Document_Code))
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Cust_Code, clsCommon.myCstr(obj.Customer_Code))
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Cust_Name, strCustName)
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Loc_Code, clsCommon.myCstr(obj.Bill_To_Location))
            objSMSH.SMS_Text = objSMSH.SMS_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Loc_Name, strLocationName)
        ...
        If clsCommon.myLen(strEMailContent) > 0 Then
            ...
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Doc_Date, clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy"))
            ...
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Cust_Code, clsCommon.myCstr(obj.Customer_Code))
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Cust_Name, strCustName)
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Loc_Code, clsCommon.myCstr(obj.Bill_To_Location))
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.Loc_Name, strLocationName)
            objEmailH.Email_Text = objEmailH.Email_Text.Replace(XpertERPEngine.frmEMailAndSMSSetting.DocAmount, obj.Total_Amt)
    ...
    Public Shared Sub CreateSMSContent(ByVal strSMSContent As String, ByVal trans As SqlTransaction)
        If clsCommon.myLen(strSMSContent) > 0 Then
            ...
            objSMSH.SaveData(clsUserMgtCode.frmdispatchAdviceProductSale, objSMSH, trans)
            objSMSH = Nothing
        End If
    End Sub
    Public Shared Sub CreateEmailContent(ByVal strEmailContent As String, ByVal trans As SqlTransaction)
        'MailCode Start
        If clsCommon.myLen(strEmailContent) > 0 Then
            Dim qry As String = "SELECT EMail_Subject from TSPL_ES_Content where Form_ID='" + clsUserMgtCode.frmdispatchAdviceProductSale + "'"
            Dim EmailSubject As String = clsCommon.myCstr(clsDBFuncationality.getSingleValue("SELECT EMail_Subject from TSPL_ES_Content where Form_ID='" & clsUserMgtCode.frmdispatchAdviceProductSale & "'", trans))
            Dim objSMSH As New clsEMailHead()
        ...
        End If
    End Sub
    Private Shared Function ConvertDeliveryToSaleOrder(ByVal objDelivery As clsPSDispatchAdvice, ByVal trans As SqlTransaction) As clsPSSalesOrder
        Dim obj As New clsPSSalesOrder()
        obj = New clsPSSalesOrder()
        obj.Auto_SaleOrder = 1
        obj.RT_RATE = objDelivery.RT_RATE
        If clsCommon.myLen(objDelivery.Salesman_Code) > 0 Then
            Dim strSql As String = "select Level1_Code,Level2_Code,	Level3_Code,Level4_Code from TSPL_SALESMAN_MAPPING where Salesman_Code='" & obj.Salesman_Code & "'"
            Dim dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(strSql, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
        ...
        obj.Itemwise = objDelivery.Itemwise
        obj.Advance_Percentage = objDelivery.Advance_Percentage
        If objDelivery.Cust_PODate IsNot Nothing Then
            obj.Cust_PODate = obj.Cust_PODate
        End If

        obj.Against_Booking_No = objDelivery.Against_Booking_No
        obj.Total_Comm_Amt = objDelivery.Total_Comm_Amt
        obj.Cust_PO_No = objDelivery.Cust_PO_No
        obj.HeadDisc_Per = objDelivery.HeadDisc_Per
        obj.HeadDisc_PerAmt = objDelivery.HeadDisc_PerAmt
        obj.HeadDisc_Amt = objDelivery.HeadDisc_Amt
        obj.Road_Permit_No = objDelivery.Road_Permit_No
        obj.Price_Group_Code = objDelivery.Price_Group_Code
        obj.Route_No = objDelivery.Route_No
        obj.Route_Desc = objDelivery.Route_Desc
        obj.Price_Code = objDelivery.Price_Code
        obj.Document_Date = objDelivery.Document_Date
        obj.CloseSO = "N"
        obj.Delivery_date = objDelivery.Document_Date
        obj.Customer_Code = objDelivery.Customer_Code
        obj.Customer_Name = objDelivery.Customer_Name
        obj.Ref_No = objDelivery.Ref_No
        obj.Total_Tax_Amt = objDelivery.Total_Tax_Amt
        obj.Remarks = objDelivery.Remarks
        obj.Bill_To_Location = objDelivery.Bill_To_Location
        obj.Ship_To_Location = objDelivery.Ship_To_Location
        obj.Comments = objDelivery.Comments
        obj.On_Hold = objDelivery.On_Hold
        obj.Mode_Of_Transport = "By Road"
        obj.Description = objDelivery.Description
        obj.Tax_Group = objDelivery.Tax_Group
        obj.SalesOrder_Type = ""
        obj.Item_Type = objDelivery.Item_Type
        obj.Dept = objDelivery.Dept
        obj.Dept_Desc = objDelivery.Dept_Desc
        obj.PROJECT_ID = objDelivery.PROJECT_ID
        obj.Approvel_Required = 0
        If clsCommon.myLen(objDelivery.TAX1) > 0 Then
            obj.TAX1 = objDelivery.TAX1
            obj.TAX1_Rate = objDelivery.TAX1_Rate
            obj.TAX1_Base_Amt = objDelivery.TAX1_Base_Amt
            obj.TAX1_Amt = objDelivery.TAX1_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX2) > 0 Then
            obj.TAX2 = objDelivery.TAX2
            obj.TAX2_Rate = objDelivery.TAX2_Rate
            obj.TAX2_Base_Amt = objDelivery.TAX2_Base_Amt
            obj.TAX2_Amt = objDelivery.TAX2_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX3) > 0 Then
            obj.TAX3 = objDelivery.TAX3
            obj.TAX3_Rate = objDelivery.TAX3_Rate
            obj.TAX3_Base_Amt = objDelivery.TAX3_Base_Amt
            obj.TAX3_Amt = objDelivery.TAX3_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX4) > 0 Then
            obj.TAX4 = objDelivery.TAX4
            obj.TAX4_Rate = objDelivery.TAX4_Rate
            obj.TAX4_Base_Amt = objDelivery.TAX4_Base_Amt
            obj.TAX4_Amt = objDelivery.TAX4_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX5) > 0 Then
            obj.TAX5 = objDelivery.TAX1
            obj.TAX5_Rate = objDelivery.TAX5_Rate
            obj.TAX5_Base_Amt = objDelivery.TAX5_Base_Amt
            obj.TAX5_Amt = objDelivery.TAX5_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX6) > 0 Then
            obj.TAX6 = objDelivery.TAX6
            obj.TAX6_Rate = objDelivery.TAX6_Rate
            obj.TAX6_Base_Amt = objDelivery.TAX6_Base_Amt
            obj.TAX6_Amt = objDelivery.TAX6_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX7) > 0 Then
            obj.TAX7 = objDelivery.TAX7
            obj.TAX7_Rate = objDelivery.TAX7_Rate
            obj.TAX7_Base_Amt = objDelivery.TAX7_Base_Amt
            obj.TAX7_Amt = objDelivery.TAX7_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX8) > 0 Then
            obj.TAX8 = objDelivery.TAX8
            obj.TAX8_Rate = objDelivery.TAX8_Rate
            obj.TAX8_Base_Amt = objDelivery.TAX8_Base_Amt
            obj.TAX8_Amt = objDelivery.TAX8_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX9) > 0 Then
            obj.TAX9 = objDelivery.TAX9
            obj.TAX9_Rate = objDelivery.TAX9_Rate
            obj.TAX9_Base_Amt = objDelivery.TAX9_Base_Amt
            obj.TAX9_Amt = objDelivery.TAX9_Amt
        End If
        If clsCommon.myLen(objDelivery.TAX1) > 0 Then
            obj.TAX10 = objDelivery.TAX10
            obj.TAX10_Rate = objDelivery.TAX10_Rate
            obj.TAX10_Base_Amt = objDelivery.TAX10_Base_Amt
            obj.TAX10_Amt = objDelivery.TAX10_Amt
        End If


        obj.Terms_Code = objDelivery.Terms_Code
        obj.Due_Date = objDelivery.Due_Date
        obj.Discount_Base = objDelivery.Discount_Base
        obj.Discount_Amt = objDelivery.Discount_Amt
        obj.Amount_Less_Discount = objDelivery.Amount_Less_Discount
        obj.Total_Amt = objDelivery.Total_Amt
        obj.Abandonment_No = 0
        'obj.Against_Quotation_No = txtReqNo.Value
        obj.Against_DeliveryNo = ""
        obj.SO_Validity = 0
        obj.Commission_Apply = objDelivery.Commission_Apply
        obj.Dispatch_date = objDelivery.Dispatch_date
        obj.Vehicle_Code = objDelivery.Vehicle_Code
        obj.Vehicle_No = objDelivery.Vehicle_No
        obj.Vehicle_Capacity = objDelivery.Vehicle_Capacity
        obj.Payment_Terms = objDelivery.Payment_Terms
        obj.Dispatch_Terms = objDelivery.Dispatch_Terms
        obj.Dispatch_Period = objDelivery.Dispatch_Period
        ...
        If clsCommon.myLen(obj.Add_Charge_Code1) > 0 Then
            obj.Add_Charge_Code1 = objDelivery.Add_Charge_Code1
            obj.Add_Charge_Name1 = objDelivery.Add_Charge_Name1
            obj.Add_Charge_Amt1 = objDelivery.Add_Charge_Amt1
        End If
        If clsCommon.myLen(obj.Add_Charge_Code2) > 0 Then
            obj.Add_Charge_Code2 = objDelivery.Add_Charge_Code2
            obj.Add_Charge_Name2 = objDelivery.Add_Charge_Name2
            obj.Add_Charge_Amt2 = objDelivery.Add_Charge_Amt2
        End If
        If clsCommon.myLen(obj.Add_Charge_Code3) > 0 Then
            obj.Add_Charge_Code3 = objDelivery.Add_Charge_Code3
            obj.Add_Charge_Name3 = objDelivery.Add_Charge_Name3
            obj.Add_Charge_Amt3 = objDelivery.Add_Charge_Amt3
        End If
        If clsCommon.myLen(obj.Add_Charge_Code4) > 0 Then
            obj.Add_Charge_Code4 = objDelivery.Add_Charge_Code4
            obj.Add_Charge_Name4 = objDelivery.Add_Charge_Name4
            obj.Add_Charge_Amt4 = objDelivery.Add_Charge_Amt4
        End If
        If clsCommon.myLen(obj.Add_Charge_Code5) > 0 Then
            obj.Add_Charge_Code5 = objDelivery.Add_Charge_Code5
            obj.Add_Charge_Name1 = objDelivery.Add_Charge_Name5
            obj.Add_Charge_Amt5 = objDelivery.Add_Charge_Amt5
        End If
        If clsCommon.myLen(obj.Add_Charge_Code6) > 0 Then
            obj.Add_Charge_Code6 = objDelivery.Add_Charge_Code6
            obj.Add_Charge_Name6 = objDelivery.Add_Charge_Name6
            obj.Add_Charge_Amt6 = objDelivery.Add_Charge_Amt6
        End If
        If clsCommon.myLen(obj.Add_Charge_Code7) > 0 Then
            obj.Add_Charge_Code7 = objDelivery.Add_Charge_Code7
            obj.Add_Charge_Name7 = objDelivery.Add_Charge_Name7
            obj.Add_Charge_Amt7 = objDelivery.Add_Charge_Amt7
        End If
        If clsCommon.myLen(obj.Add_Charge_Code8) > 0 Then
            obj.Add_Charge_Code8 = objDelivery.Add_Charge_Code8
            obj.Add_Charge_Name8 = objDelivery.Add_Charge_Name8
            obj.Add_Charge_Amt8 = objDelivery.Add_Charge_Amt8
        End If
        If clsCommon.myLen(obj.Add_Charge_Code9) > 0 Then
            obj.Add_Charge_Code9 = objDelivery.Add_Charge_Code9
            obj.Add_Charge_Name9 = objDelivery.Add_Charge_Name9
            obj.Add_Charge_Amt9 = objDelivery.Add_Charge_Amt9
        End If
        If clsCommon.myLen(obj.Add_Charge_Code10) > 0 Then
            obj.Add_Charge_Code10 = objDelivery.Add_Charge_Code10
            obj.Add_Charge_Name10 = objDelivery.Add_Charge_Name10
            obj.Add_Charge_Amt10 = objDelivery.Add_Charge_Amt10
        End If
        obj.Total_Add_Charge = objDelivery.Total_Add_Charge

        obj.Salesman_Code = objDelivery.Salesman_Code
        obj.Salesman_Name = objDelivery.Salesman_Name

        obj.Arr = New List(Of clsPSSalesOrderDetail)
        For Each objDeliveryDetail As clsPSDispatchAdviceDetail In objDelivery.Arr

            Dim objTr As New clsPSSalesOrderDetail()
            If objDeliveryDetail.Scheme_Item = "N" Then
                objTr.Line_No = objDeliveryDetail.Line_No
                objTr.Alternate_UOM = objDeliveryDetail.Alternate_UOM
                objTr.RATE_UOM = objDeliveryDetail.RATE_UOM
                objTr.Manual_Item_Cost = objDeliveryDetail.Manual_Item_Cost
                objTr.Against_Booking_No = objDeliveryDetail.Booking_Code
                objTr.Item_Group = objDeliveryDetail.Item_Group
                objTr.BOOK_QTY_UOM = objDeliveryDetail.BOOK_QTY_UOM
                objTr.BOOK_Rate = objDeliveryDetail.BOOK_Rate
                objTr.BOOK_RATE_UOM = objDeliveryDetail.BOOK_RATE_UOM
                objTr.TAX_PAID = objDeliveryDetail.TAX_PAID

                objTr.Row_Type = objDeliveryDetail.Row_Type
                objTr.Item_Code = objDeliveryDetail.Item_Code
                objTr.Item_Desc = objDeliveryDetail.Item_Desc
                objTr.Qty = objDeliveryDetail.Qty
                objTr.Balance_Qty = 0
                objTr.Unit_code = objDeliveryDetail.Unit_code
                objTr.OrgUnit_code = objDeliveryDetail.OrgUnit_code
                objTr.OrgRateUnit_code = objDeliveryDetail.OrgRateUnit_code
                'objTr.Quotation_Code = clsCommon.myCstr(grow.Cells(colReqistionNo).Value)
                objTr.Location = objDeliveryDetail.Location
                objTr.Ship_Party = obj.Customer_Code
                objTr.Location = objDeliveryDetail.Location
                objTr.Item_Cost = objDeliveryDetail.Item_Cost
                objTr.Amount = objDeliveryDetail.Amount
                objTr.Disc_Per = objDeliveryDetail.Disc_Per
                objTr.Disc_Amt = objDeliveryDetail.Disc_Amt
                objTr.Amt_Less_Discount = objDeliveryDetail.Amt_Less_Discount
                objTr.TAX1 = objDeliveryDetail.TAX1
                objTr.TAX1_Base_Amt = objDeliveryDetail.TAX1_Base_Amt
                objTr.TAX1_Rate = objDeliveryDetail.TAX1_Rate
                objTr.TAX1_Amt = objDeliveryDetail.TAX1_Amt
                objTr.TAX2 = objDeliveryDetail.TAX2
                objTr.TAX2_Base_Amt = objDeliveryDetail.TAX2_Base_Amt
                objTr.TAX2_Rate = objDeliveryDetail.TAX2_Rate
                objTr.TAX2_Amt = objDeliveryDetail.TAX2_Amt
                objTr.TAX3 = objDeliveryDetail.TAX3
                objTr.TAX3_Base_Amt = objDeliveryDetail.TAX3_Base_Amt
                objTr.TAX3_Rate = objDeliveryDetail.TAX3_Rate
                objTr.TAX3_Amt = objDeliveryDetail.TAX3_Amt
                objTr.TAX4 = objDeliveryDetail.TAX4
                objTr.TAX4_Base_Amt = objDeliveryDetail.TAX4_Base_Amt
                objTr.TAX4_Rate = objDeliveryDetail.TAX4_Rate
                objTr.TAX4_Amt = objDeliveryDetail.TAX4_Amt
                objTr.TAX5 = objDeliveryDetail.TAX5
                objTr.TAX5_Base_Amt = objDeliveryDetail.TAX5_Base_Amt
                objTr.TAX5_Rate = objDeliveryDetail.TAX5_Rate
                objTr.TAX5_Amt = objDeliveryDetail.TAX5_Amt
                objTr.TAX6 = objDeliveryDetail.TAX6
                objTr.TAX6_Base_Amt = objDeliveryDetail.TAX6_Base_Amt
                objTr.TAX6_Rate = objDeliveryDetail.TAX6_Rate
                objTr.TAX6_Amt = objDeliveryDetail.TAX6_Amt
                objTr.TAX7 = objDeliveryDetail.TAX7
                objTr.TAX7_Base_Amt = objDeliveryDetail.TAX7_Base_Amt
                objTr.TAX7_Rate = objDeliveryDetail.TAX7_Rate
                objTr.TAX7_Amt = objDeliveryDetail.TAX7_Amt
                objTr.TAX8 = objDeliveryDetail.TAX8
                objTr.TAX8_Base_Amt = objDeliveryDetail.TAX8_Base_Amt
                objTr.TAX8_Rate = objDeliveryDetail.TAX8_Rate
                objTr.TAX8_Amt = objDeliveryDetail.TAX8_Amt
                objTr.TAX9 = objDeliveryDetail.TAX9
                objTr.TAX9_Base_Amt = objDeliveryDetail.TAX9_Base_Amt
                objTr.TAX9_Rate = objDeliveryDetail.TAX9_Rate
                objTr.TAX9_Amt = objDeliveryDetail.TAX9_Amt
                objTr.TAX10 = objDeliveryDetail.TAX10
                objTr.TAX10_Base_Amt = objDeliveryDetail.TAX10_Base_Amt
                objTr.TAX10_Rate = objDeliveryDetail.TAX10_Rate
                objTr.TAX10_Amt = objDeliveryDetail.TAX10_Amt
                objTr.Total_Tax_Amt = objDeliveryDetail.Total_Tax_Amt
                objTr.Item_Net_Amt = objDeliveryDetail.Item_Net_Amt
                objTr.Specification = objDeliveryDetail.Specification
                objTr.Remarks = objDeliveryDetail.Remarks
                'objTr.Location = txtBillToLocation.Value 'clsCommon.myCstr(grow.Cells(colLocationCode).Value)
                objTr.MRP = objDeliveryDetail.MRP
                objTr.Scheme_Applicable = objDeliveryDetail.Scheme_Applicable
                objTr.Scheme_Code = objDeliveryDetail.Scheme_Code
                objTr.Scheme_Item = objDeliveryDetail.Scheme_Item
                objTr.Item_Tax = objDeliveryDetail.Item_Tax
                objTr.Total_MRP_Amt = objDeliveryDetail.Total_MRP_Amt
                objTr.Total_Basic_Amt = objDeliveryDetail.Total_Basic_Amt
                objTr.Total_Disc_Amt = objDeliveryDetail.Total_Disc_Amt
                objTr.Cust_Discount = objDeliveryDetail.Cust_Discount
                objTr.Total_Cust_Discount = objDeliveryDetail.Total_Cust_Discount
                objTr.ActualRate = objDeliveryDetail.ActualRate
                objTr.Cust_DiscountQty = objDeliveryDetail.Cust_DiscountQty
                objTr.Price_Date = objDeliveryDetail.Price_Date
                objTr.Price_code = objDeliveryDetail.Price_code
                objTr.Abatement_Per = objDeliveryDetail.Abatement_Per
                objTr.Abatement_Amt = objDeliveryDetail.Abatement_Amt
                objTr.FOC_Item = objDeliveryDetail.FOC_Item

                objTr.Item_Weight = objDeliveryDetail.Item_Weight
                objTr.Conv_Factor = objDeliveryDetail.Conv_Factor
                objTr.TotalItem_Weight = objDeliveryDetail.TotalItem_Weight
                objTr.Batch_No = objDeliveryDetail.Batch_No
                objTr.Bin_No = objDeliveryDetail.Bin_No
                objTr.HeadDiscPer = objDeliveryDetail.HeadDiscPer
                objTr.HeadDiscPerAmt = objDeliveryDetail.HeadDiscPerAmt
                objTr.Expiry_Date = objDeliveryDetail.Expiry_Date
                objTr.MFG_Date = objDeliveryDetail.MFG_Date
                objTr.Markup_On = objDeliveryDetail.Markup_On
                objTr.Markup_Percent = objDeliveryDetail.Markup_Percent
                objTr.Landing_Cost = objDeliveryDetail.Landing_Cost
                objTr.CustDiscPer = objDeliveryDetail.CustDiscPer
                objTr.HeadDiscAmt = objDeliveryDetail.HeadDiscAmt
                objTr.CasdDiscScheme_Code = objDeliveryDetail.CasdDiscScheme_Code
                objTr.Purchase_Cost = objDeliveryDetail.Purchase_Cost
                objTr.OrgRate = objDeliveryDetail.OrgRate
                objTr.PrincipleCode = objDeliveryDetail.PrincipleCode
                objTr.PrincipleDesc = objDeliveryDetail.PrincipleDesc
                objTr.vendor_code = objDeliveryDetail.vendor_code
                objTr.vendor_desc = objDeliveryDetail.vendor_desc

                objTr.HeadDiscPer = objDeliveryDetail.HeadDiscPer
                objTr.HeadDiscPerAmt = objDeliveryDetail.HeadDiscPerAmt

                objTr.Commission_Rate = objDeliveryDetail.Commission_Rate
                objTr.Commission_Party = objDeliveryDetail.Commission_Party
                objTr.Commission_Amt = objDeliveryDetail.Commission_Amt
                objTr.Amt_Less_Commission = objDeliveryDetail.Amt_Less_Commission
                objTr.Ship_Party = obj.Customer_Code
                objTr.delivery_code = ""
            End If
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsPSDispatchAdvice = clsPSDispatchAdvice.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_Code) > 0) Then
            Try
                ...
                'End If
                Dim qry As String = "delete from TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE where Document_Code='" + strCode + "'"
                isSaved = clsDBFuncationality.ExecuteNonQuery(qry, trans)

                qry = "delete from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where Document_Code='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    Public Shared Function IsValidCustomer(ByVal ArrPONo As List(Of String), ByVal strVendorCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code,TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Customer_Code where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Customer_Code not in ('" + strVendorCode + "')"
    ...
    Public Shared Function IsValidTaxGroupForPO(ByVal ArrPONo As List(Of String), ByVal strTaxGroupCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select Document_Code,Tax_Group from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Tax_Group not in ('" + strTaxGroupCode + "')"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                Dim msg As String = "Error. "
                For Each dr As DataRow In dt.Rows
    ...
    Public Shared Function IsValidProjectForSO(ByVal strPONo As String, ByVal strProject As String) As String
        Dim strProj As String = clsDBFuncationality.getSingleValue("select PROJECT_ID from TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE where Document_Code ='" + strPONo + "'")
        Return strProj
    End Function

    Public Shared Function ClosedData(ByVal obj As clsPSDispatchAdvice, ByVal strCode As String, ByVal strCloseRemarks As String) As Boolean
        Try
            Dim qry As String = "update TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE set close_yn='" + obj.CloseSO + "',CloseRemarks='" + strCloseRemarks + "' where comp_code='" + objCommonVar.CurrentCompanyCode + "' and document_code='" + strCode + "'"
...
Public Class clsPSDispatchAdviceDetail
#Region "Variables"
    Public Converted_Qty As Double = 0
    Public Rate_UnitQty As Double = 0
    Public AlternateRate As Double = 0
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsPSDispatchAdviceDetail), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsPSDispatchAdviceDetail In Arr
                Dim coll As New Hashtable()
                clsCommon.AddColumnsForChange(coll, "AlternateRate", obj.AlternateRate)
                ...
                clsCommon.AddColumnsForChange(coll, "BOOK_QTY_UOM", obj.BOOK_QTY_UOM, True)
                clsCommon.AddColumnsForChange(coll, "BOOK_Rate", obj.BOOK_Rate)
                clsCommon.AddColumnsForChange(coll, "RT_Rate", obj.RT_Rate)
                clsCommon.AddColumnsForChange(coll, "BOOK_RATE_UOM", obj.BOOK_RATE_UOM, True)
                ...
                clsCommon.AddColumnsForChange(coll, "Booking_Code", obj.Booking_Code, True)
                clsCommon.AddColumnsForChange(coll, "Ship_Party", obj.Ship_Party, True)
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    Public Shared Function DemoSaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsPSDispatchAdviceDetail), ByVal trans As SqlTransaction, ByVal strDatabase As String) As Boolean
        ...
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsPSDispatchAdviceDetail In Arr
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommon.AddColumnsForChange(coll, "HeadDiscPer", obj.HeadDiscPer)
                clsCommon.AddColumnsForChange(coll, "HeadDiscPerAmt", obj.HeadDiscPerAmt)
                clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    ...
    Public Shared Function GetBalancePOQty(ByVal strPOCode As String, ByVal strICode As String, ByVal strCurrGRNNo As String, ByVal strUOM As String, ByVal dblMRP As Double, ByVal dblAssessable As Double) As Double
        Dim qry As String = "select SUM(qty * RI) as Balance from(  " & _
            " select TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Qty as Qty,1 as RI from TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE left outer join TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE on TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Document_Code=TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Document_Code where TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Status=0 and TSPL_DISPATCH_ADVICE_HEAD_PRODUCTSALE.Status=1 and TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Document_Code ='" + strPOCode + "' and TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Item_Code='" + strICode + "' and  TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Unit_code='" + strUOM + "' and isnull(TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "'" & _
            " union all " & _
    ...
    Public Shared Function CompletePO(ByVal strReqCode As String, ByVal strICode As String, ByVal LineNo As Integer) As Boolean
        Dim qry As String = "update TSPL_DISPATCH_ADVICE_DETAIL_PRODUCTSALE set Status ='1' where Document_Code='" + strReqCode + "' and Line_No='" + clsCommon.myCstr(LineNo) + "' and Item_Code='" + strICode + "'"
        Return clsDBFuncationality.ExecuteNonQuery(qry)
    End Function
End Class


Public Class clsPSDispatchAdviceHist
#Region "Variables"
#End Region
    ...
    Public Shared Function SaveData(ByVal strCode As String, ByVal intAmbandentNo As Integer, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        Try
            Dim obj As clsPSDispatchAdvice = clsPSDispatchAdvice.GetData(strCode, NavigatorType.Current, trans)
            Dim coll As New Hashtable()
