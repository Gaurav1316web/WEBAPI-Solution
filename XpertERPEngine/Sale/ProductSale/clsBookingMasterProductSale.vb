...
Public Class clsBookingMasterProductSale

#Region "Variables"
    Public Is_Taxable As Integer = 0
    Public Including_Insurance As Integer = 0
    Public BookValidity_date As DateTime = Nothing
    Public Advance_Percentage As Decimal = 0
    Public Itemwise As Integer = 0
    ...
    Public Arr As List(Of clsBookingDetailProductSale) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsBookingMasterProductSale, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean) As Boolean
        ...
        Try
            ...
            If isNewEntry Then
                obj.Document_Code = clsERPFuncationality.GetNextCode(trans, clsCommon.myCDate(obj.Document_Date), clsDocType.frmBookingProductSale, "", "")
            ...
            clsCommon.AddColumnsForChange(coll, "BookValidity_date", clsCommon.GetPrintDate(obj.BookValidity_date, "dd/MMM/yyyy hh:mm tt"))
            ...
            If isNewEntry Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_BOOKING_MASTER_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Else
                If isMakeAbandomentNo Then
                    obj.Abandonment_No = obj.Abandonment_No + 1
                    clsCommon.AddColumnsForChange(coll, "Abandonment_No", obj.Abandonment_No)
                End If
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_BOOKING_MASTER_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsBookingDetailProductSale.SaveData(obj.Document_Code, Arr, trans)
        ...
        Return isSaved
    End Function
    Public Function DemoSaveData(ByVal obj As clsBookingMasterProductSale, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean, ByVal strDatabase As String, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        'Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        ...
        Try
            ...
            Dim qry As String = "delete from " + strDatabase + ".dbo.TSPL_BOOKING_DETAIL_PRODUCTSALE where Document_Code='" + obj.Document_Code + "'"
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            Dim strDocNo As String = ""
            If isNewEntry Then
            ...
            If isNewEntry Then
                ...
                clsCommon.AddColumnsForChange(coll, "Created_By", objCommonVar.CurrentUserCode)
                clsCommon.AddColumnsForChange(coll, "Created_Date", clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt"))
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_BOOKING_MASTER_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Else
                If isMakeAbandomentNo Then
                    obj.Abandonment_No = obj.Abandonment_No + 1
                    clsCommon.AddColumnsForChange(coll, "Abandonment_No", obj.Abandonment_No)
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_BOOKING_MASTER_PRODUCTSALE", OMInsertOrUpdate.Update, "TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsBookingDetailProductSale.DemoSaveData(obj.Document_Code, Arr, trans, strDatabase)
        ...
        Return isSaved
    End Function
    Public Shared Function checkSaveNotification(ByVal obj As clsBookingMasterProductSale, ByVal trans As SqlTransaction)
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                If clsCommon.CompairString(dr("Criteria"), "Credit days") = CompairStringResult.Equal Then
                    qry += "Select COUNT(*) from TSPL_BOOKING_MASTER_PRODUCTSALE" & _
        " LEFT OUTER JOIN TSPL_SD_SHIPMENT_HEAD on TSPL_SD_SHIPMENT_HEAD.Against_Sales_Order=TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code" & _
        ...
        " WHERE TSPL_BOOKING_MASTER_PRODUCTSALE.Status=1" & _
        " AND TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code='" + obj.Customer_Code + "'" & _
        " AND TSPL_BOOKING_MASTER_PRODUCTSALE.Due_Date<'" + clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy") + "'" & _
        " AND ISNULL(TSPL_Customer_Invoice_Head.Balance_Amt,0)<>0 "
                ...
                ElseIf clsCommon.CompairString(dr("Criteria"), "Credit Amount") = CompairStringResult.Equal Then
                    qry = "Select SUM(TSPL_Customer_Invoice_Head.Balance_Amt) from TSPL_BOOKING_MASTER_PRODUCTSALE" & _
        " LEFT OUTER JOIN TSPL_SD_SHIPMENT_HEAD on TSPL_SD_SHIPMENT_HEAD.Against_Sales_Order=TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code" & _
        " LEFT OUTER JOIN TSPL_SD_SALE_INVOICE_HEAD ON TSPL_SD_SALE_INVOICE_HEAD.Against_Shipment_No=TSPL_SD_SHIPMENT_HEAD.Document_Code" & _
        " LEFT OUTER JOIN TSPL_Customer_Invoice_Head ON TSPL_Customer_Invoice_Head.Against_Sale_No=TSPL_SD_SALE_INVOICE_HEAD.Document_Code" & _
        " WHERE TSPL_BOOKING_MASTER_PRODUCTSALE.Status=1" & _
        " AND TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code='" + obj.Customer_Code + "'" & _
        " AND TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Date<'" + clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy") + "'" & _
        " AND ISNULL(TSPL_Customer_Invoice_Head.Balance_Amt,0)<>0 "
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsBookingMasterProductSale
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsBookingMasterProductSale
        Dim obj As clsBookingMasterProductSale = Nothing
        Dim qry As String = "SELECT TSPL_BOOKING_MASTER_PRODUCTSALE.Is_Taxable,TSPL_BOOKING_MASTER_PRODUCTSALE.Including_Insurance,TSPL_BOOKING_MASTER_PRODUCTSALE.BookValidity_date,TSPL_BOOKING_MASTER_PRODUCTSALE.close_yn,TSPL_BOOKING_MASTER_PRODUCTSALE.Cust_PO_No,TSPL_BOOKING_MASTER_PRODUCTSALE.price_group_code, TSPL_BOOKING_MASTER_PRODUCTSALE.Route_No,TSPL_BOOKING_MASTER_PRODUCTSALE.Route_Desc,TSPL_BOOKING_MASTER_PRODUCTSALE.Price_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.SalesOrder_Type ,TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Date, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name ,TSPL_BOOKING_MASTER_PRODUCTSALE.Status, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.On_Hold,TSPL_BOOKING_MASTER_PRODUCTSALE.Ref_No,TSPL_BOOKING_MASTER_PRODUCTSALE.Description,TSPL_BOOKING_MASTER_PRODUCTSALE.Remarks, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Tax_Group,TSPL_BOOKING_MASTER_PRODUCTSALE.Bill_To_Location,TSPL_BOOKING_MASTER_PRODUCTSALE.Ship_To_Location, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX1,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX1_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX1_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX1_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX2,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX2_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX2_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX2_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX3,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX3_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX3_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX3_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX4,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX4_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX4_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX4_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX5,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX5_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX5_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX5_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX6,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX6_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX6_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX6_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX7,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX7_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX7_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX7_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX8,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX8_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX8_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX8_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX9,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX9_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX9_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX9_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.TAX10,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX10_Rate,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX10_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TAX10_Base_Amt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Discount_Base,TSPL_BOOKING_MASTER_PRODUCTSALE.Discount_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.Amount_Less_Discount, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Total_Tax_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.Total_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.Mode_Of_Transport," & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Comments,TSPL_BOOKING_MASTER_PRODUCTSALE.Comp_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Terms_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Due_Date , " & _
        " TSPL_LOCATION_MASTER.Location_Desc as BillToLocationName,TSPL_SHIP_TO_LOCATION.Ship_To_Desc as ShipToLocationName, " & _
        " TSPL_TAX_GROUP_MASTER.Tax_Group_Desc as TaxGroupName,TSPL_TERMS_MASTER.Terms_Desc as TermsName,TSPL_BOOKING_MASTER_PRODUCTSALE.Posting_Date, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Delivery_date,TSPL_BOOKING_MASTER_PRODUCTSALE.Dept,TSPL_BOOKING_MASTER_PRODUCTSALE.Dept_Desc,TSPL_BOOKING_MASTER_PRODUCTSALE.Item_Type, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Modify_By,TSPL_BOOKING_MASTER_PRODUCTSALE.Modify_Date,TSPL_BOOKING_MASTER_PRODUCTSALE.Created_By," & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Created_Date,TSPL_BOOKING_MASTER_PRODUCTSALE.Abandonment_No,TSPL_BOOKING_MASTER_PRODUCTSALE.Against_Quotation_No, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code1,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name1,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt1, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code2,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name2,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt2, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code3,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name3,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt3, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code4,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name4,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt4, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code5,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name5,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt5, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code6,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name6,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt6, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code7,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name7,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt7, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code8,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name8,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt8, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code9 ,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name9,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt9 ," & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Code10 ,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Name10,TSPL_BOOKING_MASTER_PRODUCTSALE.Add_Charge_Amt10, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Total_Add_Charge,TSPL_BOOKING_MASTER_PRODUCTSALE.Salesman_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Salesman_Name, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.CURRENCY_CODE,TSPL_BOOKING_MASTER_PRODUCTSALE.CONVRATE,TSPL_BOOKING_MASTER_PRODUCTSALE.APPLICABLEFROM ,TSPL_BOOKING_MASTER_PRODUCTSALE.PROJECT_ID,TSPL_BOOKING_MASTER_PRODUCTSALE.Approvel_Required,TSPL_BOOKING_MASTER_PRODUCTSALE.Is_Approved" & _
        " ,TSPL_BOOKING_MASTER_PRODUCTSALE.HeadDisc_Per,TSPL_BOOKING_MASTER_PRODUCTSALE.HeadDisc_PerAmt,TSPL_BOOKING_MASTER_PRODUCTSALE.HeadDisc_Amt,TSPL_BOOKING_MASTER_PRODUCTSALE.TotCashDiscAmt, " & _
        " TSPL_BOOKING_MASTER_PRODUCTSALE.Itemwise,TSPL_BOOKING_MASTER_PRODUCTSALE.Advance_Percentage,TSPL_BOOKING_MASTER_PRODUCTSALE.Dispatch_Terms,TSPL_BOOKING_MASTER_PRODUCTSALE.Payment_Terms,TSPL_BOOKING_MASTER_PRODUCTSALE.Dispatch_Period FROM TSPL_BOOKING_MASTER_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_BOOKING_MASTER_PRODUCTSALE.Bill_To_Location " & _
        " left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_BOOKING_MASTER_PRODUCTSALE.Ship_To_Location left outer join  " & _
        " TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_BOOKING_MASTER_PRODUCTSALE.Tax_Group left " & _
        " outer join TSPL_TERMS_MASTER on TSPL_TERMS_MASTER.Terms_Code=TSPL_BOOKING_MASTER_PRODUCTSALE.Terms_Code left " & _
        " outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code  where 2=2"
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 And clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code in (" + strwherecls + ") "
        ElseIf clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            whrClas = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ")"
        ElseIf clsCommon.myLen(strwherecls) > 0 Then
            whrClas = " AND TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code in (" + strwherecls + ")"
        End If
        '-----------------------------------------------------
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code = (select MIN(Document_Code) from TSPL_BOOKING_MASTER_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Last
                qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_BOOKING_MASTER_PRODUCTSALE where 1=1 " + whrClas + ")"
            Case NavigatorType.Next
                qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code = (select Min(Document_Code) from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code>'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code = (select Max(Document_Code) from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code<'" + strPONo + "' " + whrClas + ")"
            Case NavigatorType.Current
                qry += " and TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code = '" + strPONo + "'"
        End Select
        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)

        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsBookingMasterProductSale()
            If dt.Rows(0)("BookValidity_date") IsNot DBNull.Value Then
                obj.BookValidity_date = clsCommon.myCDate(dt.Rows(0)("BookValidity_date"))
            End If
            ...
            End If
            '' END CURRENCYCONVERSION 
            qry = "SELECT  TSPL_BOOKING_DETAIL_PRODUCTSALE.OrgUnit_code,TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code,TSPL_BOOKING_DETAIL_PRODUCTSALE.Line_No,TSPL_BOOKING_DETAIL_PRODUCTSALE.Status, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Row_Type,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_BOOKING_DETAIL_PRODUCTSALE.Qty, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Quotation_Code,TSPL_BOOKING_DETAIL_PRODUCTSALE.Balance_Qty,TSPL_BOOKING_DETAIL_PRODUCTSALE.Unit_code, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Location,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Cost,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10_Rate,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Amount, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Disc_Per,TSPL_BOOKING_DETAIL_PRODUCTSALE.Disc_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Amt_Less_Discount, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Total_Tax_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Net_Amt,TSPL_LOCATION_MASTER.Location_Desc as LocationName, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX1_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX2_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX3_Base_Amt, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX4_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX5_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX6_Base_Amt, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX7_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX8_Base_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX9_Base_Amt, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX10_Base_Amt,(case when len(isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.Quotation_Code,''))>0 then (select MAX(Qty) from TSPL_SD_QUOTATION_DETAIL where Quotation_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Quotation_Code and " & _
            "Item_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code)  else 0 end) as OriginalReqQty,TSPL_BOOKING_DETAIL_PRODUCTSALE.Specification, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Remarks,TSPL_BOOKING_DETAIL_PRODUCTSALE.MRP,TSPL_BOOKING_DETAIL_PRODUCTSALE.Assessable, " & _
            " TSPL_BOOKING_DETAIL_PRODUCTSALE.MRP,TSPL_BOOKING_DETAIL_PRODUCTSALE.Scheme_Applicable,TSPL_BOOKING_DETAIL_PRODUCTSALE.Scheme_Code, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Scheme_Item,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Tax,TSPL_BOOKING_DETAIL_PRODUCTSALE.Total_MRP_Amt, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Total_Basic_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Total_Disc_Amt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Cust_Discount, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Total_Cust_Discount,TSPL_BOOKING_DETAIL_PRODUCTSALE.ActualRate,TSPL_BOOKING_DETAIL_PRODUCTSALE.Cust_DiscountQty, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Price_code,TSPL_BOOKING_DETAIL_PRODUCTSALE.Abatement_Per,TSPL_BOOKING_DETAIL_PRODUCTSALE.Abatement_Amt, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.FOC_Item,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Weight,TSPL_BOOKING_DETAIL_PRODUCTSALE.Price_Date,TSPL_BOOKING_DETAIL_PRODUCTSALE.Batch_No,TSPL_BOOKING_DETAIL_PRODUCTSALE.MFG_Date,TSPL_BOOKING_DETAIL_PRODUCTSALE.Expiry_Date, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.TotalItem_Weight,TSPL_BOOKING_DETAIL_PRODUCTSALE.Conv_Factor,TSPL_BOOKING_DETAIL_PRODUCTSALE.Purchase_Cost,TSPL_BOOKING_DETAIL_PRODUCTSALE.OrgRate, " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.HeadDiscPer,TSPL_BOOKING_DETAIL_PRODUCTSALE.HeadDiscPerAmt,TSPL_BOOKING_DETAIL_PRODUCTSALE.Bin_No,TSPL_BOOKING_DETAIL_PRODUCTSALE.vendor_code,TSPL_BOOKING_DETAIL_PRODUCTSALE.vendor_desc,TSPL_BOOKING_DETAIL_PRODUCTSALE.PrincipleCode,TSPL_BOOKING_DETAIL_PRODUCTSALE.PrincipleDesc,TSPL_BOOKING_DETAIL_PRODUCTSALE.Markup_On,TSPL_BOOKING_DETAIL_PRODUCTSALE.Markup_Percent,TSPL_BOOKING_DETAIL_PRODUCTSALE.Landing_Cost,TSPL_BOOKING_DETAIL_PRODUCTSALE.HeadDiscAmt,TSPL_BOOKING_DETAIL_PRODUCTSALE.CustDiscPer,TSPL_BOOKING_DETAIL_PRODUCTSALE.CasdDiscScheme_Code " & _
            ",TSPL_BOOKING_DETAIL_PRODUCTSALE.BOOK_RATE_UOM,TSPL_BOOKING_DETAIL_PRODUCTSALE.TAX_PAID,TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Group " & _
            "FROM TSPL_BOOKING_DETAIL_PRODUCTSALE left outer join TSPL_LOCATION_MASTER on " & _
            "TSPL_LOCATION_MASTER.Location_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Location left outer join TSPL_ITEM_MASTER on " & _
            "TSPL_ITEM_MASTER.Item_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code where " & _
            "TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code='" + obj.Document_Code + "' ORDER BY TSPL_BOOKING_DETAIL_PRODUCTSALE.Line_No asc"

            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.Arr = New List(Of clsBookingDetailProductSale)
                Dim objTr As clsBookingDetailProductSale
                For Each dr As DataRow In dt.Rows
                    objTr = New clsBookingDetailProductSale
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String) As Boolean
        ...
        Try
            If (clsCommon.myLen(strDocNo) <= 0) Then
                Throw New Exception("Booking No not found to Post")
            End If
            Dim strPostDate As String = clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy hh:mm tt")

            Dim obj As clsBookingMasterProductSale = clsBookingMasterProductSale.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            Dim qry As String = ""
            Dim isResult As Boolean = clsApprovalScreen.CheckApprovalLevel(FormId, "TSPL_BOOKING_MASTER_PRODUCTSALE", "Document_Code", strDocNo, trans)
            ...
            '    qry = "Select ISNULL(Approval_Level,'')Approval_Level, Level1_User, Level2_User, Level3_User from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code='" + strDocNo + "' "
            ...
            '        End If
            '        qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Level1_User='" + objCommonVar.CurrentUserCode + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + clsCommon.GETSERVERDATE(trans) + "' where Document_Code='" + strDocNo + "'"
            ...
            '        End If
            '        qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Level2_User='" + objCommonVar.CurrentUserCode + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + clsCommon.GETSERVERDATE(trans) + "' where Document_Code='" + strDocNo + "'"
            '        clsDBFuncationality.ExecuteNonQuery(qry, trans)
            '    Else
            '        If clsCommon.myLen(clsCommon.myCstr(dt1.Rows(0)("Level3_User"))) > 0 Then
            '            Throw New Exception("Level 3 Approval Already Done.")
            '        End If
            '        qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Level3_User='" + objCommonVar.CurrentUserCode + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + clsCommon.GETSERVERDATE(trans) + "' where Document_Code='" + strDocNo + "'"
            '        clsDBFuncationality.ExecuteNonQuery(qry, trans)
            '    End If

            '    qry = "Select Level1_User, Level2_User, Level3_User from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code='" + strDocNo + "' "
            ...
            '        qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Status=1, Posting_Date='" + strPostDate + "' where Document_Code='" + strDocNo + "' "
            '        clsDBFuncationality.ExecuteNonQuery(qry, trans)
            '    ElseIf clsCommon.CompairString(Userlevel, "Level2") = CompairStringResult.Equal Then
            '        qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Status=1, Posting_Date='" + strPostDate + "' where Document_Code='" + strDocNo + "' "
            '        clsDBFuncationality.ExecuteNonQuery(qry, trans)
            ...
            qry = "Update TSPL_BOOKING_MASTER_PRODUCTSALE set Status=1, Posting_Date='" + strPostDate + "',Modify_By='" + objCommonVar.CurrentUserCode + "', Modify_Date='" + strPostDate + "' where Document_Code='" + strDocNo + "'"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strDocNo, "TSPL_BOOKING_MASTER_PRODUCTSALE", "Document_Code", trans)
            trans.Commit()
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsBookingMasterProductSale = clsBookingMasterProductSale.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_Code) > 0) Then
            Try
                ...
                End If
                clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strCode, "TSPL_BOOKING_MASTER_PRODUCTSALE", "Document_Code", "TSPL_BOOKING_DETAIL_PRODUCTSALE", "Document_Code", trans)

                Dim qry As String = "delete from TSPL_BOOKING_DETAIL_PRODUCTSALE where Document_Code='" + strCode + "'"
                isSaved = clsDBFuncationality.ExecuteNonQuery(qry, trans)

                qry = "delete from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    Public Shared Function IsValidCustomer(ByVal ArrPONo As List(Of String), ByVal strVendorCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code,TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code,TSPL_CUSTOMER_MASTER.Customer_Name from TSPL_BOOKING_MASTER_PRODUCTSALE left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_BOOKING_MASTER_PRODUCTSALE.Customer_Code where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Customer_Code not in ('" + strVendorCode + "')"
    ...
    Public Shared Function IsValidTaxGroupForPO(ByVal ArrPONo As List(Of String), ByVal strTaxGroupCode As String) As Boolean
        If ArrPONo IsNot Nothing AndAlso ArrPONo.Count > 0 Then
            Dim qry As String = "select Document_Code,Tax_Group from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code  in (" + clsCommon.GetMulcallString(ArrPONo) + ") and Tax_Group not in ('" + strTaxGroupCode + "')"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                Dim msg As String = "Error. "
                For Each dr As DataRow In dt.Rows
    ...
    Public Shared Function IsValidProjectForSO(ByVal strPONo As String, ByVal strProject As String) As String
        Dim strProj As String = clsDBFuncationality.getSingleValue("select PROJECT_ID from TSPL_BOOKING_MASTER_PRODUCTSALE where Document_Code ='" + strPONo + "'")
        Return strProj
    End Function

    Public Shared Function ClosedData(ByVal obj As clsBookingMasterProductSale, ByVal strCode As String, ByVal strCloseRemarks As String) As Boolean
        Try
            Dim qry As String = "update TSPL_BOOKING_MASTER_PRODUCTSALE set close_yn='" + obj.CloseSO + "' where comp_code='" + objCommonVar.CurrentCompanyCode + "' and document_code='" + strCode + "'"
...
Public Class clsBookingDetailProductSale
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsBookingDetailProductSale), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsBookingDetailProductSale In Arr
                Dim coll As New Hashtable()
                ...
                clsCommon.AddColumnsForChange(coll, "OrgUnit_code", obj.OrgUnit_code, True)
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_BOOKING_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    Public Shared Function DemoSaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsBookingDetailProductSale), ByVal trans As SqlTransaction, ByVal strDatabase As String) As Boolean
        ...
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsBookingDetailProductSale In Arr
               ...
               "TSPL_ITEM_PRICE_MASTER.Item_Basic_Net=" & obj.MRP & " and TSPL_ITEM_PRICE_MASTER.UOM='" & obj.Unit_code & "' "
                ...
                clsCommon.AddColumnsForChange(coll, "HeadDiscPer", obj.HeadDiscPer)
                clsCommon.AddColumnsForChange(coll, "HeadDiscPerAmt", obj.HeadDiscPerAmt)
                clsCommonFunctionality.UpdateDataTable(coll, strDatabase + ".dbo.TSPL_BOOKING_DETAIL_PRODUCTSALE", OMInsertOrUpdate.Insert, "", trans)
            Next
        End If
        Return True
    End Function
    ...
    Public Shared Function GetBalancePOQty(ByVal strPOCode As String, ByVal strICode As String, ByVal strCurrGRNNo As String, ByVal strUOM As String, ByVal dblMRP As Double, ByVal dblAssessable As Double) As Double
        Dim qry As String = "select SUM(qty * RI) as Balance from(  " & _
            " select TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code as ICode,TSPL_BOOKING_DETAIL_PRODUCTSALE.Qty as Qty,1 as RI from TSPL_BOOKING_DETAIL_PRODUCTSALE left outer join TSPL_BOOKING_MASTER_PRODUCTSALE on TSPL_BOOKING_MASTER_PRODUCTSALE.Document_Code=TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code where TSPL_BOOKING_DETAIL_PRODUCTSALE.Status=0 and TSPL_BOOKING_MASTER_PRODUCTSALE.Status=1 and TSPL_BOOKING_DETAIL_PRODUCTSALE.Document_Code ='" + strPOCode + "' and TSPL_BOOKING_DETAIL_PRODUCTSALE.Item_Code='" + strICode + "' and  TSPL_BOOKING_DETAIL_PRODUCTSALE.Unit_code='" + strUOM + "' and isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_BOOKING_DETAIL_PRODUCTSALE.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "'" & _
            " union all " & _
    ...
    Public Shared Function CompletePO(ByVal strReqCode As String, ByVal strICode As String, ByVal LineNo As Integer) As Boolean
        Dim qry As String = "update TSPL_BOOKING_DETAIL_PRODUCTSALE set Status ='1' where Document_Code='" + strReqCode + "' and Line_No='" + clsCommon.myCstr(LineNo) + "' and Item_Code='" + strICode + "'"
