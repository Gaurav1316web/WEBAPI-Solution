...
Public Class clsMccMaterialSaleReturnFarmer
#Region "Variables"
    ...
    Public Arr As List(Of clsMccMaterialSaleReturnFarmerDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsMccMaterialSaleReturnFarmer, ByVal isNewEntry As Boolean) As Boolean
        Dim isSaved As Boolean = True
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        Try
            '' Anubhooti 06-Sep-2014 BM00000003735
            'clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Sales And Distribution", "Sale Return Farmer", obj.Bill_To_Location, obj.Document_Date, trans)
            '==shivani
            'clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Milk Procurement MCC", "MCC Material Sale Return Farmer", obj.Bill_To_Location, obj.Document_Date, trans)
            clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleFarmerPayment, clsUserMgtCode.frmMCCMaterialSaleReturnFarmer, obj.Bill_To_Location, obj.Document_Date, trans)
            ...
            If isNewEntry Then
                obj.Document_Code = clsERPFuncationality.GetNextCode(trans, obj.Document_Date, clsDocType.frmMCCMaterialSaleReturnFarmer, "", obj.Bill_To_Location)
            ...
            If isNewEntry Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_MCC_Sale_Return_Head_Farmer", OMInsertOrUpdate.Insert, "", trans)
            Else
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_MCC_Sale_Return_Head_Farmer", OMInsertOrUpdate.Update, "TSPL_MCC_Sale_Return_Head_Farmer.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsMccMaterialSaleReturnFarmerDetail.SaveData(obj.Document_Code, obj.Document_Date, Arr, trans)
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsMccMaterialSaleReturnFarmer
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsMccMaterialSaleReturnFarmer
        Dim obj As clsMccMaterialSaleReturnFarmer = Nothing
        Dim qry As String = "SELECT  TSPL_MCC_Sale_Return_Head_Farmer.Return_Type,TSPL_MCC_Sale_Return_Head_Farmer.HeadDisc_PerAmt,TSPL_MCC_Sale_Return_Head_Farmer.Cust_PO_No,TSPL_MCC_Sale_Return_Head_Farmer.VehicleNo, TSPL_MCC_Sale_Return_Head_Farmer.Vehicle_Code,TSPL_MCC_Sale_Return_Head_Farmer.price_group_code , " & _
        "TSPL_MCC_Sale_Return_Head_Farmer.Invoice_Type,TSPL_MCC_Sale_Return_Head_Farmer.HeadDisc_Per,TSPL_MCC_Sale_Return_Head_Farmer.HeadDisc_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TotCashDiscAmt,TSPL_MCC_Sale_Return_Head_Farmer.Route_No,TSPL_MCC_Sale_Return_Head_Farmer.Route_Desc,TSPL_MCC_Sale_Return_Head_Farmer.Price_Code, TSPL_MCC_Sale_Return_Head_Farmer.Document_Code,TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,TSPL_MCC_Sale_Return_Head_Farmer.Farmer_Code,TSPL_MP_MASTER.MP_NAME,TSPL_MCC_Sale_Return_Head_Farmer.Status,TSPL_MCC_Sale_Return_Head_Farmer.On_Hold,TSPL_MCC_Sale_Return_Head_Farmer.Ref_No,TSPL_MCC_Sale_Return_Head_Farmer.Description,TSPL_MCC_Sale_Return_Head_Farmer.Remarks,TSPL_MCC_Sale_Return_Head_Farmer.Tax_Group,TSPL_MCC_Sale_Return_Head_Farmer.Bill_To_Location,TSPL_MCC_Sale_Return_Head_Farmer.Ship_To_Location,TSPL_MCC_Sale_Return_Head_Farmer.TAX1,TSPL_MCC_Sale_Return_Head_Farmer.TAX1_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX1_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX1_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX2,TSPL_MCC_Sale_Return_Head_Farmer.TAX2_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX2_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX2_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX3,TSPL_MCC_Sale_Return_Head_Farmer.TAX3_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX3_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX3_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX4,TSPL_MCC_Sale_Return_Head_Farmer.TAX4_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX4_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX4_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX5,TSPL_MCC_Sale_Return_Head_Farmer.TAX5_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX5_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX5_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX6,TSPL_MCC_Sale_Return_Head_Farmer.TAX6_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX6_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX6_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX7,TSPL_MCC_Sale_Return_Head_Farmer.TAX7_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX7_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX7_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX8,TSPL_MCC_Sale_Return_Head_Farmer.TAX8_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX8_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX8_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX9,TSPL_MCC_Sale_Return_Head_Farmer.TAX9_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX9_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX9_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX10,TSPL_MCC_Sale_Return_Head_Farmer.TAX10_Rate,TSPL_MCC_Sale_Return_Head_Farmer.TAX10_Amt,TSPL_MCC_Sale_Return_Head_Farmer.TAX10_Base_Amt,TSPL_MCC_Sale_Return_Head_Farmer.Discount_Base,TSPL_MCC_Sale_Return_Head_Farmer.Discount_Amt,TSPL_MCC_Sale_Return_Head_Farmer.Amount_Less_Discount,TSPL_MCC_Sale_Return_Head_Farmer.Total_Tax_Amt,TSPL_MCC_Sale_Return_Head_Farmer.Comments,TSPL_MCC_Sale_Return_Head_Farmer.Comp_Code,TSPL_MCC_Sale_Return_Head_Farmer.Terms_Code,TSPL_MCC_Sale_Return_Head_Farmer.Due_Date ,TSPL_LOCATION_MASTER.Location_Desc as BillToLocationName,TSPL_SHIP_TO_LOCATION.Ship_To_Desc as ShipToLocationName,TSPL_TAX_GROUP_MASTER.Tax_Group_Desc as TaxGroupName,TSPL_TERMS_MASTER.Terms_Desc as TermsName,TSPL_MCC_Sale_Return_Head_Farmer.Posting_Date,TSPL_MCC_Sale_Return_Head_Farmer.Total_Amt,TSPL_MCC_Sale_Return_Head_Farmer.Carrier,TSPL_MCC_Sale_Return_Head_Farmer.VehicleNo,TSPL_MCC_Sale_Return_Head_Farmer.GRNo,TSPL_MCC_Sale_Return_Head_Farmer.GENo,TSPL_MCC_Sale_Return_Head_Farmer.GEDate, TSPL_MCC_Sale_Return_Head_Farmer.Dept,TSPL_MCC_Sale_Return_Head_Farmer.Dept_Desc,TSPL_MCC_Sale_Return_Head_Farmer.Item_Type,TSPL_MCC_Sale_Return_Head_Farmer.Against_Invoice_No ,TSPL_MCC_Sale_Return_Head_Farmer.Against_Invoice_No,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code1,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name1,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt1,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code2,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name2,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt2,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code3,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name3,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt3,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code4,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name4,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt4,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code5,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name5,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt5,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code6,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name6,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt6,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code7,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name7,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt7,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code8,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name8,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt8,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code9 ,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name9,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt9 ,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Code10 ,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name10,TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt10,TSPL_MCC_Sale_Return_Head_Farmer.Total_Add_Charge,TSPL_MCC_Sale_Return_Head_Farmer.Tax_Calculation_Type,TSPL_MCC_Sale_Return_Head_Farmer.Challan_No, TSPL_MCC_Sale_Return_Head_Farmer.Challan_Date, TSPL_MCC_Sale_Return_Head_Farmer.Inv_Date,TSPL_MCC_Sale_Return_Head_Farmer.Inv_No,TSPL_MCC_Sale_Return_Head_Farmer.Is_Internal ,TSPL_MCC_Sale_Return_Head_Farmer.Salesman_Code ,TSPL_MCC_Sale_Return_Head_Farmer.Salesman_Name,"
        qry += " TSPL_MCC_Sale_Return_Head_Farmer.CURRENCY_CODE,TSPL_MCC_Sale_Return_Head_Farmer.CONVRATE,TSPL_MCC_Sale_Return_Head_Farmer.APPLICABLEFROM,TSPL_MCC_Sale_Return_Head_Farmer.PROJECT_ID,TSPL_MCC_Sale_Return_Head_Farmer.Total_Amt,TSPL_MCC_Sale_Return_Head_Farmer.Balance_Amt "
        qry += " FROM TSPL_MCC_Sale_Return_Head_Farmer"
        qry += " left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_MCC_Sale_Return_Head_Farmer.Bill_To_Location "
        qry += " left outer join TSPL_SHIP_TO_LOCATION on TSPL_SHIP_TO_LOCATION.Ship_To_Code=TSPL_MCC_Sale_Return_Head_Farmer.Ship_To_Location "
        qry += " left outer join  TSPL_TAX_GROUP_MASTER on TSPL_TAX_GROUP_MASTER.Tax_Group_Code= TSPL_MCC_Sale_Return_Head_Farmer.Tax_Group "
        qry += " left outer join TSPL_TERMS_MASTER on TSPL_TERMS_MASTER.Terms_Code=TSPL_MCC_Sale_Return_Head_Farmer.Terms_Code "
        qry += " left outer join TSPL_MP_MASTER on TSPL_MP_MASTER.MP_CODE=TSPL_MCC_Sale_Return_Head_Farmer.Farmer_Code where TSPL_MCC_Sale_Return_Head_Farmer.Trans_Type='MCC'"
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 And clsCommon.myLen(strwherecls) > 0 Then
            whrCls = " AND Bill_To_Location in (" + objCommonVar.strCurrUserLocations + ") and TSPL_MCC_Sale_Return_Head_Farmer.Farmer_Code in (" + strwherecls + ") "
        ...
        ElseIf clsCommon.myLen(strwherecls) > 0 Then
            whrCls = " AND TSPL_MCC_Sale_Return_Head_Farmer.Farmer_Code in (" + strwherecls + ")"
        End If
        '-----------------------------------------------------
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code = (select MIN(Document_Code) from TSPL_MCC_Sale_Return_Head_Farmer WHERE 1=1 " + whrCls + ")"
            Case NavigatorType.Last
                qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code = (select Max(Document_Code) from TSPL_MCC_Sale_Return_Head_Farmer WHERE 1=1 " + whrCls + ")"
            Case NavigatorType.Current
                qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code = '" + strPONo + "'"
            Case NavigatorType.Next
                qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code = (select Min(Document_Code) from TSPL_MCC_Sale_Return_Head_Farmer where Document_Code>'" + strPONo + "' " + whrCls + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code = (select Max(Document_Code) from TSPL_MCC_Sale_Return_Head_Farmer where Document_Code<'" + strPONo + "' " + whrCls + ")"
        End Select
        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)

        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsMccMaterialSaleReturnFarmer()
            ...
            obj.Farmer_Name = clsCommon.myCstr(dt.Rows(0)("MP_NAME"))
            ...
            qry = "SELECT TSPL_MCC_Sale_Return_Detail_Farmer.InvoiceScheme_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Cash_Scheme_Amount,TSPL_MCC_Sale_Return_Detail_Farmer.Cash_Scheme_Type,TSPL_MCC_Sale_Return_Detail_Farmer.Cash_Scheme_Pers,TSPL_MCC_Sale_Return_Detail_Farmer.Cash_Scheme_Code,TSPL_MCC_Sale_Return_Detail_Farmer.TAX_PAID ,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Group, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Item_UOM,TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Item_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Type,TSPL_MCC_Sale_Return_Detail_Farmer.Alternate_UOM,TSPL_MCC_Sale_Return_Detail_Farmer.RATE_UOM , TSPL_MCC_Sale_Return_Detail_Farmer.OrgUnit_code,TSPL_MCC_Sale_Return_Detail_Farmer.Is_Mannual_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Line_No, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Status,TSPL_MCC_Sale_Return_Detail_Farmer.Row_Type,TSPL_MCC_Sale_Return_Detail_Farmer.status,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code, " & _
            "TSPL_ITEM_MASTER.Item_Desc,TSPL_MCC_Sale_Return_Detail_Farmer.Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Free_Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Invoice_Code, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Invoice_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Balance_Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Unit_code, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Location,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Cost,TSPL_MCC_Sale_Return_Detail_Farmer.TAX1,TSPL_MCC_Sale_Return_Detail_Farmer.TAX1_Rate, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX1_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX2,TSPL_MCC_Sale_Return_Detail_Farmer.TAX2_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX2_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX3,TSPL_MCC_Sale_Return_Detail_Farmer.TAX3_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX3_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX4, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX4_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX4_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX5,TSPL_MCC_Sale_Return_Detail_Farmer.TAX5_Rate, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX5_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX6,TSPL_MCC_Sale_Return_Detail_Farmer.TAX6_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX6_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX7,TSPL_MCC_Sale_Return_Detail_Farmer.TAX7_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX7_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX8, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX8_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX8_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX9,TSPL_MCC_Sale_Return_Detail_Farmer.TAX9_Rate, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX9_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX10,TSPL_MCC_Sale_Return_Detail_Farmer.TAX10_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.TAX10_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Amount,TSPL_MCC_Sale_Return_Detail_Farmer.Disc_Per,TSPL_MCC_Sale_Return_Detail_Farmer.Disc_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Amt_Less_Discount,TSPL_MCC_Sale_Return_Detail_Farmer.Total_Tax_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Net_Amt, " & _
            "TSPL_LOCATION_MASTER.Location_Desc as LocationName,TSPL_MCC_Sale_Return_Detail_Farmer.TAX1_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX2_Base_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX3_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX4_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX5_Base_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX6_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX7_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX8_Base_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.TAX9_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.TAX10_Base_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.MRP , " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Batch_No,TSPL_MCC_Sale_Return_Detail_Farmer.MFG_Date,TSPL_MCC_Sale_Return_Detail_Farmer.Expiry_Date, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Specification,TSPL_MCC_Sale_Return_Detail_Farmer.Remarks,TSPL_MCC_Sale_Return_Detail_Farmer.Assessable, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.AssessableAmt,TSPL_MCC_Sale_Return_Detail_Farmer.DamageQty,TSPL_MCC_Sale_Return_Detail_Farmer.Return_Amount,TSPL_MCC_Sale_Return_Detail_Farmer.Damage_Amount, " & _
             "TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Applicable,TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Code, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Scheme_Item,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Tax,TSPL_MCC_Sale_Return_Detail_Farmer.Total_MRP_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Total_Basic_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.Total_Disc_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.Cust_Discount, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Total_Cust_Discount,TSPL_MCC_Sale_Return_Detail_Farmer.ActualRate,TSPL_MCC_Sale_Return_Detail_Farmer.Cust_DiscountQty, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Price_code,TSPL_MCC_Sale_Return_Detail_Farmer.Abatement_Per,TSPL_MCC_Sale_Return_Detail_Farmer.Abatement_Amt, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.FOC_Item,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Weight,TSPL_MCC_Sale_Return_Detail_Farmer.Price_Date, " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.Bin_No,TSPL_MCC_Sale_Return_Detail_Farmer.vendor_code,TSPL_MCC_Sale_Return_Detail_Farmer.vendor_desc,TSPL_MCC_Sale_Return_Detail_Farmer.PrincipleCode,TSPL_MCC_Sale_Return_Detail_Farmer.PrincipleDesc,TSPL_MCC_Sale_Return_Detail_Farmer.TotalItem_Weight,TSPL_MCC_Sale_Return_Detail_Farmer.Conv_Factor,TSPL_MCC_Sale_Return_Detail_Farmer.Purchase_Cost,TSPL_MCC_Sale_Return_Detail_Farmer.OrgRate,  " & _
            "TSPL_MCC_Sale_Return_Detail_Farmer.HeadDiscPer,TSPL_MCC_Sale_Return_Detail_Farmer.HeadDiscPerAmt,TSPL_MCC_Sale_Return_Detail_Farmer.Markup_On,TSPL_MCC_Sale_Return_Detail_Farmer.Markup_Percent,TSPL_MCC_Sale_Return_Detail_Farmer.Landing_Cost,TSPL_MCC_Sale_Return_Detail_Farmer.HeadDiscAmt,TSPL_MCC_Sale_Return_Detail_Farmer.CustDiscPer,TSPL_MCC_Sale_Return_Detail_Farmer.CasdDiscScheme_Code "
            qry += " FROM TSPL_MCC_Sale_Return_Detail_Farmer "
            qry += " left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_MCC_Sale_Return_Detail_Farmer.Location "
            qry += " left outer join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER.Item_Code=TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code"
            qry += " where TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code='" + obj.Document_Code + "' ORDER BY TSPL_MCC_Sale_Return_Detail_Farmer.Line_No"
            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.Arr = New List(Of clsMccMaterialSaleReturnFarmerDetail)
                Dim objTr As clsMccMaterialSaleReturnFarmerDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsMccMaterialSaleReturnFarmerDetail
                    ...
                    objTr.arrSrItem = clsSerializeInvenotry.GetData("Sale Return Farmer", objTr.Document_Code, objTr.Item_Code, objTr.Line_No, trans)
                    objTr.arrBatchItem = clsBatchInventory.GetData("MCC-MSR-F", objTr.Document_Code, objTr.Item_Code, objTr.Line_No, trans)
                    obj.Arr.Add(objTr)
                Next
            End If
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, Optional ByVal strVoucherNoForRecreatedOnly As String = Nothing) As Boolean
        ...
        Try
            ...
            End If
            Dim obj As clsMccMaterialSaleReturnFarmer = clsMccMaterialSaleReturnFarmer.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            Dim isResult As Boolean = clsApprovalScreen.CheckApprovalLevel(FormId, "TSPL_MCC_Sale_Return_Head_Farmer", "Document_Code", obj.Document_Code, trans)
            ...
            For Each objTr As clsMccMaterialSaleReturnFarmerDetail In obj.Arr
                ...
                If clsCommon.CompairString(objTr.Row_Type, clsItemRowType.RowTypeItem) = CompairStringResult.Equal Then
                    ...
                    Dim objInv As clsMCCMaterialSaleFarmer
                    Dim arr As New List(Of String)
                    Dim dblCogsBasicCost As Double
                    objInv = clsMCCMaterialSaleFarmer.GetData(objTr.Invoice_Code, NavigatorType.Current, trans)
                    If Not objInv Is Nothing Then
                        For Each objInvDetail As clsMCCMaterialSaleFarmerDetail In objInv.Arr
                            ...
                            "Source_Doc_No='" & objTr.Invoice_Code & "' And TSPL_INVENTORY_MOVEMENT.Item_Code='" & objTr.Item_Code & "'", trans))
                            End If
                        Next
                    End If
                    '''' COGS ENDS HERE
                    ...
                    objInventoryMovemnt.Cust_Code = "" 'obj.MP_CODE
                ...
                End If
            Next
            ''richa agarwal 23/06/2015 change transtype from Sale Return Farmer to MCC-MSR-F against ticket no .BM00000007126
            clsInventoryMovement.SaveData("MCC-MSR-F", obj.Document_Code, obj.Document_Date, clsCommon.GetPrintDate(obj.Document_Date, "dd/MM/yyyy"), ArrInventoryMovement, trans)

            CreateJournalEntry(obj.Document_Code, trans, strVoucherNoForRecreatedOnly)
            qry = "Update TSPL_MCC_Sale_Return_Head_Farmer set Status=1, Posting_Date='" + clsCommon.GetPrintDate(obj.Document_Date, "dd/MMM/yyyy") + "',Modify_By='" + objCommonVar.CurrentUserCode + "'"
            qry += " where Document_Code='" + strDocNo + "'"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strDocNo, "TSPL_MCC_SALE_RETURN_HEAD_FARMER", "Document_Code", trans)
    ...
    Public Shared Function CreateJournalEntry(ByVal strCode As String, ByVal trans As SqlTransaction, Optional ByVal strVoucherNoForRecreatedOnly As String = Nothing) As Boolean
        If clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.AllowPurchaseAccounting, clsFixedParameterCode.AllowPurchaseAccounting, trans)) = 0 Then
            ...
            Dim obj As clsMccMaterialSaleReturnFarmer = clsMccMaterialSaleReturnFarmer.GetData(strCode, NavigatorType.Current, trans)
            ...
            End If
            Dim qry As String = "SELECT  TSPL_DISCOUNT_MASTER.Account_Code FROM TSPL_DISCOUNT_MASTER" + Environment.NewLine + _
            ...
            Dim Acc() As String = {FarmerCtrlAccount, -1 * obj.Total_Amt}
            ArryLstGLAC.Add(Acc)

            For ii As Integer = 0 To obj.Arr.Count - 1
                qry = "select TSPL_SALES_ACCOUNTS.Sales_Return_Account from TSPL_ITEM_MASTER " + Environment.NewLine + _
                "left outer join TSPL_SALES_ACCOUNTS on TSPL_SALES_ACCOUNTS.Sales_Class_Code=TSPL_ITEM_MASTER.Sale_Class_Code" + Environment.NewLine + _
                ...
                Dim Acc1() As String = {qry, obj.Arr(ii).Amt_Less_Discount}
            ...
            If obj.TAX1_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX1_Amt}
            ...
            If obj.TAX2_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX2_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX3_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX3_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX4_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX4_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX5_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX5_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX6_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX6_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX7_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX7_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX8_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX8_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX9_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX9_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
            If obj.TAX10_Amt <> 0 Then
                ...
                End If
                Dim AccInvDR() As String = {qry, obj.TAX10_Amt}
                ArryLstGLAC.Add(AccInvDR)
            End If
                ...
                If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                    For Each dr As DataRow In dt.Rows
                      ...
                      "where TSPL_ITEM_MASTER.Item_Code='" + clsCommon.myCstr(dr("Item_Code")) + "'"
                        ...
                        End If
                        qry = clsERPFuncationality.ChangeGLAccountLocationSegment(qry, obj.Bill_To_Location, trans)
                        Dim Acc2() As String = {qry, -1 * clsCommon.myCdbl(dr("Cost"))}
                        ArryLstGLAC.Add(Acc2)

                        qry = "SELECT TSPL_PURCHASE_ACCOUNTS.Inv_Control_Account FROM TSPL_ITEM_MASTER" + Environment.NewLine + _
                        "left outer JOIN  TSPL_PURCHASE_ACCOUNTS  ON  TSPL_PURCHASE_ACCOUNTS.Purchase_Class_Code = TSPL_ITEM_MASTER.Purchase_Class_Code " + Environment.NewLine + _
                        "WHERE TSPL_ITEM_MASTER.Item_Code='" + clsCommon.myCstr(dr("Item_Code")) + "'"
                        qry = clsDBFuncationality.getSingleValue(qry, trans)
                        If clsCommon.myLen(qry) <= 0 Then
                        ...
                        End If
                        qry = clsERPFuncationality.ChangeGLAccountLocationSegment(qry, obj.Bill_To_Location, trans)
                        Dim Acc1() As String = {qry, clsCommon.myCdbl(dr("Cost"))}
                        ArryLstGLAC.Add(Acc1)
                    Next
                End If
            End If
    ...
    'Private Shared Function createARInvoice(ByVal obj As clsMccMaterialSaleReturnFarmer, ByVal trans As SqlTransaction) As Boolean
    ...
    '    objCustInv.Customer_Code = obj.Farmer_Code
    '    objCustInv.Customer_Name = obj.Farmer_Name
    '    objCustInv.Posting_Date = obj.Document_Date
    '    Dim qry As String = " select Cust_Account from TSPL_CUSTOMER_MASTER where Cust_Code='" + obj.Farmer_Code + "'"
    ...
    Private Shared Function GetFirstItemCode(ByVal Arr As List(Of clsMccMaterialSaleReturnFarmerDetail)) As String
        For Each objtr As clsMccMaterialSaleReturnFarmerDetail In Arr
            If clsCommon.CompairString(objtr.Row_Type, clsItemRowType.RowTypeItem) = CompairStringResult.Equal Then
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsMccMaterialSaleReturnFarmer = clsMccMaterialSaleReturnFarmer.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_Code) > 0) Then
            Try
                ...
                End If
                clsSerializeInvenotry.DeleteData("Sale Return Farmer", strCode, trans)
                clsBatchInventory.DeleteData("MCC-MSR-F", strCode, trans)
                clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strCode, "TSPL_MCC_SALE_RETURN_HEAD_FARMER", "Document_Code", "TSPL_MCC_Sale_Return_Detail_Farmer", "Document_Code", trans)
                Dim qry As String = "delete from TSPL_MCC_Sale_Return_Detail_Farmer where Document_Code='" + strCode + "'"
                isSaved = clsDBFuncationality.ExecuteNonQuery(qry, trans)

                qry = "delete from TSPL_MCC_Sale_Return_Head_Farmer where Document_Code='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    '        Dim qry As String = "select Document_Code,Farmer_Code,MP_Name from TSPL_MCC_Sale_Return_Head_Farmer where Document_Code in (" + clsCommon.GetMulcallString(Arr) + ") and MP_CODE not in ('" + strVendorCode + "')"
    '        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
    '        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
    '            Dim msg As String = "Error. "
    '            For Each dr As DataRow In dt.Rows
    '                msg += Environment.NewLine + "SRN No:" + clsCommon.myCstr(dr("Document_Code")) + " Is For Vendor Code: " + clsCommon.myCstr(dr("MP_CODE")) + " Vendor Name:" + clsCommon.myCstr(dr("MP_Name"))
    '            Next
    ...
    '         "select TSPL_MCC_Sale_Return_Head_Farmer.Document_Code,TSPL_MCC_Sale_Return_Head_Farmer .Item_Type as ItemType," & _
    '         "(replace( CONVERT(varchar(11), TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,104),'.','/')+' '+CONVERT(varchar(100),TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,108) )as MRN_Date,TSPL_MCC_Sale_Return_Head_Farmer.Customer_Name,TSPL_MCC_Sale_Return_Head_Farmer.GRNo,TSPL_MCC_Sale_Return_Head_Farmer.GENo," & _
    '         "(case when LEN(TSPL_MCC_Sale_Return_Head_Farmer.GEDate)>0  then REPLACE( CONVERT(varchar(11), TSPL_MCC_Sale_Return_Head_Farmer.GEDate,104),'.','/') else '' end) as GEDate,TSPL_MCC_Sale_Return_Head_Farmer.VehicleNo,TSPL_MCC_Sale_Return_Head_Farmer.Remarks ,TSPL_MCC_Sale_Return_Head_Farmer.Ref_No,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Desc,TSPL_MCC_Sale_Return_Detail_Farmer.Unit_code," & _
    ...
    '         "TSPL_MCC_Sale_Return_Detail_Farmer.Leak_Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Burst_Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Short_Qty from TSPL_MCC_Sale_Return_Detail_Farmer left outer join TSPL_MCC_Sale_Return_Head_Farmer on TSPL_MCC_Sale_Return_Head_Farmer.Document_Code= TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code " & _
    '         " left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER .Location_Code=TSPL_MCC_Sale_Return_Head_Farmer.Bill_To_Location   where Item_Type ='F'"
    '                If FromDate.HasValue AndAlso ToDate.HasValue Then
    '                    qry += " and Convert(date,TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,103)>=Convert(date,'" + FromDate + "',103)and Convert(date,TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,103)<=Convert(date,'" + ToDate + "',103) "
    '                End If
    ...
    '                    qry += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code in (" + clsCommon.GetMulcallString(ArrSrnNo) + ")  "
    '                End If
    '                If ArrVendor IsNot Nothing AndAlso ArrVendor.Count > 0 Then
    '                    qry += " and TSPL_MCC_Sale_Return_Head_Farmer.MP_CODE in (" + clsCommon.GetMulcallString(ArrVendor) + ")" 'ADDED BY ABHISHEK AS ON 30 AUG 2012
    '                End If
    ...
    '                Dim strquery As String = "SELECT TSPL_MCC_Sale_Return_Head_Farmer.Document_Code, TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,TSPL_MCC_Sale_Return_Head_Farmer.Customer_Name,(case when len(against_mrn)>0 then (select MRN_Date  from tspl_mrn_head where tspl_mrn_head.MRN_No =against_mrn) else Document_Date end ) as Challan_Date, TSPL_MCC_Sale_Return_Head_Farmer.Ref_No  " & _
    '                      "as Challan_No, TSPL_MCC_Sale_Return_Head_Farmer.Inv_No, TSPL_MCC_Sale_Return_Head_Farmer.Inv_Date, TSPL_MCC_Sale_Return_Head_Farmer.GRNo,TSPL_MCC_Sale_Return_Head_Farmer.Amount_Less_Discount ,TSPL_MCC_Sale_Return_Head_Farmer.GENo,TSPL_MCC_Sale_Return_Head_Farmer.Total_Amt, " & _
    '                      "TSPL_MCC_Sale_Return_Head_Farmer.GEDate, TSPL_MCC_Sale_Return_Head_Farmer.VehicleNo, TSPL_MCC_Sale_Return_Head_Farmer.Carrier,TSPL_MCC_Sale_Return_Head_Farmer.Remarks,TSPL_MCC_Sale_Return_Detail_Farmer.Landed_Cost_Rate,TSPL_MCC_Sale_Return_Detail_Farmer.Landed_Cost_Amount , TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code,TSPL_MCC_Sale_Return_Detail_Farmer.Row_Type,TSPL_MCC_Sale_Return_Detail_Farmer.Amt_Less_Discount," & _
    '"TSPL_MCC_Sale_Return_Detail_Farmer.Item_Cost as basicRate,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Net_Amt as BasicTotal,TSPL_MCC_Sale_Return_Detail_Farmer.Unit_Cost_Tax_Rate as UCTR," & _
    '"TSPL_MCC_Sale_Return_Detail_Farmer.Unit_Cost_Tax as uctax,TSPL_MCC_Sale_Return_Detail_Farmer.Item_Desc,TSPL_MCC_Sale_Return_Detail_Farmer.Unit_code,TSPL_MCC_Sale_Return_Detail_Farmer.Qty,TSPL_MCC_Sale_Return_Detail_Farmer.Rejected_Qty,TSPL_MCC_Sale_Return_Head_Farmer.MP_CODE,TSPL_MCC_Sale_Return_Head_Farmer.Total_Amt,TSPL_MCC_Sale_Return_Detail_Farmer.ITEM_COST," & _
    ' "TSPL_VENDOR_MASTER.Add1 as venAdd1, TSPL_VENDOR_MASTER.Add2 as vanadd2, TSPL_VENDOR_MASTER.Add3 as venadd3, " & _
    '"tax1.Tax_Code_Desc as tax1name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax1_amt,0) as txt1amt,tax2.Tax_Code_Desc as tax2name," & _
    '"isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax2_amt,0) as txt2amt,tax3.Tax_Code_Desc as tax3name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax3_amt,0) as txt3amt," & _
    '"tax4.Tax_Code_Desc as tax4name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax4_amt,0) as txt4amt,tax5.Tax_Code_Desc as tax5name," & _
    '"isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax5_amt,0) as txt5amt,tax6.Tax_Code_Desc as tax6name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax6_amt,0) as txt6amt " & _
    '",tax7.Tax_Code_Desc as tax7name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax7_amt,0) as txt7amt,tax8.Tax_Code_Desc as tax8name," & _
    '"isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax8_amt,0) as txt8amt, tax9.Tax_Code_Desc as tax9name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax9_amt,0) as txt9amt," & _
    '"tax10.Tax_Code_Desc as tax10name,isnull (TSPL_MCC_Sale_Return_Head_Farmer.tax10_amt,0) as txt10amt, TSPL_COMPANY_MASTER.Comp_Name as compname, " & _
    '"TSPL_COMPANY_MASTER.Logo_Img,TSPL_COMPANY_MASTER.Logo_Img2,TSPL_MCC_Sale_Return_Detail_Farmer.Qty," & _
    '"case when tax1.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax1_amt else null end as Tax1Recoverable," & _
    '"case when tax2.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.TAX2_Amt else null end as Tax2Recoverable, " & _
    '"case when tax3.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax3_amt else null end as Tax3Recoverable, " & _
    '"case when tax4.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax4_amt else null end as Tax4Recoverable, " & _
    '"case when tax5.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax5_amt else null end as Tax5Recoverable, " & _
    '"case when tax6.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax6_amt else null end as Tax6Recoverable," & _
    '"case when tax7.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax7_amt else null end as Tax7Recoverable, " & _
    '"case when tax8.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax8_amt else null end as Tax8Recoverable, " & _
    '"case when tax9.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax9_amt else null end as Tax9Recoverable," & _
    '"case when tax10.Tax_Recoverable='Y' then TSPL_MCC_Sale_Return_Head_Farmer.tax10_amt else null end as Tax10Recoverable, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX1_Rate ,0),103)+'%' as txt1Rate," & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX2_Rate   ,0),103)+'%' as txt2Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX3_Rate  ,0),103)+'%' as txt3Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX4_Rate  ,0),103)+'%' as txt4Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX5_Rate  ,0),103)+'%' as txt5Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX6_Rate  ,0),103)+'%' as txt6Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX7_Rate  ,0),103)+'%' as txt7Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX8_Rate  ,0),103)+'%' as txt8Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX9_Rate  ,0),103)+'%' as txt9Rate, " & _
    '"convert(varchar,isnull (TSPL_MCC_Sale_Return_Head_Farmer.TAX10_Rate  ,0),103)+'%' as txt10Rate," & _
    '"TSPL_MCC_Sale_Return_Detail_Farmer.Amt_Less_Discount as Value,(select SUM(rejected_qty) from TSPL_MCC_Sale_Return_Detail_Farmer where Document_Code=TSPL_MCC_Sale_Return_Head_Farmer.Document_Code) as Rej_qty, (select SUM(TSPL_MRN_DETAIL.MRN_Qty) from TSPL_MCC_Sale_Return_Detail_Farmer left outer join TSPL_MRN_DETAIL on TSPL_MRN_DETAIL .MRN_No=TSPL_MCC_Sale_Return_Detail_Farmer.Invoice_Code and TSPL_MRN_DETAIL.Item_Code=TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code where Document_Code =TSPL_MCC_Sale_Return_Head_Farmer.Document_Code)as MrnTotQty, (select SUM(Qty) from TSPL_MCC_Sale_Return_Detail_Farmer where Document_Code=TSPL_MCC_Sale_Return_Head_Farmer.Document_Code) as SRNQtyTotal, (select case when COUNT(xxx.PI_No)>1 then Min(xxx.PI_No)+ ' *' else Min(xxx.PI_No)end as PINO from" & _
    '" ( select TSPL_PI_DETAIL.PI_No from TSPL_PI_DETAIL  where  TSPL_PI_DETAIL.SRN_Id= TSPL_MCC_Sale_Return_Head_Farmer.Document_Code " & _
    '" GROUP by TSPL_PI_DETAIL.PI_No)xxx) as PInvNo  ,    " & _
    '       " TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name1 as Add1Name, " & _
    '     " TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt1 as Add1 , " & _
    '     "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name2 as Add2Name, " & _
    '     "   TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt2 as Add2 , " & _
    '     "    TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name3 as Add3Name, " & _
    '     "   TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt3 as Add3 , " & _
    '     "    TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name4 as Add4Name, " & _
    '     "    TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt4 as Add4 , " & _
    '     "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name5 as Add5Name, " & _
    '      "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt5 as Add5 , " & _
    '      "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name6 as Add6Name, " & _
    '      "    TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt6 as Add6 , " & _
    '      "    TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name7 as Add7Name, " & _
    '      "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt7 as Add7 , " & _
    '      "       TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name8 as Add8Name, " & _
    '      "      TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt8 as Add8 , " & _
    '       "      TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name9 as Add9Name, " & _
    '       "      TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt9 as Add9 , " & _
    '       "      TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Name10 as Add10Name, " & _
    '       "     TSPL_MCC_Sale_Return_Head_Farmer.Add_Charge_Amt10 as Add10,TSPL_MCC_Sale_Return_Head_Farmer.Against_RGP,TSPL_MCC_Sale_Return_Detail_Farmer .Specification   " & _
    ' " FROM  TSPL_MCC_Sale_Return_Detail_Farmer INNER JOIN TSPL_MCC_Sale_Return_Head_Farmer ON TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code = TSPL_MCC_Sale_Return_Head_Farmer.Document_Code " & _
    ' "INNER JOIN TSPL_COMPANY_MASTER ON TSPL_MCC_Sale_Return_Head_Farmer.Comp_Code = TSPL_COMPANY_MASTER.Comp_Code  " & _
    ' "INNER JOIN TSPL_VENDOR_MASTER ON TSPL_MCC_Sale_Return_Head_Farmer.MP_CODE = TSPL_VENDOR_MASTER.MP_CODE " & _
    ' "left outer join TSPL_TAX_MASTER as tax1 on tax1.tax_code =TSPL_MCC_Sale_Return_Head_Farmer.tax1  " & _
    ' "left outer join tspl_tax_master as tax2 on tax2.tax_code = TSPL_MCC_Sale_Return_Head_Farmer.tax2 " & _
    ' "left outer join tspl_tax_master as tax3 on tax3.Tax_Code=TSPL_MCC_Sale_Return_Head_Farmer .TAX3 " & _
    ' "left outer join TSPL_TAX_MASTER as tax4 on tax4.Tax_Code= TSPL_MCC_Sale_Return_Head_Farmer .tax4 " & _
    ' "left outer join TSPL_TAX_MASTER as tax5 on tax5.Tax_Code=TSPL_MCC_Sale_Return_Head_Farmer .tax5 " & _
    ' "left outer join TSPL_TAX_MASTER as tax6 on tax6.Tax_Code =TSPL_MCC_Sale_Return_Head_Farmer .TAX6  " & _
    ' "left outer join TSPL_TAX_MASTER as tax7 on tax7.Tax_Code =TSPL_MCC_Sale_Return_Head_Farmer .TAX7  " & _
    ' "left outer join TSPL_TAX_MASTER as tax8 on tax8.Tax_Code =TSPL_MCC_Sale_Return_Head_Farmer .TAX8 " & _
    ' "left outer join TSPL_TAX_MASTER as tax9 on tax9.Tax_Code =TSPL_MCC_Sale_Return_Head_Farmer .TAX9 " & _
    ' " left outer join TSPL_TAX_MASTER as tax10 on tax10.Tax_Code =TSPL_MCC_Sale_Return_Head_Farmer .TAX10  " & _
    ' "left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER .Location_Code=TSPL_MCC_Sale_Return_Head_Farmer.Bill_To_Location  " & _
    ' " where TSPL_MCC_Sale_Return_Head_Farmer .Item_Type not in('F')"

    '                If FromDate.HasValue AndAlso ToDate.HasValue Then
    '                    strquery += " and Convert(date,TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,103)>=Convert(date,'" + FromDate + "',103)and Convert(date,TSPL_MCC_Sale_Return_Head_Farmer.Document_Date,103)<=Convert(date,'" + ToDate + "',103) "
    ...
    '                End If
    '                If ArrSrnNo IsNot Nothing AndAlso ArrSrnNo.Count > 0 Then
    '                    strquery += " and TSPL_MCC_Sale_Return_Head_Farmer.Document_Code in (" + clsCommon.GetMulcallString(ArrSrnNo) + ")  "
    '                End If
    '                If ArrVendor IsNot Nothing AndAlso ArrVendor.Count > 0 Then
    '                    strquery += " and TSPL_MCC_Sale_Return_Head_Farmer.MP_CODE in (" + clsCommon.GetMulcallString(ArrVendor) + ")  "
    ...
    Public Shared Function ReverseAndUnpost(ByVal strCode As String) As Boolean
        ...
        Try
            ...
            Dim Qry As String = "select Status from TSPL_MCC_Sale_Return_Head_Farmer where Document_Code='" + strCode + "'"
            If Not clsCommon.myCdbl(clsDBFuncationality.getSingleValue(Qry, trans)) = 1 Then
                Throw New Exception("Transaction status should be posted for reverse and unpost")
            End If

            Qry = "select distinct Doc_No from TSPL_MP_PAY_PROCESS_MCC_SALE_RETURN where Return_Doc_No='" + strCode + "'"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(Qry, trans)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            Dim VoucherNo As String = clsDBFuncationality.getSingleValue("select Voucher_No from TSPL_JOURNAL_MASTER where Source_Code='MC-FR' and Source_Doc_No='" + strCode + "'", trans)
            ...
            Qry = "delete from TSPL_INVENTORY_MOVEMENT where Source_Doc_No='" + strCode + "' and Trans_Type='MCC-MSR-F'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)

            Qry = "Update TSPL_MCC_Sale_Return_Head_Farmer set Status = 0 where Document_Code='" + strCode + "'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strCode, "TSPL_MCC_SALE_RETURN_HEAD_FARMER", "Document_Code", trans)
            trans.Commit()
        Catch ex As Exception
            trans.Rollback()
            Throw New Exception(ex.Message)
...
Public Class clsMccMaterialSaleReturnFarmerDetail
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal dtDocDate As DateTime, ByVal Arr As List(Of clsMccMaterialSaleReturnFarmerDetail), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsMccMaterialSaleReturnFarmerDetail In Arr
                Dim coll As New Hashtable()
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_MCC_Sale_Return_Detail_Farmer", OMInsertOrUpdate.Insert, "", trans)
                clsSerializeInvenotry.SaveData("Sale Return Farmer", strDocNo, dtDocDate, "I", obj.Item_Code, obj.Location, obj.Line_No, obj.arrSrItem, trans)
                clsBatchInventory.SaveData("MCC-MSR-F", strDocNo, dtDocDate, "I", obj.Item_Code, obj.Location, obj.Line_No, obj.MRP, obj.Unit_code, obj.arrBatchItem, trans)
            Next
        End If
        Return True
    End Function
    ...
    Public Shared Function GetBalanceSRNQty(ByVal strSRNCode As String, ByVal strICode As String, ByVal strCurrPINNo As String, ByVal strUOM As String, ByVal dblMRP As Double, ByVal dblAssessable As Double) As Double
        Dim qry As String = "select SUM(qty * RI) as Balance from(  " & _
            " select TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code as ICode,TSPL_MCC_Sale_Return_Detail_Farmer.Qty as Qty,1 as RI from TSPL_MCC_Sale_Return_Detail_Farmer left outer join TSPL_MCC_Sale_Return_Head_Farmer on TSPL_MCC_Sale_Return_Head_Farmer.Document_Code=TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code where TSPL_MCC_Sale_Return_Detail_Farmer.Status=0 and TSPL_MCC_Sale_Return_Head_Farmer.Status=1 and TSPL_MCC_Sale_Return_Detail_Farmer.Document_Code ='" + strSRNCode + "' and TSPL_MCC_Sale_Return_Detail_Farmer.Item_Code='" + strICode + "' and  TSPL_MCC_Sale_Return_Detail_Farmer.Unit_code='" + strUOM + "' and isnull(TSPL_MCC_Sale_Return_Detail_Farmer.MRP,0)='" + clsCommon.myCstr(dblMRP) + "' and isnull(TSPL_MCC_Sale_Return_Detail_Farmer.Assessable,0)='" + clsCommon.myCstr(dblAssessable) + "' " & _
            " union all " & _
    ...
    Public Shared Function CompleteSRN(ByVal strDoccode As String, ByVal strICode As String, ByVal LineNo As Integer) As Boolean
        Dim qry As String = "update TSPL_MCC_Sale_Return_Detail_Farmer set Status=1 where Document_Code='" + strDoccode + "' and Line_No='" + clsCommon.myCstr(LineNo) + "' and Item_Code='" + strICode + "'"
