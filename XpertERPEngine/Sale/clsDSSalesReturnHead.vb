...
from 
  (
    ...
    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsDSSalesReturnHead
        ...
        qry += " TSPL_SD_SALE_RETURN_HEAD.CURRENCY_CODE,TSPL_SD_SALE_RETURN_HEAD.CONVRATE,TSPL_SD_SALE_RETURN_HEAD.APPLICABLEFROM,TSPL_SD_SALE_RETURN_HEAD.PROJECT_ID ,TSPL_SD_SALE_RETURN_HEAD.Is_Cancelled,TSPL_SD_SALE_RETURN_HEAD.OpeningBal,TSPL_SD_SALE_RETURN_HEAD.DrAmt ,TSPL_SD_SALE_RETURN_HEAD.CrAmt,TSPL_SD_SALE_RETURN_HEAD.ClosingBa "
