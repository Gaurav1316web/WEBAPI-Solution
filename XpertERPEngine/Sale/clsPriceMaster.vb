...
#Region "Variables"
    ...
    Public Default_For_Tarnsfer As Integer = 0
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strPriceCode As String, ByVal arr As List(Of clsPriceComponentMapping)) As Boolean
        ...
        Try
            ...
            For Each obj As clsPriceComponentMapping In arr
                ...
                '           clsDBFuncationality.ExecuteNonQuery("UPDATE TSPL_PRICE_COMPONENT_MAPPING 
                'SET Default_For_Tarnsfer = 0 )", trans)
                If obj.Default_For_Tarnsfer > 0 Then
                    clsDBFuncationality.ExecuteNonQuery("UPDATE TSPL_PRICE_COMPONENT_MAPPING SET Default_For_Tarnsfer = 0", trans)

                End If

                clsDBFuncationality.ExecuteNonQuery("update TSPL_PRICE_COMPONENT_MAPPING set Transfer  =" & obj.Transfer & ",Inactive=" & obj.Inactive & ",Default_For_Tarnsfer=" & obj.Default_For_Tarnsfer & ",default_Type=" & obj.Default_Type & " where Price_Code ='" & obj.Price_Code & "'", trans)
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As List(Of clsPriceComponentMapping)
        Dim obj As clsPriceComponentMapping = Nothing
        Dim qry As String = "SELECT distinct [Price_code] as [Price Code] ,[Price_Code_Desc] as [Description], Remarks,vendor_code,Transfer,Inactive,Default_Type,Default_For_Tarnsfer FROM [TSPL_PRICE_COMPONENT_MAPPING] where 2=2"
        Select Case NavType
            Case NavigatorType.Current
        ...
        Try
            ...
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                ...
                For Each dr As DataRow In dt1.Rows
                    ...
                    obj.Default_For_Tarnsfer = clsCommon.myCdbl(dt.Rows(0)("Default_For_Tarnsfer"))
