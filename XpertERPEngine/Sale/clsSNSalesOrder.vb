...
Public Class clsSNSalesOrderHead
...
#Region "Variables"
    ...
    Public Arr As List(Of clsSNSalesOrderDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsSNSalesOrderHead, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean) As Boolean
        ...
        Try
            ...
            End If
            isSaved = isSaved AndAlso clsSNSalesOrderDetail.SaveData(obj.Document_Code, Arr, trans)
        ...
        Return isSaved
    End Function
    Public Function DemoSaveData(ByVal obj As clsSNSalesOrderHead, ByVal isNewEntry As Boolean, ByVal isMakeAbandomentNo As Boolean, ByVal strDatabase As String, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        'Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        ...
        Try
            ...
            Else
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_SD_SALES_ORDER_HEAD", OMInsertOrUpdate.Update, "TSPL_SD_SALES_ORDER_HEAD.Document_Code='" + obj.Document_Code + "'", trans)
            End If
            isSaved = isSaved AndAlso clsSNSalesOrderDetail.DemoSaveData(obj.Document_Code, Arr, trans, strDatabase)
        ...
        Return isSaved
    End Function
    Public Shared Function checkSaveNotification(ByVal obj As clsSNSalesOrderHead, ByVal trans As SqlTransaction)
        Try
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsSNSalesOrderHead
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsSNSalesOrderHead
        Dim obj As clsSNSalesOrderHead = Nothing
        Dim qry As String = "SELECT TSPL_SD_SALES_ORDER_HEAD.is_taxable,TSPL_SD_SALES_ORDER_HEAD.close_yn,TSPL_SD_SALES_ORDER_HEAD.Cust_PO_No,TSPL_SD_SALES_ORDER_HEAD.price_group_code, TSPL_SD_SALES_ORDER_HEAD.Route_No,TSPL_SD_SALES_ORDER_HEAD.Route_Desc,TSPL_SD_SALES_ORDER_HEAD.Price_Code,TSPL_SD_SALES_ORDER_HEAD.Document_Code,TSPL_SD_SALES_ORDER_HEAD.SalesOrder_Type ,TSPL_SD_SALES_ORDER_HEAD.Document_Date, " & _
        ...
        " outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_SD_SALES_ORDER_HEAD.Customer_Code  where 2=2"
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            End If
            '' END CURRENCYCONVERSION 
            qry = "SELECT TSPL_SD_SALES_ORDER_DETAIL.ItemwiseTaxCode, TSPL_SD_SALES_ORDER_DETAIL.commitedQty,TSPL_SD_SALES_ORDER_DETAIL.IsCommited, TSPL_SD_SALES_ORDER_DETAIL.Document_Code,TSPL_SD_SALES_ORDER_DETAIL.Line_No,TSPL_SD_SALES_ORDER_DETAIL.Status, " & _
            ...
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                ...
                Dim objTr As clsSNSalesOrderDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsSNSalesOrderDetail
                    ...
                    objTr.CommitedQty = clsCommon.myCdbl(dr("CommitedQty"))
                    objTr.IsCommited = clsCommon.myCstr(dr("IsCommited"))
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String) As Boolean 'BM00000008148
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        Try
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        ...
        Try
            ...
            Dim obj As clsSNSalesOrderHead = clsSNSalesOrderHead.GetData(strDocNo, NavigatorType.Current, trans)
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsSNSalesOrderHead = clsSNSalesOrderHead.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
    ...
    Public Shared Function ClosedData(ByVal obj As clsSNSalesOrderHead, ByVal strCode As String, ByVal strCloseRemarks As String) As Boolean
        Try
...
Public Class clsSNSalesOrderDetail
#Region "Variables"
    Public Document_Code As String = Nothing
    ...
    Public CommitedQty As Double = 0
    Public IsCommited As String = Nothing
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsSNSalesOrderDetail), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsSNSalesOrderDetail In Arr
                Dim coll As New Hashtable()
                ...
                clsCommon.AddColumnsForChange(coll, "CommitedQty", obj.CommitedQty)
                clsCommon.AddColumnsForChange(coll, "IsCommited", obj.IsCommited)
        ...
        Return True
    End Function
    Public Shared Function DemoSaveData(ByVal strDocNo As String, ByVal Arr As List(Of clsSNSalesOrderDetail), ByVal trans As SqlTransaction, ByVal strDatabase As String) As Boolean
...
Public Class clsSNSalesOrderHeadHist
#Region "Variables"
#End Region
    ...
    Public Shared Function SaveData(ByVal strCode As String, ByVal intAmbandentNo As Integer, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        Try
            Dim obj As clsSNSalesOrderHead = clsSNSalesOrderHead.GetData(strCode, NavigatorType.Current, trans)
            Dim coll As New Hashtable()
