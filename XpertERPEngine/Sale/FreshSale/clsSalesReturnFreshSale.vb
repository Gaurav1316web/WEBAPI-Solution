...
Public Class clsSalesReturnFreshSale
#Region "Variables"
    ...
    Public Arr As List(Of clsSalesReturnFreshSaleDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsSalesReturnFreshSale, ByVal isNewEntry As Boolean) As Boolean
        ...
        Try
            ...
            ''
            clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Fresh Sale", "Fresh Sale Return", obj.Bill_To_Location, obj.Document_Date, trans)
            ...
            If isNewEntry Then
                If obj.Is_Cancelled = 1 Then
                    obj.Document_Code = clsERPFuncationality.GetNextCode(trans, obj.Document_Date, clsDocType.frmSaleReturnFreshSale, clsDocTransactionType.SaleReturnCancel, obj.Bill_To_Location)
                Else
                    obj.Document_Code = clsERPFuncationality.GetNextCode(trans, obj.Document_Date, clsDocType.frmSaleReturnFreshSale, clsDocTransactionType.NA, obj.Bill_To_Location)
                End If
            ...
            ' done by richa SWA/12/09/18-000052 for swadesh to save leakage amount.
            ...
            ''---------------------
            If isNewEntry Then
                clsCommon.AddColumnsForChange(coll, "Trans_Type", "FS")
            ...
            End If
            isSaved = isSaved AndAlso clsSalesReturnFreshSaleDetail.SaveData(obj.Document_Code, obj.Document_Date, Arr, trans, obj)
    ...
    Public Shared Function GetData(ByVal strDocumentNo As String, ByVal NavType As NavigatorType) As clsSalesReturnFreshSale
        Return GetData(strDocumentNo, NavType, Nothing)
    End Function

    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsSalesReturnFreshSale
        Dim obj As clsSalesReturnFreshSale = Nothing
        Dim qry As String = "SELECT TSPL_SD_SALE_RETURN_HEAD.LeakageAmount, TSPL_SD_SALE_RETURN_HEAD.CrateQty, TSPL_SD_SALE_RETURN_HEAD.Return_Type,TSPL_SD_SALE_RETURN_HEAD.HeadDisc_PerAmt,TSPL_SD_SALE_RETURN_HEAD.Cust_PO_No,TSPL_SD_SALE_RETURN_HEAD.VehicleNo, TSPL_SD_SALE_RETURN_HEAD.Vehicle_Code,TSPL_SD_SALE_RETURN_HEAD.price_group_code , " & _
        ...
        qry += " TSPL_SD_SALE_RETURN_HEAD.CURRENCY_CODE,TSPL_SD_SALE_RETURN_HEAD.CONVRATE,TSPL_SD_SALE_RETURN_HEAD.APPLICABLEFROM,TSPL_SD_SALE_RETURN_HEAD.PROJECT_ID,TSPL_SD_SALE_RETURN_HEAD.Is_Cancelled,TSPL_SD_SALE_RETURN_HEAD.Gate_Entry_No "
        ...
        qry += " left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_SD_SALE_RETURN_HEAD.Customer_Code where TSPL_SD_SALE_RETURN_HEAD.Trans_Type='FS' and TSPL_SD_SALE_RETURN_HEAD.Screen_Type='' "
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsSalesReturnFreshSale()
            ...
            qry = "SELECT  TSPL_SD_SALE_RETURN_DETAIL.ItemLeakageAmount,TSPL_SD_SALE_RETURN_DETAIL.Delivery_Code,TSPL_SD_SALE_RETURN_DETAIL.Crate,TSPL_SD_SALE_RETURN_DETAIL.Sampling,TSPL_SD_SALE_RETURN_DETAIL.InvoiceScheme_Code,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Amount,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Type,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Pers,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Code, " & _
            "TSPL_SD_SALE_RETURN_DETAIL.Scheme_Item_UOM,TSPL_SD_SALE_RETURN_DETAIL.Scheme_Qty,TSPL_SD_SALE_RETURN_DETAIL.Scheme_Item_Code, " & _
            "TSPL_SD_SALE_RETURN_DETAIL.Scheme_Type,TSPL_SD_SALE_RETURN_DETAIL.OrgUnit_code,TSPL_SD_SALE_RETURN_DETAIL.Is_Mannual_Amt,TSPL_SD_SALE_RETURN_DETAIL.Document_Code,TSPL_SD_SALE_RETURN_DETAIL.Line_No, " & _
            ...
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                ...
                Dim objTr As clsSalesReturnFreshSaleDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsSalesReturnFreshSaleDetail
    ...
    Public Shared Function ReverseAndUnpost(ByVal strCode As String) As Boolean
        ...
        Try
            ...
            Qry = "update tspl_batch_item set against_inv_movement_trans_id=NULL where document_type='FS-SR' and document_code='" + strCode + "'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)

            Qry = "delete from TSPL_INVENTORY_MOVEMENT where Source_Doc_No='" & strCode & "' and Trans_Type= 'FS-SR'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)

            Qry = "delete from TSPL_INVENTORY_MOVEMENT_New where Source_Doc_No='" & strCode & "' and Trans_Type= 'FS-SR'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String) As Boolean
        ...
        Try
            ...
            End If
            Dim obj As clsSalesReturnFreshSale = clsSalesReturnFreshSale.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            isSaved = isSaved AndAlso clsInventoryMovement.SaveData("FS-SR", obj.Document_Code, obj.Document_Date, clsCommon.GetPrintDate(obj.Document_Date, "dd/MM/yyyy"), ArrInventoryMovement, trans)
    ...
    Public Shared Function createARInvoice(ByVal obj As clsSalesReturnFreshSale, ByVal trans As SqlTransaction, Optional ByVal strARNoForRecreate As String = Nothing, Optional ByVal strVoucherForRecreate As String = Nothing) As Boolean
            ...
            If clsCommon.CompairString(objTr.Scheme_Item, "N") = CompairStringResult.Equal OrElse clsCommon.CompairString(objTr.Scheme_Item, "Y") = CompairStringResult.Equal Then
                ...
                If objTr.Return_Amount > 0 Then
                    ...
                    If clsCommon.CompairString(objTr.Scheme_Item, "N") = CompairStringResult.Equal AndAlso clsCommon.CompairString(objTr.Sampling, 0) = CompairStringResult.Equal Then
                        objCustInvTR.Amount_less_Discount = objTr.Return_Amount - objTr.Cash_Scheme_Amount ''By Balwinder on 21/06/2018 with ranjana mam added [- objTr.Cash_Scheme_Amount].
        ...
        objCustInv.SaveData(objCustInv, True, trans, "FreshSaleReturn", strVoucherForRecreate, strARNoForRecreate)
        clsCustomerInvoiceHead.PostData("FreshSaleReturn", objCustInv.Document_No, "", trans)
        Return True
    End Function

    Private Shared Function GetFirstItemCode(ByVal Arr As List(Of clsSalesReturnFreshSaleDetail)) As String
        For Each objtr As clsSalesReturnFreshSaleDetail In Arr
            If clsCommon.CompairString(objtr.Row_Type, clsItemRowType.RowTypeItem) = CompairStringResult.Equal Then
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsSalesReturnFreshSale = clsSalesReturnFreshSale.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal dtDocDate As DateTime, ByVal Arr As List(Of clsSalesReturnFreshSaleDetail), ByVal trans As SqlTransaction, ByVal objShipment As clsSalesReturnFreshSale) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            Dim dblTotLeagageamt As Decimal = 0
            For Each obj As clsSalesReturnFreshSaleDetail In Arr
                Dim coll As New Hashtable()
                ''richa against leakage SWA/12/09/18-000052
                Dim dblLeakageAmt As Decimal = 0
                If objShipment.LeakageAmount > 0 And (clsCommon.CompairString(obj.Scheme_Item, "No") = CompairStringResult.Equal Or clsCommon.CompairString(obj.Scheme_Item, "N") = CompairStringResult.Equal) Then
            ...
            Next
            ''richa against leakage amount SWA/12/09/18-000052
            If objShipment.LeakageAmount > 0 Then
                Dim dblItemLeakageAmtForDetail As Double = Math.Round(clsCommon.myCdbl(clsDBFuncationality.getSingleValue("select SUM(ITEMLEAKAGEAMOUNT) from TSPL_SD_SALE_RETURN_DETAIL where document_code='" & strDocNo & "'", trans)), 2)
                ...
                If dblItemLeakageAmtForDetail > objShipment.LeakageAmount Then
                    ...
                    If dblDiffLeakage <> 0 Then
                        Dim intLineNo As Integer = clsCommon.myCdbl(clsDBFuncationality.getSingleValue("Select max(Line_No)  from TSPL_SD_SALE_RETURN_DETAIL where scheme_item='N' and document_code='" & strDocNo & "' ", trans))
                        clsDBFuncationality.ExecuteNonQuery("Update TSPL_SD_SALE_RETURN_DETAIL set ItemLeakageAmount = ItemLeakageAmount - " & dblDiffLeakage & ",Item_Net_Amt=Item_Net_Amt + " & dblDiffLeakage & " where Line_No=" & intLineNo & " ", trans)
                    End If
