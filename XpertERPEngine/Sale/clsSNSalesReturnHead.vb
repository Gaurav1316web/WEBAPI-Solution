...
#End Region
    ...
    Public Shared Function GetBalance(ByVal InvoiceNo As String, ByVal ConvFact As Double) As Double
        Dim Qry As String = "Select Sum(Qty*RI) from (select TSPL_SD_SALE_INVOICE_DETAIL.Item_Code as ICode,TSPL_SD_SALE_INVOICE_DETAIL.Qty*" + clsCommon.myCstr(ConvFact) + " As Qty,1 as RI 
                             ...
                             Where TSPL_SD_SALE_INVOICE_HEAD.Document_Code='" + InvoiceNo + "'
                             union all 
                             select TSPL_SD_SALE_RETURN_DETAIL.Item_Code as ICode,TSPL_SD_SALE_RETURN_DETAIL.Qty*" + clsCommon.myCstr(ConvFact) + " As Qty,-1 as RI 
                             ...
                             Where TSPL_SD_SALE_RETURN_HEAD.Against_Invoice_No='" + InvoiceNo + "'
                             ) final"
    ...
    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsSNSalesReturnHead
        ...
        qry += " TSPL_SD_SALE_RETURN_HEAD.CURRENCY_CODE,TSPL_SD_SALE_RETURN_HEAD.CONVRATE,TSPL_SD_SALE_RETURN_HEAD.APPLICABLEFROM,TSPL_SD_SALE_RETURN_HEAD.PROJECT_ID,TSPL_SD_SALE_RETURN_HEAD.Is_ManualTCS "
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            qry = "SELECT  TSPL_SD_SALE_RETURN_DETAIL.Is_Mannual_Amt,TSPL_SD_SALE_RETURN_DETAIL.Document_Code,TSPL_SD_SALE_RETURN_DETAIL.Line_No, " &
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, ByVal trans As SqlTransaction, Optional ByVal strARInvoiceNoForRecreatedOnly As String = Nothing, Optional ByVal strVoucherNoForRecreatedOnly As String = Nothing) As Boolean
        Try
            ...
            isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
            isSaved = isSaved AndAlso clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, obj.Document_Code, "TSPL_SD_SALE_RETURN_HEAD", "Document_Code", trans)
