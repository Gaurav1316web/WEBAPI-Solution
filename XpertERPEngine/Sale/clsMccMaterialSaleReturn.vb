...
Public Class clsMccMaterialSaleReturn
#Region "Variables"
    ...
    Public Arr As List(Of clsMccMaterialSaleReturnDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsMccMaterialSaleReturn, ByVal isNewEntry As Boolean) As Boolean
        ...
        Try
            ...
            clsBatchInventory.DeleteData("MCC-MSR", obj.Document_Code, trans)
    ...
    Public Shared Function GetData(ByVal strPONo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsMccMaterialSaleReturn
        ...
        qry += " left outer join TSPL_CUSTOMER_MASTER on TSPL_CUSTOMER_MASTER.Cust_Code=TSPL_SD_SALE_RETURN_HEAD.Customer_Code where TSPL_SD_SALE_RETURN_HEAD.Trans_Type='MCC'"
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsMccMaterialSaleReturn()
            ...
            qry = "SELECT TSPL_SD_SALE_RETURN_DETAIL.InvoiceScheme_Code,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Amount,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Type,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Pers,TSPL_SD_SALE_RETURN_DETAIL.Cash_Scheme_Code,TSPL_SD_SALE_RETURN_DETAIL.TAX_PAID ,TSPL_SD_SALE_RETURN_DETAIL.Item_Group, " &
            ...
            "TSPL_SD_SALE_RETURN_DETAIL.HeadDiscPer,TSPL_SD_SALE_RETURN_DETAIL.HeadDiscPerAmt,TSPL_SD_SALE_RETURN_DETAIL.Markup_On,TSPL_SD_SALE_RETURN_DETAIL.Markup_Percent,TSPL_SD_SALE_RETURN_DETAIL.Landing_Cost,TSPL_SD_SALE_RETURN_DETAIL.HeadDiscAmt,TSPL_SD_SALE_RETURN_DETAIL.Transporter_Commission_Rate,TSPL_SD_SALE_RETURN_DETAIL.Transporter_Commission_Amt,TSPL_SD_SALE_RETURN_DETAIL.CustDiscPer,TSPL_SD_SALE_RETURN_DETAIL.CasdDiscScheme_Code "
            ...
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                ...
                Dim objTr As clsMccMaterialSaleReturnDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsMccMaterialSaleReturnDetail
                    ...
                    objTr.arrBatchItem = clsBatchInventory.GetData("MCC-MSR", objTr.Document_Code, objTr.Item_Code, objTr.Line_No, trans)
                    obj.Arr.Add(objTr)
                Next
            End If
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, Optional ByVal strVoucherNoForRecreateOnly As String = Nothing, Optional ByVal strARInvoiceNoRecreateOnly As String = Nothing) As Boolean
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        Try
            Dim isSaved As Boolean = True
            ...
            End If
            Dim obj As clsMccMaterialSaleReturn = clsMccMaterialSaleReturn.GetData(strDocNo, NavigatorType.Current, trans)
            ...
            If objCommonVar.CreateAutoReceiptEntryDCSSale Then
                If clsCommon.CompairString(obj.Is_CashSale, "Y") = CompairStringResult.Equal Then
                    obj.RecieptEntryOfDCSSaleReturn(obj, trans)
                End If
            End If
    ...
    Shared Function APInvoice_DebitNote(ByVal obj As clsMccMaterialSaleReturn, ByVal trans As SqlTransaction) As Boolean
        Dim isSaved As Boolean = True
        Try
            ...
            objVendInv.Against_MCC_Material_Sale_Return = obj.Document_Code
            ...
            objVendInv.Remarks = "AP Debit Note Against MCC Material Sale Return - " & obj.Document_Code & ""
            objVendInv.Description = "AP Debit Note Against MCC Material Sale Return - " & obj.Document_Code & ""
    ...
    Public Function RecieptEntryOfDCSSaleReturn(ByVal objDCSSaleReturn As clsMccMaterialSaleReturn, ByVal trans As SqlTransaction) As String
        Try
            Dim dblReceiptAmt As Double = (objDCSSaleReturn.Total_Amt - objDCSSaleReturn.TotalSubsidyAmt)
            If dblReceiptAmt > 0 Then
                Dim obj As New clsRcptEntryHeader()
                obj.Entry_Desc = "DCS Sale Return No - " + objDCSSaleReturn.Document_Code + " for Cash Memo No - " & objDCSSaleReturn.Document_Code & "  "
                obj.Receipt_Date = clsCommon.GetPrintDate(objDCSSaleReturn.Document_Date, "dd/MMM/yyyy")
                obj.Receipt_Post_Date = clsCommon.GetPrintDate(objDCSSaleReturn.Document_Date, "dd/MMM/yyyy")
                obj.Bank_Code = clsCommon.myCstr(objDCSSaleReturn.Bank_Code)
                obj.Document_No = objDCSSaleReturn.Document_Code
                obj.Receipt_Type = "R"
                obj.Payment_Code = clsCommon.myCstr(objDCSSaleReturn.Payment_Terms)
                obj.Cheque_No = ""
                obj.Cheque_Date = Nothing
                obj.Cust_Code = clsCommon.myCstr(objDCSSaleReturn.Customer_Code)
                ...
                If obj.SaveData(obj, True, trans) Then
                    clsRcptEntryHeader.funRcptPost(obj.Receipt_No, trans, "MReceivable", objDCSSaleReturn.Bill_To_Location, True)
                    'clsCommon.MyMessageBoxShow("Receipt No: '" + obj.Receipt_No + "' create aganist DCS Sale no: '" + objDCSSaleReturn.Document_Code + "'")
                    clsDBFuncationality.ExecuteNonQuery("Update TSPL_SD_SALE_RETURN_HEAD set Receipt_No ='" & obj.Receipt_No & "' where Document_Code='" + objDCSSaleReturn.Document_Code + "'", trans)
                End If
                '---------------------------------------------------------------------------
        ...
        Return Nothing
    End Function
    ''richa ERO/19/03/19-000517 added on 27 March,2019
    Public Shared Function ReverseAndUnpost(ByVal strCode As String) As Boolean
        ...
        Try
            ...
            Qry = "select Doc_No from TSPL_PAYMENT_PROCESS_MCC_SALE_RETURN where Return_Doc_No='" + strCode + "'"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(Qry, trans)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                Throw New Exception("Return No [" + strCode + "] is used in Payment process No [" + clsCommon.myCstr(dt.Rows(0)("Doc_No")) + "]")
            End If
            If objCommonVar.CreateAutoReceiptEntryDCSSale Then
                ...
                If dt IsNot Nothing AndAlso dtReceipt.Rows.Count > 0 Then
                    clsDBFuncationality.ExecuteNonQuery("Update TSPL_SD_SALE_RETURN_HEAD set Receipt_No=null where Document_Code='" + strCode + "'", trans)
            ...
            Qry = "Select document_no from TSPL_VENDOR_INVOICE_HEAD where Against_MCC_Material_Sale_Return='" + strCode + "'"
            dt = clsDBFuncationality.GetDataTable(Qry, trans)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                For Each dr As DataRow In dt.Rows
            ...
            Dim VoucherNo As String = clsDBFuncationality.getSingleValue("select Voucher_No from TSPL_JOURNAL_MASTER where source_code='AR-CR' and source_doc_no=(Select Document_No from TSPL_Customer_Invoice_Head where Against_MCC_Material_Sale_Return ='" & clsCommon.myCstr(strCode) & "')", trans)
            If clsCommon.myLen(VoucherNo) > 0 Then
                ...
                clsDBFuncationality.ExecuteNonQuery(Qry, trans)
            End If
            Dim strARInvoiceNo As String = clsCommon.myCstr(clsDBFuncationality.getSingleValue("Select Document_No from TSPL_Customer_Invoice_Head where Against_MCC_Material_Sale_Return ='" & clsCommon.myCstr(strCode) & "'", trans))
            ...
            Qry = "Delete from TSPL_Customer_Invoice_Detail where Document_No =(Select Document_No from TSPL_Customer_Invoice_Head where Against_MCC_Material_Sale_Return ='" & clsCommon.myCstr(strCode) & "')"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)
            Qry = "Delete from TSPL_Customer_Invoice_Head where Against_MCC_Material_Sale_Return ='" & clsCommon.myCstr(strCode) & "'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)
            ...
            Qry = "delete from TSPL_INVENTORY_MOVEMENT where Source_Doc_No='" + strCode + "' and Trans_Type='MCC-MSR'"
            clsDBFuncationality.ExecuteNonQuery(Qry, trans)

            clsBatchInventory.ReverseAndUnpost("MCC-MSR", strCode, trans)
        ...
        Return True
    End Function
    Public Shared Function UpdateInventoryMovement(ByVal obj As clsMccMaterialSaleReturn, ByVal trans As SqlTransaction, Optional ByVal UpdateInventory As Boolean = False) As Boolean
        Try
            Dim qry As String = ""
            ...
            For Each objTr As clsMccMaterialSaleReturnDetail In obj.Arr
                ...
                If clsCommon.CompairString(objTr.Row_Type, clsItemRowType.RowTypeItem) = CompairStringResult.Equal Then
                    ...
                    If clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.AllowPurchaseAccounting, clsFixedParameterCode.AllowPurchaseAccounting, trans)) = 0 Then
                        ...
                        qry = "select Loc_Segment_Code from TSPL_LOCATION_MASTER where Location_Code='" + objTr.Location + "'"
                        Dim strLocatinSegment As String = clsCommon.myCstr(clsDBFuncationality.getSingleValue(qry, trans))
                        If clsCommon.myLen(item_Purchase_Class) > 0 Then
                            ...
                            If clsCommon.myLen(Inventory_Purchase_code) > 0 Then
                                ''done by richa agarwal 13 March,2019 pass true becuase location is of segment type ERO/13/03/19-000511
            ...
            clsInventoryMovement.SaveData("MCC-MSR", obj.Document_Code, obj.Document_Date, clsCommon.GetPrintDate(obj.Document_Date, "dd/MM/yyyy"), ArrInventoryMovement, trans)
        ...
        Return True
    End Function
    Public Shared Function createARInvoice(ByVal obj As clsMccMaterialSaleReturn, ByVal trans As SqlTransaction, ByVal strARNoForRecreate As String, ByVal strVoucherNoRecreate As String, ByVal strFormID As String) As Boolean
        ...
        objCustInv.Against_MCC_Material_Sale_Return = obj.Document_Code
...
where TSPL_CUSTOMER_VENDOR_MAPPING.Cust_Code='" + obj.Customer_Code + "'", trans))
        ...
        If clsCommon.CompairString(obj.Return_Type, "P") = CompairStringResult.Equal Then
            ...
            Next
        End If
        objCustInv.SaveData(objCustInv, True, trans, "", strVoucherNoRecreate, strARNoForRecreate)
        clsCustomerInvoiceHead.PostData("", objCustInv.Document_No, "", trans)
        Return True
    End Function

    Private Shared Function GetFirstItemCode(ByVal Arr As List(Of clsMccMaterialSaleReturnDetail)) As String
        For Each objtr As clsMccMaterialSaleReturnDetail In Arr
            If clsCommon.CompairString(objtr.Row_Type, clsItemRowType.RowTypeItem) = CompairStringResult.Equal Then
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        End If
        Dim obj As clsMccMaterialSaleReturn = clsMccMaterialSaleReturn.GetData(strCode, NavigatorType.Current)
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
    ...
    Public Shared Function CancelData(ByVal Form_Id As String, ByVal Doc_No As String, ByVal isCancelByAdmin As Boolean) As Boolean
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        Try
            CancelData(Form_Id, Doc_No, trans, isCancelByAdmin)
            trans.Commit()
        Catch ex As Exception
            trans.Rollback()
            Throw New Exception(ex.Message)
        ...
        Return True
    End Function
    Public Shared Function CancelData(ByVal Form_Id As String, ByVal Doc_No As String, ByVal trans As SqlTransaction, ByVal isCancelByAdmin As Boolean) As Boolean
        Try
            Dim qry As String = ""
            Dim obj As clsMccMaterialSaleReturn = clsMccMaterialSaleReturn.GetData(Doc_No, NavigatorType.Current, trans)
            If obj Is Nothing OrElse clsCommon.myLen(obj.Document_Code) <= 0 Then
            ...
            qry = "select Document_No from TSPL_Customer_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "'"
            ...
            qry = "select Voucher_No from TSPL_JOURNAL_MASTER  where Source_Doc_No in (select Document_No from TSPL_Customer_Invoice_Head  where Document_No='" & Document_No & "')"
            ...
            qry = "delete from TSPL_JOURNAL_DETAILS where Voucher_No in (select Voucher_No from TSPL_JOURNAL_MASTER where Source_Doc_No in (select Document_No from TSPL_Customer_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "'))"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_JOURNAL_MASTER where Source_Doc_No in (select Document_No from TSPL_Customer_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_Customer_Invoice_Detail where Document_No in (Select Document_No from TSPL_Customer_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_Customer_Invoice_Head where Against_MCC_Material_Sale_Return='" & Doc_No & "'"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_CUSTOM_FIELD_VALUES where Transaction_Code in ('" & Doc_No & "') "
            clsDBFuncationality.ExecuteNonQuery(qry, trans)

            '' cancel Vendor invoice data
            qry = "select Document_No from tspl_vendor_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "'"
            Document_No = clsCommon.myCstr(clsDBFuncationality.getSingleValue(qry, trans))
            If clsCommon.myLen(Document_No) > 0 Then
                clsCommonFunctionality.SaveCancelData(objCommonVar.CurrentUserCode, Document_No, "tspl_vendor_Invoice_Head", "Document_No", "TSPL_VENDOR_INVOICE_DETAIL", "Document_No", trans)
            End If

            '' cancel journal master Vendor invoice
            qry = "select Voucher_No from TSPL_JOURNAL_MASTER  where Source_Doc_No in (select Document_No from TSPL_Customer_Invoice_Head  where Document_No='" & Document_No & "')"
            Voucher_No = clsCommon.myCstr(clsDBFuncationality.getSingleValue(qry, trans))
            If clsCommon.myLen(Voucher_No) > 0 Then
                clsCommonFunctionality.SaveCancelData(objCommonVar.CurrentUserCode, Voucher_No, "TSPL_JOURNAL_MASTER", "Voucher_No", "TSPL_JOURNAL_DETAILS", "Voucher_No", trans)
            End If
            ''delete data from multiple tables
            qry = "delete from TSPL_JOURNAL_DETAILS where Voucher_No in (select Voucher_No from TSPL_JOURNAL_MASTER where Source_Doc_No in (select Document_No from tspl_vendor_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "'))"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_JOURNAL_MASTER where Source_Doc_No in (select Document_No from tspl_vendor_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from tspl_vendor_Invoice_Detail where Document_No in (Select Document_No from tspl_vendor_Invoice_Head  where Against_MCC_Material_Sale_Return='" & Doc_No & "')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from tspl_vendor_Invoice_Head where Against_MCC_Material_Sale_Return='" & Doc_No & "'"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)


            qry = "delete from TSPL_BATCH_ITEM where  Document_Code='" & Doc_No & "' and Document_Type in ('MCC-MSR')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            qry = "delete from TSPL_INVENTORY_MOVEMENT where Source_Doc_No='" & Doc_No & "' and Trans_Type in ('MCC-MSR')"
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
            ...
            '' Cancel E-Invoice ----------------------------- 
            Dim strIrnNo As String = clsCommon.myCstr(clsDBFuncationality.getSingleValue("select IRN_No from TSPL_SD_SALE_RETURN_HEAD where Document_Code='" & Doc_No & "'", trans))
...
Public Class clsMccMaterialSaleReturnDetail
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strDocNo As String, ByVal dtDocDate As DateTime, ByVal Arr As List(Of clsMccMaterialSaleReturnDetail), ByVal trans As SqlTransaction) As Boolean

        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsMccMaterialSaleReturnDetail In Arr
                Dim coll As New Hashtable()
                ...
                clsBatchInventory.SaveData("MCC-MSR", strDocNo, dtDocDate, "I", obj.Item_Code, obj.Location, obj.Line_No, obj.MRP, obj.Unit_code, obj.arrBatchItem, trans)
            Next
        End If
        Return True
    End Function
