...
where Document_No='" + obj.Document_No + "' 
    ...
    Public Shared Function GetAttachQry(ByVal StrCode As String) As String
        ...
        Dim Qry As String = "select TSPL_COMPANY_MASTER.Comp_Name,TSPL_COMPANY_MASTER.Add1,TSPL_COMPANY_MASTER.City_Code,TSPL_COMPANY_MASTER.State,TSPL_COMPANY_MASTER.Pincode,TSPL_COMPANY_MASTER.Circle_No,TSPL_COMPANY_MASTER.Fax,TSPL_COMPANY_MASTER.Phone1,TSPL_COMPANY_MASTER.Phone2,TSPL_PRODUCTION_UPLOADER_HEAD.Document_No as Doc_Code, convert(date,TSPL_PRODUCTION_UPLOADER_HEAD.Document_Date,103) as Doc_Date,TSPL_PRODUCTION_UPLOADER_HEAD.Location_FG,TSPL_PRODUCTION_UPLOADER_HEAD.Location_RM,TSPL_PRODUCTION_UPLOADER_HEAD.Location_PK,TSPL_PRODUCTION_UPLOADER_HEAD.Batch_No,TSPL_PRODUCTION_UPLOADER_HEAD.Batch_Date,TSPL_PRODUCTION_UPLOADER_HEAD.Description,TSPL_PRODUCTION_UPLOADER_DETAIL.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_PRODUCTION_UPLOADER_DETAIL.Batch_No as Batch,TSPL_PRODUCTION_UPLOADER_DETAIL.Batch_Date as [Batch Date],TSPL_PRODUCTION_UPLOADER_DETAIL.Qty,TSPL_PRODUCTION_UPLOADER_DETAIL.UOM,TSPL_PRODUCTION_UPLOADER_DETAIL.Shift_Code,TSPL_PRODUCTION_UPLOADER_HEAD.status,TSPL_INVENTORY_MOVEMENT.Item_Code as RM_ItemCode,TSPL_INVENTORY_MOVEMENT.Item_Desc as RM_ItemDesc,TSPL_INVENTORY_MOVEMENT.Qty as RM_Qty,TSPL_INVENTORY_MOVEMENT.UOM as RM_UOM,TSPL_INVENTORY_MOVEMENT.Batch_No as RM_BatchNo ,TSPL_INVENTORY_MOVEMENT.Posting_Date as RM_Posting_Date,TSPL_INVENTORY_MOVEMENT.Location_Code as RM_Location_Code
          from TSPL_PRODUCTION_UPLOADER_DETAIL
         ...
         left join TSPL_INVENTORY_MOVEMENT on TSPL_INVENTORY_MOVEMENT.Source_Doc_No = cast(TSPL_PRODUCTION_UPLOADER_DETAIL.PK_ID as varchar)
         left join TSPL_COMPANY_MASTER on 2=2
         where TSPL_INVENTORY_MOVEMENT.Trans_Type='DRY-PRO-UPL' and TSPL_INVENTORY_MOVEMENT.InOut = 'O' and TSPL_PRODUCTION_UPLOADER_HEAD.Document_No='" + StrCode + "'
          union all select TSPL_COMPANY_MASTER.Comp_Name,TSPL_COMPANY_MASTER.Add1,TSPL_COMPANY_MASTER.City_Code,TSPL_COMPANY_MASTER.State,TSPL_COMPANY_MASTER.Pincode,TSPL_COMPANY_MASTER.Circle_No,TSPL_COMPANY_MASTER.Fax,TSPL_COMPANY_MASTER.Phone1,TSPL_COMPANY_MASTER.Phone2,TSPL_PRODUCTION_UPLOADER_HEAD.Document_No as Doc_Code, convert(date,TSPL_PRODUCTION_UPLOADER_HEAD.Document_Date,103) as Doc_Date,TSPL_PRODUCTION_UPLOADER_HEAD.Location_FG,TSPL_PRODUCTION_UPLOADER_HEAD.Location_RM,TSPL_PRODUCTION_UPLOADER_HEAD.Location_PK,TSPL_PRODUCTION_UPLOADER_HEAD.Batch_No,TSPL_PRODUCTION_UPLOADER_HEAD.Batch_Date,TSPL_PRODUCTION_UPLOADER_HEAD.Description,TSPL_PRODUCTION_UPLOADER_DETAIL.Item_Code,TSPL_ITEM_MASTER.Item_Desc,TSPL_PRODUCTION_UPLOADER_DETAIL.Batch_No as Batch,TSPL_PRODUCTION_UPLOADER_DETAIL.Batch_Date as [Batch Date],TSPL_PRODUCTION_UPLOADER_DETAIL.Qty,TSPL_PRODUCTION_UPLOADER_DETAIL.UOM,TSPL_PRODUCTION_UPLOADER_DETAIL.Shift_Code,TSPL_PRODUCTION_UPLOADER_HEAD.status,TSPL_INVENTORY_MOVEMENT_NEW.Item_Code as RM_ItemCode,TSPL_INVENTORY_MOVEMENT_NEW.Item_Desc as RM_ItemDesc,TSPL_INVENTORY_MOVEMENT_NEW.Qty as RM_Qty,TSPL_INVENTORY_MOVEMENT_NEW.UOM as RM_UOM,TSPL_INVENTORY_MOVEMENT_NEW.Batch_No as RM_BatchNo ,TSPL_INVENTORY_MOVEMENT_NEW.Posting_Date as RM_Posting_Date,TSPL_INVENTORY_MOVEMENT_NEW.Location_Code as RM_Location_Code
            from TSPL_INVENTORY_MOVEMENT_NEW
            left outer join TSPL_PRODUCTION_UPLOADER_DETAIL on cast(TSPL_PRODUCTION_UPLOADER_DETAIL.PK_ID as varchar) = TSPL_INVENTORY_MOVEMENT_NEW.Source_Doc_No
           ...
           left join TSPL_ITEM_MASTER on TSPL_ITEM_MASTER.Item_Code = TSPL_PRODUCTION_UPLOADER_DETAIL.Item_Code
           left join TSPL_COMPANY_MASTER on 2=2
           where Trans_Type='DRY-PRO-UPL' and InOut = 'O' and TSPL_PRODUCTION_UPLOADER_HEAD.Document_No='" + StrCode + "'"
