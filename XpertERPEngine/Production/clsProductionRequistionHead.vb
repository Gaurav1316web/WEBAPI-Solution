...
Public Class clsProductionRequistionHead
#Region "Variables"
    ...
    Public ArrTr As List(Of clsProductionRequistionDetail) = Nothing
...
#End Region
    ...
    Public Function SaveData(ByVal obj As clsProductionRequistionHead, ByVal isNewEntry As Boolean) As Boolean
    ...
    Public Function SaveData(ByVal obj As clsProductionRequistionHead, ByVal isNewEntry As Boolean, ByVal trans As SqlTransaction) As Boolean
        Try
            Dim isSaved As Boolean = True
            ...
            '    Dim dt As DataTable = clsDBFuncationality.GetDataTable("Select Level1_Approval_Status, Level2_Approval_Status, Level3_Approval_Status,Level4_Approval_Status,Level5_Approval_Status from TSPL_PP_REQUISITION_HEAD WHERE Requisition_Id ='" + obj.Requisition_Id + "'", trans)
            ...
            'End If
            '-----------------------------------------------
            Dim qry As String = "delete from TSPL_PP_REQUISITION_DETAIL where Requisition_Id='" + obj.Requisition_Id + "'"
            ...
            If (isNewEntry) Then
                ...
                If clsCommon.CompairString(obj.Item_Type, "F") = CompairStringResult.Equal AndAlso clsCommon.CompairString(obj.Is_Internal, "Y") = CompairStringResult.Equal Then
                    obj.Requisition_Id = clsERPFuncationality.GetNextCode(trans, obj.Requisition_Date, clsDocType.frmProductionStoreRequest, clsDocTransactionType.FinishedGoodInternal, obj.Location)
                ...
                ElseIf clsCommon.CompairString(obj.Item_Type, "S") = CompairStringResult.Equal AndAlso clsCommon.CompairString(obj.Is_Internal, "Y") = CompairStringResult.Equal Then
                    obj.Requisition_Id = clsERPFuncationality.GetNextCode(trans, obj.Requisition_Date, clsDocType.frmProductionStoreRequest, clsDocTransactionType.SemiFinishedGoodInternal, obj.Location)
                ...
                ElseIf (clsCommon.CompairString(obj.Item_Type, "O") Or clsCommon.CompairString(obj.Item_Type, "R") Or clsCommon.CompairString(obj.Item_Type, "P") = CompairStringResult.Equal) And clsCommon.CompairString(obj.Is_Internal, "Y") = CompairStringResult.Equal Then
                    obj.Requisition_Id = clsERPFuncationality.GetNextCode(trans, obj.Requisition_Date, clsDocType.frmProductionStoreRequest, clsDocTransactionType.OtherInternal, obj.Location)
            ...
            If isNewEntry Then
                ...
                isSaved = isSaved AndAlso clsCommonFunctionality.UpdateDataTable(coll, "TSPL_PP_REQUISITION_HEAD", OMInsertOrUpdate.Insert, "", trans)
            Else
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal IsInternal As String) As clsProductionRequistionHead
        Return GetData(strCode, NavType, Nothing, IsInternal)
    End Function

    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal trans As SqlTransaction, ByVal IsInternal As String) As clsProductionRequistionHead
        Return GetData(strCode, NavType, trans, IsInternal, "")
    End Function

    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As common.NavigatorType, ByVal trans As SqlTransaction, ByVal IsInternal As String, ByVal FORMTYPE As String) As clsProductionRequistionHead
        Dim obj As clsProductionRequistionHead = Nothing
        Dim whrclas As String = ""
        Dim qry As String = "select TSPL_PP_REQUISITION_HEAD.close_yn,TSPL_PP_REQUISITION_HEAD.Requisition_Id,convert(varchar,TSPL_PP_REQUISITION_HEAD.Requisition_Date,103) as Requisition_Date,TSPL_PP_REQUISITION_HEAD.Expire_Date,TSPL_PP_REQUISITION_HEAD.Require_Date,TSPL_PP_REQUISITION_HEAD.Status,TSPL_PP_REQUISITION_HEAD.On_Hold,TSPL_PP_REQUISITION_HEAD.Manual_Complete,TSPL_PP_REQUISITION_HEAD.Ref_No,TSPL_PP_REQUISITION_HEAD.Description,TSPL_PP_REQUISITION_HEAD.Remarks,TSPL_PP_REQUISITION_HEAD.Location,TSPL_LOCATION_MASTER.Location_Desc as LocationName,TSPL_PP_REQUISITION_HEAD.Comments,TSPL_PP_REQUISITION_HEAD.Created_By,TSPL_PP_REQUISITION_HEAD.Created_Date,TSPL_PP_REQUISITION_HEAD.Modify_By,TSPL_PP_REQUISITION_HEAD.Modify_Date,TSPL_PP_REQUISITION_HEAD.Comp_Code,TSPL_PP_REQUISITION_HEAD.Posting_Date,TSPL_PP_REQUISITION_HEAD.Item_Type,Is_internal  "

        qry += " FROM TSPL_PP_REQUISITION_HEAD left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_PP_REQUISITION_HEAD.Location where  2=2"
        ...
        Select Case NavType
            Case NavigatorType.First
                qry += " and TSPL_PP_REQUISITION_HEAD.Requisition_Id=(select MIN(Requisition_Id) from TSPL_PP_REQUISITION_HEAD Where 1=1 " + whrclas + ")"
            Case NavigatorType.Last
                qry += " and TSPL_PP_REQUISITION_HEAD.Requisition_Id=(select Max(Requisition_Id) from TSPL_PP_REQUISITION_HEAD Where 1=1 " + whrclas + ")"
            Case NavigatorType.Next
                qry += " and TSPL_PP_REQUISITION_HEAD.Requisition_Id=(select Min(Requisition_Id) from TSPL_PP_REQUISITION_HEAD where Requisition_Id > '" + strCode + "' " + whrclas + ")"
            Case NavigatorType.Previous
                qry += " and TSPL_PP_REQUISITION_HEAD.Requisition_Id=(select Max(Requisition_Id) from TSPL_PP_REQUISITION_HEAD where Requisition_Id < '" + strCode + "' " + whrclas + ")"
            Case NavigatorType.Current
                qry += " and TSPL_PP_REQUISITION_HEAD.Requisition_Id='" + strCode + "'  "
        End Select

        Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            obj = New clsProductionRequistionHead()
            ...
            qry = "SELECT TSPL_PP_REQUISITION_DETAIL.Requisition_Id,TSPL_PP_REQUISITION_DETAIL.Line_No, TSPL_PP_REQUISITION_DETAIL.Item_Code,TSPL_PP_REQUISITION_DETAIL.Item_Desc,TSPL_PP_REQUISITION_DETAIL.Requisition_Qty,TSPL_PP_REQUISITION_DETAIL.Unit_Code,TSPL_PP_REQUISITION_DETAIL.Location,TSPL_LOCATION_MASTER.Location_Desc as LocationName ,TSPL_PP_REQUISITION_DETAIL.Status,TSPL_PP_REQUISITION_DETAIL.Specification,TSPL_PP_REQUISITION_DETAIL.Remarks,TSPL_PP_REQUISITION_DETAIL.Row_Type FROM TSPL_PP_REQUISITION_DETAIL left outer join TSPL_LOCATION_MASTER on TSPL_LOCATION_MASTER.Location_Code=TSPL_PP_REQUISITION_DETAIL.Location where TSPL_PP_REQUISITION_DETAIL.Requisition_Id='" + obj.Requisition_Id + "' ORDER BY TSPL_PP_REQUISITION_DETAIL.Line_No"
            dt = New DataTable()
            dt = clsDBFuncationality.GetDataTable(qry, trans)
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                obj.ArrTr = New List(Of clsProductionRequistionDetail)
                Dim objTr As clsProductionRequistionDetail
                For Each dr As DataRow In dt.Rows
                    objTr = New clsProductionRequistionDetail()
    ...
    Public Shared Function CloseprData(ByVal strDocNo As String, ByVal cls As String) As Boolean
        ...
        Try
            ...
            'Dim obj As clsProductionRequistionHead = clsProductionRequistionHead.GetData(strDocNo, NavigatorType.Current, trans, "")
            ...
            'End If
            'Dim qry As String
            'qry = "Update TSPL_PP_REQUISITION_HEAD set close_yn='" + cls + "' where Requisition_Id='" + strDocNo + "'"
    ...
    Public Shared Function PostData(ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        ...
        Try
            ...
            '    qry = "Update TSPL_PP_REQUISITION_HEAD set "
            ...
            'Else
            '    qry = "Update TSPL_PP_REQUISITION_HEAD set Status=1, Posting_Date='" + strPostDate + "',Modify_By='" + objCommonVar.CurrentUserCode + "' where Requisition_Id='" + strDocNo + "'"
            'End If
            ...
            'End If
            'If clsCommon.CompairString(clsCommon.myCstr(obj.Description), "Auto Indent") = CompairStringResult.Equal Then
            '    clsProductionRequistionDetail.UpdateAutoIndentReorderQty(strDocNo, obj.ArrTr, trans)
            'End If
    ...
    'Private Shared Sub CreateInternalEmailSMS(ByVal obj As clsProductionRequistionHead, ByVal trans As SqlTransaction)
    '    Dim qry As String = ""
    ...
    '            " left join TSPL_PP_REQUISITION_HEAD on TSPL_PP_REQUISITION_HEAD.Created_By=TSPL_USER_MASTER.User_Code " &
    '            " where TSPL_PP_REQUISITION_HEAD.Requisition_Id='" + obj.Requisition_Id + "'"
    ...
    '            For Each objdetail As clsProductionRequistionDetail In obj.ArrTr
    ...
    Public Shared Function DeleteData(ByVal strCode As String, ByVal trans As SqlTransaction) As Boolean
        ...
        End If
        Dim obj As clsProductionRequistionHead = clsProductionRequistionHead.GetData(strCode, NavigatorType.Current, trans, "")
        ...
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Requisition_Id) > 0) Then
            Try
                ...
                qry = "delete from TSPL_PP_REQUISITION_HEAD where Requisition_Id='" + strCode + "'"
                isSaved = isSaved AndAlso clsDBFuncationality.ExecuteNonQuery(qry, trans)
    ...
    Public Shared Function ReverseAndUnpost(ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        Try
            Dim qry As String = "select 1 from TSPL_PP_REQUISITION_HEAD where Requisition_Id='" + strDocNo + "' and Status=1"
            Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry, trans)
            If dt Is Nothing OrElse dt.Rows.Count <= 0 Then
                Throw New Exception("Transaction status should be posted.")
            End If

            dt = clsDBFuncationality.GetDataTable("select Requisition_Date,Location from TSPL_PP_REQUISITION_HEAD where Requisition_Id='" + strDocNo + "'", trans)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleProductionDairy, clsUserMgtCode.frmProductionStoreRequest, clsCommon.myCstr(dt.Rows(0)("Location")), clsCommon.myCDate(dt.Rows(0)("Requisition_Date")), trans)
    ...
    Public Shared Function CancelData(ByVal Form_Id As String, ByVal Doc_No As String) As Boolean
        ...
        Try
            ...
            Dim obj As clsProductionRequistionHead = clsProductionRequistionHead.GetData(Doc_No, NavigatorType.Current, trans, "")
            If obj Is Nothing OrElse clsCommon.myLen(obj.Requisition_Id) <= 0 Then
                Throw New Exception("Document- " & Doc_No & " not found")
            End If

            clsCommonFunctionality.SaveCancelData(objCommonVar.CurrentUserCode, Doc_No, "TSPL_PP_REQUISITION_HEAD", "Requisition_Id", "TSPL_PP_REQUISITION_DETAIL", "Requisition_Id", trans)

            clsProductionRequistionHead.ReverseAndUnpost(Doc_No, trans)
            clsProductionRequistionHead.DeleteData(Doc_No, trans)
    ...
    Public Shared Function CloseProdStoreRequest(ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        Try
            Dim qry As String = " update TSPL_PP_REQUISITION_HEAD set close_yn = 'Y' where Requisition_Id = '" + strDocNo + "' "
            clsDBFuncationality.ExecuteNonQuery(qry, trans)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    '    Dim qry As String = "select 1 from TSPL_PP_REQUISITION_DETAIL where Requisition_Id ='" + strReqNo + "' and Item_Code='" + strICode + "' and Vendor_Code not in ('','" + strVendorCode + "')"
    ...
    '    Dim qry As String = "select 1 from TSPL_PP_REQUISITION_HEAD where Requisition_Id ='" + strReqNo + "' and PROJECT_ID='" & strProject & "'"
    '    Dim dt As DataTable = clsDBFuncationality.GetDataTable(qry)
    '    If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
    '    Else
    '        Return False
    ...
    '    Dim strProj As String = clsDBFuncationality.getSingleValue("select ISNULL(PROJECT_ID,'') from TSPL_PP_REQUISITION_HEAD where Requisition_Id ='" + strReqNo + "'")
    '    Return strProj
    'End Function
...
Public Class clsProductionRequistionDetail
#Region "Variables"
...
#End Region
    ...
    Public Shared Function SaveData(ByVal strReqNo As String, ByVal Arr As List(Of clsProductionRequistionDetail), ByVal trans As SqlTransaction) As Boolean
        Dim intLineNo As Integer = 1
        If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
            For Each obj As clsProductionRequistionDetail In Arr
                Dim coll As New Hashtable()
                ...
                clsCommonFunctionality.UpdateDataTable(coll, "TSPL_PP_REQUISITION_DETAIL", OMInsertOrUpdate.Insert, "", trans)
    ...
    'Public Shared Function UpdateAutoIndentReorderQty(ByVal strReqNo As String, ByVal Arr As List(Of clsProductionRequistionDetail), ByVal trans As SqlTransaction) As Boolean
    '    If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
    '        For Each obj As clsProductionRequistionDetail In Arr
    ...
    '        " select TSPL_PP_REQUISITION_DETAIL.Item_Code as ICode,TSPL_PP_REQUISITION_DETAIL.Requisition_Qty as Qty,1 as RI from TSPL_PP_REQUISITION_DETAIL left outer join TSPL_PP_REQUISITION_HEAD on TSPL_PP_REQUISITION_HEAD.Requisition_Id=TSPL_PP_REQUISITION_DETAIL.Requisition_Id where TSPL_PP_REQUISITION_DETAIL.Status='N' and TSPL_PP_REQUISITION_HEAD.Status=1 and TSPL_PP_REQUISITION_DETAIL.Requisition_Id='" + strReqCode + "' and TSPL_PP_REQUISITION_DETAIL.Item_Code='" + strICode + "'" &
    '        " union all " &
    ...
    Public Shared Function CompleteRequition(ByVal strReqCode As String, ByVal strICode As String, ByVal LineNo As Integer) As Boolean
        Dim qry As String = "update TSPL_PP_REQUISITION_DETAIL set Status ='Y' where Requisition_Id='" + strReqCode + "' and Line_No='" + clsCommon.myCstr(LineNo) + "' and Item_Code='" + strICode + "'"
