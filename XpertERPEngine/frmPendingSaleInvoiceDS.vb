...
Public Class frmPendingSaleInvoiceDS
#Region "Variables"
    ...
    Public ArrReturn As List(Of clsPSInvoiceHeadDetail) = Nothing
...
#End Region
    ...
    Sub btnOKPressed()
        ArrReturn = New List(Of clsPSInvoiceHeadDetail)
        Dim obj As clsPSInvoiceHeadDetail = Nothing
        For ii As Integer = 0 To gv1.RowCount - 1
            If (clsCommon.myCBool(gv1.Rows(ii).Cells(colDSelect).Value)) Then
                obj = New clsPSInvoiceHeadDetail()
    ...
    Sub LoadData()
        Try
            ...
            qry += " and convert(date,TSPL_SD_SALE_INVOICE_HEAD.Document_Date,103) > =convert(date,'" + tp_FromDate.Value + "',103) and convert(date,TSPL_SD_SALE_INVOICE_HEAD.Document_Date,103) <= convert(date,'" + tp_ToDate.Value + "',103) AND TSPL_SD_SALE_RETURN_HEAD.Is_Taxable=" & Is_Taxable & " " + Environment.NewLine
