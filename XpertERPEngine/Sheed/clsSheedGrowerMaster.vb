...
Public Class clsSheedGrowerMaster
    ...
    Public Function SaveData(ByVal obj As clsSheedGrowerMaster, ByVal isNewEntry As Boolean) As Boolean
        ...
        Return True
    End Function
    Public Shared Function SaveData(ByVal obj As clsSheedGrowerMaster, ByVal isNewEntry As Boolean, ByVal trans As SqlTransaction) As Boolean
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As NavigatorType) As clsSheedGrowerMaster
        Dim trans As SqlTransaction = clsDBFuncationality.GetTransactin()
        Try
            Dim obj As clsSheedGrowerMaster = GetData(strCode, NavType, trans)
            trans.Commit()
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsSheedGrowerMaster
        Dim obj As clsSheedGrowerMaster = Nothing
