        ...
        Try
            If (obj1.Arr IsNot Nothing AndAlso obj1.Arr.Count > 0) Then
                ...
                For Each obj As clsPhysicalstock In obj1.Arr
                    ...
                    clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleMaterial, clsUserMgtCode.frmPhysicalStock, obj.Main_Location, obj.Stock_Date, trans)
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                For Each dr As DataRow In dt.Rows
                    ...
                    If dts IsNot Nothing AndAlso dts.Rows.Count > 0 Then
                        ...
                        clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleMaterial, clsUserMgtCode.frmPhysicalStock, clsCommon.myCstr(dts.Rows(0)("Location")), clsCommon.myCDate(dts.Rows(0)("Stock_Date")), tran)
                    End If
    ...
    Public Shared Function PostData(ByVal strDocNo As String, ByVal isCheckForPosted As Boolean, ByVal trans As SqlTransaction, ByVal location As String, ByVal sublocation As String, ByVal is_Milk As Boolean) As Boolean
        Try
            ...
            If dts IsNot Nothing AndAlso dts.Rows.Count > 0 Then
                ...
                clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleMaterial, clsUserMgtCode.frmPhysicalStock, clsCommon.myCstr(dts.Rows(0)("Location")), clsCommon.myCDate(dts.Rows(0)("Stock_Date")), trans)
            End If
    ...
    Public Shared Function DeleteData(ByVal strDocNo As String) As Boolean
        ...
        Try
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleMaterial, clsUserMgtCode.frmPhysicalStock, clsCommon.myCstr(dt.Rows(0)("Location")), clsCommon.myCDate(dt.Rows(0)("Stock_Date")), tran)
            End If
