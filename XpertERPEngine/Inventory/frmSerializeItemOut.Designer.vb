...
Partial Class frmSerializeItemOut
    ...
    Public WithEvents btnFillAuto As Telerik.WinControls.UI.RadButton
    Public WithEvents txtBarCode As common.Controls.MyTextBox
    Public WithEvents btnOK As Telerik.WinControls.UI.RadButton
End Class
