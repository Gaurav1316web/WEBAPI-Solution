...
#End Region
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        Try
            ...
            clsCommonFunctionality.SaveDeletedData(objCommonVar.CurrentUserCode, strCode, "TSPL_LEAVE_SETTING", "LEAVE_CODE", Nothing)
    ...
    Public Shared Function GetData(ByVal strCode As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsLeaveSetting
        ...
        If clsCommon.myLen(objCommonVar.strCurrUserLocations) > 0 Then
            whrQry = " And TSPL_LEAVE_SETTING.Location_Code in (" + objCommonVar.strCurrUserLocations + ")"
        End If
