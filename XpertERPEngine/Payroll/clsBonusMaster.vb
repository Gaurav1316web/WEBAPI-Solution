...
#End Region
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        Try
            ...
            End If
            clsCommonFunctionality.SaveDeletedData(objCommonVar.CurrentUserCode, strCode, "TSPL_BONUS_MASTER", "BONUS_CODE", Nothing)
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, strCode, "TSPL_BONUS_MASTER", "BONUS_CODE", Nothing)
    ...
    Public Function SaveData(ByVal obj As clsBonusMaster, ByVal isNewEntry As Boolean) As Boolean
        ...
        Try
            ...
            End If
            clsCommonFunctionality.SaveHistoryData(objCommonVar.CurrentUserCode, obj.Code, "TSPL_BONUS_MASTER", "BONUS_CODE", Nothing)
