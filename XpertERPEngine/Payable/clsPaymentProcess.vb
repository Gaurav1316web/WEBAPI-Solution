...
where TSPL_PAYMENT_PROCESS_MCC_SALE.doc_no  in (" + strDocNo + ") 
        ...
        If dt IsNot Nothing And dt.Rows.Count > 0 Then
            ...
            ElseIf clsCommon.CompairString(objCommonVar.CurrComp_Code1, "UDP") = CompairStringResult.Equal OrElse clsCommon.CompairString(objCommonVar.CurrentCompanyCode, "RCDF") = CompairStringResult.Equal Then
