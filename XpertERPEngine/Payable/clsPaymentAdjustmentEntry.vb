...
#Region "Variables"
    ...
    Public Against_Make_Saving_Payment As String = Nothing
#End Region
    ...
    Public Shared Function GetData(ByVal strAdjNo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsPaymentAdjustmentEntry
       ...
       "  0 as BalanceAmt," &
       " [TSPL_Payment_Adjustment_Header].[Remarks], [Adjustment_Amount], ISNULL([Is_Post],'N') as Is_Post,[TSPL_Payment_Adjustment_Header].Adjust_Type,TSPL_Payment_Adjustment_Header.Adjustment_Amount_Before_RO,TSPL_Payment_Adjustment_Header.Round_Off_Amount,TSPL_Payment_Adjustment_Header.Against_Payment_Process,TSPL_Payment_Adjustment_Header.Against_Make_Saving_Payment FROM [TSPL_Payment_Adjustment_Header]" &
