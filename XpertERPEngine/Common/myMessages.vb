...
Public Module myMessages
    ...
    Public Function ReCreateJEConfirm() As Boolean
        message = "Do you want to recreate JE."
        If common.clsCommon.MyMessageBoxShow(message, "", MessageBoxButtons.YesNo, RadMessageIcon.Question) = DialogResult.No Then
            Return False
        End If
        Return True
    ...
    Public Function ApprovalConfirm() As Boolean
        ...
        Return True
    End Function
    Public Function RequestApprovalConfirm() As Boolean
        message = "Do you want to Approved Request."
        If common.clsCommon.MyMessageBoxShow(message, "", MessageBoxButtons.YesNo, RadMessageIcon.Question) = DialogResult.No Then
            Return False
        End If
        Return True
    End Function
    Public Function RequestRejectConfirm() As Boolean
    ...
    Public Function GLAccountRefreshConfirm() As Boolean
        ...
        Return True
    End Function
    Public Function DairyGatePassPovisionConfirm() As Boolean
        message = "Transpoter is Not Tag with Vehicle Or Transpoter is not Vendor Type .Do you want to Post this record without Povision Entry."
        If common.clsCommon.MyMessageBoxShow(message, "", MessageBoxButtons.YesNo, RadMessageIcon.Question) = DialogResult.No Then
            Return False
        End If
        Return True
