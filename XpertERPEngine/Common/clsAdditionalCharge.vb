...
#Region "Variables"
    ...
    Public Price_CodeFOR As String
    ...
    Public Cast_Category_Code As String = String.Empty
    Public Distict_Code As String = String.Empty
    Public Block_Code As String = String.Empty
    Public Revenue_Village_Code As String = String.Empty
    Public Grampanchayat_Code As String = String.Empty
    Public Panchayat_Samiti_Code As String = String.Empty
    Public Vidhan_Sabha_Code As String = String.Empty
