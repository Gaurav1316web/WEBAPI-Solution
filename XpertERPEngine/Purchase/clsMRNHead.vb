...
#End Region
    Public Function SaveData(ByVal obj As clsMRNHead, ByVal isNewEntry As Boolean, Optional ByVal isamendment As Boolean = False) As Boolean
        ...
        Return True
    End Function
    Public Shared Function funMRNPrint(ByVal Form_ID As String, ByVal isCancel As Boolean, ByVal strDate As DateTime, ByVal StrDocNo As String) As Boolean
        'Try
        Dim TSPL_MRN_HEAD As String = Nothing
        Dim TSPL_MRN_DETAIL As String = Nothing
        Dim SD_SHIPMENT_HEAD As String = Nothing
        Dim SD_SHIPMENT_DETAIL As String = Nothing
        If isCancel Then
            TSPL_MRN_HEAD = " TSPL_MRN_HEAD_Cancel_Data As TSPL_MRN_HEAD "
            TSPL_MRN_DETAIL = " TSPL_MRN_DETAIL_Cancel_Data As TSPL_MRN_DETAIL "
        Else
            TSPL_MRN_HEAD = " TSPL_MRN_HEAD"
            TSPL_MRN_DETAIL = " TSPL_MRN_DETAIL "
                ...
                Else
                    ...
                    Else
                        If ShowItemAllStructureWise Then
                            obj.MRN_No = clsERPFuncationality.GetNextCode(trans, clsCommon.myCDate(obj.MRN_Date), clsDocType.MRN, clsDocTransactionType.All, obj.Bill_To_Location)
                        Else
