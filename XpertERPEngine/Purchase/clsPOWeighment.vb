...
#End Region
    'Public Shared Function CancelPOWeighmentData(ByVal strCode As String) As Boolean
...
select Against_GRN_No from TSPL_PO_WEIGHTMENT_HEAD where Weighment_Code='" + clsCommon.myCstr(strPOWNo) + "' ))fin"
 ...
 left outer join TSPL_GRN_HEAD on TSPL_GRN_HEAD.GRN_No=TSPL_PO_WEIGHTMENT_HEAD.Against_GRN_No where Weighment_Code= '" + obj.Weighment_Code + "' ", trans)
            clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, "Purchase Order", "Purchase Order", clsCommon.myCstr(dts.Rows(0)("Bill_To_Location")), obj.Weighment_Date, trans)
