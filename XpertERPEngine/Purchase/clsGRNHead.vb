...
#End Region
    ...
    Public Shared Function funGRNPrint(ByVal Form_ID As String, ByVal isCancel As Boolean, ByVal strDate As DateTime, ByVal StrDocNo As String) As Boolean
        ...
        If clsCommon.myLen(StrDocNo) > 0 Then
            ...
            Dim TSPL_GRN_HEAD As String = Nothing
            Dim TSPL_GRN_DETAIL As String = Nothing
            If isCancel Then
                TSPL_GRN_HEAD = " tspl_GRN_HEAD_Cancel_Data  AS HEAD"
                TSPL_GRN_DETAIL = " tspl_GRN_detail_Cancel_Data"
                'SD_SHIPMENT_HEAD = " TSPL_SD_SHIPMENT_HEAD_Cancel_Data As TSPL_SD_SHIPMENT_HEAD "
                ' SD_SHIPMENT_DETAIL = " TSPL_SD_SHIPMENT_DETAIL_Cancel_Data As TSPL_SD_SHIPMENT_DETAIL "
            Else
                TSPL_GRN_HEAD = " tspl_GRN_HEAD As tspl_GRN_HEAD as head"
                TSPL_GRN_DETAIL = " tspl_GRN_DETAIL As tspl_GRN_DETAIL as detail "
            End If
        ...
        If strquery IsNot Nothing AndAlso clsCommon.myLen(strquery) > 0 Then
                ...
                frmCRV.funsubreportWithdt(Form_ID, CrystalReportFolder.PurchaseOrder, dt, clsERPFuncationality.CompanyAddresShowinHeaderPartForERODE(), "crptGRNReport", "GRN Report", clsCommon.myCDate(dt.Rows(0)("GRN Date")), "SubRptCmpnyMasterForERODE.rpt")
                frmCRV = Nothing
                End If
            End If
