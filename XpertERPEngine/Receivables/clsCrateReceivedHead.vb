...
#End Region
    ...
    Public Shared Function GetData(ByVal strDocNo As String, ByVal NavType As NavigatorType, ByVal trans As SqlTransaction) As clsCrateReceivedHead
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            "TSPL_CRATE_RECEIVED_DETAIL_FRESHSALE.VehicleNo,TSPL_CRATE_RECEIVED_DETAIL_FRESHSALE.CrateType,TSPL_CRATE_RECEIVED_DETAIL_FRESHSALE.CrateQtyRecd, " &
            ...
            If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
                ...
                For Each dr As DataRow In dt.Rows
                    ...
                    objTr.CrateType = clsCommon.myCstr(dr("CrateType"))
    ...
    Public Shared Function DeleteData(ByVal strCode As String) As Boolean
        ...
        If (obj IsNot Nothing AndAlso clsCommon.myLen(obj.Document_No) > 0) Then
            Try
                clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleBulkSale, clsUserMgtCode.FrmCanReceived, obj.Location_Code, clsCommon.myCDate(obj.Document_Date), trans)
                ' clsERPFuncationality.ValidateLocationCode(objCommonVar.CurrentCompanyCode, clsUserMgtCode.ModuleSaleDairy, clsUserMgtCode.frmCrateReceviedDairySale, obj.Location_Code, clsCommon.myCDate(obj.Document_Date), trans)
                clsCommonFunctionality.SaveDeletedData(objCommonVar.CurrentUserCode, strCode, "TSPL_CRATE_RECEIVED_HEAD_FRESHSALE", "Document_No", "TSPL_CRATE_RECEIVED_DETAIL_FRESHSALE", "Document_No", trans)
    ...
    Public Shared Function PostData(ByVal FormId As String, ByVal strDocNo As String, ByVal trans As SqlTransaction) As Boolean
        Try
            ...
            Dim qry = "Update TSPL_CRATE_RECEIVED_HEAD_FRESHSALE set Posted=1, " &
            "Posting_Date='" + clsCommon.GetPrintDate(clsCommon.GETSERVERDATE(trans), "dd/MMM/yyyy") + "'" &
    ...
    Public Shared Function getCustomerOutstandingCrateWithOPeningAndClosing(ByVal strCustomer As String, ByVal strfromdate As String, ByVal strtodate As String, ByVal ConvRate As String) As String
        Try
            ...
            " union all " & Environment.NewLine &
            " select TSPL_SD_SHIPMENT_HEAD.Document_Date   as Document_Date,TSPL_SD_SHIPMENT_HEAD.Vehicle_Code ,TSPL_SD_SHIPMENT_HEAD.customer_code  ,-1 as Type  ,'O' as Type1,0 as OpencrateQty,0  as OpenBoxQty ,0 as OpenJaaliQty,0 as OpenCANQty, 0 as CrateQtyRecd, 0 JaaliQtyRecd ,  0  as BoxQtyRecd,0 CanQtyRecd  ,TSPL_SD_SHIPMENT_HEAD.Crate as CrateOutQty,jaali  as jaaliOutQty,TSPL_SD_SHIPMENT_HEAD.Box as boxOutQty,TSPL_SD_SHIPMENT_HEAD.ShippedCAN as CanOutQty ,0 as CrateAdjQty,0 as JaaliAdjQty,0 as  BoxAdjQty,0 as  CanAdjQty    from TSPL_SD_SHIPMENT_HEAD  where TSPL_SD_SHIPMENT_HEAD.screen_type='DS'  AND TSPL_SD_SHIPMENT_HEAD.Status =1   )" +
            Environment.NewLine + " union all " + Environment.NewLine +
...
#Region "Variable"
    ...
    Public CrateType As String = Nothing
        ...
        Try
            If (Arr IsNot Nothing AndAlso Arr.Count > 0) Then
                ...
                For Each obj As clsCrateReceivedDetail In Arr
                    ...
                    clsCommon.AddColumnsForChange(coll, "CrateType", obj.CrateType, True)
