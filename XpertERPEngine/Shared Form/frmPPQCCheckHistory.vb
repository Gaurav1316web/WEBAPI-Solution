    ...
    Private Sub gv_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gv.DoubleClick
        Try
            ...
            If clsCommon.CompairString(doc_type, "MCC") = CompairStringResult.Equal Then
                ...
                'frm.ShowDialog()
                clsOpenTransactionForm.OpenTransacionForm(clsUserMgtCode.frmQualityCheck, clsCommon.myCstr(gv.CurrentRow.Cells(coldocno).Value))
            ElseIf clsCommon.CompairString(doc_type, "Standardization") = CompairStringResult.Equal Then
                ...
                'frm.WindowState = FormWindowState.Maximized
                'frm.ShowDialog()
                clsOpenTransactionForm.OpenTransacionForm(clsUserMgtCode.frmProcessProductionStandardization, clsCommon.myCstr(gv.CurrentRow.Cells(coldocno).Value))
            ElseIf clsCommon.CompairString(doc_type, "Stage Process") = CompairStringResult.Equal Then
                ...
                'frm.WindowState = FormWindowState.Maximized
                'frm.ShowDialog()
                clsOpenTransactionForm.OpenTransacionForm(clsUserMgtCode.frmProcessProductionStageProcess, clsCommon.myCstr(gv.CurrentRow.Cells(coldocno).Value))
            End If
