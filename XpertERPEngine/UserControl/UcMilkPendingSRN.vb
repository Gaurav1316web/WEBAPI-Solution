...
#End Region
    ...
    Public Function LoaDHeadDataQuery(ByVal trans As SqlTransaction) As Boolean '==========This is For Create Bill and Incentive Both.
    ...
    Public Function LoaDHeadDataQueryVsp(ByVal trans As SqlTransaction) As Boolean '==========This is For Whose bill is Created and Want to Create only Incentive Of Those.
        MultipleFinderFillAuto = (clsCommon.myCdbl(clsFixedParameter.GetData(clsFixedParameterType.MultipleFinderFillAuto, clsFixedParameterCode.MultipleFinderFillAuto, trans)) = 1)
