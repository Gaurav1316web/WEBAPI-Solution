' ----------------- Created By Sanjay Ticket No  No  VIJ/21/10/19-000038  -------------------- '
...
Public Class frmParameterMasterEng
...
#Region "Functions"
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Dim obj As clsEngParameterMaster = clsEngParameterMaster.GetData(strCode, NavTyep)
    ...
    Sub SaveData()
        Try
            If AllowToSave() Then
                Dim obj As New clsEngParameterMaster()
                obj.Code = txtCode.Value
                obj.Description = txtdes.Text
                Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(Code) from TSPL_ENG_PARAMETER_MASTER where Code='" + obj.Code + "'")
                If (qry = 0) Then
                    isNewEntry = True
                Else
                    isNewEntry = False
                End If
                If (clsEngParameterMaster.SaveData(obj, isNewEntry)) Then
    ...
    Private Sub DeleteData()
        Try
            ...
            If myMessages.deleteConfirm() Then
                If (clsEngParameterMaster.DeleteData(txtCode.Value)) Then
...
#Region "EVENTS"
    Private Sub frmParameterMasterEng_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
        AddNew()
...
#End Region
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            ...
            txtCode.Value = clsCommon.ShowSelectForm("TSPL_ENG_PARAMETER_MASTER", qry, "Code", "", txtCode.Value, "", isButtonClicked)
    ...
    Private Sub frmParameterMasterEng_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Dim qry As String = "select count(*) from TSPL_ENG_PARAMETER_MASTER"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Description from TSPL_ENG_PARAMETER_MASTER"
        Else
    ...
    Private Sub btnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImport.Click
        ...
        If transportSql.importExcel(gv_Import, "Code", "Description") Then
            ...
            Try
                Dim objList = New List(Of clsEngParameterMaster)
                ...
                For Each grow As GridViewRowInfo In gv_Import.Rows
                    ...
                    If clsCommon.myLen(obj.Code) <= 0 Then
                        Throw New Exception("Fill parameter Code at line no. " + clsCommon.myCstr(grow.Index + 1) + "")
                    ElseIf clsCommon.myLen(obj.Code) > 30 Then
                        Throw New Exception("Parameter Code has max. length 30 see at line no. " + clsCommon.myCstr(grow.Index + 1) + "")
                    End If
                    ...
                    objList.Add(obj)
                Next
                clsEngParameterMaster.SaveData(objList)
