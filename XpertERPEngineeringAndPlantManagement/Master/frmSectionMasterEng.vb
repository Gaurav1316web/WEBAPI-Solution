' ----------------- Created By Sanjay Ticket No  VIJ/21/10/19-000035 -------------------- '
...
Public Class frmSectionMasterEng
...
#Region "Functions"
    ...
    Sub SaveData()
        Try
            If AllowToSave() Then
                Dim obj As New clsEngSectionMaster()
                obj.Code = txtCode.Value
                obj.Description = txtdes.Text
                Dim qry As Integer = clsDBFuncationality.getSingleValue("select count(Code) from TSPL_ENG_SECTION_MASTER where Code='" + obj.Code + "'")
                If (qry = 0) Then
                    isNewEntry = True
                Else
                    isNewEntry = False
...
#Region "EVENTS"
    Private Sub frmSectionMasterEng_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetUserMgmtNew()
...
#End Region
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        If txtCode.MyReadOnly OrElse isButtonClicked Then
            Dim qry As String = "select Code As Code,Description from  TSPL_ENG_SECTION_MASTER"
            txtCode.Value = clsCommon.ShowSelectForm("TSPL_ENG_SECTION_MASTER", qry, "Code", "", txtCode.Value, "", isButtonClicked)
    ...
    Private Sub frmSectionMasterEng_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        ElseIf e.Alt AndAlso e.Shift AndAlso e.Control And e.KeyCode = Keys.F12 Then
            ButtonToolTip.SetToolTip(btnsave, "Press Alt+S for Save/Update Trasnaction" + Environment.NewLine + _
                                                             "TSPL_ENG_SECTION_MASTER ")
        End If
    End Sub

    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Dim qry As String = "select count(*) from TSPL_ENG_SECTION_MASTER"
        Dim check As Integer = clsDBFuncationality.getSingleValue(qry)

        If check > 0 Then
            qry = "select Code,Description from TSPL_ENG_SECTION_MASTER"
        Else
    ...
    Private Sub btnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImport.Click
        ...
        If transportSql.importExcel(gv_Import, "Code", "Description") Then
            ...
            Try
                Dim objList = New List(Of clsEngSectionMaster)
