...
Public Class FrmViewTDS
    ...
    Private Sub FrmViewTDS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (ObjIn IsNot Nothing) Then
            ...
            txtTDSBaseCal.Value = ObjIn.Calculated_TDS_Base
            txtTDSBaseAct.Value = ObjIn.Actual_TDS_Base
            txtTDSPerCal.Value = ObjIn.TDS_Per
            txtTDSPerAct.Value = ObjIn.TDS_Per
            txtTDSAmtCal.Value = ObjIn.Calculated_TDS
            txtTDSAmtAct.Value = ObjIn.Actual_TDS
            txtSurchargePerCal.Value = ObjIn.Surcharge_Per
            txtSurchargePerAct.Value = ObjIn.Surcharge_Per
            txtSurchargeAmtCal.Value = ObjIn.Calculated_Surcharge
            txtSurchargeAmtAct.Value = ObjIn.Actual_Surcharge
            txtEcessPerCal.Value = ObjIn.Edu_Cess_Per
            txtEcessPerAct.Value = ObjIn.Edu_Cess_Per
            txtEcessAmtCal.Value = ObjIn.Calculated_Edu_Cess
            txtEcessAmtAct.Value = ObjIn.Actual_Edu_Cess

            txtHCessPerCal.Value = ObjIn.Sec_Educess_Per
            txtHCessPerAct.Value = ObjIn.Sec_Educess_Per
            txtHCessAmtCal.Value = ObjIn.Calculated_Sec_Educess
            txtHCessAmtAct.Value = ObjIn.Actual_Sec_Educess

            txtTotTDSCal.Value = ObjIn.Calculated_Total_TDS
            txtTotTDSAct.Value = ObjIn.Actual_Total_TDS
    ...
    Private Sub RadButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        'ObjReturn = Nothing
        Me.Close()
    End Sub
    ...
    Sub CalculateActualTDS()
        txtTDSAmtAct.Value = (txtTDSBaseAct.Value * txtTDSPerAct.Value) / 100
        txtTDSAmtCal.Value = (txtTDSBaseCal.Value * txtTDSPerCal.Value) / 100
        txtSurchargeAmtAct.Value = (txtTDSBaseAct.Value * txtSurchargePerAct.Value) / 100
        txtSurchargeAmtCal.Value = (txtTDSBaseCal.Value * txtSurchargePerCal.Value) / 100
        txtEcessAmtAct.Value = (txtTDSBaseAct.Value * txtEcessPerAct.Value) / 100
        txtEcessAmtCal.Value = (txtTDSBaseCal.Value * txtEcessPerCal.Value) / 100
        txtHCessAmtAct.Value = (txtTDSBaseAct.Value * txtHCessPerAct.Value) / 100
        txtHCessAmtCal.Value = (txtTDSBaseCal.Value * txtHCessPerCal.Value) / 100
        txtTotTDSAct.Value = (txtTDSAmtAct.Value + txtSurchargeAmtAct.Value + txtEcessAmtAct.Value + txtHCessAmtAct.Value)
        txtTotTDSCal.Value = (txtTDSAmtCal.Value + txtSurchargeAmtCal.Value + txtEcessAmtCal.Value + txtHCessAmtCal.Value)
    End Sub
    ...
    Private Sub txtNatureOfDed_TxtChanged()
        ...
        If (dt IsNot Nothing AndAlso dt.Rows.Count > 0) Then
            ...
            If Not isInSideLoadData Then
                Dim objDedDetails As clsTDSDeductionDetails = clsTDSDeductionDetails.GetApplicableTDRate(txtNatureOfDeduction.Value, clsCommon.myCdbl(ObjIn.Document_Amount))
