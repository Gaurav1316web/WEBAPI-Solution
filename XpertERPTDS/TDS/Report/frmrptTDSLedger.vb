...
Public Class FrmrptTDSLedger
    ...
    Private Sub FormatGrid()
        ...
        gvReport.Columns("VLC_Uploader_Code").IsVisible = True
        gvReport.Columns("VLC_Uploader_Code").Width = 100
        gvReport.Columns("VLC_Uploader_Code").HeaderText = "VLC Uploader Code"
