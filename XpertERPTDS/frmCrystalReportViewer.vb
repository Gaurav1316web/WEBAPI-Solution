...
#End Region
    ...
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal strReportName As String, ByVal strCaption As String)
        ...
        dtTranDate = Nothing
        funreport(crpfolder, dt, EnumTecxpertPaperSize.NA, strReportName, strCaption, dtTranDate)
    End Sub
    '====================================
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal strReportName As String, ByVal strCaption As String, ByVal dtTranDate? As Date)
        funreport(crpfolder, dt, EnumTecxpertPaperSize.NA, strReportName, strCaption, dtTranDate)
    End Sub

    '=================================================
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal ePaperSize As EnumTecxpertPaperSize, ByVal strReportName As String, ByVal strCaption As String, ByVal dtTranDate? As Date)
        funreport(crpfolder, dt, ePaperSize, strReportName, strCaption, False, dtTranDate)
    End Sub
    '==============added by preeti gupta============
    ...
    End Sub
    Public Sub funreport(ByVal crpfolder As CrystalReportFolder, ByVal dt As DataTable, ByVal ePaperSize As EnumTecxpertPaperSize, ByVal strReportName As String, ByVal strCaption As String, ByVal IsShowDilogue As Boolean, ByVal dtTranDate? As Date)
    ...
    Public Sub funsubreportWithdt(ByVal crpfolder As CrystalReportFolder, ByVal dt1 As DataTable, ByVal dt2 As DataTable, ByVal strReportName As String, ByVal strCaption As String, Optional ByVal strSubReport1 As String = vbNullString, Optional ByVal strSubReport2 As String = vbNullString, Optional ByVal dt3 As DataTable = Nothing, Optional ByVal strSubReport3 As String = vbNullString, Optional ByVal dt4 As DataTable = Nothing)
        Dim dtTransDate As Date?
        dtTransDate = Nothing
        funsubreportWithdt(crpfolder, dt1, dt2, strReportName, strCaption, dtTransDate, strSubReport1, strSubReport2, dt3, strSubReport3, dt4)
    End Sub
