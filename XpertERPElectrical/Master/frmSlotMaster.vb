...
Public Class frmSlotMaster
    Inherits FrmMainTranScreen
    ' Ticket No : ERO/24/10/18-000409 By Prabhakar 
#Region "Variables"
...
#End Region
        ...
        Try
            If (AllowToSave()) Then
                ...
                If MyBase.isModifyonPasswordFlag Then
                    If clsPasswordCheckForMasters.CheckMasterPwd(clsUserMgtCode.frmSlotMaster, clsCommon.myCstr(objCommonVar.CurrentCompanyCode)) Then
                    Else
                        Return
                    End If
                End If
                Dim arr As New List(Of clsSlotMaster)
                Dim obj As New clsSlotMaster()
    ...
    Sub LoadData(ByVal strCode As String, ByVal NavTyep As NavigatorType)
        Try
            ...
            Dim obj As New clsSlotMaster()
            obj = clsSlotMaster.GetData(strCode, NavTyep, Nothing)
    ...
    Private Sub txtCode__MYValidating(ByVal sender As System.Object, ByVal e As System.EventArgs, ByVal isButtonClicked As System.Boolean) Handles txtCode._MYValidating
        Try
            Dim qst As String = "select count(*) from TSPL_SLOT_MASTER where Code='" + txtCode.Value + "'"
            ...
            If txtCode.MyReadOnly OrElse isButtonClicked Then
                LoadData(clsSlotMaster.getFinder("", txtCode.Value, isButtonClicked), NavigatorType.Current)
    ...
    Sub DeleteData()
        Try
            If (myMessages.deleteConfirm()) Then
                If (clsSlotMaster.DeleteData(txtCode.Value)) Then
    ...
    Private Sub rmExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rmExport.Click
        ...
        strDetail = " Select Code As [Code],Description As [Description] From TSPL_SLOT_MASTER "
            ...
            Try
                ...
                For Each grow As GridViewRowInfo In gv.Rows
                    ...
                    If clsCommon.myLen(strDesp) > 0 Then
                        Dim chkDesc As Integer = clsCommon.myCdbl(clsDBFuncationality.getSingleValue("select count(*) from TSPL_SLOT_MASTER where Description = '" + strDesp + "' and code <> '" + txtCode.Value + "' "))
                        If chkDesc > 0 Then
                    ...
                    If clsCommon.myLen(strcode) > 0 AndAlso clsDBFuncationality.getSingleValue("Select count(*) from TSPL_SLOT_MASTER  where Code='" + strcode + "' ") > 0 Then
                        isNewEntry = False
                    Else
                        isNewEntry = True
                    End If
